...
'Sheet29.Range("S5A_PANOfSpouse").value = UCase(Sheet29.Range("S5A_PANOfSpouse").value)
 ...
 AadhaarOfSpouse_S5A = Sheet29.Range("S5A_AadhaarOfSpouse").value
    ...
    'Ankita(23-Jan)
           ...
           'start--
'        If Sheet29.Range("S5A_AadhaarOfSpouse").value = "" Then
            If Sheet29.Range("S5A_PANOfSpouse").value = "" Then
            '--end
            
                 Msg5ASheet = Msg5ASheet + Chr(13) & "* Please enter PAN  of the spouse in schedule 5A" & Chr(13)
               ' Msg5ASheet = Msg5ASheet + Chr(13) & "Please enter aadhar of the spouse in schedule 5A" & Chr(13)
                
            End If
                
            ValidatePANOfSpouse_S5A = False
            'commented by Chetan C M on 29/08/2025
            'Exit Function
        End If
            
'Comment removed by Riyaz
        If Not chkCompulsory(AadhaarOfSpouse_S5A) Then
            If PANOfSpouse_S5A = "" Then 'comment removed by Chetan C M on 29/08/2025
                Msg5ASheet = Msg5ASheet + Chr(13) & "* Please enter Aadhaar of the spouse in schedule 5A" & Chr(13)
                ValidatePANOfSpouse_S5A = False
                Exit Function
            End If   'comment removed by Chetan C M on 29/08/2025
        End If
        ...
        End If
         '--------------------14/06/2024
        If Not checkallfieldspecialcharacter_80U_80DD(AadhaarOfSpouse_S5A) Then
               Msg5ASheet = Msg5ASheet + Chr(13) & "Please enter valid Aadhaar Number in schedule 5A" & Chr(13)
                ValidatePANOfSpouse_S5A = False
                Exit Function
        End If
...
Total = Sheet29.Range("S5A_IncRecvdUndHeadTotal").value
    If Not chkCompulsory(IncmRecvdHP) Then
        ...
        'start--
            ...
            Msg5ASheetHP = Msg5ASheetHP + Chr(13) & "Please enter Income received under the head in Schedule 5A. If null, enter Zero" & Chr(13)
        '--end
    ...
    If Not chkCompulsory(IncmHeadHP) Then
        'changed by Chetan C M on 25/08/2025
        'start--
            'Msg5ASheetHP = Msg5ASheetHP + Chr(13) & "Amount apportioned in hands of spouse from House Property in Sheet SCH5A  is Mandatory.Please fill zero if no amount is apportioned in hands of spouse" & Chr(13)
            Msg5ASheetHP = Msg5ASheetHP + Chr(13) & "Please enter Amount apportioned in the hands of the spouse in Schedule 5A. If null, enter Zero" & Chr(13)
        '--end
            ValidateHP_S5A = False
    End If
...
TDSApprndCG = Sheet29.Range("S5A_TDSApprndOfSpouseCG").value
    ...
    If Not chkCompulsory(IncmRecvdCG) Then
         ...
         'start--
            ...
            Msg5ASheetCG = Msg5ASheetCG + Chr(13) & "Please enter Income received under the head in Schedule 5A. If null, enter Zero" & Chr(13)
        '--end
    ...
    'changed by Chetan C M on 25/08/2025
         'start--
            ...
            Msg5ASheetCG = Msg5ASheetCG + Chr(13) & "Please enter Amount apportioned in the hands of the spouse in Schedule 5A. If null, enter Zero" & Chr(13)
        '--end
            ValidateCG_S5A = False
    End If
    ...
    'changed by Chetan C M on 25/08/2025
         'start--
            ...
            Msg5ASheetCG = Msg5ASheetCG + Chr(13) & "Please enter Amount of TDS deducted on income  in Schedule 5A. If null, enter Zero" & Chr(13)
        '--end
            ValidateCG_S5A = False
    End If
    ...
    'changed by Chetan C M on 25/08/2025
         'start--
            ...
            Msg5ASheetCG = Msg5ASheetCG + Chr(13) & "Please enter TDS apportioned in the hands of spouse in Schedule 5A. If null, enter Zero" & Chr(13)
        '--end
            ValidateCG_S5A = False
    End If
    ...
    If Not chkCompulsory(IncmRecvdOS) Then
        'changed by Chetan C M on 25/08/2025
         'start--
            ...
            Msg5ASheetOS = Msg5ASheetOS + Chr(13) & "Please enter Income received under the head in Schedule 5A. If null, enter Zero" & Chr(13)
        '--end
    ...
    If Not chkCompulsory(IncmHeadOS) Then
        'changed by Chetan C M on 25/08/2025
         'start--
            ...
            Msg5ASheetOS = Msg5ASheetOS + Chr(13) & "Please enter Amount apportioned in the hands of the spouse in Schedule 5A. If null, enter Zero" & Chr(13)
        '--end
            ValidateOS_S5A = False
    End If
    ...
    If Not chkCompulsory(TDSAmtDedOS) Then
        'changed by Chetan C M on 25/08/2025
         'start--
            ...
            Msg5ASheetOS = Msg5ASheetOS + Chr(13) & "Please enter Amount of TDS deducted on income  in Schedule 5A. If null, enter Zero" & Chr(13)
        '--end
            ValidateOS_S5A = False
    End If
    ...
    If Not chkCompulsory(TDSAmtDedOS) Then
        'changed by Chetan C M on 25/08/2025
         'start--
            ...
            Msg5ASheetOS = Msg5ASheetOS + Chr(13) & "Please enter TDS apportioned in the hands of spouse in Schedule 5A. If null, enter Zero" & Chr(13)
        '--end
            ValidateOS_S5A = False
    End If
