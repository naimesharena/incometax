...
'Change-28.11.2022.104.09
'    If Sheet201.Range("U_UnabsorbedDepreciationYear").Cells(1).value = "2023-24" Then
    If Sheet201.Range("U_UnabsorbedDepreciationYear").Cells(1).value = "2024-25" Then
...
'     Else
    ...
    If Dformat(Sheet52.Range("sheet9.Date"), "") <= "2026-03-31" Then
    msgbox_1398A = msgbox_1398A + """Please select appropriate option in 'Are you filing the updated return during the period.'""" & Chr(13)
     ValidateSheetGen1398A = False
      End If
       End If
   ...
   ' msgbox_1398A = msgbox_1398A + "* Please select from the drop downs given at field 'Are you eligible for filing an updated return as per the conditions laid out in first, second and third provisos to section 139(8A)?' " & Chr(13)
    msgbox_1398A = msgbox_1398A + "* Please select from the drop downs given at field 'Are you eligible for filing an updated return as per the conditions laid out in first, second, third and fourth provisos to section 139(8A)?' " & Chr(13) 'UR Shrutika(31/10/2025)
...
'    End If
    ...
    End If
End If
'------------------------------------------------Updated by Shrutika(03/11/2025)----------------------
   ...
   setTableInfoGen1398A_1
    ...
    If Sheet201.Range("U_UnabsorbedDepreciation").value = "Yes" Then
        ...
        '08/11/2024 'Malli
            ...
            msgbox_1398A = msgbox_1398A + "* ""Please select from the AY from the drodpown provided at sl.no.A12(b)""" & Chr(13)
            ValidateGen1398A_1 = False
            Exit Function
        End If
'         If end1398A_1 > 0 Then
...
'                       ' msgbox_1398A = msgbox_1398A + "Please select Whether return has been filed at Sr No." & i
'                        'Malli
...
'                        'Malli
'                         'msgbox_1398A = msgbox_1398A + "Please select Return Filed, if yes is selected at Sr No." & i
