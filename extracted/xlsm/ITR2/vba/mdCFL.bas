...
'added by Chetan C M on 28/01/202 for AY 2026-27
'start--
Public datefield12 As Variant
Public datefield13 As Variant
Public datefield14 As Variant
Public datefield15 As Variant
'--end
...
'Added by Shrutika(11/03/2025)
Dim STCGLoss5 As Variant
'-----------------------
Dim LTCGLoss1 As Variant
Dim LTCGLoss2 As Variant
Dim LTCGLoss3 As Variant
'Added by Shrutika(11/03/2025)
Dim LTCGLoss4 As Variant
'-----------------------------
...
Function ValidatesheetCFL() As Boolean
    ...
    'commented by Chetan C M on 23/01/2026 for AY 2026-27
    'start--
...
'    If Not ValidateDateOfFiling7_16() Then ValidatesheetCFL = False
    ...
    If Not ValidateDateOfFiling11_17() Then ValidatesheetCFL = False
    If Not ValidateDateOfFiling11_18() Then ValidatesheetCFL = False
    
      'Added by Aavula
     If Not ValidateDateOfFiling11_19() Then ValidatesheetCFL = False
    '''''''
    
    If Not ValidateDateOfFiling11_20() Then ValidatesheetCFL = False    'added by Chetan C M on 23/01/2026 for AY 2026-27
...
'            msgbox16 ("* Date of Filing (i) in Sch CFL  must not be less than 01/04/2017")
'            '--end
'            Exit Function
'        Else
'            DateOfFiling7_16 = Dformat(Sheet17.Range("yr2006.DateOfFiling7"), "")
...
Function ValidateDateOfFiling8_16() As Boolean
    ...
    If Len(DateOfFiling8_16) = 10 Then
        If Not CheckDateMinDDMMYYYY(DateOfFiling8_16, 1, 4, 2018, "") Then
            ValidateDateOfFiling8_16 = False
            'changed by Chetan C M on 23/01/2026 for AY 2026-27
            'start--
'            'msgbox16 ("* Date of Filing (9) in Sch CFL  must not be less than 01/04/2018")
'           msgbox16 ("* Date of Filing (ii) in Sch CFL  must not be less than 01/04/2018")
            msgbox16 ("* Date of Filing (i) in Sch CFL  must not be less than 01/04/2018")
            '--end
            Exit Function
        Else
            DateOfFiling8_16 = Dformat(Sheet17.Range("yr2006.DateOfFiling9"), "")
...
'            msgbox16 ("* Date of Filing (iii) in Sch CFL  must not be less than 01/04/2019")
            msgbox16 ("* Date of Filing (ii) in Sch CFL  must not be less than 01/04/2019")
            '--end
            Exit Function
        Else
            DateOfFiling9_16 = Dformat(Sheet17.Range("yr2007.DateOfFiling9"), "")
...
'           msgbox16 ("* Date of Filing (iv) in Sch CFL  must not be less than 01/04/2020")
            msgbox16 ("* Date of Filing (iii) in Sch CFL  must not be less than 01/04/2020")
            '--end
            Exit Function
        Else
            DateOfFiling10_16 = Dformat(Sheet17.Range("yr2020.DateOfFiling10"), "")
...
'           msgbox16 ("* Date of Filing (v) in Sch CFL  must not be less than 01/04/2021")
            msgbox16 ("* Date of Filing (iv) in Sch CFL  must not be less than 01/04/2021")
            '--end
            Exit Function
        Else
            DateOfFiling11_16 = Dformat(Sheet17.Range("yr2021.DateOfFiling11"), "")
    ...
    End If
End Function
Function ValidateDateOfFiling11_17() As Boolean
    Dim i As Long
    Dim DateOfFiling11_17
    ValidateDateOfFiling11_17 = True
    DateOfFiling11_17 = Sheet17.Range("yr2022.DateOfFiling11").value
    
    If Not CheckDateddmmyyyy(DateOfFiling11_17) Then
        ValidateDateOfFiling11_17 = False
        msgbox16 ("* DateOfFiling in Sheet : Schedule CFL  is invalid")
        Exit Function
    Else
        DateOfFiling11_17 = Dformat(Sheet17.Range("yr2022.DateOfFiling11"), "")
    End If
    
    If Len(DateOfFiling11_17) = 10 Then
        If Not CheckDateMinDDMMYYYY(DateOfFiling11_17, 1, 4, 2022, "") Then
            ValidateDateOfFiling11_17 = False
            'changed by Chetan C M on 23/01/2026 for AY 2026-27
            'start--
'            'msgbox16 ("* Date of Filing in Sch CFL  must not be less than 01/04/2022")
'            msgbox16 ("* Date of Filing (vi) in Sch CFL  must not be less than 01/04/2022")
            msgbox16 ("* Date of Filing (v) in Sch CFL  must not be less than 01/04/2022")
            '--end
            Exit Function
        Else
            DateOfFiling11_17 = Dformat(Sheet17.Range("yr2022.DateOfFiling11"), "")
    ...
    End If
End Function
' AY2024-25 DE7 naresh.agrawal
Function ValidateDateOfFiling11_18() As Boolean
    Dim i As Long
    Dim DateOfFiling11_18
    ValidateDateOfFiling11_18 = True
    DateOfFiling11_18 = Sheet17.Range("yr2023.DateOfFiling12").value
    
    If Not CheckDateddmmyyyy(DateOfFiling11_18) Then
        ValidateDateOfFiling11_18 = False
        msgbox16 ("* DateOfFiling in Sheet : Schedule CFL  is invalid")
        Exit Function
    Else
        DateOfFiling11_18 = Dformat(Sheet17.Range("yr2023.DateOfFiling12"), "")
    End If
    
    If Len(DateOfFiling11_18) = 10 Then
        If Not CheckDateMinDDMMYYYY(DateOfFiling11_18, 1, 4, 2023, "") Then
            ValidateDateOfFiling11_18 = False
        'changed by Chetan C M on 23/01/2026 for AY 2026-27
        'start--
'            'msgbox16 ("* Date of Filing in Sch CFL  must not be less than 01/04/2023")
'           msgbox16 ("* Date of Filing (vii) in Sch CFL  must not be less than 01/04/2023")
            msgbox16 ("* Date of Filing (vi) in Sch CFL  must not be less than 01/04/2023")
        '--end
            Exit Function
        Else
            DateOfFiling11_18 = Dformat(Sheet17.Range("yr2023.DateOfFiling12"), "")
...
'Added by Aavula Naresh New Dev 2025-26

Function ValidateDateOfFiling11_19() As Boolean
    Dim i As Long
    Dim DateOfFiling11_19
    ValidateDateOfFiling11_19 = True
    DateOfFiling11_19 = Sheet17.Range("yr2024.DateOfFiling13").value
    
    If Not CheckDateddmmyyyy(DateOfFiling11_19) Then
        ValidateDateOfFiling11_19 = False
        msgbox16 ("* DateOfFiling in Sheet : Schedule CFL  is invalid")
        Exit Function
    Else
        DateOfFiling11_19 = Dformat(Sheet17.Range("yr2024.DateOfFiling13"), "")
    End If
    
    If Len(DateOfFiling11_19) = 10 Then
        If Not CheckDateMinDDMMYYYY(DateOfFiling11_19, 1, 4, 2024, "") Then
            ValidateDateOfFiling11_19 = False
        'changed by Chetan C M on 23/01/2026 for AY 2026-27
        'start--
'            'msgbox16 ("* Date of Filing in Sch CFL  must not be less than 01/04/2024")
'            msgbox16 ("* Date of Filing (viii) in Sch CFL  must not be less than 01/04/2024")
             msgbox16 ("* Date of Filing (vii) in Sch CFL  must not be less than 01/04/2024")
        '--end
            Exit Function
        Else
            DateOfFiling11_19 = Dformat(Sheet17.Range("yr2024.DateOfFiling13"), "")
...
'added by Chetan C M on 23/01/2026 for AY 2026-27
'start--
Function ValidateDateOfFiling11_20() As Boolean
    Dim i As Long
    Dim DateOfFiling11_20
    ValidateDateOfFiling11_20 = True
    DateOfFiling11_20 = Sheet17.Range("yr2025.DateOfFiling14").value
    
    If Not CheckDateddmmyyyy(DateOfFiling11_20) Then
        ValidateDateOfFiling11_20 = False
        msgbox16 ("* DateOfFiling in Sheet : Schedule CFL  is invalid")
        Exit Function
    Else
        DateOfFiling11_20 = Dformat(Sheet17.Range("yr2025.DateOfFiling14"), "")
    End If
    
    If Len(DateOfFiling11_20) = 10 Then
        If Not CheckDateMinDDMMYYYY(DateOfFiling11_20, 1, 4, 2025, "") Then
            ValidateDateOfFiling11_20 = False
            msgbox16 ("* Date of Filing (viii) in Sch CFL  must not be less than 01/04/2025")
            Exit Function
        Else
            DateOfFiling11_20 = Dformat(Sheet17.Range("yr2025.DateOfFiling14"), "")
        End If
...
Function ValidateFilingDates() As Boolean
    ...
    'added by Chetan C M on 28/01/2026 for AY 2026-27
    'start--
    Dim amount12 As Variant
    Dim amount13 As Variant
    Dim amount14 As Variant
    Dim amount15 As Variant
    '--end
...
'                Sheet17.Range("yr2001.STCGLossCF2").value + Sheet17.Range("yr2001.LTCGLossCF2").value
    amount2 = Sheet17.Range("yr2001.HPLossCF2").value + Sheet17.Range("yr2001.BusLossOthThanSpecLossCF2").value + _
                Sheet17.Range("yr2001.STCGLossCF2").value + Sheet17.Range("yr2001.LTCGLossCF2").value
...
'                Sheet17.Range("yr2002.STCGLossCF3").value + Sheet17.Range("yr2002.LTCGLossCF3").value
    amount3 = Sheet17.Range("yr2002.HPLossCF3").value + Sheet17.Range("yr2002.BusLossOthThanSpecLossCF3").value + _
                Sheet17.Range("yr2002.STCGLossCF3").value + Sheet17.Range("yr2002.LTCGLossCF3").value
...
'                Sheet17.Range("yr2003.STCGLossCF4").value + Sheet17.Range("yr2003.LTCGLossCF4").value
    amount4 = Sheet17.Range("yr2003.HPLossCF4").value + _
                Sheet17.Range("yr2003.STCGLossCF4").value + Sheet17.Range("yr2003.LTCGLossCF4").value
...
'                Sheet17.Range("yr2004.STCGLossCF5").value + Sheet17.Range("yr2004.LTCGLossCF5").value '+ Sheet17.Range("yr2004.OthSrcLossRaceHorseCF5").value
    amount5 = Sheet17.Range("yr2004.HPLossCF5").value + _
                Sheet17.Range("yr2004.STCGLossCF5").value + Sheet17.Range("yr2004.LTCGLossCF5").value '+ Sheet17.Range("yr2004.OthSrcLossRaceHorseCF5").value
...
'                Sheet17.Range("yr2005.LossFrmSpecifiedBusCF6").value + Sheet17.Range("yr2005.STCGLossCF6").value + Sheet17.Range("yr2005.LTCGLossCF6").value + Sheet17.Range("yr2005.OthSrcLossRaceHorseCF6").value
    amount6 = Sheet17.Range("yr2005.HPLossCF6").value + Sheet17.Range("yr2005.LossFrmSpecBusCF6").value + _
                Sheet17.Range("yr2005.STCGLossCF6").value + Sheet17.Range("yr2005.LTCGLossCF6").value + Sheet17.Range("yr2005.OthSrcLossRaceHorseCF6").value
...
'                Sheet17.Range("yr2006.LossFrmSpecifiedBusCF7").value + Sheet17.Range("yr2006.STCGLossCF7").value + Sheet17.Range("yr2006.LTCGLossCF7").value + Sheet17.Range("yr2006.OthSrcLossRaceHorseCF7").value
     amount7 = Sheet17.Range("yr2006.HPLossCF7").value + Sheet17.Range("yr2006.LossFrmSpecBusCF7").value + _
                 Sheet17.Range("yr2006.STCGLossCF7").value + Sheet17.Range("yr2006.LTCGLossCF7").value + Sheet17.Range("yr2006.OthSrcLossRaceHorseCF7").value
...
'                Sheet17.Range("yr2006.LossFrmSpecifiedBusCF9").value + Sheet17.Range("yr2006.STCGLossCF9").value + Sheet17.Range("yr2006.LTCGLossCF9").value + Sheet17.Range("yr2006.OthSrcLossRaceHorseCF9").value
    amount8 = Sheet17.Range("yr2006.HPLossCF9").value + _
                Sheet17.Range("yr2006.STCGLossCF9").value + Sheet17.Range("yr2006.LTCGLossCF9").value + Sheet17.Range("yr2006.OthSrcLossRaceHorseCF9").value
...
'                Sheet17.Range("yr2007.LossFrmSpecifiedBusCF9").value + Sheet17.Range("yr2007.STCGLossCF9").value + Sheet17.Range("yr2007.LTCGLossCF9").value + Sheet17.Range("yr2007.OthSrcLossRaceHorseCF9").value
    amount9 = Sheet17.Range("yr2007.HPLossCF9").value + _
                Sheet17.Range("yr2007.STCGLossCF9").value + Sheet17.Range("yr2007.LTCGLossCF9").value + Sheet17.Range("yr2007.OthSrcLossRaceHorseCF9").value
...
'                Sheet17.Range("yr2020.LossFrmSpecifiedBusCF10").value + Sheet17.Range("yr2020.STCGLossCF10").value + Sheet17.Range("yr2020.LTCGLossCF10").value + Sheet17.Range("yr2020.OthSrcLossRaceHorseCF10").value
    amount10 = Sheet17.Range("yr2020.HPLossCF10").value + _
                 Sheet17.Range("yr2020.STCGLossCF10").value + Sheet17.Range("yr2020.LTCGLossCF10").value + Sheet17.Range("yr2020.OthSrcLossRaceHorseCF10").value
...
'                Sheet17.Range("yr2021.LossFrmSpecifiedBusCF11").value + Sheet17.Range("yr2021.STCGLossCF11").value + Sheet17.Range("yr2021.LTCGLossCF11").value + Sheet17.Range("yr2021.OthSrcLossRaceHorseCF11").value
    amount11 = Sheet17.Range("yr2021.HPLossCF11").value + _
                 Sheet17.Range("yr2021.STCGLossCF11").value + Sheet17.Range("yr2021.LTCGLossCF11").value + Sheet17.Range("yr2021.OthSrcLossRaceHorseCF11").value
    ...
    'added by Chetan C M on 28/01/2026 for AY 2026-27
    'start--
     datefield12 = Sheet17.Range("yr2022.DateOfFiling11").value
     
    amount12 = Sheet17.Range("yr2022.HPLossCF12").value + _
                 Sheet17.Range("yr2022.STCGLossCF12").value + Sheet17.Range("yr2022.LTCGLossCF12").value + Sheet17.Range("yr2022.OthSrcLossRaceHorseCF11").value
    ...
    datefield13 = Sheet17.Range("yr2023.DateOfFiling12").value
     
    amount13 = Sheet17.Range("yr2023.HPLossCF13").value + _
                 Sheet17.Range("yr2023.STCGLossCF13").value + Sheet17.Range("yr2023.LTCGLossCF13").value + Sheet17.Range("yr2023.OthSrcLossRaceHorseCF12").value

    If Len(datefield13) = 0 Then
        If amount13 > 0 Then
            ValidateFilingDates = False
            msgbox16 ("* DateOfFiling(14) in Sheet : Schedule CFL  is Mandatory ")
            Exit Function
        End If
    End If
    
    datefield14 = Sheet17.Range("yr2024.DateOfFiling13").value
     
    amount14 = Sheet17.Range("yr2024.HPLossCF14").value + _
                 Sheet17.Range("yr2024.STCGLossCF14").value + Sheet17.Range("yr2024.LTCGLossCF14").value + Sheet17.Range("yr2024.OthSrcLossRaceHorseCF13").value

    If Len(datefield14) = 0 Then
        If amount14 > 0 Then
            ValidateFilingDates = False
            msgbox16 ("* DateOfFiling(15) in Sheet : Schedule CFL  is Mandatory ")
            Exit Function
        End If
    End If
    
    datefield15 = Sheet17.Range("yr2025.DateOfFiling14").value
     
    amount15 = Sheet17.Range("yr2025.HPLossCF15").value + _
                 Sheet17.Range("yr2025.STCGLossCF15").value + Sheet17.Range("yr2025.LTCGLossCF15").value + Sheet17.Range("yr2025.OthSrcLossRaceHorseCF14").value

    If Len(datefield15) = 0 Then
        If amount15 > 0 Then
            ValidateFilingDates = False
            msgbox16 ("* DateOfFiling(16) in Sheet : Schedule CFL  is Mandatory ")
            Exit Function
        End If
    End If
    '--end
...
Function ValidateLTCGLossCurrentYr() As Boolean
 ValidateLTCGLossCurrentYr = True
    ...
    'LTCGLoss1 = Sheet13.Range("IHLA.Eviii5_LtclSetOff10Per").value 'by sadineni on 30/01/2026 for AY 2026-27
    'LTCGLoss2 = Sheet13.Range("IHLA.Eviii6_LtclSetOff20Per").value 'by sadineni on 30/01/2026 for AY 2026-27
     LTCGLoss3 = Sheet13.Range("IHLA.Eviii8_LtclSetOffDTAARate").value
     LTCGLoss4 = Sheet13.Range("IHLA.Exii8_LtclSetOff12.5Per").value 'Added by Shrutika(11/03/2025)
    
    'LTCGLossCurrentYrCalculated = LTCGLoss1 + LTCGLoss2 + LTCGLoss3 + LTCGLoss4 'Added by Shrutika(11/03/2025)
    
     LTCGLossCurrentYrCalculated = LTCGLoss3 + LTCGLoss4 'by sadineni on 30/01/2026 for AY 2026-27
...
'    STCGLoss1 = Sheet13.Range("IHLA.Eviii2_StclSetoff15Per").value 'by sadineni on 30/01/2026 for AY 2026-27
    ...
    'Added by Shrutika(11/03/2025)
    STCGLoss5 = Sheet13.Range("IHLA.Exii2_StclSetoff20Per").value
    
    'STCGLossCurrentYrCalculated = STCGLoss1 + STCGLoss2 + STCGLoss3 + STCGLoss4 + STCGLoss5 'Added by Shrutika(11/03/2025)
     STCGLossCurrentYrCalculated = STCGLoss2 + STCGLoss3 + STCGLoss4 + STCGLoss5 'by sadineni on 30/01/2026 for AY 2026-27
...
'Added by Riyaz Range 20&12.5% Ranges on 04/03/2025
Sheet17.Range("yr2007.STCGLossCF10").formula = "=IHLA.Eviii2_StclSetoff15Per+IHLA.Exii2_StclSetoff20Per+IHLA.Eviii3_StclSetoff30Per+IHLA.Eviii4_StclSetoffAppRate+IHLA.Eviii5_StclSetoffDTAARate"
Sheet17.Range("yr2007.LTCGLossCF10").formula = "=IHLA.Eviii5_LtclSetOff10Per+IHLA.Exii8_LtclSetOff12.5Per+IHLA.Eviii6_LtclSetOff20Per+IHLA.Eviii8_LtclSetOffDTAARate"
