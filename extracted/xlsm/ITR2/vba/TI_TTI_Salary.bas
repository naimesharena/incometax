...
'Malli____________PARTB_TI_C10_AY_2025_25
 Public ShortTerm20_8b As Variant
'----------------------------------------
...
'Malli______PartB_TI_C17_AY_2025_26
Public LongTerm_8b_125NP As Variant
'--------------------------------------
...
Public chk_paninTDS As Boolean
'----------------------------------------
...
tempcheck = ""
sRangeValue1 = ""
'EfilingCommon.DefinedgridNameRange = "Sheet9.OthMICRCode||Sheet9.OthBankName||Sheet9.OthBankAccountNumber||Sheet9.CheckBox||tempxml"
'Newly added by Bindu
'EfilingCommon.DefinedgridNameRange = "Sheet9.OthMICRCode||Sheet9.OthBankName||Sheet9.OthBankAccountNumber||Sheet9.TypeOfAccount"
'Shrutika_AY_2025_26 11/02/2025
...
If Not Validatesheet8b Then
 ...
 'added new
 '------------------------------------------
  validateRebate87AGreater 'by sadineni on 06/02/2026 for AY 2026-27
'--------------------------------------
    ...
    If end_IBAN <> end_IBANNameOfBank Or _
       ...
       'Commented by Shrutika
        ...
        If IBANSELECT = "N" And end_IBAN < 1 Then
        msgbox9 ("* Please enter the SWIFT Code  in Schedule Part B TTI in point 18")
    End If
    End If
...
'by sadineni on 06/02/2026 for AY 2026-27
Function validateRebate87AGreater() As Boolean
validateRebate87AGreater = True

Dim Rebate87Avalue As Variant
Dim TaxpayableGreater As Variant

Rebate87Avalue = (Range("Sheet9.RebateUs88E").value)
TaxpayableGreater = (Range("sheet9.TaxPayableOnTotInc").value)

If Rebate87Avalue > TaxpayableGreater Then
   msgbox9 ("*""rebate u/s 87A cannot exceed tax payable"".")
End If
...
Sub ValidateScheduleS_Click()
 ...
 If MsgScheduleS = "" Or MsgScheduleS1 = "" Then
    fmsgboxStatus "Sheet Schedule S is OK." ', vbOKOnly, "ITR 3 : 2022-23"
 End If
End Sub
Sub validateSchS()
...
subProcCaption = "Validating Schedule S"
   If Not validateScheduleS Then
    ...
    fmsgboxsmall MsgScheduleS ', vbOKOnly, "ITR 3 : 2022-23"
    CloseMsg
    End If
    validate10aaAmount
...
'     ValidateLessAllowanceTable = False
    ...
    '************************************************************************************************************
'SIT-97272 Sadineni_23_07_2025
Dim block As Long
Dim Gratuity_Sal, Ex1014iii_Gratuity As Long
...
'**********************************************************************************************************************
  ...
  '    '============================================
    ...
    endEA10_13A_6 = 0               'Ankita_14/05/2025_Changed as per clarififcation tracker updated by Bhoomija
           ...
           ' EA_Sch10of13A_BasicSalary = Sheet39.Range("Sch10of13A_BasicSalary")
           ' EA_Sch10of13A_DearAllowance = Sheet39.Range("Sch10of13A_DearAllowance")
...
'        MsgScheduleS1 = MsgScheduleS1 + "* Please select dropdown from ""Place of work"" in schedule S." & Chr(13)
        ...
        If Not chkCompulsory(EA_Sch10of13A_ActlHRArecivedA) Or EA_Sch10of13A_ActlHRArecivedA = 0 Then
            'MsgScheduleS1 = MsgScheduleS1 + "* ""Please provide actual HRA received in schedule S""" & Chr(13)
            'ValidateEA10_13A_1 = False
            'Exit Function
        Else
...
'            If Not IsNumeric(EA_Sch10of13A_ActlHRArecivedA) Then
    ...
    '=====================
        'commented by sudha need to check
        ...
        End If
         ...
         'If Not chkCompulsory(EA_Sch10of13A_BasicSalary) Or EA_Sch10of13A_BasicSalary = 0 Then
            'MsgScheduleS1 = MsgScheduleS1 + "* ""Please provide Basic salary in schedule S""" & Chr(13)
            'ValidateEA10_13A_1 = False
            'Exit Function
       ' Else
            'If Len(EA_Sch10of13A_BasicSalary) > 14 Then
               ' MsgScheduleS1 = MsgScheduleS1 + "* ""Basic salary cannot be greater than 14 digits in schedule S""" & Chr(13)
                'ValidateEA10_13A_1 = False
                'Exit Function
            'End If
            
'            If Not IsNumeric(EA_Sch10of13A_BasicSalary) Or EA_Sch10of13A_BasicSalary < 0 Then
'                MsgScheduleS1 = MsgScheduleS1 + "* ""Amount entered Should be Numeric, Non negative, no decimal, upto 99,999,999,999,999 at Basic salary in schedule S""" & Chr(13)
'               ' ValidateEA10_13A_1 = False
'               'Exit Function
'            End If
'        End If
...
'            MsgBox_EA10_13A = MsgBox_EA10_13A + "* ""Dearness Allowance cannot be greater than 14 digits in schedule S""" & Chr(13)
'            'ValidateEA10_13A_1 = False
'            'Exit Function
'            End If
'            If Not IsNumeric(EA_Sch10of13A_DearAllowance) Or EA_Sch10of13A_DearAllowance < 0 Then
'                MsgBox_EA10_13A = MsgBox_EA10_13A + "* ""Amount entered Should be Numeric, Non negative, no decimal, upto 99,999,999,999,999 at Dearness Allowance in schedule S""" & Chr(13)
'                'ValidateEA10_13A_1 = False
'               ' Exit Function
'            End If
'        End If
...
Function validate10aaAmount()
    ...
    is10AA = False
     For count = 1 To Sheet39.Range("SalarySectionCount").value
        If UCase(Sheet39.Range("sheet.EmployerCategory" & count).value = "OTHERS") Or Sheet39.Range("sheet.EmployerCategory" & count).value = "Others-Pensioners" Then
        isGovt = False
        ...
        If istan = False Then
            For Each rCell In Range("Salary.Nature1").Cells
                If rCell.value = "Sec 10(10AA)-Earned leave encashment on Retirement" Then
                    ...
                    If Range("J" & rCell.row).value > 2500000 Then ' Chandru AY2024-25 Changes
                        fmsgboxStatus "Deduction u/s 10(10AA) shall be restricted to Rs. 25 Lakh in case of  employer catergory is selected as other than Central or State Government"
...
ValidateIBANSELECT = True
    ...
    If IBANSELECT = "" Or IsEmpty(IBANSELECT) Then
        ...
        'Added by Aavula
        msgbox9 ("Selection of 'Do you have a bank account in India' is mandatory in Schedule Part B TTI in point 18.")
...
ValidateIBANNameOfBank = True
    ...
    For i = 1 To end_IBAN
        ...
        If (Len(IBANNameOfBank(i)) < 1) Or (Len(IBANNameOfBank(i)) > 125) Then
           ...
           'Addded by Jyoti
            msgbox9 ("* Please enter Name of the Bank  in Schedule Part B TTI in point 18")
...
ValidateIBANBankAccountNumber_9 = True
    ...
    For i = 1 To end_IBAN
        ...
        'Jyoti108
            ...
            msgbox9 ("Please enter the IBAN in Schedule Part B TTI in point 18")
...
ValidateIBANCountry_9 = True
    ...
    For i = 1 To end_IBAN
        ...
        'Jyoti107
            ...
            'Added by Shrutika
            msgbox9 ("Please select an option from the drop down in Schedule Part B TTI in point 18")
        'Commented by Shrutika
            'msgbox9 ("Please enter Name of the Bank  in Schedule Part B TTI in point 18")
...
Function ValidateDate_9() As Boolean
    ...
    If Not CheckDateMinDDMMYYYY(Date_9, 1, 4, 2024, "Verification date cannot be less than 01/04/2024") Then 'dpk1601
        ValidateDate_9 = False
        msgbox9 ("Date in Verification , Sheet PART B - TI - TTI must not be less than 01/04/2024" & Chr(13)) 'dpk1601
        Exit Function
    Else
        Date_9 = Dformat(Sheet52.Range("sheet9.Date"), "yyyy-mm-dd")
    End If
...
Function ValidateAOIFlag() As Boolean
    ...
    'Jyoti104
        ...
        msgbox9 ("Please select an option from the drop down  in Schedule Part B TTI in point 19" & Chr(13))
...
'SchSTotIncUnderHeadSalaries1 = Sheet39.Range("SAL.TotIncUnderHeadSalaries1").value
   ...
   ' SchSIncomeFromSalary1(i) = Sheet39.Range("SAL.IncomeFromSalary" & i + 1).value
    ...
    'Malli-----------------------17/09/24
      ...
      PIN_targetadd = Replace(state_targetadd, "H", "K")
                             ...
                             Set ws1 = Worksheets("Schedule S")  '23/09/24
        ...
        ' If state_Validation(ws1, PIN_targetadd, state_targetadd) = False Then Sheet39.Range(Replace(state_targetadd, "H", "K")).value = ""
         ...
         If Not PINstate_ModualValidation(ws1, PIN_targetadd, state_targetadd) Then
             ...
             ' MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* ""Pin code is mandatory in schedule salary.""" & Chr(13)
           validateScheduleS = False
         End If
 ...
 'Jyoti_10_03_2025
        If Sheet39.Range("SAL.TotalGrossSalary") > 99999999999999# Then
            'MsgPartBScheduleS(i) = MsgScheduleS1 + "*  cannot exceed 14 digits" & Chr(13)
            MsgPartBScheduleS(i) = MsgScheduleS1 + "*Total of gross salary from all employers cannot exceed 14 digits" & Chr(13)
            validateScheduleS = False
            Exit Function
        End If
        'Jyoti_10_03_2025
     
        If Sheet39.Range("SAL.Netsalary1") > 99999999999999# Then
            'MsgPartBScheduleS(i) = MsgScheduleS1 + "* cannot exceed 14 digits" & Chr(13)
            MsgPartBScheduleS(i) = MsgScheduleS1 + "*Net Salary (2–3- 3a)cannot exceed 14 digits" & Chr(13)
            validateScheduleS = False
            Exit Function
        End If
       'Jyoti_10_03_2025
       If Sheet39.Range("SAL.IncomeFromSalary1") > 99999999999999# Then
            'MsgPartBScheduleS(i) = MsgScheduleS1 + "* cannot exceed 14 digits" & Chr(13)
            MsgPartBScheduleS(i) = MsgScheduleS1 + "* Income chargeable under the Head ‘Salaries’ (4 – 5) cannot exceed 14 digits" & Chr(13)
            validateScheduleS = False
            Exit Function
        End If
...
'Added by Jyoti
    ...
    'MsgPartBScheduleS(i) = "Please enter a 10 character TAN in Salary Schedule" & Chr(13) & Chr(13) + MsgPartBScheduleS(i)
    'End If
    UpdateProgressBar
Next
End Function
...
On Error Resume Next
   ...
   'Added by Aavula Naresh----------
    If SchSEmpPAN(count) = "" Then
        If chk_paninTDS = False Then
            If Sheet28.Range("chk_tdsandsalary").value > 0 Then
               ' MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* ""If Column no 4 of TDS 1 Schedule is filled then Tan number of employer cannot be blank at Sr.No " & count & "  Schedule Salary.""" & Chr(13)
                
                MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* ""If Column no 4 of TDS 1 Schedule is filled then Tan of employer cannot be blank at Sr.No " & count & "  Schedule Salary.""" & Chr(13) 'Added by Shrutika(Confirm with Shilpa)15/10/2025
...
If SchSEmployer(count) = "" Or SchSEmployer(count) = "(Select)" Then
    ...
    'Shrutika
     MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* ""Please Select from the drop down at field Nature of employer in schedule Salary.""                "
...
If SchSEmpAddr(count) = "" Then
  ...
  MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Address of employer in schedule salary is mandatory." & Chr(13)
    checKMandatoryFields = False
End If
...
If SchSEmpTown_City(count) = "" Then
   ...
   MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Town/city is mandatory in schedule salary." & Chr(13)
    checKMandatoryFields = False
End If
...
If SchSEmpState(count) = "" Or Mid(SchSEmpState(count), 1, 1) = "(" Then
   ...
   MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* State is compulsory in schedule salary." & Chr(13)
    checKMandatoryFields = False
End If

'MsgBox SchSEmpState(count)
...
If Mid(SchSEmpState(count), 1, 2) = "99" Then
  ...
  MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Zip Code is compulsory in schedule salary." & Chr(13)
    checKMandatoryFields = False
    End If
...
Else
  ...
  '  MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Please enter Pincode in Salary Schedule" & Chr(13)
   ...
   'changed by Chetan C M on 11/08/2025
    'start--
'    MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Pincode is mandatory in schedule salary." & Chr(13)
    MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Pin code is mandatory in schedule salary." & Chr(13)
    '--end
    ...
    'End If
    'Malli----------------------2017/10/2024
    ElseIf SchSEmpState(count) <> "" Then
           
       Dim PIN_targetadd, state_targetadd As String
         
     'MsgBox SchSEmpState(count)
     state_targetadd = Replace(Sheet39.Range("SAL.StateCode" & count).Address, "$", "")
      PIN_targetadd = Replace(state_targetadd, "H", "K")
...
'           MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Enter Nature of salary in  section 17(1) at Sr. No " & i & "in Salary Schedule" & Chr(13)
           MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Please select Nature of salary in Salary as per section 17(1) at Sr. No " & i & "in Salary Schedule" & Chr(13)
'End Change.IDS.39
        checKMandatoryFields = False
        Exit Function
        End If
        ...
        If (Sheet39.Range("Salary.SalaryAmount" & count).Cells.item(i).value) = "" Then
            ...
            'Shrutika
            MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* ""please enter amount in salary as per section 17(1) in schedule salary"" "
...
'            MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Enter Description for the selected section 17(1)at Sr. No " & i & "in Salary Schedule" & Chr(13)
            MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "*  ""Description is mandatory if Any Other is selected. Please enter Description in Salary as per section 17(1) in schedule salary""" & Chr(13)
            checKMandatoryFields = False
            Exit Function
            End If
        End If
    ...
    'End If
        'Change-19.04.2023.103.Salary.02
        ...
        'Change-19.04.2023.103.Salary.03
        If Sheet39.Range("Salary.Section" & count).Cells.item(i).value = "Contribution made by the central government towards Agnipath scheme as referred  under section 80CCH" Then
'            If Range("sheet.EmployerCategory" & count) <> "Central Government" Or (Dformat((Sheet1.Range("sheet1.DOB").value), "") < "2001-03-31" Or Dformat((Sheet1.Range("sheet1.DOB").value), "") > "2007-04-01") Then
    'SIT-114740 by sadineni on 20/03/2026
            If Range("sheet.EmployerCategory" & count) <> "Central Government" Or (Dformat((Sheet1.Range("sheet1.DOB").value), "") < "1999-03-31" Or Dformat((Sheet1.Range("sheet1.DOB").value), "") > "2009-04-01") Then
             'If Range("sheet.EmployerCategory" & count) <> "Central Government" Then
                MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "Contribution made by the central government towards Agnipath scheme as referred  under section 80CCH can only be selected, if user has enrolled into the Agnipath Scheme"
                checKMandatoryFields = False
                Exit Function
            End If
        End If
...
'         MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Enter Nature of  perquisites in Value of perquisites as per section 17(2) at Sr. No " & i & "in Salary Schedule" & Chr(13)
         MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* ""please select dropdown in Value of perquisites as per section 17(2) in Schedule Salary""" & Chr(13)
        checKMandatoryFields = False
        Exit Function
        End If
...
'            MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Enter Description for the selected Section in Value of perquisites as per section 17(2) " & i & "in Salary Schedule" & Chr(13)
             MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* ""Description is mandatory if Any Other is selected. Please enter Description in Value of perquisites as per section 17(2) in Schedule Salary""" & Chr(13)
            checKMandatoryFields = False
            Exit Function
            End If
        End If
...
'        MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Enter Nature of Profit in lieu of Salary in Profit in lieu of salary as per section 17(3) at Sr. No " & i & "in Salary Schedule" & Chr(13)
      MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* ""please select dropdown in profit in lieu of salary as per section 17(3) in Schedule Salary""" & Chr(13)
        checKMandatoryFields = False
        Exit Function
        End If
...
'            MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Enter Amount  in Profit in lieu of salary as per section 17(3) at Sr. No " & i & Chr(13)
            MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* ""please enter amount in profit in lieu of salary as per section 17(3) in Schedule Salary""" & Chr(13)
            checKMandatoryFields = False
            Exit Function
        End If
...
'            MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* Enter Description for the selected Section in Profit in lieu of salary as per section 17(3) at Sr. No " & i & "in Salary Schedule" & Chr(13)
           MsgPartBScheduleS(count) = MsgPartBScheduleS(count) + "* ""Description is mandatory if Any Other is selected. Please enter Description in profit in lieu of salary as per section 17(3) in Schedule Salary""" & Chr(13)
            checKMandatoryFields = False
            Exit Function
            End If
        End If
...
Function ValidateShortTermUs111A_8b() As Boolean
    ...
    'Malli____________PARTB_TI_C10_AY_2025_25
     ShortTerm20_8b = Sheet7.Range("Sheet8b.ShortTerm20").value
    '----------------------------------------
    ...
    If Len(ShortTerm20_8b) > 14 Then
        msgbox8b ("ShortTermUs111A should not greater than 14 digits in Sheet PART - TI - TTI ")
        ValidateShortTermUs111A_8b = False
        Exit Function
    End If

    For i = 1 To Len(ShortTerm20_8b)
        If Not IsNumeric(ShortTerm20_8b) Then
            msgbox8b ("ShortTermUs111A must contain only digits from 0 to 9 in Sheet PART - TI - TTI ")
            ValidateShortTermUs111A_8b = False
            Exit Function
        End If
...
Function ValidateLongTerm_8b() As Boolean
    ...
    'Malli______PartB_TI_C17_AY_2025_26
    LongTerm_8b_125NP = Sheet7.Range("Sheet8b.LongTerm12.5NP").value
    '-----------------------------------
    ...
    'Malli______PartB_TI_C17_AY_2025_26
    If Len(LongTerm_8b_125NP) > 14 Then
        msgbox8b ("LongTerm should not greater than 14 digits in Sheet PART - TI - TTI ")
        ValidateLongTerm_8b = False
        Exit Function
    End If
    
    For i = 1 To Len(LongTerm_8b_125NP)
        If Not IsNumeric(LongTerm_8b_125NP) Then
            msgbox8b ("LongTerm must contain only digits from 0 to 9 in Sheet PART - TI - TTI ")
            ValidateLongTerm_8b = False
            Exit Function
        End If
...
Sub AddTotalSalary1()
  Dim Row7RangeName As String
    ...
    Totsections = Sheet39.Range("SalarySectionCount").value
        ...
        Sheet39.Range("SAL.Salary" & i).value = Sheet39.Range("SAL.AllowancesNotExempt" & i).value + Sheet39.Range("SAL.ValueOfPerquisites" & i).value + Sheet39.Range("SAL.ProfitsinLieuOfSalary" & i).value + Sheet39.Range("IncomeNotified89A" & i).value + Sheet39.Range("IncomeNotifiedOther89A" & i).value + Sheet39.Range("IncomeClaimed89A" & i).value
...
ValidateAmount = False
    ...
    For i = 1 To end_OthersNOI_s
        ...
        'start--
            ...
            MsgScheduleS1 = MsgScheduleS1 + "* Please enter Amount against Nature of Exempt Allowance in schedule salary" & Chr(13)
        '--end
            ValidateAmount = False
            Exit Function
        End If
