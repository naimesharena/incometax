...
Dim OthAmount_Salary, end_BP_xml, end_OE_xml, rngname_35AD_BP_xml, rngname_OE_BP_xml, BPDrp As Variant
...
Print #1, "<ITRForm:AssessmentYear>" & "2023" & "</ITRForm:AssessmentYear>" 'dpk1601
...
Dim i As Long
    ...
    If (TotBF_UD > 0 Or TotSetoff_UD > 0 Or TotBalance_UD > 0 Or TotBF_UD2 > 0 Or _
        ...
        writeXML "<ITRForm:CurrAssYr>2023-24</ITRForm:CurrAssYr>" 'dpk1601
...
Function GrossSalary(ByVal myindex As Long) As String
    ...
    If end_SalaryNature > 0 Then
        ...
        For j = 1 To end_SalaryNature
            ...
            If UCase(Trim(SalaryNature_Salary(myindex, j))) = UCase("Amount deemed to be income under rule 11(4) of Part-A of Fourth Schedule") Then SalaryNature_Salary(myindex, j) = "9"
            ...
            If UCase(Trim(SalaryNature_Salary(myindex, j))) = UCase("Amount deemed to be income under rule 6 of Part-A of Fourth Schedule") Then SalaryNature_Salary(myindex, j) = "10"
