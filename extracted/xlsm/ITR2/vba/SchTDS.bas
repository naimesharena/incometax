...
Option Explicit
Public msgbox_TDS1, msgbox_TDS2, msgbox_TDS3, msgValidateSheetTDS3, msgbox_TCS1 As String ', msgbox_TCS1
 Dim i As Long
...
'SectionTDSDeducted_TDS2
Public SectionTDSDeducted_TDS2, SectionTDSisdeduct_TDS2, SectionTDSisDeduct_TDS3 As Variant
Public rngname_TDS2 As Variant
Public end_TDS2, end_TDS2_GrossAmount, end_TDS2_Head, end_TDS2_Pan, end_TDS2_Section_TDS_deducted, end_TDS22, end_TDS23, end_TDS24, end_TDS25, end_TDS26, end_TDS27, end_TDS28, end_TDS29, end_TDS201, end_TDS202, end_TDS203, end_TDS204, end_TDS205, end_TDS206, end_TDS207, end_TDS208, end_TDS209, end_TDS210, end_TDS211, end_TDSTANentry As Variant
...
'----TCS----
'Public TCSCreditName_TCS As Variant
'Public TCSPanOfOther_TCS As Variant
'Public TCSAadharOfOther_TCS As Variant
'
'Public TAN_TCS As Variant
'Public EmployerOrDeductorOrCollecterName_TCS As Variant
'Public UTN_TCS As Variant
'Public DeductedYear_TCS As Variant
'Public BroughtFwdTCSAmt_TCS As Variant
'Public DeductedInOwnHands_TCS As Variant
'Public DeductedIncome5A_TCS As Variant
'Public DeductedTCS5A_TCS As Variant
'Public DeductedPAN5A_TCS As Variant
'Public TCSClaimedInOwnHands_TCS As Variant
'Public GrossAmount_TCS As Variant
'Public HeadIncome_TCS As Variant
'Public ClaimedIncome5A_TCS As Variant
'Public ClaimedTCS5A_TCS As Variant
'Public ClaimedPAN5A_TCS As Variant
'Public ClaimedAadhar5A_TCS As Variant
'Public AmtCarriedForward_TCS As Variant
'
'Public rngname_TCS As Variant
'Public end_TCS, end_TCS_GrossAmount, end_TCS_Head, end_TCS_Pan, end_TCS2, end_TCS3, end_TCS4, end_TCS5, end_TCS6, end_TCS7, end_TCS8, end_TCS9, end_TCS01, end_TCS02, end_TCS03, end_TCS04, end_TCS05, end_TCS06, end_TCS07, end_TCS08, end_TCS09, end_TCS10, end_TCS11, end_TCSTANentry As Variant


'-----TCS-----
Public TAN_TCS As Variant
Public EmployerOrDeductorOrCollecterName_TCS As Variant
Public AddrDetail_TCS As Variant
Public CityOrTownOrDistrict_TCS As Variant
Public StateCode_TCS As Variant
Public PinCode_TCS As Variant
Public AmtDebited_TCS As Variant
Public DatePayDeb_TCS As Variant
Public TotalTCS_TCS As Variant
Public BroughtFwdTDSAmt_TCS As Variant
Public AmtCarriedFwd_TCS As Variant
Public AmtTCSClaimedThisYear_TCS As Variant
Public rngname_TCS2 As Variant
Public end_TCS2 As Variant
Public rngname_TCS As Variant
Public end_TCS As Variant
Public msgValidateSheetTCS As String
Public validate_TDS2


Public TotalAmt_TDS2, TotalAmt_TDS3, TotalAmt_TCS As Variant
...
Sub Cmd_AddRows_TDS1_Imp(DiffRows As Long)
Dim vRows As Long
Sheet28.Activate
EfilingCommon.DefinedgridNameRange = ("TDS1.TAN||TDS1.EmployerOrDeductorOrCollecterName||TDS1.IncChrgSal||TDS1.TotalTDSSal")
ActiveCellRange = EfilingCommon.searchLastRow("TDS1.TAN")
...
'TDS_C1_2024_25 Change 'Malli
'EfilingCommon.DefinedgridNameRange = ("TDS2.TDSCreditName||TDS2.GrossAmount||TDS2.HeadOfIncome||TDS2.PanOtherPerson||TDSAadharOfOther_TDS2||TDS2.TAN||TDS2.Section_TDS_deducted||TDS2.DeductedYear||TDS2.BroughtFwdTDSAmt||TDS2.DeductedInOwnHands||TDS2.DeductedIncome5A||TDS2.DeductedTDS5A||TDS2.ClaimedInOwnHands||TDS2.ClaimedIncome5A||TDS2.ClaimedTDS5A||TDS2.ClaimedPAN5A||ClaimedAadhar5A_TDS2||TDS2.AmtCarriedForward")
ActiveCellRange = EfilingCommon.searchLastRow("TDS2.TAN")
vRows = EfilingCommon.insertRowUnderSectionWithFormula
End Sub

Sub Cmd_AddRows_TDS2_Imp(DiffRows As Long)
Dim vRows As Long
Sheet28.Activate
EfilingCommon.DefinedgridNameRange = ("TDS2.TDSCreditName||TDS2.GrossAmount||TDS2.HeadOfIncome||TDS2.PanOtherPerson||TDSAadharOfOther_TDS2||TDS2.TAN||TDS2.DeductedYear||TDS2.BroughtFwdTDSAmt||TDS2.DeductedInOwnHands||TDS2.DeductedIncome5A||TDS2.DeductedTDS5A||TDS2.ClaimedInOwnHands||TDS2.ClaimedIncome5A||TDS2.ClaimedTDS5A||TDS2.ClaimedPAN5A||ClaimedAadhar5A_TDS2||TDS2.AmtCarriedForward")
ActiveCellRange = EfilingCommon.searchLastRow("TDS2.TAN")
...
EfilingCommon.DefinedgridNameRange = ("TCS.TAN||TCS.EmployerOrDeductorOrCollecterName||TCS.TotalTCS||TCS.AmtTCSClaimedThisYear||TCS.AmtCarriedFwd")
ActiveCellRange = EfilingCommon.searchLastRow("TCS.TAN")
vRows = EfilingCommon.insertRowUnderSectionWithFormula
End Sub


Sub Cmd_AddRows_TCS_Imp(DiffRows As Long)
Dim vRows As Long
Sheet28.Activate
'EfilingCommon.DefinedgridNameRange = ("TCS.TAN||TCS.EmployerOrDeductorOrCollecterName||TCS.DeductedYear||TCS.BroughtFwdTDSAmt||TCS.TotalTCS||TCS.AmtTCSClaimedThisYear||TCS.AmtCarriedFwd")
EfilingCommon.DefinedgridNameRange = ("TCS.TAN||TCS.EmployerOrDeductorOrCollecterName||TCS.TotalTCS||TCS.AmtTCSClaimedThisYear||TCS.AmtCarriedFwd")
...
Sub Cmd_AddRows_TDS3_Imp(DiffRows As Long)
Dim vRows As Long
Sheet28.Activate
EfilingCommon.DefinedgridNameRange = ("TDS3.TDSCreditName||TDS3.GrossAmount||TDS3.HeadOfIncome||TDS3.PanOtherPerson||Aadhar_TDS3||TDS3.PAN||TDS3.Aadhaar||TDS3.DeductedYear||TDS3.BroughtFwdTDSAmt||TDS3.DeductedInOwnHands||TDS3.DeductedIncome5A||TDS3.DeductedTDS5A||TDS3.ClaimedInOwnHands||TDS3.ClaimedIncome5A||TDS3.ClaimedTDS5A||TDS3.ClaimedPAN5A||ClaimedAadhar5A_TDS3||TDS3.AmtCarriedForward")
ActiveCellRange = EfilingCommon.searchLastRow("TDS3.PAN")
...
'        CloseMsg
'    End If
 subProcCaption = "Validating TCS 1"
    If Not ValidateTCS1 Then
        Sheet28.Activate
        fmsgboxsmall msgValidateSheetTCS ', vbOKOnly, "ITR7"
        CloseMsg
    End If
...
'Ankita_08/09/2025_SIT-89279 =========================================
    ...
    If Sheet28.Range("Incm_TDS1").value > 0 Then
           ' If IIf(Sheet39.Range("SAL.Salary2").value = "", 0, (Sheet39.Range("SAL.Salary2").value)) < (Sheet28.Range("Incm_TDS1").value - 10) Then
                'By Bindu on 12th feb 26  IPIP-89935
            If IIf(Sheet39.Range("Tempgross").value = "", 0, (Sheet39.Range("Tempgross").value)) < (Sheet28.Range("Incm_TDS1").value - 10) Then
                fmsgbox "* ""Amount of gross salary disclosed in Schedule Salary is less than Salary reported in Schedule TDS1.""" & Chr(13)
            End If
    End If
'=====================================================================
...
For i = 1 To Sheet28.Range("TDS1.TAN").count
    ...
    If Sheet28.Range("TDS1.TAN").Cells(i, 1).value <> "" Or Sheet28.Range("TDS1.EmployerOrDeductorOrCollecterName").Cells(i, 1).value <> "" Or Sheet28.Range("TDS1.IncChrgSal").Cells(i, 1).value <> "" Or Sheet28.Range("TDS1.TotalTDSSal").Cells(i, 1).value <> "" Then


  If Sheet28.Range("TDS1.TAN").Cells(i, 1).value = "" Then
            ValidatesheetTDS1 = False
   msgbox_TDS1 = msgbox_TDS1 + "* Please enter the TAN of Employer in Schedule TDS-1 at Sr.NO " & i & "." & Chr(13)
        End If
        
        If Sheet28.Range("TDS1.EmployerOrDeductorOrCollecterName").Cells(i, 1).value = "" Then
            ValidatesheetTDS1 = False
     msgbox_TDS1 = msgbox_TDS1 + "* Please enter the Name of Employer at Sr.NO " & i & "" & Chr(13)
        End If

         If Sheet28.Range("TDS1.IncChrgSal").Cells(i, 1).value = "" Then
            ValidatesheetTDS1 = False
    msgbox_TDS1 = msgbox_TDS1 + "* Please enter the Income chargeable under Salaries in Schedule TDS1 at Sr.NO " & i & "" & Chr(13)
        End If

         If Sheet28.Range("TDS1.TotalTDSSal").Cells(i, 1).value = "" Then
            ValidatesheetTDS1 = False
    msgbox_TDS1 = msgbox_TDS1 + "* Please enter the Total Tax Deducted in Schedule TDS-1 at Sr.NO " & i & "." & Chr(13)
        End If
 ...
 If Not Len(TAN_TDS1(i)) = 0 Then
     ...
     If Not ValidateTantype_text(Mid(TAN_TDS1(i), 1, 4)) Then
      '   msgbox_TDS1 = msgbox_TDS1 + "* Please enter the TAN at Sr. No  " & i & " is invalid. First 4 alphabets, next 5 digits, then alphabet in Schedule TDS1" & Chr(13)
       'Shrutika
       msgbox_TDS1 = msgbox_TDS1 + "*  Invalid TAN. TAN format should be First 4 alphabets, then 5 digits, then alphabet in Schedule TDS-1" & Chr(13)
     ...
     End If
      ...
      If Not ValidateTANCodes(UCase(TAN_TDS1(i))) Then
               ...
               'Shrutika
               msgbox_TDS1 = msgbox_TDS1 + "* Invalid TAN" & Chr(13)
                ValidateTAN_TDS1 = False
                Exit Function
        End If
...
'         'msgbox_TDS1 = msgbox_TDS1 + "* Please enter the EmployerOrDeductorOrCollector Name at Sr.No 1 in Schedule TDS 1" & Chr(13)
'
'         'Ayush
'         msgbox_TDS1 = msgbox_TDS1 + "* Please enter the Name of Employer" & Chr(13)
'         'msgbox_TDS1 = msgbox_TDS1 + "* Please enter the Name of Employer Sr.No 1 in Schedule TDS 1" & Chr(13)
'
'
...
'
'             'Shrutika
'            ' msgbox_TDS1 = msgbox_TDS1 + "* Please enter the Total tax deducted at Sr. No " & i & " in Schedule TDS1" & Chr(13)
'              msgbox_TDS1 = msgbox_TDS1 + "* ""Please enter the Total Tax Deducted in Schedule TDS-1 at Sr. No " & i & """" & Chr(13)
'            '"Please enter the Total Tax Deducted in Schedule TDS-1".
'
...
'     setTblinfo_TDS2_Section_TDS_deducted 'TDS_C1_2024_25 Change 'Malli
    setTblinfo_TDS22
   ' setTblinfo_TDS23
    'setTblinfo_TDS24
    setTblinfo_TDS25
   ...
   ' setTblinfo_TDS201
    ...
    For i = 1 To end_TDS2
        If isdropdownblank(Sheet28.Range("TDS2.TDSCreditName").item(i).value) Then
            ...
            'Shrutika
            msgbox_TDS2 = msgbox_TDS2 + "* ""Please select the drop down for the field TDS credit relating to Self/Other Person in Schedule TDS 2"""
    ...
    If (Len(Sheet28.Range("TDS2.TDSCreditName").item(1).value) > 0) Then
        ...
        If Not ValidateSectionTDSDeducted_TDS2() Then ValidatesheetTDS2 = False 'TDS_C1_2024_25 Change 'Malli
...
'               msgbox_TDS2 = msgbox_TDS2 + "* Please select the financial year in which TDS was deducted at Sr. No " & i & " in Schedule TDS2" & Chr(13)
                msgbox_TDS2 = msgbox_TDS2 + "* ""Please select Year of tax deduction from drop-down at Sr. No " & i & " in Schedule TDS2" & Chr(13)
                ValidatesheetTDS2 = False
                Exit Function
            End If
        End If
        ...
        If Not isdropdownblank(Sheet28.Range("TDS2.DeductedYear").item(i).value) Then
            ...
            'Ankita(23-Jan)
                ' msgbox_TDS2 = msgbox_TDS2 + "* Please enter the the TDS b/f at Sr. No " & i & " in Schedule TDS2" & Chr(13)
                 'msgbox_TDS2 = msgbox_TDS2 + "* Please enter the the TDS b/f at Sr.No.1 in schedule TDS2" & Chr(13)
                 
                 'Ayush
                 msgbox_TDS2 = msgbox_TDS2 + "* Please enter the Amount of TDS brought forwarded in Schedule TDS 2" & Chr(13)
...
'               msgbox_TDS2 = msgbox_TDS2 + "* Please enter the Unclaimed TDS brought forward and Income details of TDS Deducted in the hands of any other person as per rule 37BA(2) should be provided in different rows in Sch TDS 2 at Sr. No " & i & "in Schedule TDS2" & Chr(13)
                msgbox_TDS2 = msgbox_TDS2 + "* ""Unclaimed TDS brought forward and Income details of TDS Deducted in the hands of any other person as per rule 37BA(2) should be provided in different rows in Sch TDS 2""" & Chr(13)
                ValidatesheetTDS2 = False
                Exit Function
            End If
        End If
...
'                msgbox_TDS2 = msgbox_TDS2 + "* Please enter the Unclaimed TDS brought forward and Income details of TDS Deducted in the hands of any other person as per rule 37BA(2) should be provided in different rows in Sch TDS 2 at Sr. No " & i & " in Schedule TDS2" & Chr(13)
    ...
    For i = 1 To Sheet28.Range("TDS2.TAN").count
        ...
        If Len(Sheet28.Range("TDS2.DeductedIncome5A").item(i).value) > 0 Then
            ...
            If isdropdownblank(Sheet28.Range("TDS2.TDSCreditName").item(i).value) Then
             'msgbox_TDS2 = msgbox_TDS2 + "* Enter All Mandatory Fields at Sr. No " & i & " in Schedule TDS2" & Chr(13)
              msgbox_TDS2 = msgbox_TDS2 + "* Please select the drop down for the field TDS credit  relating to Self/Other Person in Schedule TDS 2" & Chr(13)
                ValidatesheetTDS2 = False
                Exit Function
            End If
...
'               msgbox_TDS2 = msgbox_TDS2 + "* Please enter the PAN under Col(10) at Sr. No " & i & " in Schedule TDS2" & Chr(13)
                msgbox_TDS2 = msgbox_TDS2 + "* PAN is mandatory at Sr. No " & i & " in Schedule TDS 2" & Chr(13)
                ValidatesheetTDS2 = False
                Exit Function
            End If
...
'                msgbox_TDS2 = msgbox_TDS2 + "* Please enter Income at Claimed in own hands at Sr. No " & i & " in Schedule TDS2" & Chr(13)
                msgbox_TDS2 = msgbox_TDS2 + "* ""Please enter Income at Column 10 in Schedule TDS 2" & Chr(13)
                ValidatesheetTDS2 = False
                Exit Function
            End If
        ...
        If Len(Sheet28.Range("ClaimedAadhar5A_TDS2").item(i).value) > 0 Then
            If Not ValidateAadhaar(CStr(Sheet28.Range("ClaimedAadhar5A_TDS2").item(i).value)) Then
                 ...
                 'Shrutika
'                 msgbox_TDS2 = msgbox_TDS2 + "* ""Invalid Aadhaar No."" & Chr(13)"
        'Ankita_08/09/2025_SIT-89279 =========================================
                 msgbox_TDS2 = msgbox_TDS2 + "* ""Invalid Aadhaar No. at Sr. No  " & i & " in Schedule TDS2" & Chr(13)
                 ValidatesheetTDS2 = False
...
'       msgbox_TDS2 = msgbox_TDS2 + "* Amount in field Col (10) at Sr. No  " & i & " cannot be more than Col (7) or Col (8) as the case may be in Schedule TDS2" & Chr(13)
        msgbox_TDS2 = msgbox_TDS2 + "* Amount in field Col (9) at Sr. No  " & i & " cannot be more than Col (6) or Col (7) as the case may be." & Chr(13)
...
'           msgbox_TDS2 = msgbox_TDS2 + "* Please enter the PAN Of Other Person at Sr. No  " & i & " in Schedule TDS2" & Chr(13)
            msgbox_TDS2 = msgbox_TDS2 + "* Please enter the PAN/ Aadhaar of Other Person at Sr. No  " & i & " in schedule TDS2" & Chr(13)
              ValidateTDSCreditName_TDS2 = False
              Exit Function
        End If
...
'             msgbox_TDS2 = msgbox_TDS2 + "* PAN Of Other Person at Sr. No  " & i & " is invalid. First 5 alphabets, next 4 digits, then alphabet in Schedule TDS2" & Chr(13)
              msgbox_TDS2 = msgbox_TDS2 + "* ""Invalid PAN. PAN format should be First 5 Alphabets, next 4 digits, then 1 Alphabet in schedule TDS2""" & Chr(13)
             ValidateTDSCreditName_TDS2 = False
             Exit Function
            End If
...
Function ValidateTAN_TDS2() As Boolean
    ...
    If Not Len(TAN_TDS2(i)) = 0 Then
     ...
     If Not IsNumeric(Mid(TAN_TDS2(i), 5, 5)) Then
         ...
         'Shrutika
         msgbox_TDS2 = msgbox_TDS2 + "* ""Invalid TAN. TAN format should be First 4 alphabets, then 5 digits, then alphabet"" in Schedule TDS 2 & Chr(13)"
        'Ankita_08/09/2025_SIT-89279 =========================================
         msgbox_TDS2 = msgbox_TDS2 + "* ""Invalid TAN. TAN format should be First 4 alphabets, then 5 digits, then alphabet in Schedule TDS 2." & Chr(13)
         ValidateTAN_TDS2 = False
         Exit Function
 ...
 ElseIf Not chkMandatory(TAN_TDS2(i)) Then
         ...
         'Shrutika
         msgbox_TDS2 = msgbox_TDS2 + "* Please enter the TAN of Deductor in Schedule TDS 2." & Chr(13)
         ValidateTAN_TDS2 = False
...
Function ValidateTDSClaimedInOwnHands_TDS2() As Boolean
    ...
    'Ayush
         'msgbox_TDS2 = msgbox_TDS2 + "* Please enter the TDS Claimed in Own Hands at Sr. No  " & i & "in Schedule TDS2" & Chr(13)
          msgbox_TDS2 = msgbox_TDS2 + "* Please enter Tax deducted in own hands in Schedule TDS 2 or Amount in field Col (9) cannot be more than Col (6) or Col (7)." & Chr(13)
...
'     msgbox_TDS2 = msgbox_TDS2 + "* Please enter the Gross Amount at Sr. No  " & i & "in Schedule TDS2" & Chr(13)
      msgbox_TDS2 = msgbox_TDS2 + "* ""Please enter the amount in ""Gross Amount"" at Sr. No  " & i & " field in Schedule TDS 2" & Chr(13)
         ValidateTDSClaimedInOwnHands_TDS2 = False
         Exit Function
    End If
    End If
    ...
    ' msgbox_TDS2 = msgbox_TDS2 + "* Please enter the Head Income at Sr. No  " & i & "in Schedule TDS2" & Chr(13)
     msgbox_TDS2 = msgbox_TDS2 + "* ""Please select the drop down of head of income for which corresponding income offered"" in Schedule TDS 2" & Chr(13)
         ValidateTDSClaimedInOwnHands_TDS2 = False
         Exit Function
    End If
    End If
...
Sub setTblinfo_TDS2()
 ...
 Next
 end_TDS2 = ccount
 'TDS_E1_2023_24 old 'Malli
 rngname_TDS2 = "TDS2.TDSCreditName;TDS2.GrossAmount;TDS2.HeadOfIncome;TDS2.PanOtherPerson;TDSAadharOfOther_TDS2;TDS2.TAN;TDS2.DeductedYear;TDS2.BroughtFwdTDSAmt;TDS2.DeductedInOwnHands;TDS2.DeductedIncome5A;TDS2.DeductedTDS5A;TDS2.ClaimedInOwnHands;TDS2.ClaimedIncome5A;TDS2.ClaimedTDS5A;c;ClaimedAadhar5A_TDS2;TDS2.AmtCarriedForward;"
 'TDS_C1_2024_25 Change 'Malli
' rngname_TDS2 = "TDS2.TDSCreditName;TDS2.GrossAmount;TDS2.HeadOfIncome;TDS2.PanOtherPerson;TDS2.Section_TDS_deducted;TDSAadharOfOther_TDS2;TDS2.TAN;TDS2.DeductedYear;TDS2.BroughtFwdTDSAmt;TDS2.DeductedInOwnHands;TDS2.DeductedIncome5A;TDS2.DeductedTDS5A;TDS2.ClaimedInOwnHands;TDS2.ClaimedIncome5A;TDS2.ClaimedTDS5A;c;ClaimedAadhar5A_TDS2;TDS2.AmtCarriedForward;"
 End Sub
...
Function ValidatesheetTDS3() As Boolean
    ...
    If (Len(Sheet28.Range("TDS3.TDSCreditName").item(1).value) > 0) Then
        ...
        'If Not SectionTDSisDeducted_TDS3 Then ValidatesheetTDS3 = False
        If Not ValidateSectionTDSDeducted_TDS3 Then ValidatesheetTDS3 = False
    ...
    For i = 1 To Sheet28.Range("TDS3.PAN").count
        ...
        If Not isdropdownblank(Sheet28.Range("TDS3.DeductedYear").item(i).value) Then
            If Len(Sheet28.Range("TDS3.BroughtFwdTDSAmt").item(i).value) = 0 Then
                ...
                msgbox_TDS3 = msgbox_TDS3 + "* ""Please enter the Amount of TDS brought forwarded""  in Schedule TDS 3" & Chr(13)
                ValidatesheetTDS3 = False
                Exit Function
            End If
        End If
...
'                msgbox_TDS3 = msgbox_TDS3 + "* Enter All Mandatory Fields at Sr. No " & i & " in Schedule TDS3" & Chr(13)
                 msgbox_TDS3 = msgbox_TDS3 + "* Please select the drop down for the field TDS credit  relating to Self/Other Person in Schedule TDS 3" & Chr(13)
                ValidatesheetTDS3 = False
                Exit Function
            End If
...
'                msgbox_TDS3 = msgbox_TDS3 + "* Please enter the Income under Col(10) at Sr. No " & i & " in Schedule TDS3" & Chr(13)
                msgbox_TDS3 = msgbox_TDS3 + "* ""Please enter Income at Column 10"" in Schedule TDS 3" & Chr(13)
                ValidatesheetTDS3 = False
                Exit Function
            End If
...
'               msgbox_TDS3 = msgbox_TDS3 + "* Please enter the Income under Col(10) at Sr. No " & i & " in Schedule TDS3" & Chr(13)
    ...
    If (end_TDS3 <> end_TDS32) Or (end_TDS3 <> end_TDS302) Then
             msgbox_TDS3 = msgbox_TDS3 + "* Enter all Mandatory Details. in Schedule TDS3" & Chr(13)
             ValidatesheetTDS3 = False
    End If
...
Function ValidateTDSCreditName_TDS3() As Boolean
    ...
    For i = 1 To end_TDS3
        ...
        If isdropdownblank(TDSCreditName_TDS3(i)) And rangecells.item(i).Locked = False Then
            msgbox_TDS3 = msgbox_TDS3 + "* TDS Credit Name at Sr. No  " & i & " is Mandatory." & Chr(13)
...
'        msgbox_TDS3 = msgbox_TDS3 + "* Please enter the PAN of Buyer/Tenant at Sr. No  " & i & "in Schedule TDS3" & Chr(13)
         msgbox_TDS3 = msgbox_TDS3 + "* ""Please enter the PAN/Aadhaar of Other Person at Sr. No  " & i & " in Schedule TDS3""" & Chr(13)
         ValidatePAN_TDS3 = False
     Exit Function
 End If
 UpdateProgressBar
...
Function ValidateTDSClaimedInOwnHands_TDS3() As Boolean
    ...
    'Ayush
         ...
         msgbox_TDS3 = msgbox_TDS3 + "* ""Please enter Tax deducted in own hands"" in Schedule TDS 3" & Chr(13)
...
'             msgbox_TDS3 = msgbox_TDS3 + "* Please enter the Gross Amount at Sr. No  " & i & "in Schedule TDS3" & Chr(13)
              msgbox_TDS3 = msgbox_TDS3 + "* ""Please enter the amount in ""Gross Amount"" at Sr. No  " & i & " field in Schedule TDS 3" & Chr(13)
         ValidateTDSClaimedInOwnHands_TDS3 = False
         Exit Function
    End If
    ...
    'Ayush
     ...
     msgbox_TDS3 = msgbox_TDS3 + "* ""Please select the drop down of head of income for which corresponding income offered  in Schedule TDS 3""" & Chr(13)
         ValidateTDSClaimedInOwnHands_TDS3 = False
         Exit Function
    End If
    End If
...
Function SectionTDSisDeducted_TDS3() As Boolean
    ...
    If Not chkMandatory(SectionTDSisDeduct_TDS3(i)) And rangecells.item(i).Locked = False Then
         msgbox_TDS3 = msgbox_TDS3 + "* Please select the Section under which TDS is deducted at Sr. No  " & i & " in Schedule TDS3" & Chr(13)
...
'-----Malli
'TDS_C1_2024_25 Change 'Malli
 Sub setTblinfo_TDS2_Section_TDS_deducted()
 Dim rangecells As Range
 Dim mIntCells  As Long
 Dim mIntCtr  As Long
 Dim ccount  As Long
 ccount = 0
 mIntCells = Sheet28.Range("TDS2.Section_TDS_deducted").count
 Set rangecells = Sheet28.Range("TDS2.Section_TDS_deducted").Cells
 For mIntCtr = 1 To mIntCells
     If Not isdropdownblank(rangecells.item(mIntCtr).value) Then
        ccount = ccount + 1
    End If
 Next
 end_TDS2_Section_TDS_deducted = ccount
...
Function ValidateSectionTDSDeducted_TDS2() As Boolean
    ...
    ReDim SectionTDSisdeduct_TDS2(end_TDS2)
    
    For i = 1 To end_TDS2
        SectionTDSDeducted_TDS2(i) = rangecells.item(i).value
        SectionTDSisdeduct_TDS2(i) = rangecells.item(i).value
         ...
         If Not chkCompulsory(SectionTDSDeducted_TDS2(i)) Then
                ...
                msgbox_TDS2 = msgbox_TDS2 + "* ""Please select the section under which TDS is deducted at Sr. No  " & i & " in Schedule TDS2""" & Chr(13)
 ...
 Next
End Function
Function ValidateSectionTDSDeducted_TDS3() As Boolean
 
    ValidateSectionTDSDeducted_TDS3 = True
    setTblinfo_TDS3
    Dim rangecells As Range
    Set rangecells = Sheet28.Range("TDS3.TdsIsDeducted").Cells
    ReDim SectionTDSDeducted_TDS3(end_TDS3)
    ReDim SectionTDSisDeduct_TDS3(end_TDS3)
    For i = 1 To end_TDS3
        SectionTDSDeducted_TDS3(i) = rangecells.item(i).value
        SectionTDSisDeduct_TDS3(i) = rangecells.item(i).value
         
         If Not chkCompulsory(SectionTDSDeducted_TDS3(i)) Then
                'MsgTDS2ii = MsgTDS2ii + "* Please select the Section under which TDS is deducted  at Sr.No " & i & " in Schedule TDS2(ii)" & Chr(13)
                msgbox_TDS3 = msgbox_TDS3 + "* Please select the section under which TDS is deducted at Sr. No  " & i & " in Schedule TDS3" & Chr(13)
                ValidateSectionTDSDeducted_TDS3 = False
                Exit Function
        End If
    
        If (SectionTDSDeducted_TDS3(i) = "" Or SectionTDSDeducted_TDS3(i) = "(Select)") Then
                msgbox_TDS3 = msgbox_TDS3 + "* Please select the section under which TDS is deducted at Sr. No  " & i & " in Schedule TDS3" & Chr(13)
                ValidateSectionTDSDeducted_TDS3 = False
                Exit Function
       End If
...
Sub importTDS1CSVFunc(text As String)
    ...
    If (TotalDiffRow > 0) Then
        Cmd_AddRows_TDS1_Imp (TotalDiffRow)
    End If
