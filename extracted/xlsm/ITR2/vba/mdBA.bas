...
Public rowcount_PartB
Public countIFSC_PartB
'Shrutika_AY_2025_26(11/02/2025)
Public ColCount1_BA5, ColCount55_BA6_Other, ColCount1_typeaccnt_BA5 As Variant
'---------------------------------
...
Sub ValidateSheetBA()
    ...
    'vbMessgaeCaption = "ITR 2: AY: 2024-25" 'dpk1601
     vbMessgaeCaption = "ITR 2: AY: 2025-26" 'dpk1601
    ValidateBA
...
Function ValidateSchBA() As Boolean
    ...
    Msgbox_BA = ""
     ...
     'Shrutika uncomented  'AY_2025-26(11/02/2025)
     setTableInfo_BA44
     setTableInfo_BA6
     
     setTableInfo_BA66  'AY_2025_26 (11/02/2025)
     '--------------------------
     
    ' ColCount1_BA_IFSC = WorksheetFunction.Max(0, ColCount1_BA_IFSC, ColCount1_BA, ColCount4_BA, ColCount6_BA, ColCount55_BA)
    ' ColCount1_BA_IFSC = WorksheetFunction.Max(0, ColCount1_BA_IFSC, ColCount1_BA, ColCount4_BA)
...
If ColCount1_BA_IFSC > 0 Then
       ...
       'Shrutika----------AY_2025_26(11/02/2025)
    If IBANSELECT = "Y" Then
    If Not ColCount6_BA > 0 Then
        Msgbox_BA = Msgbox_BA + "* Please select atleast one account in which you prefer to get your refund  in Sheet Part B - TI TTI is mandatory" & Chr(13)
        ValidateIFSC = False
    ...
    'Added by Aavula SIT-89105 04/03/2025
    
'    If ColCount55_BA6_Other > 0 And Not ColCount1_BA5 > 0 Then
'
...
'        End If
        ...
        Msgbox_BA = Msgbox_BA + "* IFSC code is mandatory in Pt 14 i.e. bank account details in Schedule Part B TTI in point 18 at Sr.No " & i & "." & Chr(13)
        ValidateIFSC = False
        Exit Function
        End If
        ...
        If Not ValidateIFSCList(UCase(BankIFSC_BA(i))) Then
                'Msgbox_BA = Msgbox_BA + "* Invalid IFSC Code at Sr.No " & i & " Refer to your bank for valid ifsc codes." & Chr(13) & "(1st 4 Alphabets, followed by by Zero and remaining 6 should be alphanumeric)" & Chr(13)
                Msgbox_BA = Msgbox_BA + "* ""Please enter a valid IFSC in Schedule Part B TTI in point 18""" & Chr(13)
                ValidateIFSC = False
                Exit Function
        End If
...
'            End If
        ...
        If BankName_BA(i) = "" Then
            'Msgbox_BA = Msgbox_BA + "* Bank Name at Sr.No " & i & " in Part B TI TTI is mandatory" & Chr(13)
            'Msgbox_BA = Msgbox_BA + "* ""Please enter the Bank name  in Schedule Part B TTI in point 18 at Sr.No " & i & """ " & Chr(13)
           'Added by Shrutika(12/02/2025)
            Msgbox_BA = Msgbox_BA + "* ""Please enter the Bank name in Schedule Part B TTI in point 18 at Sr.No " & i & """ " & Chr(13)
            ValidateIFSC = False
            Exit Function
        End If
        ...
        End If
            ...
            'Msgbox_BA = Msgbox_BA + "* Account Number at Sr.No " & i & " in Part B TI TTI is mandatory" & Chr(13)
            Msgbox_BA = Msgbox_BA + "* ""Please enter the Account Number in Schedule Part B TTI in point 18 at Sr.No " & i & """" & Chr(13)
            ValidateIFSC = False
            Exit Function
           End If
...
Sub setTableInfo_BA_IFSC()
    ...
    rngname_BankTable = "Sheet9.OthMICRCode||Sheet9.OthBankName||Sheet9.OthBankAccountNumber||Sheet9.TypeOfAccount"
...
'               If Not (Trim(rangecells1.item(mIntCtr).value) = "" Or Trim(rangecells1.item(mIntCtr).value) = "(Select)") Then
'               ccount2 = ccount2 + 1
'               End If
