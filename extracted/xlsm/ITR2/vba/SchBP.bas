...
If Sheet9.Range("sheet10.IncRecCredPLOthHeads4Div").value > Sheet4.Range("PL.Dividends").value Then
         msgBx_BP2 = msgBx_BP2 + "* Divident Income can not be higher then Profit and loss divident income"
...
If Sheet9.Range("BP_Chargeable_rule7").value > Sheet9.Range("BP_4b_ProfitRule7").value Then
    msgBx_BP2 = msgBx_BP2 + "* Chargeable income under Rule 7 at Point 38 cannot be more than income shown at Point 4b in Schedule BP. " & Chr(13)
End If

If Sheet9.Range("BP_Chargeable_rule7A").value < (0.35 * Sheet9.Range("BP_4b_ProfitRule7A").value) Then
    msgBx_BP2 = msgBx_BP2 + "* Chargeable income under Rule 7A at Point 38 cannot be less than 35% of income shown at Point 4b in Schedule BP. " & Chr(13)
End If

If Sheet9.Range("BP_Chargeable_rule7B1").value < (0.25 * Sheet9.Range("BP_4b_ProfitRule7B1").value) Then
    msgBx_BP2 = msgBx_BP2 + "* Chargeable income under Rule 7B(1) at Point 38 cannot be less than 25% of income shown at Point 4b in Schedule BP. " & Chr(13)
End If

If Sheet9.Range("BP_Chargeable_rule7B1A").value < (0.4 * Sheet9.Range("BP_4b_ProfitRule7B2").value) Then
    msgBx_BP2 = msgBx_BP2 + "* Chargeable income under Rule 7B(1A) at Point 38 cannot be less than 40% of income shown at Point 4b in Schedule BP. " & Chr(13)
End If

If Sheet9.Range("BP_Chargeable_rule8").value < (0.4 * Sheet9.Range("BP_4b_ProfitRule8").value) Then
    msgBx_BP2 = msgBx_BP2 + "* Chargeable income under Rule 8 at Point 38 cannot be less than 40% of income shown at Point 4b in Schedule BP. " & Chr(13)
End If
