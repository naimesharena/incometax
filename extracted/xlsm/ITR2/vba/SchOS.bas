...
'Malli--AY_2025-26
Public WinOnlineGames_15_2aii_i, WinOnlineGames_15_2aii_ii As Variant
...
'
''by sai on 14/05/2025 as per DE V0.5 and V0.6
'        msgabox15 ("* ""Please ensure to offer Dividend Income u/s 2(22)(f) against the loss claimed in Schedule CG""" & Chr(13))
'        ValidatesheetOS = False
'        Exit Function
'    End If
'End If
        
'by Konda on 04/05/2026 as Per DE V0.3--SIT-118881
...
Function ValidateOS_Section1() As Boolean
    ...
    For i = 1 To end_os
      ...
      If OS_Section <> "" And OS_income <> "" Then
...
For i = 1 To end_os111
    ...
    'Added by Jyoti
             'msgabox15 ("* Please enter the amount in Income Benefit in 2c of OS schedule")
             msgabox15 ("* ""Please enter the amount in Income Benefit in 2c of OS schedule""")
    ...
    'Added by Jyoti
            'msgabox15 ("* Please enter the amount in Tax Benefit in 2c of OS schedule")
             msgabox15 ("* ""Please enter the amount in Tax Benefit in 2c of OS schedule""")
   ...
   'Added by Jyoti
      msgabox15 ("* ""Please select the Assessment Year in 2c of OS schedule""")
           validate_OS111 = False
        End If
...
Dim CalculatedOS5A1aA As Variant
...
'os_DTAAAmount5AC = Sheet14.Range("DTAA_5AC1ab_OS").value + Sheet14.Range("Os_PTI_5AC1ab_DTAA").value + Sheet14.Range("DTAA_5AC1b_OS").value + Sheet14.Range("Os_PTI_5AC1b_DTAA").value
...
'DTAA_5BB_OS = Sheet14.Range("DTAA_5BB_OS").value
CheckDivDTAA = Sheet14.Range("DivDTAA").value
CheckDivDTAA_1aiii = Sheet14.Range("DivDTAA_1aiii").value  'Malli AY_2025-26
    ...
    If (Sheet14.Range("os.InterestGross").value < 0) Then
     If os_DTAAAmount1 > (Sheet14.Range("os.DividendGross").value + _
        ...
        If os_DTAAAmount2a > (Sheet14.Range("os.WinLottRacePuzz").value) Then
             validate_OSDTAA = False
            msgabox15 ("Total amount of income chargeable to tax under DTAA (Winning from Lottry) cannot be greater than value of 2a(i)")
            Exit Function
            End If
 'Chandru Change as per OS_C7 AY24-25
         If os_DTAAAmount2aii > (Sheet14.Range("os.WinOnlineGame").value) Then
             validate_OSDTAA = False
            msgabox15 ("Total amount of income chargeable to tax under DTAA (Winning from Online Games) cannot be greater than value of 2a(ii)")
            Exit Function
            End If
...
'Chandru Change as per OS_C7 AY24-25 ***(Need Clarification from BA for Error Message)
...
Function ValidateOthersSectionOS() As Boolean
    ...
    OthersSourceSection_OS(i) = Sheet14.Range(cellrange).value
            ...
            If isdropdownblank(OthersSourceSection_OS(i)) Then
              ...
              'Shrutika
             ' msgabox15 ("* Nature field is mandatory in 1e of OS schedule.")
               msgabox15 ("* ""Nature field is mandatory in 1e of OS schedule.""")
...
Function ValidateOthersSectionAmtOS() As Boolean
    ...
    OthersSourceAmount_OS(i) = rangecells.item(i).value
            ...
            If isdropdownblank(OthersSourceAmount_OS(i)) Then
                ...
                'Shrutika
                'msgabox15 (" *Amount field is mandatory in 1e of OS schedule.")
                msgabox15 ("* ""Amount field is mandatory in 1e of OS schedule.""")
                '"Amount field is mandatory in 1e of OS schedule."
...
'    WinOnlineGames_15_2aii_ii = Sheet14.Range("os.WinOnlineGame2aii_ii").value
    ...
    'AY_2024_25_OLD
        ...
        msgabox15 ("* Net winnings cannot be greater than 14 digits in schedule OS")
    ...
    If Not IsNumeric(WinOnlineGames_15) Then
        ...
        msgabox15 ("* Net winnings must contain only digits from 0 to 9 in schedule OS")
        ValidateWinOnlineGames_15 = False
        Exit Function
    End If
...
End Function
Function DefaultWinOnlineGames_15() As String
    WinOnlineGames_15 = "0"
End Function
...
Dim dtaa_1aiii As Variant 'Malli_AY_2025-26
Dim Source_1aiii As Variant 'Malli_AY_2025_26
Dim dtaa_1b As Variant
Dim dtaa_1c As Variant
Dim dtaa_1d As Variant
Dim dtaa_5A1ai As Variant

Dim dtaa_5A1aA As Variant
...
Source_1aiii = Sheet14.Range("Os.1aiii").value  'Malli_AY_2025_26
...
msgabox15 ("* The total of all the quarter of Income from Lottery must be equal to 2a(i) of Schedule OS-DTAA 115BB" & Chr(13))
ValidateSectionAmount = False
Exit Function
End If

'Shrutika----------27/03/2025
Dim TempincomeFromaiii As Variant 'IncD_115A1aiiiQTot
TempincomeFromaiii = Range("IncD_115A1aiiiQTot").value
...
msgabox15 ("* The total of all the quarter of Income from Online Games must be equal to 2a(ii) of Schedule OS-DTAA 115BBJ" & Chr(13))
ValidateSectionAmount = False
Exit Function
End If
...
'Shrutika
 msgabox15 ("* Amount of income in Col.2 of Sl. No. 2e cannot be more than the amount mentioned in the relevant field above" & Chr(13))
...
Function Validateos_PTIAmount() As Boolean
    ...
    os_PTIAmount(i) = rangecells.item(i).value
        ...
        'Newly changed Error Msg by Bindu as per Defect from Testing team 1e to 2e
...
' Ankita(23-Jan)
Function IBANCOUNTRY6()
Sheet7.Range("os.Country").value = "(Select)"
End Function




'Malli AY_2025_26 NEW CHANGE
