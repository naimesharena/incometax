...
Sub ValidateSheet80GGC_Click()
 Dim vbMessgaeCaption As String
  'vbMessgaeCaption = "ITR 1: AY: 2024-25"
   vbMessgaeCaption = "ITR 1: AY: 2025-26" 'Shrutika(27-02-25)
  Validate80GGC
'MsgBox "Sheet 80GGC is OK", vbOKOnly, vbMessgaeCaption
fmsgbox "Sheet 80GGC is OK"
End Sub
Sub Validate80GGC()
...
Sub setTableInfo80GGC() '80GGC_C1
    ...
    Dim ccount  As Long
    ccount = 0
    Set rangecells = Sheet59.Range("DateofDonation_80GGC").Cells
    mIntCells = Sheet59.Range("DateofDonation_80GGC").count
   ...
   ' rngName_80GGC = "DateofDonation_80GGC;Donationincash_80GGC;Donationinothermode_80GGC;TotalDonation_80GGC;EligibleAmountofDonation_80GGC;NatureofTransaction_80GGC;Chequeno_80GGC;IFSC_80GGC;"
    ...
    rngName_80GGC = "DateofDonation_80GGC;Donationincash_80GGC;Donationinothermode_80GGC;TotalDonation_80GGC;EligibleAmountofDonation_80GGC;NatureofTransaction_80GGC;politicalName_80GGC;politicalPan_80GGC;Chequeno_80GGC;IFSC_80GGC;"
...
Sub setTableInfo80GGC1() '80GGC_C2
    ...
    Dim ccount  As Long
    ccount = 0
    Set rangecells = Sheet59.Range("Donationincash_80GGC").Cells
    mIntCells = Sheet59.Range("Donationincash_80GGC").count
    For mIntCtr = 1 To mIntCells
        If Not rangecells.item(mIntCtr).value = "" Then
        ccount = ccount + 1
        End If
...
Sub setTableInfo80GGC2() '80GGC_C3
    ...
    Dim ccount  As Long
    ccount = 0
    Set rangecells = Sheet59.Range("Donationinothermode_80GGC").Cells
    mIntCells = Sheet59.Range("Donationinothermode_80GGC").count
    For mIntCtr = 1 To mIntCells
        If Not rangecells.item(mIntCtr).value = "" Then
        ccount = ccount + 1
        End If
...
Sub setTableInfo80GGC8()
    ...
    Dim ccount  As Long
    ccount = 0
    Set rangecells = Sheet59.Range("politicalName_80GGC").Cells
    mIntCells = Sheet59.Range("politicalName_80GGC").count
    For mIntCtr = 1 To mIntCells
        If Not rangecells.item(mIntCtr).value = "" Then
        ccount = ccount + 1
        End If
...
Sub setTableInfo80GGC9()
    ...
    Dim ccount  As Long
    ccount = 0
    Set rangecells = Sheet59.Range("politicalPan_80GGC").Cells
    mIntCells = Sheet59.Range("politicalPan_80GGC").count
    For mIntCtr = 1 To mIntCells
        If Not rangecells.item(mIntCtr).value = "" Then
        ccount = ccount + 1
        End If
...
Sub setTableInfo80GGC3() '80GGC_C4
    ...
    Dim ccount  As Long
    ccount = 0
    Set rangecells = Sheet59.Range("NatureofTransaction_80GGC").Cells
    mIntCells = Sheet59.Range("NatureofTransaction_80GGC").count
    For mIntCtr = 1 To mIntCells
...
Sub setTableInfo80GGC4() '80GGC_C5
    ...
    Dim ccount  As Long
    ccount = 0
    Set rangecells = Sheet59.Range("Chequeno_80GGC").Cells
    mIntCells = Sheet59.Range("Chequeno_80GGC").count
    For mIntCtr = 1 To mIntCells
        If Not isdropdownblank(rangecells.item(mIntCtr).value) Then
        ccount = ccount + 1
        End If
...
Sub setTableInfo80GGC5() '80GGC_C6
    ...
    Dim ccount  As Long
    ccount = 0
    Set rangecells = Sheet59.Range("IFSC_80GGC").Cells
    mIntCells = Sheet59.Range("IFSC_80GGC").count
    For mIntCtr = 1 To mIntCells
        If Not rangecells.item(mIntCtr).value = "" Then
        ccount = ccount + 1
        End If
...
Sub AddRows80GGC() '80CCG
   ...
   ' EfilingCommon.DefinedgridNameRange = "DateofDonation_80GGC||Donationincash_80GGC||Donationinothermode_80GGC||TotalDonation_80GGC||EligibleAmountofDonation_80GGC||Chequeno_80GGC||IFSC_80GGC||"
    ...
    'Added by Shrutika- 27/03/2026 V0.2 AY-26-27
    EfilingCommon.DefinedgridNameRange = "DateofDonation_80GGC||Donationincash_80GGC||Donationinothermode_80GGC||TotalDonation_80GGC||EligibleAmountofDonation_80GGC||politicalName_80GGC||politicalPan_80GGC||Chequeno_80GGC||IFSC_80GGC||"
...
Application.EnableEvents = False
 sPassword = EfilingCommon.getmsgstate
   Sheet59.Unprotect Password:=sPassword
...
endfd:
Sheet59.Protect Password:=sPassword
...
'    setTableInfo80GGC
    ...
    For i = 1 To end80GGC
        ...
        'start--
'        'Shrutika------------AY_2025-26 NEW CHANGE
'        If Not ChkMinInclusiveDate(Dformat(DateofDonation_80GGC(i), ""), "2024-04-01") Or _
'           Not ChkMaxInclusiveDate(Dformat(DateofDonation_80GGC(i), ""), "2025-07-31") Then
        If Not ChkMinInclusiveDate(Dformat(DateofDonation_80GGC(i), ""), "2025-04-01") Or _
           Not ChkMaxInclusiveDate(Dformat(DateofDonation_80GGC(i), ""), "2026-07-31") Then
        '--end
                    MsgBox_80GGC = MsgBox_80GGC + "*  ""Date of contribution should be within the financial year at Sr. No." & i & " in Schedule 80GGC"""
                    ValidateDateofDonation_80GGC = False
                    Exit Function
        End If
        '--------------------------------------
...
Function ValidateTotal_Donation_InCash_80GGC() As Boolean
 ...
 Total_DonationInCash_80GGC = Sheet59.Range("Total_DonationInCash_80GGC").value
 
 
 If Len(Total_DonationInCash_80GGC) > 14 Then
    MsgBox_80GGC = MsgBox_80GGC + "* Total amount of Donation in Cash cannot be greater than 14 digits in Schedule 80GGC."
...
'    setTableInfo80GGC
    ...
    Set rangecells = Sheet59.Range("Donationincash_80GGC").Cells
    Set rangecells1 = Sheet59.Range("Donationinothermode_80GGC").Cells
    Dim i As Long
...
'    setTableInfo80GGC
    ...
    Set rangecells2 = Sheet59.Range("Donationinothermode_80GGC").Cells
    ReDim Donation_other_80GGC(end80GGC)
...
'          End If
          ...
          End If
            ...
            If Len(ChequeNumber_80GGC(i)) > 50 Then
                MsgBox_80GGC = MsgBox_80GGC + "* Transaction Reference number/Cheque number/IMPS/NEFT/RTGS of donation transaction at Sr.No " & i & " in Schedule 80GGC cannot exceed 50 characters" & Chr(13)
                ValidateChequeNumber_80GGC = False
                Exit Function
            End If
            ...
            If Not EfilingCommon.checkListIFSC(UCase(BankIFSC_80GGC(i))) Then
                MsgBox_80GGC = MsgBox_80GGC + "* Invalid IFS Code at Sr.No " & i & " in Schedule 80GGC.Refer to your bank for valid IFS Codes." & "(1st 4 Alphabets, followed by by Zero and remaining 6 should be alphanumeric)" & Chr(13)
                ValidateChequeNumber_80GGC = False
                Exit Function
            End If
...
'    setTableInfo80GGC
    Dim rangecells As Range
    Set rangecells = Sheet59.Range("TotalDonation_80GGC").Cells
    Dim i As Long
...
'    setTableInfo80GGC
    Dim rangecells As Range
    Set rangecells = Sheet59.Range("EligibleAmountofDonation_80GGC").Cells
    Dim i As Long
...
Function ValidateTotal_Donation_OtherMode_80GGC() As Boolean
 ...
 Total_DonationInOThMode_80GGC = Sheet59.Range("Total_DonationInOtherMode_80GGC").value
...
Function ValidateTotalof_Total_Donation_80GGC() As Boolean
 ...
 Total_TotalDonation_80GGC = Sheet59.Range("Total_Donation_80GGC").value
...
Function ValidateNamePP_80GGC() As Boolean
    ...
    For i = 1 To end80GGC
        ...
        If Len(NamePP_80GGC(i)) > 125 Then
            MsgBox_80GGC = MsgBox_80GGC + "* Name of Political Party at Sr. No." & i & " should not exceed 125 characters in schedule 80GGC" & Chr(13)
            ValidateNamePP_80GGC = False
            Exit Function
        End If
    Next
...
Function ValidatePanPP_80GGC() As Boolean
    ...
    For i = 1 To end80GGC
        ...
        If Not CheckPAN(tempPan) Then
            ...
            'changed by Chetan C M for AY 2026-27 as per DE V 0.3
            'start--
            ...
            MsgBox_80GGC = MsgBox_80GGC + "* ""Invalid PAN" & Chr(13)
            '--end
...
Function ValidateTotal_Donation_Eligible_80GGC() As Boolean
 ...
 Total_Donation_Eligible_80GGC = Sheet59.Range("Total_Donation_Eligible_80GGC").value
