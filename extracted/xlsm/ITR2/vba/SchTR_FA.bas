...
'CG_NEW_E1
'EfilingCommon.DefinedgridNameRange = "Deduction.54.DateOfTransfer||Deduction.54.CostOfHouse||Deduction.54.DateOfPursConst||Deduction.54.AmtdepCG||Deduction.54.AmtDedClaimeD"
'CG_NEW_C1 2024-25 Bindu
'EfilingCommon.DefinedgridNameRange = "Deduction.54.DateOfTransfer||Deduction.54.CostOfHouse||Deduction.54.DateOfPursConst||Deduction.54.AmtdepCG||Deduction.54.DateofDeposit||Deduction.54.AcctNum||Deduction.54.IFSCDeduction.54.AmtDedClaimed"
'Malli_22_01_2025
...
Sheets("CG").Activate
'CG_NEW_E4
'EfilingCommon.DefinedgridNameRange = "Deduction.54B.DateOfTransfer||Deduction.54B.CostOfAgriLand||Deduction.54B.DateOfPurLand||Deduction.54B.AmtdepCG||Deduction.54B.AmtDedClaimed"
'CG_NEW_C4 2024-25 Bindu
EfilingCommon.DefinedgridNameRange = "Deduction.54B.DateOfTransfer||Deduction.54B.CostOfAgriLand||Deduction.54B.DateOfPurLand||Deduction.54B.AmtdepCG||Deduction.54B.DateofDeposit||Deduction.54B.AcctNum||Deduction.54B.IFSC||Deduction.54B.AmtDedClaimed"
...
'EfilingCommon.DefinedgridNameRange = "Deduction.54F.DateOfTransfer||Deduction.54F.CostOfHouse||Deduction.54F.DateOfPurc||Deduction.54F.AmtdepCG||Deduction.54F.AmtDedClaimed"
'CG_NEW_C8 2024-25 Bindu
...
Dim vRows  As Long
Sheets("CG").Activate
EfilingCommon.DefinedgridNameRange = "Deduction.54G.DateOfTransfer||Deduction.54G.CostOfExpenses||Deduction.54G.DateOfPurc||Deduction.54G.AmtdepCG||Deduction.54G.AmtDedClaimed" '||Deduction.54GB.DateOfPurchase||Deduction.54GB.AmountDeposited||Deduction.54GB.AmountClaimed"
...
Dim vRows  As Long
Sheets("CG").Activate
'EfilingCommon.DefinedgridNameRange = "Deduction.54GA.DateOfTransfer||Deduction.54GA.CostOfExpenses||Deduction.54GA.DateOfPurc||Deduction.54GA.AmtdepCG||Deduction.54GA.AmtDedClaimed" '||Deduction.54GB.DateOfPurchase||Deduction.54GB.AmountDeposited||Deduction.54GB.AmountClaimed"
EfilingCommon.DefinedgridNameRange = "Deduction.54GA.DateOfTransfer||Deduction.54GB.PANOfEligible||Deduction.54GB.AmountUtilized||Deduction.54GB.DateOfSubscription||Deduction.54GA.CostOfExpenses||Deduction.54GA.DateOfPurc||Deduction.54GA.AmtdepCG||Deduction.54GA.AmtDedClaimed" '||Deduction.54GB.DateOfPurchase||Deduction.54GB.AmountDeposited||Deduction.54GB.AmountClaimed"
            ...
            If (TaxPaidOutsideIndia_TR(i) > 0 Or TaxReliefOutsideIndia_TR(i) > 0) Then
                ...
                If Len(ReliefClaimedUsSection_TR(i)) = 0 Or ReliefClaimedUsSection_TR(i) = "(Select)" Then
                    If TaxReliefOutsideIndia_TR(i) > 0 Then
                        ...
                        msgbox_TR ("* Section under which relief claimed(specify 90, 90A or 91) in Schedule TR is mandatory")
...
Function ValidateTotalTaxPaidOutsideIndia_TR() As Boolean
    ...
    If AssmtYrTaxRelief_TR <> "" Then
        ...
        If SecHval <> "-" Then
            msgbox_TR ("* Enter Assessment Year in format YYYY-YY, eg 2024-25") 'dpk1601
            ValidateTotalTaxPaidOutsideIndia_TR = False
            Exit Function
        End If
...
Function ValidateBankName_A1_FA() As Boolean
    ...
    For i = 1 To end_A1_FA
        ...
        If Not chkCompulsory(BankNameA1_FA(i)) Then
            ...
            'Added by Shrutika
            msgbox_A1_FA ("* Please enter the Name of the financial institution in Table A1 of Schedule FA")
...
If Not chkCompulsory(AccountOpeningDateA1_FA(i)) Then
 ...
 'Added by Shrutika
  msgbox_A1_FA ("* Please enter the date of account opening. in Table A1 of Schedule FA")
    ...
    For i = 1 To end_A1_FA
        ...
        If Not chkCompulsory(GrossInterest_A1_FA(i)) Then
           'Commented by Shrutika
            ...
            'Added by Shrutika
            msgbox_A1_FA ("* Please enter the Gross interest paid/credited to the account during the period in Table A1 of Schedule FA.")
    ...
    For i = 1 To end_A2_FA
        ...
        If isdropdownblank(GrossInterestNature_A2_FA(i)) Then
          'Commented by Shrutika
            ...
            'Added by Shrutika
            msgbox_A2_FA ("* Please Select the nature of amount from the drop downs provided in Table A2 of Schedule FA")
...
Function ValidateInitialvalue_Investment_A3_FA() As Boolean
    ...
    For i = 1 To end_A3_FA
        ...
        If Not chkCompulsory(Initialvalue_Investment(i)) Then
          'Commented by Shrutika
            'msgbox_A3_FA ("* Please enter the Gross interest paid or credited at Sr. No  " & i & " in Table A3 of Schedule FA")
            'Added by Shrutika
             msgbox_A3_FA ("* Please enter the Initial value of the investment. in Table A3 of Schedule FA.")
...
Function ValidateBankAddress_A4_FA() As Boolean
    ...
    For i = 1 To end_A4_FA
        ...
        'Commented by Shrutika
            ...
            'changed by Chetan C M on 29/08/2025
            'start--
'            'Added by Shrutika
'            msgbox_A4_FA ("* Please select the Country Name and Code in Table A4 of Schedule FA.")
             msgbox_A4_FA ("* Please enter the Address of financial institution in Table A4 of Schedule FA.")
             '--end
...
Function ValidateZipCode_A4_FA() As Boolean
    ...
    For i = 1 To end_A4_FA
        ...
        'changed by Chetan C M on 29/08/2025
            ...
            msgbox_A4_FA ("* Please enter the ZIP Code in Table A4 of Schedule FA.")
            '--end
...
Function ValidatesheetBFA() As Boolean
    ...
    'Commented by Shrutika
        ...
        'Added by Shrutika
        msgbox_B_FA ("* Please select the Country Name and Code in Table B of Schedule FA.")
        ValidatesheetBFA = False
        Exit Function
    End If
End Function
...
Function ValidateEntityNature_B_FA() As Boolean
    ...
    For i = 1 To end_B_FA
        ...
        'Commented by Shrutika
           ...
           'start--
'           'Added by Shrutika
'            msgbox_B_FA ("* Please enter the name of the entity in Table B of Schedule FA")
            msgbox_B_FA ("* Please enter the Nature of entity in Table B of Schedule FA.")
            '--end
...
Function ValidateEntityAdd_B_FA() As Boolean
    ...
    For i = 1 To end_B_FA
        ...
        'Commented by Shrutika
            ...
            'Added by Shrutika
            msgbox_B_FA ("* Please enter the Address of the entity in Table B of Schedule FA.")
...
NatureOfInterestB_FA(i) = rangecells.item(i).value
 ...
 'Commented by Shrutika
            ...
            'Added by Shrutika
            msgbox_B_FA ("* Please provide the nature of interest in Table B of Schedule FA.")
...
IncomeIncurredInAccB_FA(i) = rangecells.item(i).value
    ...
    'Commented by Shrutika
        ...
        'Added by Shrutika
        msgbox_B_FA ("* Please enter the income accrued from such financial interest in Table B of Schedule FA.")
...
If Not chkCompulsory(AmountB_FA(i)) Then
   'Commented by Shrutika
       ...
       'Added by Shrutika
        msgbox_B_FA ("* Please enter the amount of the income taxable in Table B of Schedule FA")
...
If isdropdownblank(Schedule_B_FA(i)) Then
  'Commented by Shrutika
        ...
        'Added by Shrutika
        msgbox_B_FA ("* Please enter the Schedule where income was offered in Table B of Schedule FA.")
...
If Not chkCompulsory(ItemNumber_B_FA(i)) Then
  'Commented by Shrutika
        ...
        'Added by Shrutika
        msgbox_B_FA ("* Please enter the Item number of schedule in Table B of Schedule FA.")
...
Function ValidatesheetCFA() As Boolean
    ...
    'Commented by Shrutika
        ...
        'Added by Shrutika
        msgbox_C_FA ("* Please select the Country Name and Code in Table C of Schedule FA.")
        ValidatesheetCFA = False
        Exit Function
    End If
End Function
...
Function ValidateCountry_C_FA() As Boolean
    ...
    For i = 1 To end_C_FA
        ...
        If isdropdownblank(CountryName) Then
            msgbox_C_FA ("* Please select the CountryName and Code at Sr. No  " & i & "  in Table C of Schedule FA")
    ...
    For i = 1 To end_C_FA
        ...
        'Commented by Shrutika
           ' msgbox_C_FA ("* Please enter the ZipCode at Sr. No  " & i & "  is Mandatory.If  ZIP code is not available, then enter XXXXXX in Table C of Schedule FA")
            'Added by Shrutika
             msgbox_C_FA ("* Please enter ZIP code, if  ZIP code is not available, then enter XXXXXX in Table C of Schedule FA.")
 ...
 Dim rangecells As Range
    ...
    For i = 1 To end_C_FA
        ...
        'Commented by Shrutika
            ...
            'start--
'            'Added by Shrutika
'            msgbox_C_FA ("* Please enter the Address of the Property in Table C of Schedule FA.")
            msgbox_C_FA ("* Please provide the details of ownership in Table C of Schedule FA.")
            '--end
 ...
 Dim rangecells As Range
    ...
    For i = 1 To end_C_FA
        ...
        'Commented by Shrutika
            ...
            'Added by Shrutika
            msgbox_C_FA ("* Please enter the date since financial interest in entity held in Table C of Schedule FA.")
...
Dim rangecells As Range
    ...
    For i = 1 To end_C_FA
        ...
        'Commented by Shrutika
          ...
          'Added by Shrutika
            msgbox_C_FA ("* Please enter the amount of the income taxable in Table C of Schedule FA")
...
Dim rangecells As Range
    ...
    For i = 1 To end_C_FA
        ...
        'Commented by Shrutika
          ...
          'Added by Shrutika
            msgbox_C_FA ("* Please enter the Schedule where income was offered in Table C of Schedule FA")
...
Dim rangecells As Range
    ...
    For i = 1 To end_C_FA
        ...
        'Commented by Shrutika
            ...
            'Added by Shrutika
            msgbox_C_FA ("* Please enter the Item number of schedule in Table C of Schedule FA.")
...
Function ValidateTotalInv_C_FA() As Boolean
    ...
    For i = 1 To end_C_FA
        ...
        'Commented by Shrutika
            ...
            'Added by Shrutika
            msgbox_C_FA ("* Please enter the Total Investment amount in Table C of Schedule FA.")
...
Function ValidatesheetDFA() As Boolean
    ...
    'Commented by Shrutika
       ' msgbox_D_FA ("* Enter all mandatory field in Table D of Schedule FA")
        'Added by Shrutika
        msgbox_D_FA ("* Please select the Country Name and Code in Table d of Schedule FA.")
        ValidatesheetDFA = False
        Exit Function
    End If
End Function
...
Function ValidateZipCode_D_FA() As Boolean
    ...
    For i = 1 To end_D_FA
        ...
        'Commented by Shrutika
            ...
            'Added by Shrutika
            msgbox_D_FA ("* Please enter ZIP code, if  ZIP code is not available, then enter XXXXXX in Table D of Schedule FA,Please enter the Nature of Asset in Table D of Schedule FA.")
...
Function ValidateAssetNature_D_FA() As Boolean
    ...
    For i = 1 To end_D_FA
        ...
        'changed by Chetan C M on 29/08/2025
        'start--
            'msgbox_D_FA ("* Please enter the Asset Nature at Sr. No  " & i & " in Table D of Schedule FA")
            msgbox_D_FA ("* Please enter the Nature of Asset in Table D of Schedule FA.")
        '--end
 ...
 Dim rangecells As Range
    ...
    For i = 1 To end_D_FA
        ...
        'Commented by Shrutika
           ...
           'Added by Shrutika
            msgbox_D_FA ("* Please provide the details of ownership in Table D of Schedule FA.")
        ...
        DateofAcquistionD_FA(i) = rangecells.item(i).value
          ...
          'Commented by Shrutika
           ' msgbox_D_FA ("* Please enter the Date of Acquistion at Sr. No  " & i & " in Table D of Schedule FA")
            'Added by Shrutika
            msgbox_D_FA ("* Please enter the date since financial interest in entity held in Table D of Schedule FA.")
...
Dim rangecells As Range
    ...
    For i = 1 To end_D_FA
        ...
        'Commented by Shrutika
           ...
           'Added by Shrutika
            msgbox_D_FA ("* Please enter the Income derived from the asset in Table D of Schedule FA.")
...
Dim rangecells As Range
    ...
    For i = 1 To end_D_FA
        ...
        'Commented by Shrutika
           ...
           'Added by Shrutika
            msgbox_D_FA ("* Please enter the amount of the income taxable in Table D of Schedule FA.")
...
Dim rangecells As Range
    ...
    For i = 1 To end_D_FA
        ...
        'Commented by Shrutika
         ...
         'Added by Shrutika
            msgbox_D_FA ("* Please enter the Schedule where income was offered in Table D of Schedule FA")
...
Dim rangecells As Range
    ...
    For i = 1 To end_D_FA
        ...
        'Commented by Shrutika
         ...
         'Added by Shrutika
            msgbox_D_FA ("* Please enter the Item number of schedule in Table D of Schedule FA.")
 ...
 Dim rangecells As Range
    ...
    For i = 1 To end_F_FA
        ...
        'start--
            ...
            msgbox_F_FA ("* Please enter the date of account opening in Table F of Schedule FA.")
        '--end
...
Dim rangecells As Range
    ...
    For i = 1 To end_F_FA
        ...
        'start--
            ...
            msgbox_F_FA ("* Please select the appropriate option in Table F of Schedule FA.")
        '--end
    ...
    For i = 1 To end_F_FA
      ...
      If WheteherTaxableIncomeF_FA(i) = "Y" Then
        ...
        'start--
            ...
            msgbox_F_FA ("* Please enter the details of the income derived in the account in Table F of Schedule FA.")
        '--end
...
Dim i As Long
    ...
    For i = 1 To end_F_FA
        ...
        'start--
            ...
            msgbox_F_FA ("* Please enter the amount of the income taxable in Table F of Schedule FA.")
        '--end
    ...
    For i = 1 To end_F_FA
       ...
       If WheteherTaxableIncomeF_FA(i) = "Y" Then
        ...
        'start--
            ...
            msgbox_F_FA ("* Please enter the Schedule where income was offered in Table F of Schedule FA.")
        '--end
    ...
    For i = 1 To end_F_FA
      ...
      If WheteherTaxableIncomeF_FA(i) = "Y" Then
        ...
        'start--
            ...
            msgbox_F_FA ("* Please enter the Item number of schedule in Table F of Schedule FA.")
        '--end
...
Function ValidateInstAdd_E_FA() As Boolean
    ...
    For i = 1 To end_E_FA
        ...
        'start--
            ...
            msgbox_E_FA ("* Please enter the Address of the Institution in Table E of Schedule FA.")
        '--end
 ...
 Dim rangecells As Range
    ...
    For i = 1 To end_E_FA
        ...
        'start--
            ...
            msgbox_E_FA ("* Please select the appropriate option in Table E of Schedule FA.")
        '--end
...
Dim rangecells As Range
    ...
    For i = 1 To end_E_FA
        ...
        'start--
            ...
            msgbox_E_FA ("* Please enter the details of the income accrued in the account in Table E of Schedule FA.")
        '--end
...
Dim rangecells As Range
    ...
    For i = 1 To end_E_FA
        ...
        'start--
            ...
            msgbox_E_FA ("* Please enter the amount of the income taxable in Table E of Schedule FA.")
        '--end
...
Dim rangecells As Range
    ...
    For i = 1 To end_E_FA
        ...
        'start--
            ...
            msgbox_E_FA ("* Please enter the Schedule where income was offered in Table E of Schedule FA.")
        '--end
...
Dim rangecells As Range
    ...
    For i = 1 To end_E_FA
        ...
        'start--
            ...
            msgbox_E_FA ("* Please enter the Item number of schedule in Table E of Schedule FA.")
        '--end
...
Function ValidatePeakBalInv_E_FA() As Boolean
    ...
    For i = 1 To end_E_FA
        ...
        'start--
            ...
            msgbox_E_FA ("* Please enter Peak Balance in Table E of Schedule FA.")
        '--end
 ...
 Dim rangecells As Range
    ...
    For i = 1 To end_G_FA
        ...
        'changed by Chetan C M on 29/08/2025
            ...
            msgbox_G_FA ("* Please select the appropriate option in Table G of Schedule FA.")
            '--end
    ...
    For i = 1 To end_G_FA
        ...
        If WhetherTaxableIncomeG_FA(i) = "Y" Then
            ...
            'start--
                ...
                msgbox_G_FA ("* Please enter the amount of the income taxable in Table G of Schedule FA.")
            '--end
    ...
    For i = 1 To end_G_FA
        ...
        If WhetherTaxableIncomeG_FA(i) = "Y" Then
            ...
            'start--
                ...
                msgbox_G_FA ("* Please enter the Schedule where income was offered in Table G of Schedule FA.")
            '--end
    ...
    For i = 1 To end_G_FA
     ...
     If WhetherTaxableIncomeG_FA(i) = "Y" Then
            ...
            'start--
                ...
                msgbox_G_FA ("* Please enter the Item number of schedule in Table G of Schedule FA.")
            '--end
