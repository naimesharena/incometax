...
'added by Chetan C M on 20/05/2025 for AY 2025-26
'start--
'TableA1
...
Sub Next_80DClick()
Dim sourceSheet As Worksheet
Set sourceSheet = ThisWorkbook.Sheets("DI")
sourceSheet.Activate
End Sub
 Sub Prev80D_Click()
Sheet17.Activate
...
Function ChkFamilyMember() As Boolean
    ...
    FamilyMember = Sheet55.Range("DropDown_ValueOf_FamilyM_80D")
    If (SheetALL.Range("bacValue").value) = 2 Then
'Change-16.05.2023.101.80D -> SIT-51316 B
...
'            Exit Function
        ...
        End If
    End If
    SeniorCitizen = Sheet55.Range("DropDown_ValueOf_SC_80D")
    If (SheetALL.Range("bacValue").value) = 2 Then
        If Mid(Trim(Sheet1.Range("sheet1.Status")), 1, 1) <> "H" Then
            If Trim(SeniorCitizen) = "" Or Trim(SeniorCitizen) = "(Select)" Then
'Change-16.05.2023.101.80D -> SIT-51316 C
              'MsgBox_80D = MsgBox_80D + "* Please select an option from the dropdown in Sheet 80D" & Chr(13)
...
'setTblinfo_80DNameA1
 ...
 '  NameA1_80D(i) = rangecells.item(i).value
        ...
        End If
         ...
         If Len(NameA1_80D(i)) > 125 Then 'Changed by Bindu on 4th July 25
...
Function ValidatePolicyA1_80D() As Boolean
    ...
    Dim i As Long
    Dim cellrange As String
    Set rangecells = Sheet55.Range("PolicyNumA1.80D").Cells
    ReDim PolicyA1_80D(end_80D)
    For i = 1 To end_80D
    cellrange = GetMergedAddressCell(rangecells, i)
    PolicyA1_80D(i) = Sheet55.Range(cellrange).value
        ...
        End If
         ...
         If Len(PolicyA1_80D(i)) > 125 Then 'Updated by Bindu on 4th July 25
            MsgBox_80D = MsgBox_80D + "* Policy Number in schedule 80D at Sl.no. " & i & " in table 1a cannot be more than 125 characters." & Chr(13)
            ValidatePolicyA1_80D = False
            Exit Function
         End If
...
'    Dim i As Long
'    Dim cellrange As String
'    Set rangecells = Sheet55.Range("ReceiptNumA1.80D").Cells
...
'    ReceiptA1_80D(i) = Sheet55.Range(cellrange).value
'
...
Function ValidateAmtA1_80D() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet55.Range("AmtA1.80D").item(1, 1).Cells
...
'         End If
         ...
         If Not IsNumeric(AmtA1_80D(i)) Then
            MsgBox_80D = MsgBox_80D + "Amount of premioum in schedule 80D at Sl.no. " & i & " in table 1a should be Numeric value" & Chr(13)
            ValidateAmtA1_80D = False
            Exit Function
        End If

        If AmtA1_80D(i) > 99999999999999# Then
            MsgBox_80D = MsgBox_80D + "* Amount of premioum in schedule 80D at Sl.no. " & i & " in table 1a cannot exceed 14 digits" & Chr(13)
            ValidateAmtA1_80D = False
            Exit Function
        End If

       If AmtA1_80D(i) < 0 Or AmtA1_80D(i) = 0 Then
            MsgBox_80D = MsgBox_80D + """Health Insurance Amount"" claimed in table 1a Sl.no. " & i & " should be more than 0 in schedule 80D" & Chr(13)
            ValidateAmtA1_80D = False
            Exit Function
        End If
    'Shutika 12/06/2025 (SIT-93562)
     If Sheet55.Range("TotAmtA1.80D") > 99999999999999# Then
...
'setTblinfo_80DNameA1
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet55.Range("NameInsurerB1.80D").Cells
    Dim cellrange As String
    ReDim NameB1_80D(end_80DB1)
    For i = 1 To end_80DB1
    cellrange = GetMergedAddressCell(rangecells, i)
    NameB1_80D(i) = Sheet55.Range(cellrange).value
'        NameB1_80D(i) = rangecells.item(i).Value
        ...
        End If
         ...
         If Len(NameB1_80D(i)) > 125 Then 'Updated by Bindu 4th July 25
...
Function ValidatePolicyB1_80D() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet55.Range("PolicyNumB1.80D").Cells
    ...
    cellrange = GetMergedAddressCell(rangecells, i)
    PolicyB1_80D(i) = Sheet55.Range(cellrange).value
        ...
        End If
         ...
         If Len(PolicyB1_80D(i)) > 125 Then 'Updated by Bindu on 4th July 25
            MsgBox_80D = MsgBox_80D + "* Policy Number in schedule 80D at Sl.no. " & i & " in table 1b cannot be more than 125 characters." & Chr(13)
            ValidatePolicyB1_80D = False
            Exit Function
         End If
...
'    Dim rangecells As Range
'    Dim i As Long
'    Set rangecells = Sheet55.Range("ReceiptNumB1.80D").Cells
'
'    'ReDim ReceiptNumB1_80D(end_80DB1)
'     ReDim ReceiptB1_80D(end_80DB1)
'    For i = 1 To end_80DB1
'    cellrange = GetMergedAddressCell(rangecells, i)
'    ReceiptB1_80D(i) = Sheet55.Range(cellrange).value
...
Function ValidateAmtB1_80D() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet55.Range("AmtB1.80D").item(1, 1).Cells
...
'         End If
         ...
         If Not IsNumeric(AmtB1_80D(i)) Then
            MsgBox_80D = MsgBox_80D + "Amount of premioum in schedule 80D at Sl.no. " & i & " in table 1b should be Numeric value" & Chr(13)
            ValidateAmtB1_80D = False
            Exit Function
        End If
        
        If AmtB1_80D(i) > 99999999999999# Then
            MsgBox_80D = MsgBox_80D + "* Amount of premioum in schedule 80D at Sl.no. " & i & " in table 1b cannot exceed 14 digits" & Chr(13)
            ValidateAmtB1_80D = False
            Exit Function
        End If
        ...
        'Shutika 12/06/2025 (SIT-93562)
     If Sheet55.Range("TotAmtB1.80D") > 99999999999999# Then
...
'setTblinfo_80DNameA1
    ...
    Dim i As Long
    Dim cellrange As String
    Set rangecells = Sheet55.Range("NameInsurerA2.80D").Cells
    ReDim NameA2_80D(end_80DA2)
    For i = 1 To end_80DA2
    cellrange = GetMergedAddressCell(rangecells, i)
    NameA2_80D(i) = Sheet55.Range(cellrange).value
 '  NameA2_80D(i) = rangecells.item(i).value
        ...
        End If
         ...
         If Len(NameA2_80D(i)) > 125 Then 'Updated by Bindu on 4th July 25
...
Function ValidatePolicyA2_80D() As Boolean
    ...
    Dim i As Long
    Dim cellrange As String
    Set rangecells = Sheet55.Range("PolicyNumA2.80D").Cells
    ReDim PolicyA2_80D(end_80DA2)
    For i = 1 To end_80DA2
        cellrange = GetMergedAddressCell(rangecells, i)
        PolicyA2_80D(i) = Sheet55.Range(cellrange).value
       ' PolicyA2_80D(i) = rangecells.item(i).value
        ...
        End If
         ...
         If Len(PolicyA2_80D(i)) > 125 Then 'Updated by Bindu on 4th July 25
            MsgBox_80D = MsgBox_80D + "* Policy Number in schedule 80D at Sl.no. " & i & " in table 2a cannot be more than 125 characters." & Chr(13)
            ValidatePolicyA2_80D = False
            Exit Function
         End If
...
'    Dim i As Long
'    Dim cellrange As String
'    Set rangecells = Sheet55.Range("ReceiptNumA2.80D").Cells
'    'ReDim ReceiptNumA2_80D(end_80DA2)
'     ReDim ReceiptA2_80D(end_80DA2)
'
'    For i = 1 To end_80DA2
'    cellrange = GetMergedAddressCell(rangecells, i)
'    ReceiptA2_80D(i) = Sheet55.Range(cellrange).value
...
Function ValidateAmtA2_80D() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
   ' Set rangecells = Sheet55.Range("AmtA2.80D").Cells
   Set rangecells = Sheet55.Range("AmtA2.80D").item(1, 1).Cells
...
'         End If
        ...
        If Not IsNumeric(AmtA2_80D(i)) Then
            MsgBox_80D = MsgBox_80D + "Amount of premioum in schedule 80D at Sl.no. " & i & " in table 2a should be Numeric value" & Chr(13)
            ValidateAmtA2_80D = False
            Exit Function
        End If
        
        If AmtA2_80D(i) > 99999999999999# Then
            MsgBox_80D = MsgBox_80D + "* Amount of premioum in schedule 80D at Sl.no. " & i & " in table 2a cannot exceed 14 digits" & Chr(13)
            ValidateAmtA2_80D = False
            Exit Function
        End If
        
        If AmtA2_80D(i) < 0 Or AmtA2_80D(i) = 0 Then
            MsgBox_80D = MsgBox_80D + """Health Insurance Amount"" claimed in table 2a Sl.no. " & i & "  should be more than 0 in schedule 80D" & Chr(13)
            ValidateAmtA2_80D = False
            Exit Function
        End If
        'Shutika 12/06/2025 (SIT-93562)
     If Sheet55.Range("TotAmtA2.80D") > 99999999999999# Then
...
'setTblinfo_80DNameA1
    ...
    Set rangecells = Sheet55.Range("NameInsurerB2.80D").Cells
    ReDim NameB2_80D(end_80DB2)
    For i = 1 To end_80DB2
    cellrange = GetMergedAddressCell(rangecells, i)
    NameB2_80D(i) = Sheet55.Range(cellrange).value
'        NameB2_80D(i) = rangecells.item(i).Value
        ...
        End If
         ...
         If Len(NameB2_80D(i)) > 125 Then 'Updated by Bindu on 4th July 25
...
Function ValidatePolicyB2_80D() As Boolean
    ...
    Set rangecells = Sheet55.Range("PolicyNumB2.80D").Cells
    ReDim PolicyB2_80D(end_80DB2)
    For i = 1 To end_80DB2
    cellrange = GetMergedAddressCell(rangecells, i)
    PolicyB2_80D(i) = Sheet55.Range(cellrange).value
'   PolicyB2_80D(i) = rangecells.item(i).value
        ...
        End If
         ...
         If Len(PolicyB2_80D(i)) > 125 Then 'Updated by Bindu on 4th July 25
            MsgBox_80D = MsgBox_80D + "* Policy Number in schedule 80D at Sl.no. " & i & " in table 2b cannot be more than 125 characters." & Chr(13)
            ValidatePolicyB2_80D = False
            Exit Function
         End If
...
'    Dim i As Long
'    Dim cellrange As String
'    Set rangecells = Sheet55.Range("ReceiptNumB2.80D").Cells
'    'ReDim ReceiptNumB2_80D(end_80DB2)
'    ReDim ReceiptB2_80D(end_80DB2)
'
'    For i = 1 To end_80DB2
'    cellrange = GetMergedAddressCell(rangecells, i)
'    ReceiptB2_80D(i) = Sheet55.Range(cellrange).value
...
Function ValidateAmtB2_80D() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet55.Range("AmtB2.80D").item(1, 1).Cells
...
'         End If
         ...
         If Not IsNumeric(AmtB2_80D(i)) Then
            MsgBox_80D = MsgBox_80D + "Amount of premioum in schedule 80D at Sl.no. " & i & " in table 2b should be Numeric value" & Chr(13)
            ValidateAmtB2_80D = False
            Exit Function
        End If
        
        If AmtB2_80D(i) > 99999999999999# Then
            MsgBox_80D = MsgBox_80D + "* Amount of premioum in schedule 80D at Sl.no. " & i & " in table 2b cannot exceed 14 digits" & Chr(13)
            ValidateAmtB2_80D = False
            Exit Function
        End If
        ...
        'Shutika 12/06/2025 (SIT-93562)
     If Sheet55.Range("TotAmtB2.80D") > 99999999999999# Then
 ...
 'Added by Shrutika(SIT-93562)
'
' If Sheet55.Range("TotAmtA1.80D").value >= 14 Then
' MsgBox_80D = MsgBox_80D + "* "" Total of Payments should be  14 Digits,numeric and non negative."""
'
' End If
'
' If Sheet55.Range("TotAmtB1.80D").value >= 14 Then
' MsgBox_80D = MsgBox_80D + "* "" Total of Payments should be  14 Digits,numeric and non negative."""
'  End If
'
' If Sheet55.Range("TotAmtA2.80D").value >= 14 Then
' MsgBox_80D = MsgBox_80D + "* "" Total of Payments should be  14 Digits,numeric and non negative."""
'  End If
'
'  If Sheet55.Range("TotAmtB2.80D").value >= 14 Then
' MsgBox_80D = MsgBox_80D + "* "" Total of Payments should be  14 Digits,numeric and non negative."""
'  End If
'  '---------------------------------------------------
End Function
