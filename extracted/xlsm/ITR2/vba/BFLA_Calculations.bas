...
'ltcgBreakUp3 = cgosIncome_cgInc_ltcg_prctg10_secProviso '' cgosIncome_cgInc_ltcg_prctg10_secProviso NOt using  commented  by Bindu as this sec changed from 10 to 20
...
'templtcgBreakUp3 = ltcgBreakUp3'' cgosIncome_cgInc_ltcg_prctg10_secProviso NOt using  commented  by Bindu as this sec changed from 10 to 20
...
Sheet8.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4").value = Application.WorksheetFunction.Max(0, ltcgBreakUp4 - templtcgBreakUp4) + _
                                                            Application.WorksheetFunction.Max(0, ltcgBreakUp5 - templtcgBreakUp5) + _
                                                            Application.WorksheetFunction.Max(0, ltcgBreakUp6 - templtcgBreakUp6) + _
                                                            Application.WorksheetFunction.Max(0, ltcgBreakUp7 - templtcgBreakUp7) + _
                                                           Application.WorksheetFunction.Max(0, ltcgBreakUp8 - templtcgBreakUp8)
                                                            
'Application.WorksheetFunction.Max(0, storeLTCG3 - templtcgBreakUp3) deleted by Bindu as this sec changed from 10 to 20
Sheet9.Range("adjtotloss.STCGLossCF9").value = Application.WorksheetFunction.Max(0, storeSTCG1 - tempstcgBreakUp1) + _
       ...
       ' cgosIncome_cgInc_ltcg_prctg10_secProviso = templtcgBreakUp3 '' cgosIncome_cgInc_ltcg_prctg10_secProviso NOt using  commented  by Bindu as this sec changed from 10 to 20
 ...
 'storing diff section remaining value
    ...
    'Sheet16.Range("BFLAtemp10SecPro").value = cgosIncome_cgInc_ltcg_prctg10_secProviso '' cgosIncome_cgInc_ltcg_prctg10_secProviso NOt using  commented  by Bindu as this sec changed from 10 to 20
