...
'NEWLY ADDED FOR U/S 54
Public dateOfdeposit, BankAccntnum, BankIFSC As Variant
Public DateofDepositB, BankIFSCB, BankAccntnumB As Variant

Public DateofDepositF, BankIFSCF, BankAccntnumF As Variant
...
Sub setTableInfo_Ded54BDateTransfer()
    ...
    'CG_NEW_E4
    'rngname_Ded54B = "Deduction.54B.DateOfTransfer;Deduction.54B.CostOfAgriLand;Deduction.54B.DateOfPurLand;Deduction.54B.AmtdepCG;Deduction.54B.AmtDedClaimed;"
...
'    msgboxSHEETCG = "Deduction u/s 54EC:" & Chr(13) & Chr(13)
    ...
    If (Len(Sheet13.Range("Deduction.54EC.DateOfTransfer").item(0).value) > 0) Then
        ...
        'If Not ValidateDed54ECDateofDeposit() Then ValidateDednTable54EC_CG = False
        'If Not ValidateDedEC54IFSC() Then ValidateDednTable54EC_CG = False
...
Sub setTableInfo_Ded54GDateTransfer()
    ...
    Next
    end_Ded54G_1 = ccount
    rngname_Ded54G = "Deduction.54G.DateOfTransfer;Deduction.54G.CostOfExpenses;Deduction.54G.DateOfPurc;Deduction.54G.AmtdepCG;Deduction.54G.AmtDedClaimed"
End Sub
...
Sub setTableInfo_Ded54GADateTransfer()
    ...
    rngname_Ded54GA = "Deduction.54GA.DateOfTransfer;Deduction.54GA.CostOfExpenses;Deduction.54GA.DateOfPurc;Deduction.54GA.AmtdepCG;Deduction.54GA.AmtDedClaimed"
End Sub
...
Sub setTableInfo_Ded54FDateTransfer()
    ...
    end_Ded54F_1 = ccount
    'CG_NEW_E8
    'rngname_Ded54F = "Deduction.54F.DateOfTransfer;Deduction.54F.CostOfHouse;Deduction.54F.DateOfPurc;Deduction.54F.AmtdepCG;Deduction.54F.AmtDedClaimed"
...
'If Not ChkMaxDOBDate(DateOfTransferF(i), "31/03/2025") Then
'        ValidateDed54FDateTransfer = False
'        msgboxSHEETCG = msgboxSHEETCG + "* Date of transfer of original asset at Sr. No " & i & " should not be after 31/03/2025 for AY 2025-26 at D1d In schedule CG." & Chr(13)
...
'     End If
    ...
    If (Len(AmountDepositedF(i)) > 14) Then
        msgboxSHEETCG = msgboxSHEETCG + "* Amount Deposited at Sr.No " & i & " cannot exceed 14 digits." & Chr(13)
        ValidateDed54FAmountDeposited = False
        Exit Function
    End If
...
Function ValidateDed54FAmountClaimed() As Boolean
    ...
    If (Len(AmountClaimedF(i)) > 9) Then
        msgboxSHEETCG = msgboxSHEETCG + "* Amount Claimed at Sr.No " & i & " cannot exceed 9 digits." & Chr(13)
        ValidateDed54FAmountClaimed = False
        Exit Function
    End If
 Next
...
Sub setTableInfo_Ded54DateTransfer()
    ...
    end_Ded54_1 = ccount
    'CG_NEW_E1
    'rngname_Ded54 = "Deduction.54.DateOfTransfer;Deduction.54.CostOfHouse;Deduction.54.DateOfPursConst;Deduction.54.AmtdepCG;Deduction.54.AmtDedClaimed;"
...
Function ValidateDed54IFSC() As Boolean
    ...
    If Len(CashDeposited(i)) > 0 And CashDeposited(i) <> 0 Then
            ...
            'SIT-89533
'                msgboxSHEETCG = msgboxSHEETCG + "* Please enter the Account Number at Sr.No " & i & " in Sheet CG is mandatory" & Chr(13)
                msgboxSHEETCG = msgboxSHEETCG + "* Please enter the Account Number at Sr.No " & i & " in Schedule CG" & Chr(13)
                ValidateDed54IFSC = False
                'Exit Function
           End If
        End If
...
For i = 1 To end_Ded54F_1
    ...
    AmountDepositedF(i) = rangecells1.item(i).value

    If Len(AmountDepositedF(i)) > 0 And AmountDepositedF(i) <> 0 Then
