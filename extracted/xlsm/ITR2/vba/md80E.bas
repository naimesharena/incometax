...
Function ValidateAccntNum_80E() As Boolean
    ...
    Set rangecells1 = Sheet60.Range("LoanfrmBankOrInstitute.80E").Cells  'Malli
    ...
    For i = 1 To end_80E
        ...
        If Not chkCompulsory(AccntNum_80E(i)) Then
            ' MsgBox_80E = MsgBox_80E + "* ""Please provide Loan Account number of the Bank/Institution from which loan is taken in schedule 80E"" at Sr. No " & i & "" & Chr(13)
             MsgBox_80E = MsgBox_80E + "* ""Please provide Loan Account number of the Bank / Institution from which loan is taken or any reference number if loan is taken from an Institution which does not provide loan account number in schedule 80E"" at Sr. No " & i & "" & Chr(13)
...
'            MsgBox_80E = MsgBox_80E + "* ""Please provide Date of taking loan in schedule 80E"" at Sr. No " & i & "" & Chr(13)
        ...
        ValidateLoanDate_80E = False
          ...
          Exit Function
        End If
'Konda updated on 07-05-2026---SIT-119150
'        If Not ChkMaxDate_80E(Trim(LoanDate_80E(i)), "31-03-2025") Then
...
Function ValidateLoanOutstanding_80E() As Boolean
    ...
    For i = 1 To end_80E
        ...
        'Ankita_05/05/2025_Commented as per DESheet_v0.7
            ...
            MsgBox_80E = MsgBox_80E + "* ""Loan outstanding as on last date of financial year is mandatory in schedule 80E. Please enter 0 in case the entire loan is repaid during the year""" & Chr(13)
   ...
   ' BankAccountNumber = Sheet5.Range("IncD.BankAccountNumber")
    ...
    If Len(BankAccountNumber) > 0 Then
        ...
        '  MsgBox_80E = MsgBox_80E & " ""Please provide correct Loan Account number of the Bank / Institution or any reference number if loan is taken from an Institution which does not provide loan account number""" & Chr(13)
             MsgBox_80E = MsgBox_80E & "* ""Please provide correct Loan Account number of the Bank / Institution or any reference number if loan is taken from an Institution which does not provide loan account number in schedule 80E """ & Chr(13)
  ...
  '----------------------------------------------------------------
   ...
   ' MsgBox_80E = MsgBox_80E & "* Loan Account number at Sr.No " & cc & " is invalid  in schedule 80E" & Chr(13)
    ...
    If countnum < 1 Then
       ...
       ' errmsgVerification = errmsgVerification & "* ""Please provide correct Loan Account number of the Bank/  Institution or any reference number if loan is taken from an Institution which does not provide loan account number""" & Chr(13)
         errmsgVerification = errmsgVerification & "* ""Please provide correct Loan Account number of the Bank / Institution or any reference number if loan is taken from an Institution which does not provide loan account number in schedule 80E """ & Chr(13)
...
'Changed by Konda on 07-05-2026--SIT-119150
'        If Year > 2025 Then
        If Year > 2026 Then
