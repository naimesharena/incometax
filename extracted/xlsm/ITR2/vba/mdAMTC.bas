...
'''''''''''''''''''''''''''''''''''''''''''
Public AssYr_AMTC10 As Variant  'Malli
Public Gross4i10 As Variant 'Malli
Public Balance4i10 As Variant 'Malli


Public AMTCredit4i10 As Variant 'Malli
Public BalAmtCreditCarryFwd11 As Variant 'Malli
Public SetOff4i9 As Variant 'Malli
Public Gross4i9 As Variant 'Malli

'Added by Naresh(AY-2025-2026)
Public Gross4i11 As Variant
Public AMTCredit4i11 As Variant
Public Balance4i11 As Variant
Public BalAmtCreditCarryFwd20 As Variant
...
Public BalAmtCreditCarryFwd21 As Variant
...
Function ValidateAssessmentYearForAMTC() As Boolean
   ...
   AssYr_AMTC3 = Sheet23.Range("AMTC.AssYr13_143").value
    ...
    End If
'Malli
'AMTC_C24_AY_2024-25  ADD 'Malli
 AssYr_AMTC10 = Sheet23.Range("AMTC.AssYr23_24").value
 If Len(AssYr_AMTC10) <> 7 Then
        MsgboxAMTC = MsgboxAMTC & "* Assessment Year in Sheet : Schedule AMTC must be exactly 7 characters " & Chr(13)
        ValidateAssessmentYearForAMTC = False
        Exit Function
    End If
...
Function ValidateAmtCreditSetOff4i() As Boolean
    ...
    SetOff4i9 = Sheet23.Range("AMTC.AmtCreditSetOfEy9").value
    If Len(SetOff4i9) > 14 Then
    ...
    If (IIf(Gross4i9 = "", 0, Gross4i9) < IIf(SetOff4i9 = "", 0, SetOff4i9)) Then
        MsgboxAMTC = MsgboxAMTC & "* Set-off in earlier years B2 cannot be greater than Gross B1 in Sheet : AMTC" & Chr(13)
        ValidateAmtCreditSetOff4i = False
        Exit Function
    End If
    
    For i = 1 To Len(SetOff4i9)
        If Not IsNumeric(SetOff4i9) Then
...
Function ValidateAmtCreditBalance4i() As Boolean
    ...
    'Malli
    'AMTC_C27_AY_2024-25  ADD 'Malli
    Balance4i10 = Sheet23.Range("AMTC.AmtCreditBalBroughtFwd10").value
    If Len(Balance4i10) > 14 Then
        MsgboxAMTC = MsgboxAMTC & "* AMT credit Balance in assessment year  2023_24 in Sheet : Schedule AMTC should be at most 14 digits " & Chr(13)
        ValidateAmtCreditBalance4i = False
        Exit Function
    End If
    ...
    For i = 1 To Len(Balance4i10)
        If Not IsNumeric(Balance4i10) Then
            MsgboxAMTC = MsgboxAMTC & "* AMT credit Balance  in assessment year 2023_24  in Sheet : Schedule AMTC must contain only digits from 0 to 9" & Chr(13)
            ValidateAmtCreditBalance4i = False
            Exit Function
        End If
    Next
    
    'Updated by Bindu on 23rd April 25
    Balance4i11 = Sheet23.Range("AMTC.AmtCreditBalBroughtFwd11").value
    If Len(Balance4i10) > 14 Then
        MsgboxAMTC = MsgboxAMTC & "* AMT credit Balance in assessment year  2024_25 in Sheet : Schedule AMTC should be at most 14 digits " & Chr(13)
        ValidateAmtCreditBalance4i = False
        Exit Function
    End If
    ...
    For i = 1 To Len(Balance4i11)
        If Not IsNumeric(Balance4i11) Then
            MsgboxAMTC = MsgboxAMTC & "* AMT credit Balance  in assessment year 2024_25  in Sheet : Schedule AMTC must contain only digits from 0 to 9" & Chr(13)
            ValidateAmtCreditBalance4i = False
            Exit Function
        End If
    Next
    ...
    If Len(Balance4i12) > 14 Then
        MsgboxAMTC = MsgboxAMTC & "* AMT credit Balance in assessment year  2025_26 in Sheet : Schedule AMTC should be at most 14 digits " & Chr(13)
        ValidateAmtCreditBalance4i = False
        Exit Function
    End If
    ...
    For i = 1 To Len(Balance4i12)
        If Not IsNumeric(Balance4i12) Then
            MsgboxAMTC = MsgboxAMTC & "* AMT credit Balance  in assessment year 2025_26  in Sheet : Schedule AMTC must contain only digits from 0 to 9" & Chr(13)
            ValidateAmtCreditBalance4i = False
            Exit Function
        End If
    Next
...
Function ValidateAmtBalAmtCreditCarryFwd1() As Boolean
    ...
    'Malli
    'AMTC_C29_AY_2024-25  ADD 'Malli
    BalAmtCreditCarryFwd11 = Sheet23.Range("AMTC.BalAmtCreditCarryFwd10").value
    If Len(BalAmtCreditCarryFwd11) > 14 Then
        MsgboxAMTC = MsgboxAMTC & "* Balance AMT credit carried forward  in assessment year  2023_24 in Sheet : Schedule AMTC should be at most 14 digits " & Chr(13)
        ValidateAmtBalAmtCreditCarryFwd1 = False
        Exit Function
    End If
    For i = 1 To Len(BalAmtCreditCarryFwd11)
        If Not IsNumeric(BalAmtCreditCarryFwd11) Then
            MsgboxAMTC = MsgboxAMTC & "* Balance AMT credit carried forward  in assessment year  2023_24  in Sheet : Schedule AMTC must contain only digits from 0 to 9" & Chr(13)
            ValidateAmtBalAmtCreditCarryFwd1 = False
            Exit Function
        End If
    Next
   ...
   'Added by Aavula Naresh New dev
    ...
    BalAmtCreditCarryFwd20 = Sheet23.Range("AMTC.BalAmtCreditCarryFwd11").value
    If Len(BalAmtCreditCarryFwd20) > 14 Then
        MsgboxAMTC = MsgboxAMTC & "* Balance AMT credit carried forward  in assessment year  2024_25 in Sheet : Schedule AMTC should be at most 14 digits " & Chr(13)
        ValidateAmtBalAmtCreditCarryFwd1 = False
        Exit Function
    End If
    For i = 1 To Len(BalAmtCreditCarryFwd20)
        If Not IsNumeric(BalAmtCreditCarryFwd20) Then
            MsgboxAMTC = MsgboxAMTC & "* Balance AMT credit carried forward  in assessment year  2024_25  in Sheet : Schedule AMTC must contain only digits from 0 to 9" & Chr(13)
            ValidateAmtBalAmtCreditCarryFwd1 = False
            Exit Function
        End If
    Next
''''''''''''''
   ...
   'Added by Aavula Naresh New dev
    ...
    BalAmtCreditCarryFwd21 = Sheet23.Range("AMTC.BalAmtCreditCarryFwd12").value
    If Len(BalAmtCreditCarryFwd21) > 14 Then
        MsgboxAMTC = MsgboxAMTC & "* Balance AMT credit carried forward  in assessment year  2025_26 in Sheet : Schedule AMTC should be at most 14 digits " & Chr(13)
        ValidateAmtBalAmtCreditCarryFwd1 = False
        Exit Function
    End If
    For i = 1 To Len(BalAmtCreditCarryFwd21)
        If Not IsNumeric(BalAmtCreditCarryFwd21) Then
            MsgboxAMTC = MsgboxAMTC & "* Balance AMT credit carried forward  in assessment year  2025_26 in Sheet : Schedule AMTC must contain only digits from 0 to 9" & Chr(13)
            ValidateAmtBalAmtCreditCarryFwd1 = False
            Exit Function
        End If
    Next
...
Function ValidateAmtCreditGross4ii() As Boolean
    ...
    If Gross4ii > WorksheetFunction.Max(0, TaxSection115JC_AMTC - TaxOthProvisions_AMTC) Then
        MsgboxAMTC = MsgboxAMTC & "* The amount of Gross AMT Credit (B1) 2019-20 can not exceed (1-2)" & Chr(13)
        ValidateAmtCreditGross4ii = False
        Exit Function
    End If
End Function
