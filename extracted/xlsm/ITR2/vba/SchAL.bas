...
ValidatesheetSchAL = True
   ...
   ' If (TotalIncome_PARTBTI > 5000000 And isdropdownblank(IsImmovableAsset)) Then
    If (TotalIncome_PARTBTI > 10000000 And isdropdownblank(IsImmovableAsset)) Then 'Changed by Shrutika(As Per DE_Ver_0.5/0.6)
   ...
   ' If (TotalIncome_PARTBTI > 5000000 And isdropdownblank(IsInterestHeld)) Then
    If (TotalIncome_PARTBTI > 10000000 And isdropdownblank(IsInterestHeld)) Then 'Changed by Shrutika(As Per DE_Ver_0.5/0.6)
...
'Change-10.03.2023.101 -> defectlog Test-16
   ' If (Not (blankChkA)) And Sheet7.Range("Sheet8b.TotalIncome").value > 5000000 Then
    If (Not (blankChkA)) And Sheet7.Range("Sheet8b.TotalIncome").value > 10000000 Then 'Changed by Shrutika(As Per DE_Ver_0.5/0.6)
        If (blankChkBD) Then
...
'        End If
    ...
    If Not (blankChkBD) Or blankChkCntB >= 1 Then
      ...
      '  If blankChkCntB <> 9 And Sheet7.Range("Sheet8b.TotalIncome").value > 5000000 Then
        If blankChkCntB <> 9 And Sheet7.Range("Sheet8b.TotalIncome").value > 10000000 Then 'Changed by Shrutika(As Per DE_Ver_0.5/0.6)
            msgboxAL = msgboxAL + "* Please fill the amount fields at Point B or / and  Point D. If not applicable, enter zeros.in schedule AL" & Chr(13)
            ValidatesheetSchAL = False
            'Exit Function
        End If
        
         'Added by Shrutika(05/06/2025) SIT-93645
        If (blankChkBD) And Sheet7.Range("Sheet8b.NetAgricultureIncomeOrOtherIncomeForRate").value > 10000000 Then
msgboxAL = msgboxAL + "* Please enter the amount Liabilities in relation to Assets in schedule AL" & Chr(13)
            ValidatesheetSchAL = False
       ' End If
        Exit Function
    End If
    ...
    If Not (blankChkC) Then
        If (blankChkA) Then
'Change-16.05.2023.101.Enhancement -> SIT-51316
           ' If Sheet7.Range("Sheet8b.TotalIncome").value > 5000000 Then
            If Sheet7.Range("Sheet8b.TotalIncome").value > 10000000 Then 'Changed by Shrutika(As Per DE_Ver_0.5/0.6)
                msgboxAL = msgboxAL + "* Please select an option at Point A.in schedule AL" & Chr(13)
                ValidatesheetSchAL = False
                'Exit Function
            End If
       ...
       ' If (blankChkBD) And Sheet7.Range("Sheet8b.TotalIncome").value > 5000000 Then
        If (blankChkBD) And Sheet7.Range("Sheet8b.TotalIncome").value > 10000000 Then 'Changed by Shrutika(As Per DE_Ver_0.5/0.6)
        'Ankita(23-Jan)
         ' msgboxAL = msgboxAL + "* Please fill the amount fields at Point B or / and  Point D. If not applicable, enter zeros.in schedule AL" & Chr(13)
  ...
  '  If (TotalIncome_PARTBTI > 5000000) Then  ' And Status_6 <> "F") Then
    If (TotalIncome_PARTBTI > 10000000) Then 'Changed by Shrutika(As Per DE_Ver_0.5/0.6)
...
ValidateImmovableAssetAddress_AL = True
    ...
    For i = 1 To count_AL1
        ...
        'Ankita
            'msgboxAL = msgboxAL + "* Flat/Door/Block No. at Address of immovable asset is Mandatory at Sr.No " & i & " in schedule AL" & Chr(13)
             'msgboxAL = msgboxAL + "* Flat/Door/Building in Sheet AL is mandatory. & Chr(13)
             
             msgboxAL = msgboxAL + "* Flat/Door/Building in Sheet AL is mandatory at Sr.No " & i & "." & Chr(13) 'Added by Aavula
    ...
    'Added by Jyoti 10.01.2024

          msgboxAL = msgboxAL + "* Area/ Locality in Sheet: AL is mandatory." & Chr(13)
          ValidateImmovableAssetAddress_AL = False
           Exit Function
        End If
     ...
     'Added by Jyoti 10.01.2024
            ...
            msgboxAL = msgboxAL + "* Area/ Locality cannot be more than 50 characters in schedule AL " & Chr(13)
            ValidateImmovableAssetAddress_AL = False
            Exit Function
        End If
     ...
     'Added by Jyoti 10.01.2024
            ...
            'msgboxAL = msgboxAL + "* Town/City/District in Sheet: AL is mandatory. " & i & " in schedule AL" & Chr(13)
            'Added by Shrutika
            msgboxAL = msgboxAL + "* Town/City/District in Sheet: AL is mandatory." & Chr(13)
            ValidateImmovableAssetAddress_AL = False
            Exit Function
        End If
    ...
    'Added by Jyoti 10.01.2024
            ...
            msgboxAL = msgboxAL + "*Town/City/District cannot be more than 50 characters in schedule AL" & Chr(13)
            ValidateImmovableAssetAddress_AL = False
            Exit Function
        End If
    ...
    'Added by Jyoti 10.01.2024
            ...
            msgboxAL = msgboxAL + "* State in Sheet: AL is mandatory." & Chr(13)
            ValidateImmovableAssetAddress_AL = False
            Exit Function
        End If
        ...
        Sheets("AL").Activate  'Malli 18/09/2023
...
'17/10/2024------------Malli
    ...
    If PINstate_ModualValidation(ws1, PIN_targetadd, state_targetadd) = False Then Sheet43.Range(Replace(state_targetadd, "K", "M")).value = ""
       
       If Sheet43.Range(Replace(state_targetadd, "K", "M")).value = "" Then
        ImmovableAssetAddress8(i) = rangecells7.item(i).value
       End If
      '-----------------------------
    ...
    'Added by Jyoti 10.01.2024
            ...
            msgboxAL = msgboxAL + "* Country in Sheet: AL is mandatory." & Chr(13)
            ValidateImmovableAssetAddress_AL = False
            Exit Function
        End If
        ...
        'Ankita
           'msgboxAL = msgboxAL + "* Pin Code at Address of immovable asset is Mandatory at Sr.No " & i & " in schedule AL" & Chr(13)
            'msgboxAL = msgboxAL + "* Pin code is mandatory." & Chr(13)
            
            'Added by Aavula
            msgboxAL = msgboxAL + "* Pin code is mandatory at Sr.No " & i & "." & Chr(13)
        ...
        If Len(ImmovableAssetAddress8(i)) > 6 Then
            'msgboxAL = msgboxAL + "* PinCode at Address of immovable asset  at Sr.No " & i & "  cannot exceed 6 digits in schedule AL" & Chr(13)
             msgboxAL = msgboxAL + "* Pin code should be exactly 6 digits in schedule AL at Sr.No " & i & "" & Chr(13)
        ...
        If Not IsNumeric(ImmovableAssetAddress8(i)) Then
            msgboxAL = msgboxAL + "* PinCode at Address is Invalid in schedule AL at Sr.No " & i & "  " & Chr(13)
   ...
   '        msgboxAL = msgboxAL + "* Zip Code at Address of immovable asset is Mandatory at Sr.No " & i & " in schedule AL" & Chr(13)
           ' msgboxAL = msgboxAL + "* Zip code is mandatory in schedule AL" & Chr(13)
            
            'Added by Aavula
              msgboxAL = msgboxAL + "* Zip code is mandatory in schedule AL at Sr.No " & i & "" & Chr(13)
        ...
        If Len(ImmovableAssetAddress9(i)) > 8 Then
            ...
            'Added by Aavula
            msgboxAL = msgboxAL + "* Zip code should be exactly 6 digits in schedule AL at Sr.No " & i & "" & Chr(13)
