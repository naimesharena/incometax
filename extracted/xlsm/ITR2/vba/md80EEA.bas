...
'       end_24b = ((end_24b - 1) + rowcount_Int24B)  'Newly Update on 02/05/2025
 '   End If
    ...
    Else
       end_80EEA = ((end_80EEA - 1) + rowcount_80EEA)  'Newly Update on 02/05/2025
    End If
...
If Combination_80EEA_24B = False Then
        ...
        MsgBox_80EEA = MsgBox_80EEA & ("""Deduction u/s 80EEA can be claimed only if the limit u/s 24(b) is exhausted. So please note that the loan details of respective property under which 80EEA is being claimed should be the same as in table 24(b)""") & Chr(13) 'Changed by Shrutika(ver.6)
        fmsgboxStatus MsgBox_80EEA
...
'  If (Sheet60.Range("TotAmt.80EEA").value > 0 And Not Sheet1.Range("IncD.InterestBorrowedCapital").value > 0) Then
...
If Sheet60.Range("Stampduty.80EEA").value > 0 And end_80EEA = 0 Then
...
'    If (Sheet60.Range("MaxLoan_80EEA").value) > 3500000 Then
