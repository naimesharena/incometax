...
'    If RelevantClauseClaimed_80GGANew(i) = "(Select)" Or RelevantClauseClaimed_80GGANew(i) = "" Then
...
'        End If
        ...
        If isdropdownblank(RelevantClauseClaimed_80GGANew(i)) Then
           ...
           'Shrutika
           MsgBox_80GGANew = MsgBox_80GGANew + "* Please select relevant clause from Drop-Down in Schedule 80GGA."
...
ValidateState_Code_80GGANew = True
    ...
    For i = 1 To end80GGAN
       ...
       Sheet56.Activate  'Malli 18/09/2024
     ...
     state_targetadd = Replace(rangecells.item(i).Address, "$", "")
      ...
      Dim ws1 As Worksheet
                             'Set ws1 = Worksheets("RA")  '23/09/24  '80GGA
     '17/10/2024'-----------------------------------
      Set ws1 = Worksheets("80GGA")
         'If state_Validation(ws1, PIN_targetadd, state_targetadd) = False Then Sheet56.Range(Replace(state_targetadd, "I", "J")).value = "" 'State_Code_80GGANew(i) = ""
        If PINstate_ModualValidation(ws1, PIN_targetadd, state_targetadd) = False Then Sheet56.Range(Replace(state_targetadd, "I", "J")).value = "" 'State_Code_80GGANew(i) = ""
...
ValidatePincode_80GGANew = True
    ...
    For i = 1 To end80GGAN
        ...
        If Not chkMandatory(Pincode_80GGANew(i)) Then
            ...
            'Shrutika
             MsgBox_80GGANew = MsgBox_80GGANew + "* ""Please enter pin code of donee in Schedule 80GGA.""" & Chr(13)
...
ValidatePAN_of_donee_80GGANew = True
    ...
    PAN_of_donee_80GGANew(i) = UCase(rangecells.item(i).value)
        ...
        'Commented by Shrutika
            'MsgBox_80GGANew = MsgBox_80GGANew + "* Please enter PAN of donee at Sr. No " & i & "in Schedule 80GGA" & Chr(13)
            'Added by Shrutika
            MsgBox_80GGANew = MsgBox_80GGANew + "* ""Please enter PAN of donee."""
            
            ' MsgBox_80GGANew = MsgBox_80GGANew + "* Please enter PAN of donee " & Chr(13)
        ...
        If Not CheckDoneePAN(UCase(PAN_of_donee_80GGANew(i))) Then
             'MsgBox_80GGANew = MsgBox_80GGANew + "* PAN of donee at Sr. No  " & i & " is Invalid. PAN format should be First 5 Alphabets, next 4 digits, then 1 Alphabet." & "in Schedule 80GGA" & Chr(13)
             'MsgBox_80GGANew = MsgBox_80GGANew + "* ""Invalid PAN at Sr. No  " & i & ". PAN format should be First 5 Alphabets, next 4 digits, then 1 Alphabet in Schedule 80GGA.""" & Chr(13)
             
             'Newly modified by Shrutika on 31/07/2024
...
ValidateDonationAmt_80GGANew = True
    ...
    For i = 1 To end80GGAN
        ...
        'Ankita(23-Jan)
           ...
           ' MsgBox_80GGANew = MsgBox_80GGANew + "* Donation in cash or Donation in other mode in Schedule 80GGA " & Chr(13)
            'MsgBox_80GGANew = MsgBox_80GGANew + "* Enter the amount of donation either in field Donation in cash or Donation in other mode in Schedule 80GGA " & Chr(13)
             MsgBox_80GGANew = MsgBox_80GGANew + "* ""Enter the amount of donation either in field ""Donation in cash"" or ""Donation in other mode"" in Schedule 80GGA""" & Chr(13)
