...
Function ValidateEA10_13A_1() As Boolean
    ...
    endEA10_13A_4 = 0
    endEA10_13A_5 = 0
    endEA10_13A_6 = 0   '14/05/2025
    
            EA_Sch10of13A_PlaceofWrk = Sheet15.Range("Sch10of13A_PlaceofWrk")
            EA_Sch10of13A_ActlHRArecivedA = Sheet15.Range("Sch10of13A_ActlHRArecivedA")
            EA_Sch10of13A_ActlRentpaid = Sheet15.Range("Sch10of13A_ActlRentpaid")
            EA_Sch10of13A_DetlsofSalpersec17of1 = Sheet15.Range("Sch10of13A_DetlsofSalpersec17of1")
            EA_Sch10of13A_BasicSalary = Sheet15.Range("Sch10of13A_BasicSalary")
            EA_Sch10of13A_DearAllowance = Sheet15.Range("Sch10of13A_DearAllowance")
            EA_Sch10of13A_Actlrentpaid10persalaryB = Sheet15.Range("Sch10of13A_Actlrentpaid10persalaryB")
            EA_Sch10of13A_50Por40Pofsalary = Sheet15.Range("Sch10of13A_50Por40Pofsalary")
            EA_Sch10of13A_ElgiblExmptAllwnce10of13A = Sheet15.Range("Sch10of13A_ElgiblExmptAllwnce10of13A")
     ...
     'Malli------14/05/2025
     'EA_Sch10of13A_50Por40Pofsalary
...
endEA10_13A = WorksheetFunction.Max(0, endEA10_13A_1, endEA10_13A_2, endEA10_13A_3, endEA10_13A_4, endEA10_13A_5, endEA10_13A_6)
 ...
 If endEA10_13A > 0 Then
  ' MsgBox_EA10_13A = MsgBox_EA10_13A + "     at Sr. No " & i & "" & Chr(13)
        ...
        'Updated by Bindu from Work to residence
        ...
        Else
            If Len(EA_Sch10of13A_ActlHRArecivedA) > 14 Then
                ...
                Exit Function
            End If
            'If Not IsNumeric(EA_Sch10of13A_ActlHRArecivedA) Then '14/05/2025
        ...
        Else
            If Len(EA_Sch10of13A_ActlRentpaid) > 14 Then
                ...
                Exit Function
            End If
            If Not IsNumeric(EA_Sch10of13A_ActlRentpaid) Or EA_Sch10of13A_ActlRentpaid < 0 Then '14/05/2025
        ...
        Else
            If Len(EA_Sch10of13A_DetlsofSalpersec17of1) > 14 Then
                ...
                Exit Function
            End If
            If Not IsNumeric(EA_Sch10of13A_DetlsofSalpersec17of1) Or EA_Sch10of13A_DetlsofSalpersec17of1 < 0 Then '14/05/2025
        ...
        EA_Sch10of13A_2Plus4 = EA_Sch10of13A_ActlHRArecivedA + EA_Sch10of13A_DetlsofSalpersec17of1
                If EA_Sch10of13A_2Plus4 > Sheet1.Range("IncD.IncomeFromSal_ii").value Then
        ...
        Else
            If Len(EA_Sch10of13A_BasicSalary) > 14 Then
                ...
                Exit Function
            End If
            If Not IsNumeric(EA_Sch10of13A_BasicSalary) Or EA_Sch10of13A_BasicSalary < 0 Then '14/05/2025
        ...
        If EA_Sch10of13A_DearAllowance <> "" Then
            ...
            Exit Function
            End If
            If Not IsNumeric(EA_Sch10of13A_DearAllowance) Or EA_Sch10of13A_DearAllowance < 0 Then '14/05/2025
        ...
        If EA_Sch10of13A_Actlrentpaid10persalaryB <> "" Then
            ...
            Exit Function
            End If
            If Not IsNumeric(EA_Sch10of13A_Actlrentpaid10persalaryB) Or EA_Sch10of13A_Actlrentpaid10persalaryB < 0 Then '14/05/2025
        ...
        '50% /40% of salary©
        'If EA_Sch10of13A_50Por40Pofsalary <> "" Then    '14/05/2025
           ...
           Dim Per50Salaryaspersection17 As Variant
            ...
            If Per50Salaryaspersection17 <> "" Then
                If EA_Sch10of13A_50Por40Pofsalary > Per50Salaryaspersection17 Then
                  'MsgBox_EA10_13A = MsgBox_EA10_13A + "* ""The value in this field shall not be more than 50% of field 4 ""Details of Salary as per Section 17(1)""""" & Chr(13)
            ...
            Exit Function
            End If
            If Not IsNumeric(EA_Sch10of13A_50Por40Pofsalary) Or EA_Sch10of13A_50Por40Pofsalary < 0 Then '14/05/2025
        ...
        If EA_Sch10of13A_ElgiblExmptAllwnce10of13A <> "" Then
            ...
            Exit Function
            End If
            If Not IsNumeric(EA_Sch10of13A_ElgiblExmptAllwnce10of13A) Or EA_Sch10of13A_ElgiblExmptAllwnce10of13A < 0 Then '14/05/2025
...
Sub setTableInfoSch10of13A_PlaceofWrk()
    ...
    Dim ccount  As Long
    ccount = 0
    Set rangecells = Sheet15.Range("Sch10of13A_PlaceofWrk").Cells
    mIntCells = Sheet15.Range("Sch10of13A_PlaceofWrk").count
...
Sub setTableInfoSch10of13A_ActlHRArecivedA()
    ...
    Set rangecells = Sheet15.Range("Sch10of13A_ActlHRArecivedA").Cells
    mIntCells = Sheet15.Range("Sch10of13A_ActlHRArecivedA").count
    For mIntCtr = 1 To mIntCells
