...
'end_80EEB = WorksheetFunction.Max(0, end_80EEBLoanfrm, end_80EEBbankName, , end_80EEBAccntNum, end_80EEBLoanDate, end_80EEBLoanAmt, end_80EEBLoanOutstanding, end_80EEBVehicleValue, end_80EEBVehicleReg, end_80EEBIntrst)
...
'    If (Sheet20.Range("TotAmt.80EEBB").value) > 2000000 Then
...
If Len(Sheet20.Range("TotAmt.80EEB").value) > 14 Then
...
Function ValidateLoanfrm_80EEB() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet20.Range("LoanfrmBankOrInstitute.80EEB").Cells
    ...
    For i = 1 To end_80EEB
        ...
        If isdropdownblank(Loanfrm_80EEB(i)) Then
             MsgBox_80EEB = MsgBox_80EEB + "* Please select dropdown from ""Loan taken from"" in schedule 80EEB at Sr. No " & i & "" & Chr(13)

            ValidateLoanfrm_80EEB = False
            Exit Function
        End If
'         If Loanfrm_80EEB(i) = "(Select)" Then
'          MsgBox_80EEB = MsgBox_80EEB + "* Please select dropdown from ""Loan taken from"" in 80EEB schedule at Sr. No " & i & "" & Chr(13)
'            ValidateLoanfrm_80EEB = False
'            Exit Function
'        End If
...
'    Set rangecells = Range("LoanfrmBankOrInstitute.80EEB").Cells
'    Set rangecells1 = Range("IFSC.80EEB").Cells
...
'          MsgBox_80EEB = MsgBox_80EEB + "* IFSC of the Bank at Sr. No " & i & " in Sheet 80EEB should be 11 characters." & Chr(13)
'            ValidateIFSC_80EEB = False
'            Exit Function
'        End If
'
...
'          MsgBox_80EEB = MsgBox_80EEB + "* PAN of the institution from which loan is taken at Sr. No " & i & " in Sheet 80EEB should be 10 characters." & Chr(13)
'            ValidatePAN_80EEB = False
'            Exit Function
'        End If
'
...
Function ValidateBankName_80EEB() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet20.Range("bankName.80EEB").Cells
    ReDim BankName_80EEB(end_80EEB)
    For i = 1 To end_80EEB
        BankName_80EEB(i) = rangecells.item(i).value
        If Not chkCompulsory(BankName_80EEB(i)) Then
'             MsgBox_80EEB = MsgBox_80EEB + "* ""Please provide Name of the Bank/ Institution/Person from which the loan is taken in schedule 80EEB at Sr. No " & i & """" & Chr(13)
'SIT-91941 by sai on 25/04/2025
        ...
        End If
         If Len(BankName_80EEB(i)) > 125 Then
          MsgBox_80EEB = MsgBox_80EEB + "* Name of the Bank/ Institution from which the loan is taken in Sheet 80EEB at Sr. No " & i & "should be less than or equal to 125 characters." & Chr(13)
            ValidateBankName_80EEB = False
            Exit Function
        End If
...
'    Dim rangecells1 As Range
'    Dim i As Long
'    Set rangecells = Sheet20.Range("IFSC.80EEBB").Cells
'    Set rangecells1 = Sheet20.Range("LoanfrmBankOrInstitute.80EEBB").Cells
'    ReDim IFSC_80EEB(end_80EEB)
'    ReDim Loanfrom_80EEB(end_80EEB)
'    For i = 1 To end_80EEB
'        IFSC_80EEB(i) = rangecells.item(i).value
'       ' Loanfrom_80EEB(i) = rangecells.item(i).value
'     '   If Loanfrom_80EEB(i) = "Bank" Then
'        If Not chkCompulsory(IFSC_80EEB(i)) Then
'             MsgBox_80EEB = MsgBox_80EEB + "* Please select dropdown from ""Loan taken from"" at Sr. No " & i & " in 80EEB schedule." & Chr(13)
'            ValidateIFSC_80EEB = False
'            Exit Function
'        End If
'      '  End If
'
'         If Len(IFSC_80EEB(i)) > 11 Then
'          MsgBox_80EEB = MsgBox_80EEB + "* IFSC at Sr. No " & i & " in Sheet 80EEB should be 11 characters." & Chr(13)
'            ValidateIFSC_80EEB = False
'            Exit Function
'        End If
'
'Next
''
''If (Sheet20.Range("LoanfrmBankOrInstitute.80EEB").value = "Bank") Then
''        If Sheet20.Range("IFSC.80EEB").value = "" Then
...
''            MsgBox_80EEB = MsgBox_80EEB & "*""IFSC""" & Chr(13)
''            ValidateIFSC_80EEB = False
''        End If
''        End If
'
...
Function ValidateAccntNum_80EEB() As Boolean
    ...
    Dim i As Long
    Set rangecells = Sheet20.Range("loanAccNum.80EEB").Cells
    Set rangecells1 = Sheet20.Range("LoanfrmBankOrInstitute.80EEB").Cells
    ReDim AccntNum_80EEB(end_80EEB)
    ReDim BankorInst_80EEB(end_80EEB)
    
    For i = 1 To end_80EEB
        AccntNum_80EEB(i) = rangecells.item(i).value
        BankorInst_80EEB(i) = rangecells1.item(i).value
        ...
        End If
         If Len(AccntNum_80EEB(i)) > 20 Then
          MsgBox_80EEB = MsgBox_80EEB + "* Loan Account number  at Sr. No " & i & " in Sheet 80EEB less than 20 characters." & Chr(13)
            ValidateAccntNum_80EEB = False
            Exit Function
        End If
        
        If BankorInst_80EEB(i) = "Bank" Then
    ...
    If BankorInst_80EEB(i) = "Institution" Then
        If Not checkfieldspecialcharacter1(AccntNum_80EEB(i)) Then
...
Function ValidateVehicleReg_80EEB() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet20.Range("VehicleRegNum.80EEB").Cells
    ...
    For i = 1 To end_80EEB
        ...
        If Not checkfieldspecialcharacter80DD_80U(VehicleReg_80EEB(i)) Then
...
Function ValidateLoanDate_80EEB() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet20.Range("loanDate.80EEB").Cells
    ...
    For i = 1 To end_80EEB
        ...
        End If
         If Len(LoanDate_80EEB(i)) > 10 Then
          MsgBox_80EEB = MsgBox_80EEB + "* Date of taking loan  at Sr. No " & i & " in Sheet 80EEB less than 10 characters." & Chr(13)
            ValidateLoanDate_80EEB = False
            Exit Function
        End If
        'CheckDateddmmyyyy
         If Not CheckDateddmmyyyy(LoanDate_80EEB(i)) Then
         MsgBox_80EEB = MsgBox_80EEB + " ""Please enter date in valid format"" at Sr. No " & i & "." & Chr(13)
        ValidateLoanDate_80EEB = False
        ...
        MsgBox_80EEB = MsgBox_80EEB + " ""Date of sanction of Loan shall be between 01/04/2019 to 31/03/2023"" at Sr. No " & i & "." & Chr(13)
        ValidateLoanDate_80EEB = False
...
Function ValidateLoanAmt_80EEB() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet20.Range("loanAmt.80EEB").Cells
...
'    Dim rangecells As Range
'    Dim i As Long
'    Set rangecells = Sheet20.Range("Vehicle_value.80EEB").Cells
...
Function ValidateLoanOutstanding_80EEB() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet20.Range("loanOutstanding.80EEB").Cells
...
Function ValidateIntrst_80EEB() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    Set rangecells = Sheet20.Range("Intrst.80EEB").Cells
...
'--------------------------------------------------------------------
    ...
    If countnum < 1 Then
        errmsgVerification = errmsgVerification & "* Loan Account number at Sr.No " & cc & "  in schedule 80EEB is invalid. Account Number should have a minimum of 1 numeric digit (1-9)" & Chr(13)
        ValidateBankAccountNumber_80EEB = False
        Exit Function
    End If
End Function
