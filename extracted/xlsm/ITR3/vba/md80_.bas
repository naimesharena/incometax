...
'added by Chetan C M for AY 2026-27 as per DE V 0.2
...
'        fmsgboxsmall msgValidateVIAerror + msgValidate_80CCC
'        fmsgboxsmall msgValidateVIAerror + msgValidate_80CCD_1
'        fmsgboxsmall msgValidateVIAerror + msgValidate_80CCD_1b
        CloseMsg
    End If
...
vRows = EfilingCommon.insertRowUnderSectionWithFormula
End Sub
'Added by Aavula Naresh 0.6V changes
Sub addrowsIC80_Sikkim()
Dim vRows As Variant
EfilingCommon.DefinedgridNameRange = ("IC80.Sikkim")
ActiveCellRange = EfilingCommon.searchLastRow("IC80.Sikkim")
vRows = EfilingCommon.insertRowUnderSectionWithFormula
End Sub
...
'    If Not ValidateDeductInUttaranchal_IC80() Then ValidatesheetIC80 = False
    ...
    'Added by Aavula Naresh 0.6V changes
    If Not ValidateSikkim_IC80() Then ValidatesheetIC80 = False
...
'****************comment by Chetan C M for AY 2026-27 as per DE V 0.2********************
'--start--
If Sheet19.Range("scvia.Section80CCD_SE").value > 0 Or Sheet19.Range("scvia.Section80CCD1B_SE").value > 0 Then
...
'commented by chetan C M for AY2026-27--start
...
'      msgbox_VIA ("*""Please enter valid 125 digit pran of the taxpayer.""") & Chr(13)
'    ValidatesheetVIA = False
'    'Exit Function
'    End If
...
'End If
'        If Sheet19.Range("Sheet19.Specified_Disease").MergeArea.Locked = False Then
'
'        'If Sheet19.Range("SELECT80DDB").value <> "(Select)" Or Sheet19.Range("scvia.Section80DDB").value > 0 Then
'        If Sheet19.Range("scvia.Section80DDB").value > 0 Then
'                If Sheet19.Range("Sheet19.Specified_Disease") = "(Select)" Or Sheet19.Range("Sheet19.Specified_Disease") = "" Then
...
'    End If
 ...
 If Sheet19.Range("Sheet19.Specified_Disease").MergeArea.Locked = False Then
        ...
        'If Sheet19.Range("SELECT80DDB").value <> "(Select)" Or Sheet19.Range("scvia.Section80DDB").value > 0 Then
        If Sheet19.Range("scvia.Section80DDB").value > 0 Then
                If Sheet19.Range("SELECT80DDB") = "(Select)" Or Sheet19.Range("SELECT80DDB") = "" Then
                      'msgbox_VIA ("* ""Name of Specified disease is mandatory""") & Chr(13)
                      msgbox_VIA ("* ""Please select an option from the drop down provided at Sec.80DDB under Chapter VIA""") & Chr(13)
                      ValidatesheetVIA = False
                      Exit Function
               End If
        End If
...
If Sheet19.Range("Sheet19.Specified_Disease").MergeArea.Locked = False Then
If Sheet19.Range("scvia.Section80DDB").value > 0 Or Sheet19.Range("scvia.Section80DDB").value = "1-Self or dependent" Or Sheet19.Range("scvia.Section80DDB").value = "2-Self or Dependent(Senior Citizen)" Then
                If Sheet19.Range("Sheet19.Specified_Disease") = "(Select)" Or Sheet19.Range("Sheet19.Specified_Disease") = "" Then
                      msgbox_VIA ("* ""Name of Specified disease is mandatory""") & Chr(13)
...
'If Sheet19.Range("Sheet19.Specified_Disease").MergeArea.Locked = False Then
'
'If Sheet19.Range("Sheet19.Specified_Disease").value <> "(Select)" Then
'
''If IsEmpty(Sheet19.Range("SELECT80DDB")) And IsEmpty(Sheet19.Range("scvia.Section80DDB")) And IsEmpty(Sheet19.Range("Sheet19.Specified_Disease")) Then
'    If Sheet19.Range("SELECT80DDB").value = "(Select)" Or Sheet19.Range("SELECT80DDB").value = "" Then
...
''End If
'
''If Not IsEmpty(Sheet19.Range("SELECT80DDB")) And Not IsEmpty(Sheet19.Range("scvia.Section80DDB")) And Not IsEmpty(Sheet19.Range("Sheet19.Specified_Disease")) Then
'    If Sheet19.Range("SELECT80DDB").value = 0 Or Sheet19.Range("scvia.Section80DDB").value = "" Then
'    msgbox_VIA ("* ""Please provide mandatory details under 80DDB deduction.""") & Chr(13)
'    ValidatesheetVIA = False
'    Exit Function
'    End If
...
'For AY 2025-26_Sadineni_24_07_2025
'*****************************************************************************************
If Sheet19.Range("Sheet19.Specified_Disease").MergeArea.Locked = False Or Sheet19.Range("SELECT80DDB").MergeArea.Locked Then
     If (Sheet19.Range("Sheet19.Specified_Disease").value <> "(Select)" And Sheet19.Range("Sheet19.Specified_Disease").value <> "") Or (Sheet19.Range("SELECT80DDB").value <> "(Select)" And Sheet19.Range("SELECT80DDB").value <> "") Then
         If (Sheet19.Range("Sheet19.Specified_Disease").value = "(Select)" Or Sheet19.Range("Sheet19.Specified_Disease").value = "") Or (Sheet19.Range("SELECT80DDB").value = "(Select)" Or Sheet19.Range("SELECT80DDB").value = "") Then
                    msgbox_VIA ("* ""Please provide mandatory details under 80DDB deduction.""") & Chr(13)
                    ValidatesheetVIA = False
                    Exit Function
         End If
...
'******************************************************************************************
        ...
        If Sheet19.Range("scvia.Section80GG").value > 0 Then
                If Sheet19.Range("Sheet19.AckNum") = "(Select)" Or Sheet19.Range("Sheet19.AckNum") = "" Then
...
'''''''''''''''''''''''''''''
                ...
                If Sheet19.Range("Sheet19.AckNum.10CCD") = "(Select)" Or Sheet19.Range("Sheet19.AckNum.10CCD") = "" Then
...
''''''''''''''''''''''''''''''
' If Len(Sheet19.Range("Sheet19.AckNum.10CCD").value) > 0 Then --------- Added on 08/07/2025
  If Len(Sheet19.Range("Sheet19.AckNum.10CCD").value) > 0 And Sheet19.Range("Sheet19.AckNum.10CCD").Locked = False Then
    If SheetALL.Range("bacValue").value = 2 Then
      If Sheet1.Range("sheet1.Status") <> "H-HUF" Then
...
'''''''''''''''''''''''''''''''
                ...
                If Sheet19.Range("Sheet19.AckNum.10CCE") = "(Select)" Or Sheet19.Range("Sheet19.AckNum.10CCE") = "" Then
...
'''''''''''''''''''''''''''''''
'If Len(Sheet19.Range("Sheet19.AckNum.10CCE").value) > 0 Then  --------Added on 08/07/2025
 If Len(Sheet19.Range("Sheet19.AckNum.10CCE").value) > 0 And Sheet19.Range("Sheet19.AckNum.10CCE").Locked = False Then
   If SheetALL.Range("bacValue").value = 2 Then
      If Sheet1.Range("sheet1.Status") <> "H-HUF" Then
...
'            msgbox_VIA ("* Please select an option at dropdown of Sec.80DDB under Chapter VIA")
            msgbox_VIA ("* ""Please select an option from the drop down provided at Sec.80DDB under Chapter VIA""")
...
'    If Sheet19.Range("Section80CCH").value = "80CCH" Then
'        If (Not check80CCH_Eligible()) Then
'            msgbox_VIA ("* Deductions as referred  under section 80CCH will be applicable only for Central Govt Employees; for AY 2023-24, age of user selecting this dropdown should be from 17 to 22 years")
'            ValidatesheetVIA = False
'            Exit Function
'        End If
'
'        If Sheet19.Range("Anyother80CCH").value = "" Or Sheet19.Range("Anyother80CCH").value = 0 Then
...
'added by Chetan C M for AY 2026-27 as per DE V0.1
'start--
...
'ValidateSikkim_IC80
Function ValidateSikkim_IC80() As Boolean
    ValidateSikkim_IC80 = True
    Dim rangecells As Range
    Dim count, i As Variant
    Set rangecells = Sheet37.Range("IC80.Sikkim").Cells
    count = 0
    For i = 1 To (rangecells.Cells.count)
    If rangecells.item(i).value <> "" Then
    count = count + 1
    ...
    ReDim IC80_Sikkim(count)
    For i = 1 To count
    IC80_Sikkim(i) = rangecells.item(i).value
    Next
End Function
...
Function ValidateTotDeductInNorthEast_IC80() As Boolean
    ...
    If Len(IC80_TotDeductInNorthEast) > 14 Then
       'Malli_03/10/2025  SIT-95654  issue sr.no 3
        'msgbox_IC80 ("* TotDeductInNorthEast in Sch 80-IC should not be greater than 14 digits ")
        'msgbox_IC80 ("* TotDeductInNorthEast in Sch 80-IE should not be greater than 14 digits ")
        msgbox_IC80 ("* Total of deduction for undertakings located in North-east in Sch 80-IE should not be greater than 14 digits ")
        '----------------------------
...
Function ValidateTotSchedule80_IC_IC80() As Boolean
    ...
    If Len(IC80_TotSchedule80_IC) > 14 Then
        ...
        'msgbox_IC80 ("* TotSchedule80_IC in Sch 80-IC should not be greater than 14 digits ")
         'msgbox_IC80 ("* TotSchedule80_IC in Sch 80-IE should not be greater than 14 digits ")
         msgbox_IC80 ("* Total deduction under section 80-IE (ai) in Sch 80-IE should not be greater than 14 digits ")
        '---------------------------------------
...
'newly added by Chetan C M for AY 2026-27 DE sheet V0.1
...
'End Sub
    ...
    Set sourceSheet = ThisWorkbook.Sheets("VI-A")
    sourceSheet.Activate
    EfilingCommon.DefinedgridNameRange = "S.No_CCD_pran||Pran_Number"
    ActiveCellRange = EfilingCommon.searchLastRow("S.No_CCD_pran")
    vRows = EfilingCommon.insertRowUnderSectionWithFormula_80CCC_VIA
        ...
        End If
         ...
         If Len(Type_80CCC(i)) > 125 Then
          msgValidateVIAerror = msgValidateVIAerror + "* Type of Identifier in schedule 80CCC at Sr. No " & i & """ should be less than or equal to 125 characters." & Chr(13)
            ...
            Exit Function
        End If
        If Not checkallfieldspecialcharacter(Type_80CCC(i)) Then
...
Function ValidateName_80CCC() As Boolean
    ...
    For i = 1 To end_80CCC
        ...
        'changed by Chetan C M for AY 2026-27 as per DE V 0.2--start--
...
'             msgValidateVIAerror = msgValidateVIAerror + "* Amount in schedule 80CCC at Sl.no. " & i & " should not Contain special characters." & Chr(13)
             msgValidateVIAerror = msgValidateVIAerror + "* Amount should be Numeric, Non negative, No decimal and up to 14 digits at Sl.no. " & i & "" & Chr(13)
            ValidateAmount_80CCC = False
            Exit Function
        End If
...
'****************added by Chetan C M for AY 2026-27(V 0.2)********************
'--start--
'Chetan C M on 28/04/2026
        ...
        pran_80CCC(i) = rangecells.item(i, 1).value
         If Len(pran_80CCC(i)) > 12 Then
          msgValidateVIAerror = msgValidateVIAerror + "* Please enter a valid 12 digit PRAN at Sr. No " & i & "" & Chr(13)
            ...
            Exit Function
        End If
'If Not checkallfieldspecialcharacter(pran_80CCC(i)) Then
If Not checkallfieldspecialcharacter_PRAN(pran_80CCC(i)) Then 'SIT-119718 by sadineni on 18/05/2026
...
'SIT-119718 by sadineni on 18/05/2026
Function checkallfieldspecialcharacter_PRAN(field As Variant) As Boolean
    Dim i, j As Long
    checkallfieldspecialcharacter_PRAN = True
    Dim arr As Variant
    arr = Array("@", "*", "!", "-", "&", "#", "~", ";", "?", "/", "\", ":", "(", ")", "+", "=", "{", "}", "[", "]", "^", "%", "$", """", "'", ">", "<", "&", """", "'", ">", "<", ".")
    'arr = Array("&", """", "'", ">", "<")
    For i = 1 To Len(field)
        ...
        If Mid(field, i, 1) = arr(j) Then
            checkallfieldspecialcharacter_PRAN = False
            Exit Function
        End If
        Next
    Next
