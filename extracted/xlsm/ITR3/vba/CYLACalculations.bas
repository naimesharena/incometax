...
Public Bussiness_Loss_Flag As Boolean
...
Function Validatesheet16() As Boolean
 ...
 'Newly added by sai on 03/04/2024==============================================
...
'Sai Code missed
If Not ValidateBFLA_LTCG_Limit() Then Validatesheet16 = False
If Not ValidateBFLA_BFSL_Limit() Then Validatesheet16 = False
If Not ValidateBFLA_BFSD_Limit() Then Validatesheet16 = False
If Not ValidateBFLA_BFSL_LessthanCFL_BFSL() Then Validatesheet16 = False
If Not ValidateBFLA_BFSD_LessthanCFL_BFSD() Then Validatesheet16 = False


'If Not ValidateBFLA_BFNB_LessthanCFL_BFNB() Then Validatesheet16 = False 'for testing commented by sai on 10/07/2025

Bussiness_Loss_Flag = True

'Commented by Riyaz on 04/06/2026
'If Not ValidateBFLA_BFNBaBFSLaBFSD_Limit_CFL() Then Validatesheet16 = False
If Not ValidateBFLA_BFNB_Limit() Then Validatesheet16 = False
 '=============================================================================
    ...
    If Not ValidateUD() Then Validatesheet16 = False   'newly added on 13-06-2024

    
            'Brought forward lossset off
            ...
            If Not ValidateBroughtforwardlosssetoff_BFLA_vib() Then Validatesheet16 = False 'Added by Bindu
            ...
            If Not ValidateBroughtforwardlosssetoff_BFLA_x() Then Validatesheet16 = False
            If Not ValidateBroughtforwardlosssetoff_BFLA_xb() Then Validatesheet16 = False 'Added by Bindu
            
            
            If Not ValidateBroughtforwardlosssetoff_BFLA_xi() Then Validatesheet16 = False
            If Not ValidateBroughtforwardlosssetoff_BFLA_xii() Then Validatesheet16 = False
            'Malli-----29/05/2024
              If Not ValidateBroughtForwardLossSetoff_44BBA() Then Validatesheet16 = False
            '---------
            ...
            'Brought forwarddepreciation set off
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_ii() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_iv() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_v() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_vi() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_vib() Then Validatesheet16 = False 'Added by Bindu
            
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_vii() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_viii() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_ix() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_x() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_xb() Then Validatesheet16 = False 'Added by Bindu
            
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_xi() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_xii() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_xiii() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_xiv() Then Validatesheet16 = False
            If Not ValidateBroughtforwarddepreciationsetoff_BFLA_xv() Then Validatesheet16 = False
            
            'Brought forwardallowance under section35(4) set off
            If Not ValidateBroughtforalloundsec35_4_ii() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_iv() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_v() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_vi() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_vib() Then Validatesheet16 = False 'Newly added by Bindu
            
            If Not ValidateBroughtforalloundsec35_4_vii() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_viii() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_ix() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_x() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_xb() Then Validatesheet16 = False 'Newly added by Bindu
            
            
            If Not ValidateBroughtforalloundsec35_4_xi() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_xii() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_xiii() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_xiv() Then Validatesheet16 = False
            If Not ValidateBroughtforalloundsec35_4_xv() Then Validatesheet16 = False

            If Not Validatesumfwdloss_fwddepr_fwdallowundsec35_4_setoffs() Then Validatesheet16 = False
...
'LTCG-20%
Dim ltcgPrctg20SecProviso As Double 'OS-by sai on 10/04/2025
...
'Added by Riyaz on 09/04/2025
Dim stcgPercent15Sec111a_20 As Double
Dim stcgPercent15Sec115ad_1_b_ii_20 As Double
Dim stcgPTI20 As Double




'LTCG-12.5% by sai on 09/04/2025
'*****************************************************************************************************************
...
'---Newly added by Bindu on 4th June 26

Dim ltcgPTI125112B1g As Double
Dim ltcgPTI125112B2e As Double
Dim ltcgPTI125112B5c As Double
Dim ltcgPTI125112B9e As Double
Dim ltcgPTI125112B10 As Double
'--Ends


Dim ltcgPrctg125SecProviso As Double
...
'--Newly added by Bindu on 4th June 26
ltcgPTI125112B1g = Application.WorksheetFunction.Max(0, Sheet31.Range("temp125Sec_112_B1g").value)
ltcgPTI125112B2e = Application.WorksheetFunction.Max(0, Sheet31.Range("temp125Sec_112_B2e").value)
ltcgPTI125112B5c = Application.WorksheetFunction.Max(0, Sheet31.Range("temp125Sec_112_B5c").value)
ltcgPTI125112B9e = Application.WorksheetFunction.Max(0, Sheet31.Range("temp125Sec_112_B9e").value)
ltcgPTI125112B10 = Application.WorksheetFunction.Max(0, Sheet31.Range("temp125Sec_112_B10").value)
'--Ends
...
ltcgPrctg125SecProviso = Application.WorksheetFunction.Max(0, Sheet31.Range("temp125SecPro").value)

'Added by Riyaz on 25/02/2026
ltcgPrctg125Sec115AD3 = Application.WorksheetFunction.Max(0, Sheet31.Range("temp125Sec115AD3").value)
...
'LTCG-20%
ltcgPrctg20SecProviso = Application.WorksheetFunction.Max(0, Sheet31.Range("temp20SecPro").value) 'OS-by sai on 10/04/2025


ltcgPrctg10SecProviso = Application.WorksheetFunction.Max(0, Sheet31.Range("temp10SecPro").value)
...
'Added by Riyaz on 09/04/2025
stcgPercent15Sec111a_20 = Application.WorksheetFunction.Max(0, Sheet31.Range("temp20Sec111a").value)
stcgPercent15Sec115ad_1_b_ii_20 = Application.WorksheetFunction.Max(0, Sheet31.Range("temp20Sec115ad1bii").value)
...
'7a.Short-term capital gain taxable at 20%
'added by Riyaz on 09/04/2025
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
...
'end Change Chandru
        ...
        If (setOffRem >= 0) Then
           Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff1c").value = Sheet16.Range("stcg.IncOfCurYrUnderThatHead1c").value
                stcgPercent15Sec111a_20 = 0
                stcgPTI20 = 0
                stcgPercent15Sec115ad_1_b_ii_20 = 0
       Else
        Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff1c").value = prevSetOffRem
             If (prevSetOffRem >= 0 And stcgPercent15Sec115ad_1_b_ii_20 > prevSetOffRem) Then
                    stcgPercent15Sec115ad_1_b_ii_20 = stcgPercent15Sec115ad_1_b_ii_20 - prevSetOffRem
                    prevSetOffRem = 0
            Else
                    prevSetOffRem = prevSetOffRem - stcgPercent15Sec115ad_1_b_ii_20
                    stcgPercent15Sec115ad_1_b_ii_20 = 0
            End If
            ...
            If (prevSetOffRem >= 0 And stcgPercent15Sec111a_20 > prevSetOffRem) Then
                    stcgPercent15Sec111a_20 = stcgPercent15Sec111a_20 - prevSetOffRem
                    prevSetOffRem = 0
            Else
                  prevSetOffRem = prevSetOffRem - stcgPercent15Sec111a_20
                    stcgPercent15Sec111a_20 = 0
            End If
        setOffRem = 0
     End If
            ...
            If (ltcgSetOffRem >= setOffRem) Then
                ...
                If (setOffRem >= 0) Then
                    Sheet16.Range("ltcg.OthSrcLossNoRaceHorseSetoff2a").value = ltcgSetOffRem
                        ...
                        ltcgPTI20 = 0
                        ltcgPrctg20Sec112 = 0
                        ltcgPrctg20SecProviso = 0 'OS- by sai on 10/04/2025
...
'                        End If
                        ...
                        '--15. B10
                         If (tempAk >= 0 And ltcgPTI125112B10 > tempAk) Then
                                ltcgPTI125112B10 = ltcgPTI125112B10 - tempAk
                                tempAk = 0
                        Else
                              tempAk = tempAk - ltcgPTI125112B10
                                ltcgPTI125112B10 = 0
                        End If
                        
                        '-14. B9e
                         If (tempAk >= 0 And ltcgPTI125112B9e > tempAk) Then
                                ltcgPTI125112B9e = ltcgPTI125112B9e - tempAk
                                tempAk = 0
                        Else
                              tempAk = tempAk - ltcgPTI125112B9e
                                ltcgPTI125112B9e = 0
                        End If
                        
                        '--13. B5c
                         If (tempAk >= 0 And ltcgPTI125112B5c > tempAk) Then
                                ltcgPTI125112B5c = ltcgPTI125112B5c - tempAk
                                tempAk = 0
                        Else
                              tempAk = tempAk - ltcgPTI125112B5c
                                ltcgPTI125112B5c = 0
                        End If
                        
                        '--12. B2e
                         If (tempAk >= 0 And ltcgPTI125112B2e > tempAk) Then
                                ltcgPTI125112B2e = ltcgPTI125112B2e - tempAk
                                tempAk = 0
                        Else
                              tempAk = tempAk - ltcgPTI125112B2e
                                ltcgPTI125112B2e = 0
                        End If
                        '--11. B6ie - 112(1)(c )
...
'Newly added by Riyaz on 25/02/2026
                       ...
                       '-5. B1(g)
                        If (tempAk >= 0 And ltcgPTI125112B1g > tempAk) Then
                                ltcgPTI125112B1g = ltcgPTI125112B1g - tempAk
                                tempAk = 0
                        Else
                              tempAk = tempAk - ltcgPTI125112B1g
                                ltcgPTI125112B1g = 0
                        End If
...
'End change
        ...
        '---Newly added by Bindu on 4th June 26
        cgosIncome_cgInc_ltcg_PTI125_112_B1g = ltcgPTI125112B1g
        cgosIncome_cgInc_ltcg_PTI125_112_B2e = ltcgPTI125112B2e
        cgosIncome_cgInc_ltcg_PTI125_112_B5c = ltcgPTI125112B5c
        cgosIncome_cgInc_ltcg_PTI125_112_B9e = ltcgPTI125112B9e
        cgosIncome_cgInc_ltcg_PTI125_112_B10 = ltcgPTI125112B10
        '--Ends
        
        
        cgosIncome_cgInc_ltcg_prctg125_secProviso = ltcgPrctg125SecProviso
'Newly added by Riyaz on 25/02/2026
...
'End change*************************************************************************************************************************
        ...
        cgosIncome_cgInc_ltcg_prctg20_secProviso = ltcgPrctg20SecProviso 'OS-by sai on 10/04/2025
        
        
        cgosIncome_cgInc_ltcg_prctg10_secProviso = ltcgPrctg10SecProviso
...
'Added by Riyaz on 09/04/2024
        cgosIncome_cgInc_stcg_prctg20_sec111a = stcgPercent15Sec111a_20
        cgosIncome_cgInc_stcg_prctg20_sec115ad_1_b_ii = stcgPercent15Sec115ad_1_b_ii_20
...
Dim ltcgPrctg20SecProviso As Double 'HP-by sai on 10/04/2025
...
'--Newly added by Bindu 4th June 26
ltcgPTI125112B1g = cgosIncome_cgInc_ltcg_PTI125_112_B1g
ltcgPTI125112B2e = cgosIncome_cgInc_ltcg_PTI125_112_B2e
ltcgPTI125112B5c = cgosIncome_cgInc_ltcg_PTI125_112_B5c
ltcgPTI125112B9e = cgosIncome_cgInc_ltcg_PTI125_112_B9e
ltcgPTI125112B10 = cgosIncome_cgInc_ltcg_PTI125_112_B10
'---

ltcgPrctg125SecProviso = cgosIncome_cgInc_ltcg_prctg125_secProviso
...
ltcgPrctg20SecProviso = cgosIncome_cgInc_ltcg_prctg20_secProviso 'HP-by sai on 10/04/2025

ltcgPrctg10SecProviso = cgosIncome_cgInc_ltcg_prctg10_secProviso
...
'Added by Riyaz on 09/04/2025
 stcgPercent15Sec111a_20 = cgosIncome_cgInc_stcg_prctg20_sec111a
 stcgPercent15Sec115ad_1_b_ii_20 = cgosIncome_cgInc_stcg_prctg20_sec115ad_1_b_ii
...
'1. salary Income
'added by Chandru
' If Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "No" Or Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "Yes-but beyond due date" Then
...
'MsgBox setOffRem
    ...
    If Sheet16.Range("salary.HPlossCurYrSetoff1").value + Sheet16.Range("salary.OthSrcLossNoRaceHorseSetoff1").value > Sheet16.Range("SAL.TotIncUnderHeadSalaries1").value Then
    Sheet16.Range("salary.HPlossCurYrSetoff1", "salary.OthSrcLossNoRaceHorseSetoff1").value = 0
    MsgBox ("The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1")
    End If
...
' If Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "No" Or Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "Yes-but beyond due date" Then
 ...
 Sheet16.Unprotect Password:=getmsgstate
        ...
        Sheet16.Range("busprof.HPlossCurYrSetoff").Interior.Color = (&HD8D8D8)
        Sheet16.Range("busprof.HPlossCurYrSetoff").Locked = True
    ...
    Else
                ...
                If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
                Sheet16.Unprotect Password:=getmsgstate
                Sheet16.Range("busprof.HPlossCurYrSetoff").Locked = False
                Sheet16.Range("busprof.HPlossCurYrSetoff").Interior.Color = RGB(255, 255, 204)
                
                Else
                
                Sheet16.Range("busprof.HPlossCurYrSetoff").Locked = True
                Sheet16.Range("busprof.HPlossCurYrSetoff").Interior.ColorIndex = 2
...
busIncSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("busprof.IncOfCurYrUnderThatHead").value - Sheet16.Range("busprof.OthSrcLossNoRaceHorseSetoff").value)
    ...
    'Added by Chandru
    If Sheet16.Range("busprof.HPlossCurYrSetoff").value > Sheet16.Range("busprof.IncOfCurYrUnderThatHead").value Then
        Sheet16.Range("busprof.HPlossCurYrSetoff").value = 0
        MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
    
    If Sheet16.Range("busprof.HPlossCurYrSetoff").value + Sheet16.Range("busprof.OthSrcLossNoRaceHorseSetoff").value > Sheet16.Range("busprof.IncOfCurYrUnderThatHead").value Then
        Sheet16.Range("busprof.HPlossCurYrSetoff", "busprof.OthSrcLossNoRaceHorseSetoff").value = 0
        MsgBox ("The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1")
    End If
...
' If Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "No" Or Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "Yes-but beyond due date" Then
 ...
 Sheet16.Unprotect Password:=getmsgstate
        ...
        Sheet16.Range("busprofspec.HPlossCurYrSetoff0a").Interior.Color = (&HD8D8D8)
        Sheet16.Range("busprofspec.HPlossCurYrSetoff0a").Locked = True
    ...
    Else
                ...
                If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
                Sheet16.Unprotect Password:=getmsgstate
                Sheet16.Range("busprofspec.HPlossCurYrSetoff0a").Locked = False
                Sheet16.Range("busprofspec.HPlossCurYrSetoff0a").Interior.Color = RGB(255, 255, 204)
                
                Else
                
                Sheet16.Range("busprofspec.HPlossCurYrSetoff0a").Locked = True
                Sheet16.Range("busprofspec.HPlossCurYrSetoff0a").Interior.ColorIndex = 2
...
specIncSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("busprofspec.IncOfCurYrUnderThatHead0a").value - Sheet16.Range("busprofspec.OthSrcLossNoRaceHorseSetoff0a").value)
    ...
    'Added by Chandru
    If Sheet16.Range("busprofspec.HPlossCurYrSetoff0a").value > Sheet16.Range("busprofspec.IncOfCurYrUnderThatHead0a").value Then
    Sheet16.Range("busprofspec.HPlossCurYrSetoff0a").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
    If Sheet16.Range("busprofspec.HPlossCurYrSetoff0a").value + Sheet16.Range("busprofspec.OthSrcLossNoRaceHorseSetoff0a").value > Sheet16.Range("busprofspec.IncOfCurYrUnderThatHead0a").value Then
    Sheet16.Range("busprofspec.HPlossCurYrSetoff0a", "busprofspec.OthSrcLossNoRaceHorseSetoff0a").value = 0
...
' If Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "No" Or Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "Yes-but beyond due date" Then
 ...
 Sheet16.Unprotect Password:=getmsgstate
        ...
        Sheet16.Range("busprof0b.HPlossCurYrSetoff0b").Interior.Color = (&HD8D8D8)
        Sheet16.Range("busprof0b.HPlossCurYrSetoff0b").Locked = True
    ...
    Else
                ...
                If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
                Sheet16.Unprotect Password:=getmsgstate
                Sheet16.Range("busprof0b.HPlossCurYrSetoff0b").Locked = False
                Sheet16.Range("busprof0b.HPlossCurYrSetoff0b").Interior.Color = RGB(255, 255, 204)
                
                Else
                
                Sheet16.Range("busprof0b.HPlossCurYrSetoff0b").Locked = True
                Sheet16.Range("busprof0b.HPlossCurYrSetoff0b").Interior.ColorIndex = 2
...
specBusIncSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("busprofspecified.IncOfCurYrUnderThatHead0b").value - Sheet16.Range("busprofspecified.OthSrcLossNoRaceHorseSetoff0b").value)
    ...
    'Added by Chandru
    If Sheet16.Range("busprof0b.HPlossCurYrSetoff0b").value > Sheet16.Range("busprofspecified.IncOfCurYrUnderThatHead0b").value Then
    Sheet16.Range("busprof0b.HPlossCurYrSetoff0b").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
    If Sheet16.Range("busprof0b.HPlossCurYrSetoff0b").value + Sheet16.Range("busprofspecified.OthSrcLossNoRaceHorseSetoff0b").value > Sheet16.Range("busprofspecified.IncOfCurYrUnderThatHead0b").value Then
    Sheet16.Range("busprof0b.HPlossCurYrSetoff0b", "busprofspecified.OthSrcLossNoRaceHorseSetoff0b").value = 0
...
setOffRem = setOffRem - Sheet16.Range("othSecinclnlhrs.IncOfCurYrUnderThatHead3").value
  ...
  End If
    ...
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
    If Sheet16.Range("othSecinclnlhrs.HPlossCurYrSetoff3").value + Sheet16.Range("othSecinclnlhrs.BusLossSetoff3").value > Sheet16.Range("othSecinclnlhrs.IncOfCurYrUnderThatHead3").value Then
...
raceHrsSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("rh.IncOfCurYrUnderThatHead4").value - Sheet16.Range("rh.OthSrcLossNoRaceHorseSetoff4").value)
  ...
  End If
    ...
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
    If Sheet16.Range("rh.HPlossCurYrSetoff4").value + Sheet16.Range("rh.BusLossSetoff4").value + Sheet16.Range("rh.OthSrcLossNoRaceHorseSetoff4").value > Sheet16.Range("rh.IncOfCurYrUnderThatHead4").value Then
    Sheet16.Range("rh.HPlossCurYrSetoff4", "rh.OthSrcLossNoRaceHorseSetoff4").value = 0
...
' If Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "No" Or Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "Yes-but beyond due date" Then
 ...
 Sheet16.Unprotect Password:=getmsgstate
        ...
        Sheet16.Range("rh.HPlossCurYrSetoff4_DTAARates").Interior.Color = (&HD8D8D8)
        Sheet16.Range("rh.HPlossCurYrSetoff4_DTAARates").Locked = True
    ...
    Else
                ...
                If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
                Sheet16.Unprotect Password:=getmsgstate
                Sheet16.Range("rh.HPlossCurYrSetoff4_DTAARates").Locked = False
                Sheet16.Range("rh.HPlossCurYrSetoff4_DTAARates").Interior.Color = RGB(255, 255, 204)
                
                Else
                
                Sheet16.Range("rh.HPlossCurYrSetoff4_DTAARates").Locked = True
                Sheet16.Range("rh.HPlossCurYrSetoff4_DTAARates").Interior.ColorIndex = 2
...
OSDTAASetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("rh.IncOfCurYrUnderThatHead4_DTAARates").value - Sheet16.Range("rh.OthSrcLossNoRaceHorseSetoff4_DTAARates").value)
    ...
    'Added by Chandru
    If Sheet16.Range("rh.HPlossCurYrSetoff4_DTAARates").value > Sheet16.Range("rh.IncOfCurYrUnderThatHead4_DTAARates").value Then
    Sheet16.Range("rh.HPlossCurYrSetoff4_DTAARates").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
    If Sheet16.Range("rh.HPlossCurYrSetoff4_DTAARates").value + Sheet16.Range("rh.BusLossSetoff4_DTAARates").value + Sheet16.Range("rh.OthSrcLossNoRaceHorseSetoff4_DTAARates").value > Sheet16.Range("rh.IncOfCurYrUnderThatHead4_DTAARates").value Then
    Sheet16.Range("rh.HPlossCurYrSetoff4_DTAARates", "rh.OthSrcLossNoRaceHorseSetoff4_DTAARates").value = 0
...
stcg30PercntSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("stcg.IncOfCurYrUnderThatHead1a").value - Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff1a").value)
    ...
    'Added by Chandru
    If Sheet16.Range("stcg.HPlossCurYrSetoff1a").value > Sheet16.Range("stcg.IncOfCurYrUnderThatHead1a").value Then
       Sheet16.Range("stcg.HPlossCurYrSetoff1a").value = 0
       MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
    
    If Sheet16.Range("stcg.HPlossCurYrSetoff1a").value + Sheet16.Range("stcg.BusLossSetoff1a").value + Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff1a").value > Sheet16.Range("stcg.IncOfCurYrUnderThatHead1a").value Then
       Sheet16.Range("stcg.HPlossCurYrSetoff1a", "stcg.OthSrcLossNoRaceHorseSetoff1a").value = 0
       MsgBox ("The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1")
    End If
...
stcgAppRateSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("stcg.IncOfCurYrUnderThatHead1b").value - Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff1b").value)
    ...
    If Sheet16.Range("stcg.HPlossCurYrSetoff1b").value + Sheet16.Range("stcg.BusLossSetoff1b").value + Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff1b").value > Sheet16.Range("stcg.IncOfCurYrUnderThatHead1b").value Then
        Sheet16.Range("stcg.HPlossCurYrSetoff1b", "stcg.OthSrcLossNoRaceHorseSetoff1b").value = 0
        MsgBox ("The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1")
    End If
...
'If Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "No" Or Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "Yes-but beyond due date" Then
 ...
 '-------------------------------
'10a) Short term capital gain taxable @ 20%
'Added by Riyaz on 09/04/2025
...
stcg20PercntSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("stcg.IncOfCurYrUnderThatHead1c").value - Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff1c").value)
    ...
    If Sheet16.Range("stcg.HPlossCurYrSetoff1c").value + Sheet16.Range("stcg.BusLossSetoff1c").value + Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff1c").value > Sheet16.Range("stcg.IncOfCurYrUnderThatHead1c").value Then
    Sheet16.Range("stcg.HPlossCurYrSetoff1c", "stcg.OthSrcLossNoRaceHorseSetoff1c").value = 0
...
'10b) Long term capital gain taxable @ 20%
'Malli--------------------------
' If Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "No" Or Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "Yes-but beyond due date" Then
 If SheetALL.Range("bacValue").value = 1 Then
 Sheet16.Unprotect Password:=getmsgstate
...
Dim prevLtcgSetOffRem As Double
  ...
  ltcg20PercntSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("ltcg.IncOfCurYrUnderThatHead2a").value - Sheet16.Range("ltcg.OthSrcLossNoRaceHorseSetoff2a").value)
               ...
               tempAk = setOffRem
                ...
                If (setOffRem >= 0) Then
                       Sheet16.Range("ltcg.HPlossCurYrSetoff2a").value = ltcg20PercntSetOffRem
                        ...
                        ltcgPTI20 = 0
                        ltcgPrctg20Sec11EA = 0
                        ltcgPrctg20SecProviso = 0 'HP-by sai on 10/04/2025
    ...
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
    If Sheet16.Range("ltcg.HPlossCurYrSetoff2a").value + Sheet16.Range("ltcg.BusLossSetoff2a").value + Sheet16.Range("ltcg.OthSrcLossNoRaceHorseSetoff2a").value > Sheet16.Range("ltcg.IncOfCurYrUnderThatHead2a").value Then
    Sheet16.Range("ltcg.HPlossCurYrSetoff2a", "ltcg.OthSrcLossNoRaceHorseSetoff2a").value = 0
...
stcg15PercntSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("stcg.IncOfCurYrUnderThatHead1").value - Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff1").value)
    ...
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
    If Sheet16.Range("stcg.HPlossCurYrSetoff1").value + Sheet16.Range("stcg.BusLossSetoff1").value + Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff1").value > Sheet16.Range("stcg.IncOfCurYrUnderThatHead1").value Then
    Sheet16.Range("stcg.HPlossCurYrSetoff1", "stcg.OthSrcLossNoRaceHorseSetoff1").value = 0
...
'Added by Riyaz on 25/02/2026
    ...
    If Sheet16.Range("ltcg.HPlossCurYrSetoff2b").value + Sheet16.Range("ltcg.BusLossSetoff2b").value + Sheet16.Range("ltcg.OthSrcLossNoRaceHorseSetoff2b").value > Sheet16.Range("ltcg.IncOfCurYrUnderThatHead2b").value Then
        Sheet16.Range("ltcg.HPlossCurYrSetoff2b", "ltcg.OthSrcLossNoRaceHorseSetoff2b").value = 0
        MsgBox ("The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1")
    End If
...
Dim ltcg10PercntSetOffRem As Double
    ...
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
    If Sheet16.Range("ltcg.HPlossCurYrSetoff2").value + Sheet16.Range("ltcg.BusLossSetoff2").value + Sheet16.Range("ltcg.OthSrcLossNoRaceHorseSetoff2").value > Sheet16.Range("ltcg.IncOfCurYrUnderThatHead2").value Then
    Sheet16.Range("ltcg.HPlossCurYrSetoff2", "ltcg.OthSrcLossNoRaceHorseSetoff2").value = 0
...
'End change*********************************************************************************************************8
        ...
        cgosIncome_cgInc_ltcg_prctg20_secProviso = ltcgPrctg20SecProviso 'HP-by sai on 10/04/2025
...
stcgDTAARateSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("stcg.IncOfCurYrUnderThatHead_DTAARates").value - Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff_DTAARates").value)
 ...
 '--------------------------
    ...
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
    If Sheet16.Range("stcg.HPlossCurYrSetoff_DTAARates").value + Sheet16.Range("stcg.BusLossSetoff_DTAARates").value + Sheet16.Range("stcg.OthSrcLossNoRaceHorseSetoff_DTAARates").value > Sheet16.Range("stcg.IncOfCurYrUnderThatHead_DTAARates").value Then
    Sheet16.Range("stcg.HPlossCurYrSetoff_DTAARates", "stcg.OthSrcLossNoRaceHorseSetoff_DTAARates").value = 0
...
ltcgDTAARateSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("ltcg.IncOfCurYrUnderThatHead_DTAARates").value - Sheet16.Range("ltcg.OthSrcLossNoRaceHorseSetoff_DTAARates").value)
    ...
    If Sheet16.Range("ltcg.HPlossCurYrSetoff_DTAARates").value + Sheet16.Range("ltcg.BusLossSetoff_DTAARates").value + Sheet16.Range("ltcg.OthSrcLossNoRaceHorseSetoff_DTAARates").value > Sheet16.Range("ltcg.IncOfCurYrUnderThatHead_DTAARates").value Then
       Sheet16.Range("ltcg.HPlossCurYrSetoff_DTAARates", "ltcg.OthSrcLossNoRaceHorseSetoff_DTAARates").value = 0
       MsgBox ("The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1")
    End If
...
Dim ltcgPrctg20SecProviso As Double 'Bus-by sai on 10/04/2025
...
ltcgPrctg20SecProviso = cgosIncome_cgInc_ltcg_prctg20_secProviso 'Bus-by sai on 10/04/2025
...
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("hp.BusLossSetoff2").Locked = False
        Sheet16.Range("hp.BusLossSetoff2").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("hp.BusLossSetoff2").Locked = True
        Sheet16.Range("hp.BusLossSetoff2").Interior.ColorIndex = 2
'end Change Chandru
...
'Added by Chandru
    ...
    If Sheet16.Range("hp.BusLossSetoff2").value > Sheet16.Range("hp.IncOfCurYrUnderThatHead2").value Then
    Sheet16.Range("hp.BusLossSetoff2").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("othSecinclnlhrs.BusLossSetoff3").Locked = False
        Sheet16.Range("othSecinclnlhrs.BusLossSetoff3").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("othSecinclnlhrs.BusLossSetoff3").Locked = True
        Sheet16.Range("othSecinclnlhrs.BusLossSetoff3").Interior.ColorIndex = 2
'end Change Chandru
...
'Added by Chandru
    ...
    If Sheet16.Range("othSecinclnlhrs.BusLossSetoff3").value > Sheet16.Range("othSecinclnlhrs.IncOfCurYrUnderThatHead3").value Then
    Sheet16.Range("othSecinclnlhrs.BusLossSetoff3").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("rh.BusLossSetoff4").Locked = False
        Sheet16.Range("rh.BusLossSetoff4").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("rh.BusLossSetoff4").Locked = True
        Sheet16.Range("rh.BusLossSetoff4").Interior.ColorIndex = 2
'end Change Chandru
...
'Added by Chandru
    ...
    If Sheet16.Range("rh.BusLossSetoff4").value > Sheet16.Range("rh.IncOfCurYrUnderThatHead4").value Then
    Sheet16.Range("rh.BusLossSetoff4").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("rh.BusLossSetoff4_DTAARates").Locked = False
        Sheet16.Range("rh.BusLossSetoff4_DTAARates").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("rh.BusLossSetoff4_DTAARates").Locked = True
        Sheet16.Range("rh.BusLossSetoff4_DTAARates").Interior.ColorIndex = 2
'end Change Chandru
...
'Added by Chandru
    ...
    If Sheet16.Range("rh.BusLossSetoff4_DTAARates").value > Sheet16.Range("rh.IncOfCurYrUnderThatHead4_DTAARates").value Then
    Sheet16.Range("rh.BusLossSetoff4_DTAARates").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BusLossSetoff1a").Locked = False
        Sheet16.Range("stcg.BusLossSetoff1a").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BusLossSetoff1a").Locked = True
        Sheet16.Range("stcg.BusLossSetoff1a").Interior.ColorIndex = 2
'end Change Chandru
...
'Added by Chandru
    ...
    If Sheet16.Range("stcg.BusLossSetoff1a").value > Sheet16.Range("stcg.IncOfCurYrUnderThatHead1a").value Then
    Sheet16.Range("stcg.BusLossSetoff1a").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
'6a) Short-term capital gain taxable at applicable rates
Dim stcgAppRateSetOffRem As Double
  
'added by Chandru
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BusLossSetoff1b").Locked = False
        Sheet16.Range("stcg.BusLossSetoff1b").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BusLossSetoff1b").Locked = True
        Sheet16.Range("stcg.BusLossSetoff1b").Interior.ColorIndex = 2
'end Change Chandru
...
'Added by Chandru
    ...
    If Sheet16.Range("stcg.BusLossSetoff1b").value > Sheet16.Range("stcg.IncOfCurYrUnderThatHead1b").value Then
    Sheet16.Range("stcg.BusLossSetoff1b").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
'Added by Riyaz on 09/04/2025
'6b) Short-term capital gain taxable @ 20%
Dim stcg20PercntSetOffRem As Double

'added by Chandru
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BusLossSetoff1c").Locked = False
        Sheet16.Range("stcg.BusLossSetoff1c").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BusLossSetoff1c").Locked = True
        Sheet16.Range("stcg.BusLossSetoff1c").Interior.ColorIndex = 2
'end Change Chandru
...
'Added by Chandru
    ...
    If Sheet16.Range("stcg.BusLossSetoff1c").value > Sheet16.Range("stcg.IncOfCurYrUnderThatHead1c").value Then
    Sheet16.Range("stcg.BusLossSetoff1c").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BusLossSetoff2a").Locked = False
        Sheet16.Range("ltcg.BusLossSetoff2a").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BusLossSetoff2a").Locked = True
        Sheet16.Range("ltcg.BusLossSetoff2a").Interior.ColorIndex = 2
'end Change Chandru
      ...
      ltcg20PercntSetOffRem = Application.WorksheetFunction.Max(0, Sheet16.Range("ltcg.IncOfCurYrUnderThatHead2a").value - Sheet16.Range("ltcg.OthSrcLossNoRaceHorseSetoff2a").value - Sheet16.Range("ltcg.HPlossCurYrSetoff2a").value)
        ...
        Else
                ...
                If (ltcg20PercntSetOffRem >= 0) Then
                        ...
                        ltcgPTI20 = 0
                        ltcgPrctg20Sec11EA = 0
                        ltcgPrctg20SecProviso = 0 'Bus-by sai on 10/04/2025
...
'Added by Chandru
    ...
    If Sheet16.Range("ltcg.BusLossSetoff2a").value > Sheet16.Range("ltcg.IncOfCurYrUnderThatHead2a").value Then
    Sheet16.Range("ltcg.BusLossSetoff2a").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BusLossSetoff1").Locked = False
        Sheet16.Range("stcg.BusLossSetoff1").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BusLossSetoff1").Locked = True
        Sheet16.Range("stcg.BusLossSetoff1").Interior.ColorIndex = 2
'end Change Chandru
...
'Added by Chandru
    ...
    If Sheet16.Range("stcg.BusLossSetoff1").value > Sheet16.Range("stcg.IncOfCurYrUnderThatHead1").value Then
    Sheet16.Range("stcg.BusLossSetoff1").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BusLossSetoff2b").Locked = False
        Sheet16.Range("ltcg.BusLossSetoff2b").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BusLossSetoff2b").Locked = True
        Sheet16.Range("ltcg.BusLossSetoff2b").Interior.ColorIndex = 2
...
'Added by Riyaz on 25/02/2026
   ...
   End If
    ...
    If Sheet16.Range("ltcg.BusLossSetoff2b").value > Sheet16.Range("ltcg.IncOfCurYrUnderThatHead2b").value Then
    Sheet16.Range("ltcg.BusLossSetoff2b").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
'----
...
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BusLossSetoff2").Locked = False
        Sheet16.Range("ltcg.BusLossSetoff2").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BusLossSetoff2").Locked = True
        Sheet16.Range("ltcg.BusLossSetoff2").Interior.ColorIndex = 2
'end Change Chandru
...
'Added by Chandru
    ...
    If Sheet16.Range("ltcg.BusLossSetoff2").value > Sheet16.Range("ltcg.IncOfCurYrUnderThatHead2").value Then
    Sheet16.Range("ltcg.BusLossSetoff2").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BusLossSetoff_DTAARates").Locked = False
        Sheet16.Range("stcg.BusLossSetoff_DTAARates").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BusLossSetoff_DTAARates").Locked = True
        Sheet16.Range("stcg.BusLossSetoff_DTAARates").Interior.ColorIndex = 2
'end Change Chandru
...
'Added by Chandru
    ...
    If Sheet16.Range("stcg.BusLossSetoff_DTAARates").value > Sheet16.Range("stcg.IncOfCurYrUnderThatHead_DTAARates").value Then
    Sheet16.Range("stcg.BusLossSetoff_DTAARates").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
If (Mid(Range("sheet16.CYLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BusLossSetoff_DTAARates").Locked = False
        Sheet16.Range("ltcg.BusLossSetoff_DTAARates").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BusLossSetoff_DTAARates").Locked = True
        Sheet16.Range("ltcg.BusLossSetoff_DTAARates").Interior.ColorIndex = 2
'end Change Chandru
...
'Added by Chandru
    ...
    If Sheet16.Range("ltcg.BusLossSetoff_DTAARates").value > Sheet16.Range("ltcg.IncOfCurYrUnderThatHead_DTAARates").value Then
    Sheet16.Range("ltcg.BusLossSetoff_DTAARates").value = 0
    MsgBox ("Total Losses set off cannot exceed losses that can be set-off and incomes available for set off.")
    End If
...
'Added by Riyaz on 25/02/2026
        ...
        cgosIncome_cgInc_ltcg_prctg20_secProviso = ltcgPrctg20SecProviso 'Bus-by sai on 10/04/2025
...
'        cgosIncome_cgInc_ltcg_prctg10_secProviso = ltcgPrctg10SecProviso
    ...
    Sheet31.Range("CYLAtemp20SecPro").value = cgosIncome_cgInc_ltcg_prctg20_secProviso 'Bus-by sai on 10/04/2025
    ...
    Sheet31.Range("CYLAtemp10SecPro").value = cgosIncome_cgInc_ltcg_prctg10_secProviso
...
'*******************************************************************************
        ...
        '--Newly added by Bindu on 5th June 26
        Sheet31.Range("CYLAtemp125Sec_112_B1g").value = cgosIncome_cgInc_ltcg_PTI125_112_B1g
        Sheet31.Range("CYLAtemp125Sec_112_B2e").value = cgosIncome_cgInc_ltcg_PTI125_112_B2e
        Sheet31.Range("CYLAtemp125Sec_112_B5c").value = cgosIncome_cgInc_ltcg_PTI125_112_B5c
        Sheet31.Range("CYLAtemp125Sec_112_B9e").value = cgosIncome_cgInc_ltcg_PTI125_112_B9e
        Sheet31.Range("CYLAtemp125Sec_112_B10").value = cgosIncome_cgInc_ltcg_PTI125_112_B10
...
'Added by Riyaz on 25/02/2026
        Sheet31.Range("CYLAtemp125Sec115AD3").value = cgosIncome_cgInc_ltcg_prctg125_sec115AD_3
'******************************************************************************
'Added by Riyaz on 28/07/2025
    cgosIncome_cgInc_stcg_prctg20_sec111a = stcgPercent15Sec111a_20
    cgosIncome_cgInc_stcg_prctg20_sec115ad_1_b_ii = stcgPercent15Sec115ad_1_b_ii_20
    cgosIncome_cgInc_stcg_PTI20 = stcgPTI20
...
'Added by Riyaz on 10/04/2025 for STCG 20%
Dim stcgBreakUp8 As Double
Dim stcgBreakUp9 As Double
Dim stcgBreakUp10 As Double
...
'Added by Sai on 11/04/2025 for STCG 12.5%
Dim ltcgBreakUp13 As Double
Dim ltcgBreakUp14 As Double
Dim ltcgBreakUp15 As Double
'--Newly added by Bindu on 4th June 26
Dim ltcgBreakUp15_B1g As Double
Dim ltcgBreakUp15_B2e As Double
Dim ltcgBreakUp15_B5c As Double
Dim ltcgBreakUp15_B9e As Double
Dim ltcgBreakUp15_B10 As Double
'---End


Dim ltcgBreakUp16 As Double
Dim ltcgBreakUp17 As Double
Dim ltcgBreakUp18 As Double
Dim ltcgBreakUp19 As Double
Dim ltcgBreakUp20 As Double
Dim ltcgBreakUp21 As Double
Dim ltcgBreakUp22 As Double
Dim ltcgBreakUp23 As Double
Dim ltcgBreakUp24 As Double
Dim ltcgBreakUp25 As Double
'Added by Riyaz on 25/02/2025
Dim ltcgBreakUp27 As Double
...
'Added by Riyaz on 10/04/2025 for STCG 20%
Dim tempstcgBreakUp8 As Double
Dim tempstcgBreakUp9 As Double
Dim tempstcgBreakUp10 As Double
...
'Added by Sai on 11/04/2025 for LTCG 12.5%
Dim templtcgBreakUp13 As Double
Dim templtcgBreakUp14 As Double
Dim templtcgBreakUp15 As Double
'Newly added by Bindu on 4th June 26
Dim templtcgBreakUp15_B1g As Double
Dim templtcgBreakUp15_B2e As Double
Dim templtcgBreakUp15_B5c As Double
Dim templtcgBreakUp15_B9e As Double
Dim templtcgBreakUp15_B10 As Double



Dim templtcgBreakUp16 As Double
Dim templtcgBreakUp17 As Double
Dim templtcgBreakUp18 As Double
Dim templtcgBreakUp19 As Double
Dim templtcgBreakUp20 As Double
Dim templtcgBreakUp21 As Double
Dim templtcgBreakUp22 As Double
Dim templtcgBreakUp23 As Double
Dim templtcgBreakUp24 As Double
Dim templtcgBreakUp25 As Double
'Added by Riyaz on 25/02/2026
Dim templtcgBreakUp27 As Double
...
'*************************************************************************************************
 cgosIncome_cgInc_ltcg_prctg125_sec115E_a = Sheet31.Range("CYLAtemp125Sec_115EA").value '1
 cgosIncome_cgInc_ltcg_PTI112_sec48 = Sheet31.Range("CYLAtemp125Sec_112sec_48").value '2
 'cgosIncome_cgInc_ltcg_PTI125_112_B9 = Sheet31.Range("CYLAtemp125Sec_112").value '3
 '--Newly added by Bindu on 4th June 26
  cgosIncome_cgInc_ltcg_PTI125_112_B1g = Sheet31.Range("CYLAtemp125Sec_112_B1g").value '3
cgosIncome_cgInc_ltcg_PTI125_112_B2e = Sheet31.Range("CYLAtemp125Sec_112_B2e").value
 cgosIncome_cgInc_ltcg_PTI125_112_B5c = Sheet31.Range("CYLAtemp125Sec_112_B5c").value
 cgosIncome_cgInc_ltcg_PTI125_112_B9e = Sheet31.Range("CYLAtemp125Sec_112_B9e").value
 cgosIncome_cgInc_ltcg_PTI125_112_B10 = Sheet31.Range("CYLAtemp125Sec_112_B10").value
 '----
 
 cgosIncome_cgInc_ltcg_prctg125_sec112_1_c_2 = Sheet31.Range("CYLAtemp125Sec112_C").value '4
 cgosIncome_cgInc_ltcg_prctg125_sec115AC_1 = Sheet31.Range("CYLAtemp125Sec_115AC").value '5
 cgosIncome_cgInc_ltcg_prctg125_sec115ACA_1 = Sheet31.Range("CYLAtemp125Sec_115ACA").value '6
 cgosIncome_cgInc_ltcg_prctg125_sec115AD_3_Proviso = Sheet31.Range("CYLAtemp125Sec_115AD_iii").value '7
 cgosIncome_cgInc_ltcg_prctg125_sec115E_b = Sheet31.Range("CYLAtemp125Sec_115EB").value '8
 cgosIncome_cgInc_ltcg_PTI125 = Sheet31.Range("CYLAtemp125Sec_PTI").value '9
 cgosIncome_cgInc_ltcg_prctg125_secProviso = Sheet31.Range("CYLAtemp125SecPro").value '10
 cgosIncome_cgInc_ltcg_PTI125_112 = Sheet31.Range("CYLAtemp125Sec_112_PTI").value '11
 cgosIncome_cgInc_ltcg_prctg125_sec112A = Sheet31.Range("CYLAtemp125Sec_112A").value '12
'Added by Riyaz on 25/02/2026
 cgosIncome_cgInc_ltcg_prctg125_sec115AD_3 = Sheet31.Range("CYLAtemp125Sec115AD3").value
'****************************************************************************************************
...
cgosIncome_cgInc_ltcg_prctg10_secProviso = Sheet31.Range("CYLAtemp10SecPro").value
...
'Added by Riyaz on 10/04/2025 for STCG 20%
'Updated by Bindu as its not following the order
stcgBreakUp8 = cgosIncome_cgInc_stcg_prctg20_sec115ad_1_b_ii
stcgBreakUp9 = cgosIncome_cgInc_stcg_PTI20
stcgBreakUp10 = cgosIncome_cgInc_stcg_prctg20_sec111a


'stcgBreakUp8 = cgosIncome_cgInc_stcg_prctg20_sec111a
'stcgBreakUp9 = cgosIncome_cgInc_stcg_prctg20_sec115ad_1_b_ii
'stcgBreakUp10 = cgosIncome_cgInc_stcg_PTI20
...
'***********************************************************
ltcgBreakUp13 = cgosIncome_cgInc_ltcg_prctg125_sec115E_a
ltcgBreakUp14 = cgosIncome_cgInc_ltcg_PTI112_sec48
'ltcgBreakUp15 = cgosIncome_cgInc_ltcg_PTI125_112_B9
'--Newly added by Bindu on 4th May 26
ltcgBreakUp15_B1g = cgosIncome_cgInc_ltcg_PTI125_112_B1g
ltcgBreakUp15_B2e = cgosIncome_cgInc_ltcg_PTI125_112_B2e
ltcgBreakUp15_B5c = cgosIncome_cgInc_ltcg_PTI125_112_B5c
ltcgBreakUp15_B9e = cgosIncome_cgInc_ltcg_PTI125_112_B9e
ltcgBreakUp15_B10 = cgosIncome_cgInc_ltcg_PTI125_112_B10
'--Ends

ltcgBreakUp16 = cgosIncome_cgInc_ltcg_prctg125_sec112_1_c_2
ltcgBreakUp17 = cgosIncome_cgInc_ltcg_prctg125_sec115AC_1
ltcgBreakUp18 = cgosIncome_cgInc_ltcg_prctg125_sec115ACA_1
ltcgBreakUp19 = cgosIncome_cgInc_ltcg_prctg125_sec115AD_3_Proviso
ltcgBreakUp20 = cgosIncome_cgInc_ltcg_prctg125_sec115E_b
ltcgBreakUp21 = cgosIncome_cgInc_ltcg_PTI125
ltcgBreakUp22 = cgosIncome_cgInc_ltcg_prctg125_secProviso
ltcgBreakUp23 = cgosIncome_cgInc_ltcg_PTI125_112
ltcgBreakUp24 = cgosIncome_cgInc_ltcg_prctg125_sec112A
'**************************************************************

ltcgBreakUp25 = cgosIncome_cgInc_ltcg_prctg20_secProviso
ltcgBreakUp27 = cgosIncome_cgInc_ltcg_prctg125_sec115AD_3
...
'Added by Riyaz on 10/04/2025 for STCG 20%
tempstcgBreakUp8 = stcgBreakUp8
tempstcgBreakUp9 = stcgBreakUp9
tempstcgBreakUp10 = stcgBreakUp10
...
'Added by Sai on 11/04/2025 for LTCG 12.5%
templtcgBreakUp13 = ltcgBreakUp13
templtcgBreakUp14 = ltcgBreakUp14
'templtcgBreakUp15 = ltcgBreakUp15
'--Newly added by Bindu on 4th June 26
templtcgBreakUp15_B1g = ltcgBreakUp15_B1g
templtcgBreakUp15_B2e = ltcgBreakUp15_B2e
templtcgBreakUp15_B5c = ltcgBreakUp15_B5c
templtcgBreakUp15_B9e = ltcgBreakUp15_B9e
templtcgBreakUp15_B10 = ltcgBreakUp15_B10
'--Ends

templtcgBreakUp16 = ltcgBreakUp16
templtcgBreakUp17 = ltcgBreakUp17
templtcgBreakUp18 = ltcgBreakUp18
templtcgBreakUp19 = ltcgBreakUp19
templtcgBreakUp20 = ltcgBreakUp20
templtcgBreakUp21 = ltcgBreakUp21
templtcgBreakUp22 = ltcgBreakUp22
templtcgBreakUp23 = ltcgBreakUp23
templtcgBreakUp24 = ltcgBreakUp24
templtcgBreakUp25 = ltcgBreakUp25

'Added by Riyaz on 25/02/2026
templtcgBreakUp27 = ltcgBreakUp27
...
Else
    ...
    tempLtcgCFL = 0
End If
'Newly added by Riyaz LTCG 20% on 14/04/2025
If (tempLtcgCFL > templtcgBreakUp25) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp25
       templtcgBreakUp25 = 0
Else
       templtcgBreakUp25 = Application.WorksheetFunction.Max(0, templtcgBreakUp25 - tempLtcgCFL)
            tempLtcgCFL = 0
End If
...
'LTCG 12.5%
If (tempLtcgCFL > templtcgBreakUp13) Then 'Not using
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp13
       templtcgBreakUp13 = 0
Else
       templtcgBreakUp13 = Application.WorksheetFunction.Max(0, templtcgBreakUp13 - tempLtcgCFL)
            tempLtcgCFL = 0
End If
'2
If (tempLtcgCFL > templtcgBreakUp14) Then 'Not using
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp14
       templtcgBreakUp14 = 0
Else
       templtcgBreakUp14 = Application.WorksheetFunction.Max(0, templtcgBreakUp14 - tempLtcgCFL)
            tempLtcgCFL = 0
End If
''3 Not using
'If (tempLtcgCFL > templtcgBreakUp15) Then
'       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp15
'       templtcgBreakUp15 = 0
'Else
'       templtcgBreakUp15 = Application.WorksheetFunction.Max(0, templtcgBreakUp15 - tempLtcgCFL)
'            tempLtcgCFL = 0
'End If

'15. B10
If (tempLtcgCFL > templtcgBreakUp15_B10) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp15_B10
       templtcgBreakUp15_B10 = 0
Else
       templtcgBreakUp15_B10 = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B10 - tempLtcgCFL)
            tempLtcgCFL = 0
End If
'---14. B9e
If (tempLtcgCFL > templtcgBreakUp15_B9e) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp15_B9e
       templtcgBreakUp15_B9e = 0
Else
       templtcgBreakUp15_B9e = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B9e - tempLtcgCFL)
            tempLtcgCFL = 0
End If
'--13. B5c
If (tempLtcgCFL > templtcgBreakUp15_B5c) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp15_B5c
       templtcgBreakUp15_B5c = 0
Else
       templtcgBreakUp15_B5c = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B5c - tempLtcgCFL)
            tempLtcgCFL = 0
End If
'--12. B2e
If (tempLtcgCFL > templtcgBreakUp15_B2e) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp15_B2e
       templtcgBreakUp15_B2e = 0
Else
       templtcgBreakUp15_B2e = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B2e - tempLtcgCFL)
            tempLtcgCFL = 0
End If


'11. B6ie - 112(1)(c )
If (tempLtcgCFL > templtcgBreakUp16) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp16
       templtcgBreakUp16 = 0
Else
       templtcgBreakUp16 = Application.WorksheetFunction.Max(0, templtcgBreakUp16 - tempLtcgCFL)
            tempLtcgCFL = 0
End If
'10. B6iie - 115AC(1)(c )
If (tempLtcgCFL > templtcgBreakUp17) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp17
       templtcgBreakUp17 = 0
Else
       templtcgBreakUp17 = Application.WorksheetFunction.Max(0, templtcgBreakUp17 - tempLtcgCFL)
            tempLtcgCFL = 0
End If
'9. B3iie - 115ACA(1)(b)
If (tempLtcgCFL > templtcgBreakUp18) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp18
       templtcgBreakUp18 = 0
Else
       templtcgBreakUp18 = Application.WorksheetFunction.Max(0, templtcgBreakUp18 - tempLtcgCFL)
            tempLtcgCFL = 0
End If
'8. B6iiie - 115AD(1)(iii)
If (tempLtcgCFL > templtcgBreakUp27) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp27
       templtcgBreakUp27 = 0
Else
       templtcgBreakUp27 = Application.WorksheetFunction.Max(0, templtcgBreakUp27 - tempLtcgCFL)
            tempLtcgCFL = 0
End If
'7. B8c - 115E(b)
If (tempLtcgCFL > templtcgBreakUp20) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp20
       templtcgBreakUp20 = 0
Else
       templtcgBreakUp20 = Application.WorksheetFunction.Max(0, templtcgBreakUp20 - tempLtcgCFL)
            tempLtcgCFL = 0
End If

'6. B11a2 - PTI_other than 112A_12.5%
If (tempLtcgCFL > templtcgBreakUp21) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp21
       templtcgBreakUp21 = 0
Else
       templtcgBreakUp21 = Application.WorksheetFunction.Max(0, templtcgBreakUp21 - tempLtcgCFL)
            tempLtcgCFL = 0
End If
'5. B1(g)
If (tempLtcgCFL > templtcgBreakUp15_B1g) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp15_B1g
       templtcgBreakUp15_B1g = 0
Else
       templtcgBreakUp15_B1g = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B1g - tempLtcgCFL)
            tempLtcgCFL = 0
End If

'4. B3ie - 112 Proviso_12.5%
If (tempLtcgCFL > templtcgBreakUp22) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp22
       templtcgBreakUp22 = 0
Else
       templtcgBreakUp22 = Application.WorksheetFunction.Max(0, templtcgBreakUp22 - tempLtcgCFL)
            tempLtcgCFL = 0
End If
'3. B11a1 - PTI_112A_12.5%
If (tempLtcgCFL > templtcgBreakUp23) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp23
       templtcgBreakUp23 = 0
Else
       templtcgBreakUp23 = Application.WorksheetFunction.Max(0, templtcgBreakUp23 - tempLtcgCFL)
            tempLtcgCFL = 0
End If

'2. B7c - 115AD(1)(iii) proviso
If (tempLtcgCFL > templtcgBreakUp19) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp19
       templtcgBreakUp19 = 0
Else
       templtcgBreakUp19 = Application.WorksheetFunction.Max(0, templtcgBreakUp19 - tempLtcgCFL)
            tempLtcgCFL = 0
End If

'1. B4c - 112A
If (tempLtcgCFL > templtcgBreakUp24) Then
       tempLtcgCFL = tempLtcgCFL - templtcgBreakUp24
       templtcgBreakUp24 = 0
Else
       templtcgBreakUp24 = Application.WorksheetFunction.Max(0, templtcgBreakUp24 - tempLtcgCFL)
            tempLtcgCFL = 0
End If
...
Sheet17.Unprotect Password:=getmsgstate 'Newly added by sai on 18/11/2025
...
Application.WorksheetFunction.Max(0, ltcgBreakUp13 - templtcgBreakUp13) + _
Application.WorksheetFunction.Max(0, ltcgBreakUp14 - templtcgBreakUp14) + _
Application.WorksheetFunction.Max(0, ltcgBreakUp16 - templtcgBreakUp16) + _
Application.WorksheetFunction.Max(0, ltcgBreakUp17 - templtcgBreakUp17) + _
Application.WorksheetFunction.Max(0, ltcgBreakUp18 - templtcgBreakUp18) + _
Application.WorksheetFunction.Max(0, ltcgBreakUp19 - templtcgBreakUp19) + _
Application.WorksheetFunction.Max(0, ltcgBreakUp20 - templtcgBreakUp20) + _
Application.WorksheetFunction.Max(0, ltcgBreakUp21 - templtcgBreakUp21) + _
Application.WorksheetFunction.Max(0, ltcgBreakUp22 - templtcgBreakUp22) + _
Application.WorksheetFunction.Max(0, ltcgBreakUp23 - templtcgBreakUp23) + Application.WorksheetFunction.Max(0, ltcgBreakUp24 - templtcgBreakUp24) + Application.WorksheetFunction.Max(0, ltcgBreakUp25 - templtcgBreakUp25) + Application.WorksheetFunction.Max(0, ltcgBreakUp27 - templtcgBreakUp27) + Application.WorksheetFunction.Max(0, ltcgBreakUp15_B10 - templtcgBreakUp15_B10) + Application.WorksheetFunction.Max(0, ltcgBreakUp15_B9e - templtcgBreakUp15_B9e) + Application.WorksheetFunction.Max(0, ltcgBreakUp15_B5c - templtcgBreakUp15_B5c) + Application.WorksheetFunction.Max(0, ltcgBreakUp15_B2e - templtcgBreakUp15_B2e) + Application.WorksheetFunction.Max(0, ltcgBreakUp15_B1g - templtcgBreakUp15_B1g)
'--Removed ltcgBreakUp15 added 15 series
...
Dim storeSTCG1, storeSTCG2, storeSTCG3, storeSTCG4, storeSTCG5, storeSTCG6, storeSTCG7, storeSTCG8, storeSTCG9, storeSTCG10 As Double
Dim storeLTCG1, storeLTCG2, storeLTCG3, storeLTCG4, storeLTCG5, storeLTCG6, storeLTCG7, storeLTCG7_1, storeLTCG7_2, storeLTCG8, storeLTCG9, storeLTCG10, storeLTCG11, storeLTCG12 As Double
Dim storeLTCG13, storeLTCG14, storeLTCG15, storeLTCG16, storeLTCG17, storeLTCG18, storeLTCG19, storeLTCG20, storeLTCG21, storeLTCG22, storeLTCG23, storeLTCG24, storeLTCG25, storeLTCG27 As Double
'--Newly added
Dim storeLTCG15_B1g, storeLTCG15_B2e, storeLTCG15_B5c, storeLTCG15_B9e, storeLTCG15_B10 As Double
...
'Added by Riyaz on 11/04/2025 for STCG 20%
storeSTCG8 = tempstcgBreakUp8
storeSTCG9 = tempstcgBreakUp9
storeSTCG10 = tempstcgBreakUp10
...
'Added by Riyaz on 11/04/2025 for STCG 20%
storeLTCG13 = templtcgBreakUp13
storeLTCG14 = templtcgBreakUp14
storeLTCG15 = templtcgBreakUp15
'--Newly added by Bindu on 4th June 26
storeLTCG15_B1g = templtcgBreakUp15_B1g
storeLTCG15_B2e = templtcgBreakUp15_B2e
storeLTCG15_B5c = templtcgBreakUp15_B5c
storeLTCG15_B9e = templtcgBreakUp15_B9e
storeLTCG15_B10 = templtcgBreakUp15_B10



storeLTCG16 = templtcgBreakUp16
storeLTCG17 = templtcgBreakUp17
storeLTCG18 = templtcgBreakUp18
storeLTCG19 = templtcgBreakUp19
storeLTCG20 = templtcgBreakUp20
storeLTCG21 = templtcgBreakUp21
storeLTCG22 = templtcgBreakUp22
storeLTCG23 = templtcgBreakUp23
storeLTCG24 = templtcgBreakUp24

'Added by Riyaz on 11/04/2025 for LTCG 20%
storeLTCG25 = templtcgBreakUp25
storeLTCG27 = templtcgBreakUp27
...
'Newly added by Riyaz on 11/04/2025 for STCG 20%
If (tempstcgCFL > tempstcgBreakUp8) Then
            tempstcgCFL = tempstcgCFL - tempstcgBreakUp8
            tempstcgBreakUp8 = 0
Else
            tempstcgBreakUp8 = Application.WorksheetFunction.Max(0, tempstcgBreakUp8 - tempstcgCFL)
            tempstcgCFL = 0
End If

If (tempstcgCFL > tempstcgBreakUp9) Then
            tempstcgCFL = tempstcgCFL - tempstcgBreakUp9
            tempstcgBreakUp9 = 0 ' Updated by Bindu earlier it was templtcgBreakUp9
Else
            tempstcgBreakUp9 = Application.WorksheetFunction.Max(0, tempstcgBreakUp9 - tempstcgCFL)
            tempstcgCFL = 0
End If

If (tempstcgCFL > tempstcgBreakUp10) Then
            tempstcgCFL = tempstcgCFL - tempstcgBreakUp10
            tempstcgBreakUp10 = 0
Else
            tempstcgBreakUp10 = Application.WorksheetFunction.Max(0, tempstcgBreakUp10 - tempstcgCFL)
            tempstcgCFL = 0
End If
...
'Newly added by Riyaz on 11/04/2025 for LTCG 20%
If (tempstcgCFL > templtcgBreakUp25) Then
            tempstcgCFL = tempstcgCFL - templtcgBreakUp25
            templtcgBreakUp25 = 0
Else
            templtcgBreakUp25 = Application.WorksheetFunction.Max(0, templtcgBreakUp25 - tempstcgCFL)
            tempstcgCFL = 0
End If
...
'Newly added by Riyaz on 11/04/2025 for LTCG 12.5%
If (tempstcgCFL > templtcgBreakUp13) Then 'Not using
       tempstcgCFL = tempstcgCFL - templtcgBreakUp13
       templtcgBreakUp13 = 0
Else
       templtcgBreakUp13 = Application.WorksheetFunction.Max(0, templtcgBreakUp13 - tempstcgCFL)
            tempstcgCFL = 0
End If
'2
If (tempstcgCFL > templtcgBreakUp14) Then 'Not using
       tempstcgCFL = tempstcgCFL - templtcgBreakUp14
       templtcgBreakUp14 = 0
Else
       templtcgBreakUp14 = Application.WorksheetFunction.Max(0, templtcgBreakUp14 - tempstcgCFL)
            tempstcgCFL = 0
End If
''3 Not using
'If (tempstcgCFL > templtcgBreakUp15) Then
'       tempstcgCFL = tempstcgCFL - templtcgBreakUp15
'       templtcgBreakUp15 = 0
'Else
'       templtcgBreakUp15 = Application.WorksheetFunction.Max(0, templtcgBreakUp15 - tempstcgCFL)
'            tempstcgCFL = 0
'End If

'15. B10
If (tempstcgCFL > templtcgBreakUp15_B10) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp15_B10
       templtcgBreakUp15_B10 = 0
Else
       templtcgBreakUp15_B10 = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B10 - tempstcgCFL)
            tempstcgCFL = 0
End If
'---14. B9e
If (tempstcgCFL > templtcgBreakUp15_B9e) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp15_B9e
       templtcgBreakUp15_B9e = 0
Else
       templtcgBreakUp15_B9e = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B9e - tempstcgCFL)
            tempstcgCFL = 0
End If
'--13. B5c
If (tempstcgCFL > templtcgBreakUp15_B5c) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp15_B5c
       templtcgBreakUp15_B5c = 0
Else
       templtcgBreakUp15_B5c = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B5c - tempstcgCFL)
            tempstcgCFL = 0
End If
'--12. B2e
If (tempstcgCFL > templtcgBreakUp15_B2e) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp15_B2e
       templtcgBreakUp15_B2e = 0
Else
       templtcgBreakUp15_B2e = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B2e - tempstcgCFL)
            tempstcgCFL = 0
End If


'11. B6ie - 112(1)(c )
If (tempstcgCFL > templtcgBreakUp16) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp16
       templtcgBreakUp16 = 0
Else
       templtcgBreakUp16 = Application.WorksheetFunction.Max(0, templtcgBreakUp16 - tempstcgCFL)
            tempstcgCFL = 0
End If
'10. B6iie - 115AC(1)(c )
If (tempstcgCFL > templtcgBreakUp17) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp17
       templtcgBreakUp17 = 0
Else
       templtcgBreakUp17 = Application.WorksheetFunction.Max(0, templtcgBreakUp17 - tempstcgCFL)
            tempstcgCFL = 0
End If
'9. B3iie - 115ACA(1)(b)
If (tempstcgCFL > templtcgBreakUp18) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp18
       templtcgBreakUp18 = 0
Else
       templtcgBreakUp18 = Application.WorksheetFunction.Max(0, templtcgBreakUp18 - tempstcgCFL)
            tempstcgCFL = 0
End If
'8. B6iiie - 115AD(1)(iii)
If (tempstcgCFL > templtcgBreakUp27) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp27
       templtcgBreakUp27 = 0
Else
       templtcgBreakUp27 = Application.WorksheetFunction.Max(0, templtcgBreakUp27 - tempstcgCFL)
            tempstcgCFL = 0
End If
'7. B8c - 115E(b)
If (tempstcgCFL > templtcgBreakUp20) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp20
       templtcgBreakUp20 = 0
Else
       templtcgBreakUp20 = Application.WorksheetFunction.Max(0, templtcgBreakUp20 - tempstcgCFL)
            tempstcgCFL = 0
End If

'6. B11a2 - PTI_other than 112A_12.5%
If (tempstcgCFL > templtcgBreakUp21) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp21
       templtcgBreakUp21 = 0
Else
       templtcgBreakUp21 = Application.WorksheetFunction.Max(0, templtcgBreakUp21 - tempstcgCFL)
            tempstcgCFL = 0
End If
'5. B1(g)
If (tempstcgCFL > templtcgBreakUp15_B1g) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp15_B1g
       templtcgBreakUp15_B1g = 0
Else
       templtcgBreakUp15_B1g = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B1g - tempstcgCFL)
            tempstcgCFL = 0
End If

'4. B3ie - 112 Proviso_12.5%
If (tempstcgCFL > templtcgBreakUp22) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp22
       templtcgBreakUp22 = 0
Else
       templtcgBreakUp22 = Application.WorksheetFunction.Max(0, templtcgBreakUp22 - tempstcgCFL)
            tempstcgCFL = 0
End If
'3. B11a1 - PTI_112A_12.5%
If (tempstcgCFL > templtcgBreakUp23) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp23
       templtcgBreakUp23 = 0
Else
       templtcgBreakUp23 = Application.WorksheetFunction.Max(0, templtcgBreakUp23 - tempstcgCFL)
            tempstcgCFL = 0
End If

'2. B7c - 115AD(1)(iii) proviso
If (tempstcgCFL > templtcgBreakUp19) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp19
       templtcgBreakUp19 = 0
Else
       templtcgBreakUp19 = Application.WorksheetFunction.Max(0, templtcgBreakUp19 - tempstcgCFL)
            tempstcgCFL = 0
End If

'1. B4c - 112A
If (tempstcgCFL > templtcgBreakUp24) Then
       tempstcgCFL = tempstcgCFL - templtcgBreakUp24
       templtcgBreakUp24 = 0
Else
       templtcgBreakUp24 = Application.WorksheetFunction.Max(0, templtcgBreakUp24 - tempstcgCFL)
            tempstcgCFL = 0
End If
...
'Setting off business loss with spec and specified business loss
    ...
    'Chandru
    '--44BBD Newly added by Bindu
    IncOfCurYrUndHeadFromCYLA2_16_1 = Application.WorksheetFunction.Max(0, (Sheet16.Range("busipofincl.IncOfCurYrUndHeadFromCYLA2").value - Sheet9.Range("Sheet11.section44BB").value - Sheet9.Range("Sheet11.Section44BBD").value))
    '------
    ...
    If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "N") Then 'Newly updated by Bindu
...
'------------
''added by Chandru
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate

' Sheet16.Range("").Locked = False
'  Sheet16.Range("").Interior.Color = RGB(255, 255, 204)
...
Else
'    Sheet16.Range("").Locked = True
'    Sheet16.Range("").Interior.ColorIndex = 2
...
'Newly added by Riyaz on 11/04/2024 for STCG20%
Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3c").value = Application.WorksheetFunction.Max(0, stcgBreakUp8 - tempstcgBreakUp8) + _
                                                            Application.WorksheetFunction.Max(0, stcgBreakUp9 - tempstcgBreakUp9) + _
                                                             Application.WorksheetFunction.Max(0, stcgBreakUp10 - tempstcgBreakUp10)
...
Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4a").value = Application.WorksheetFunction.Max(0, ltcgBreakUp1 - templtcgBreakUp1) + _
                                                              Application.WorksheetFunction.Max(0, ltcgBreakUp10 - templtcgBreakUp10) + _
                                                            Application.WorksheetFunction.Max(0, ltcgBreakUp2 - templtcgBreakUp2) + _
                                                            Application.WorksheetFunction.Max(0, ltcgBreakUp25 - templtcgBreakUp25)
                                                            
Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4").value = Application.WorksheetFunction.Max(0, ltcgBreakUp3 - templtcgBreakUp3) + _
                                                             Application.WorksheetFunction.Max(0, ltcgBreakUp7_1 - templtcgBreakUp7_1) + _
                                                             Application.WorksheetFunction.Max(0, ltcgBreakUp7_2 - templtcgBreakUp7_2) + _
                                                            Application.WorksheetFunction.Max(0, ltcgBreakUp4 - templtcgBreakUp4) + _
                                                            Application.WorksheetFunction.Max(0, ltcgBreakUp5 - templtcgBreakUp5) + _
...
'Added by Sai on 11/04/2025 for LTCG 12.5%
'Removed 15 & added 15 series
Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4b").value = Application.WorksheetFunction.Max(0, ltcgBreakUp13 - templtcgBreakUp13) + _
                                                             Application.WorksheetFunction.Max(0, ltcgBreakUp14 - templtcgBreakUp14) + _
                                                            Application.WorksheetFunction.Max(0, ltcgBreakUp16 - templtcgBreakUp16) + _
                                                            Application.WorksheetFunction.Max(0, ltcgBreakUp17 - templtcgBreakUp17) + _
                                                            Application.WorksheetFunction.Max(0, ltcgBreakUp18 - templtcgBreakUp18) + _
                                                           ...
                                                           Application.WorksheetFunction.Max(0, ltcgBreakUp21 - templtcgBreakUp21) + _
                                                           Application.WorksheetFunction.Max(0, ltcgBreakUp22 - templtcgBreakUp22) + _
                                                           Application.WorksheetFunction.Max(0, ltcgBreakUp23 - templtcgBreakUp23) + _
                                                           Application.WorksheetFunction.Max(0, ltcgBreakUp24 - templtcgBreakUp24) + Application.WorksheetFunction.Max(0, ltcgBreakUp27 - templtcgBreakUp27) + Application.WorksheetFunction.Max(0, ltcgBreakUp15_B10 - templtcgBreakUp15_B10) + Application.WorksheetFunction.Max(0, ltcgBreakUp15_B9e - templtcgBreakUp15_B9e) + Application.WorksheetFunction.Max(0, ltcgBreakUp15_B5c - templtcgBreakUp15_B5c) + Application.WorksheetFunction.Max(0, ltcgBreakUp15_B2e - templtcgBreakUp15_B2e) + Application.WorksheetFunction.Max(0, ltcgBreakUp15_B1g - templtcgBreakUp15_B1g)
...
Sheet17.Range("adjtotloss.STCGLossCF9").value = Application.WorksheetFunction.Max(0, storeSTCG1 - tempstcgBreakUp1) + _
                                               ...
                                               Application.WorksheetFunction.Max(0, storeSTCG7 - tempstcgBreakUp7) + Application.WorksheetFunction.Max(0, storeSTCG8 - tempstcgBreakUp8) + Application.WorksheetFunction.Max(0, storeSTCG9 - tempstcgBreakUp9) + Application.WorksheetFunction.Max(0, storeSTCG10 - tempstcgBreakUp10) + _
                                               ...
                                               Application.WorksheetFunction.Max(0, storeLTCG12 - templtcgBreakUp12) + Application.WorksheetFunction.Max(0, storeLTCG13 - templtcgBreakUp13) + Application.WorksheetFunction.Max(0, storeLTCG14 - templtcgBreakUp14) + _
                                               Application.WorksheetFunction.Max(0, storeLTCG16 - templtcgBreakUp16) + Application.WorksheetFunction.Max(0, storeLTCG17 - templtcgBreakUp17) + Application.WorksheetFunction.Max(0, storeLTCG18 - templtcgBreakUp18) + Application.WorksheetFunction.Max(0, storeLTCG19 - templtcgBreakUp19) + _
                                               Application.WorksheetFunction.Max(0, storeLTCG20 - templtcgBreakUp20) + Application.WorksheetFunction.Max(0, storeLTCG21 - templtcgBreakUp21) + Application.WorksheetFunction.Max(0, storeLTCG22 - templtcgBreakUp22) + Application.WorksheetFunction.Max(0, storeLTCG23 - templtcgBreakUp23) + _
                                               Application.WorksheetFunction.Max(0, storeLTCG24 - templtcgBreakUp24) + _
                                               Application.WorksheetFunction.Max(0, storeLTCG25 - templtcgBreakUp25) + Application.WorksheetFunction.Max(0, storeLTCG27 - templtcgBreakUp27) + Application.WorksheetFunction.Max(0, storeLTCG15_B10 - templtcgBreakUp15_B10) + Application.WorksheetFunction.Max(0, storeLTCG15_B9e - templtcgBreakUp15_B9e) + Application.WorksheetFunction.Max(0, storeLTCG15_B5c - templtcgBreakUp15_B5c) + Application.WorksheetFunction.Max(0, storeLTCG15_B2e - templtcgBreakUp15_B2e) + Application.WorksheetFunction.Max(0, storeLTCG15_B1g - templtcgBreakUp15_B1g)
...
'Chandru
 ...
 Sheet16.Range("busipofincl.BFUnabsorbedDeprSetoff2").formula = "=MAX(0,MIN(((busipofincl.IncOfCurYrUndHeadFromCYLA2-Sheet11.Section44BB-Sheet11.Section44BBD)-busipofincl.BFlossPrevYrUndSameHeadSetoff2),UD.TotSetoff))"
 ...
 If (busProfSpecProfset > 0) Then
      ...
      totalUDDeprctn = 0
      'totalUDDeprctn = totalUDDeprctn - Sheet16.Range("busipofincl.BFUnabsorbedDeprSetoff2").value
    End If
...
'Speculative
Dim Speculativeset As Double, totalUDDeprctn1 As Double
totalUDDeprctn = Sheet15.Range("UD.TotSetoff").value - Sheet16.Range("busipofincl.BFUnabsorbedDeprSetoff2").value

If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("busipofinclspec.BFUnabsorbedDeprSetoff2a").Locked = False
        Sheet16.Range("busipofinclspec.BFUnabsorbedDeprSetoff2a").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("busipofinclspec.BFUnabsorbedDeprSetoff2a").Locked = True
        Sheet16.Range("busipofinclspec.BFUnabsorbedDeprSetoff2a").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("busipofinclspecified.BFUnabsorbedDeprSetoff2b").Locked = False
        Sheet16.Range("busipofinclspecified.BFUnabsorbedDeprSetoff2b").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("busipofinclspecified.BFUnabsorbedDeprSetoff2b").Locked = True
        Sheet16.Range("busipofinclspecified.BFUnabsorbedDeprSetoff2b").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("hp.BFUnabsorbedDeprSetoff1").Locked = False
        Sheet16.Range("hp.BFUnabsorbedDeprSetoff1").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("hp.BFUnabsorbedDeprSetoff1").Locked = True
        Sheet16.Range("hp.BFUnabsorbedDeprSetoff1").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("othsrcincl.BFUnabsorbedDeprSetoff5").Locked = False
        Sheet16.Range("othsrcincl.BFUnabsorbedDeprSetoff5").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("othsrcincl.BFUnabsorbedDeprSetoff5").Locked = True
        Sheet16.Range("othsrcincl.BFUnabsorbedDeprSetoff5").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("rh.BFUnabsorbedDeprSetoff6").Locked = False
        Sheet16.Range("rh.BFUnabsorbedDeprSetoff6").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("rh.BFUnabsorbedDeprSetoff6").Locked = True
        Sheet16.Range("rh.BFUnabsorbedDeprSetoff6").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("rh.BFUnabsorbedDeprSetoff_DTAARates").Locked = False
        Sheet16.Range("rh.BFUnabsorbedDeprSetoff_DTAARates").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("rh.BFUnabsorbedDeprSetoff_DTAARates").Locked = True
        Sheet16.Range("rh.BFUnabsorbedDeprSetoff_DTAARates").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3a").Locked = False
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3a").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3a").Locked = True
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3a").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b").Locked = False
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b").Locked = True
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b").Interior.ColorIndex = 2
 'end Change Chandru
...
'Newly Added by Riyaz on 14/04/2025 for STCG 20%
Dim stcg20Perset As Double

If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3c").Locked = False
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3c").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3c").Locked = True
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3c").Interior.ColorIndex = 2
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4a").Locked = False
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4a").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4a").Locked = True
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4a").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3").Locked = False
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3").Locked = True
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3").Interior.ColorIndex = 2
 'end Change Chandru
...
'LTCG 12.5% Added by Riyaz on 14/04/2025

Dim ltcg125Perset As Double
 
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4b").Locked = False
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4b").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4b").Locked = True
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4b").Interior.ColorIndex = 2
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4").Locked = False
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4").Locked = True
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b_DTAARates").Locked = False
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b_DTAARates").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b_DTAARates").Locked = True
        Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b_DTAARates").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff_DTAARates").Locked = False
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff_DTAARates").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff_DTAARates").Locked = True
        Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff_DTAARates").Interior.ColorIndex = 2
 'end Change Chandru
...
'<-----------End of UD Depreciation set off----
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("busipofinclspec.BFAllUs35Cl4Setoff2a").Locked = False
        Sheet16.Range("busipofinclspec.BFAllUs35Cl4Setoff2a").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("busipofinclspec.BFAllUs35Cl4Setoff2a").Locked = True
        Sheet16.Range("busipofinclspec.BFAllUs35Cl4Setoff2a").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("busipofinclspecified.BFAllUs35Cl4Setoff2b").Locked = False
        Sheet16.Range("busipofinclspecified.BFAllUs35Cl4Setoff2b").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("busipofinclspecified.BFAllUs35Cl4Setoff2b").Locked = True
        Sheet16.Range("busipofinclspecified.BFAllUs35Cl4Setoff2b").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("hp.BFAllUs35Cl4Setoff1").Locked = False
        Sheet16.Range("hp.BFAllUs35Cl4Setoff1").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("hp.BFAllUs35Cl4Setoff1").Locked = True
        Sheet16.Range("hp.BFAllUs35Cl4Setoff1").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("othsrcincl.BFAllUs35Cl4Setoff5").Locked = False
        Sheet16.Range("othsrcincl.BFAllUs35Cl4Setoff5").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("othsrcincl.BFAllUs35Cl4Setoff5").Locked = True
        Sheet16.Range("othsrcincl.BFAllUs35Cl4Setoff5").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("rh.BFAllUs35Cl4Setoff6").Locked = False
        Sheet16.Range("rh.BFAllUs35Cl4Setoff6").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("rh.BFAllUs35Cl4Setoff6").Locked = True
        Sheet16.Range("rh.BFAllUs35Cl4Setoff6").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("rh.BFAllUs35Cl4Setoff_DTAARates").Locked = False
        Sheet16.Range("rh.BFAllUs35Cl4Setoff_DTAARates").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("rh.BFAllUs35Cl4Setoff_DTAARates").Locked = True
        Sheet16.Range("rh.BFAllUs35Cl4Setoff_DTAARates").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3a").Locked = False
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3a").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3a").Locked = True
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3a").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b").Locked = False
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b").Locked = True
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b").Interior.ColorIndex = 2
 'end Change Chandru
...
'Newly Added by Riyaz on 14/04/2025 for Allowances at STCG20%

Dim stcg20PerAllwnceSet As Double

If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3_c").Locked = False
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3_c").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3_c").Locked = True
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3_c").Interior.ColorIndex = 2
...
stcg20PerAllwnceSet = Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3c").value - Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3c").value - Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3c").value
    ...
    If (stcg20PerAllwnceSet <= totalUDAllwnce) Then
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3_c").value = stcg20PerAllwnceSet
        totalUDAllwnce = totalUDAllwnce - stcg20PerAllwnceSet
    Else:
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3_c").value = totalUDAllwnce
        totalUDAllwnce = 0
    End If
    Else:
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3_c").value = 0
    End If
End If
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4a").Locked = False
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4a").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4a").Locked = True
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4a").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3").Locked = False
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3").Locked = True
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3").Interior.ColorIndex = 2
 'end Change Chandru
...
'LTCG 12.5% Added by Riyaz on 14/04/2024

Dim ltcg125PerAllwnceSet As Double

If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4_c").Locked = False
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4_c").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4_c").Locked = True
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4_c").Interior.ColorIndex = 2
...
ltcg125PerAllwnceSet = Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4b").value - Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4b").value - Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4b").value
    ...
    If (ltcg125PerAllwnceSet <= totalUDAllwnce) Then
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4_c").value = ltcg125PerAllwnceSet
        totalUDAllwnce = totalUDAllwnce - ltcg125PerAllwnceSet
    Else:
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4_c").value = totalUDAllwnce
        totalUDAllwnce = 0
    End If
    Else:
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4_c").value = 0
    End If
 End If
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4").Locked = False
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4").Locked = True
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b_DTAARates").Locked = False
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b_DTAARates").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b_DTAARates").Locked = True
        Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b_DTAARates").Interior.ColorIndex = 2
 'end Change Chandru
...
If (Mid(Range("sheet16.BFLA_Edit").value, 1, 1) = "Y") Then
Sheet16.Unprotect Password:=getmsgstate
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff_DTAARates").Locked = False
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff_DTAARates").Interior.Color = RGB(255, 255, 204)

    Else

        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff_DTAARates").Locked = True
        Sheet16.Range("ltcg.BFAllUs35Cl4Setoff_DTAARates").Interior.ColorIndex = 2
 'end Change Chandru
...
'----
Dim sumUD35_4_stcg15Per As Double, sumUD35_4_stcg20Per As Double, sumUD35_4_stcg30Per As Double, sumUD35_4_stcgAppPer, sumUD35_4_stcgDTAA As Double
Dim sumUD35_4_ltcg20Per As Double, sumUD35_4_ltcg125Per As Double, sumUD35_4_ltcg10Per, sumUD35_4_ltcgDTAA As Double


sumUD35_4_stcg15Per = Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3").value + Sheet16.Range("stcg.BFAllUs35Cl4Setoff3").value
sumUD35_4_stcg20Per = Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3c").value + Sheet16.Range("stcg.BFAllUs35Cl4Setoff3_c").value
...
sumUD35_4_ltcg125Per = Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4b").value + Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4_c").value
...
'STCG 20%
        If (sumUD35_4_stcg20Per > tempstcgBreakUp8) Then
            sumUD35_4_stcg20Per = sumUD35_4_stcg20Per - tempstcgBreakUp8
            tempstcgBreakUp8 = 0
        Else:
            tempstcgBreakUp8 = Application.WorksheetFunction.Max(0, tempstcgBreakUp8 - sumUD35_4_stcg20Per)
            sumUD35_4_stcg20Per = 0
        End If
        
        If (sumUD35_4_stcg20Per > tempstcgBreakUp9) Then
            sumUD35_4_stcg20Per = sumUD35_4_stcg20Per - tempstcgBreakUp9
            tempstcgBreakUp9 = 0
        Else:
            tempstcgBreakUp9 = Application.WorksheetFunction.Max(0, tempstcgBreakUp9 - sumUD35_4_stcg20Per)
            sumUD35_4_stcg20Per = 0
        End If
        
        If (sumUD35_4_stcg20Per > tempstcgBreakUp10) Then
            sumUD35_4_stcg20Per = sumUD35_4_stcg20Per - tempstcgBreakUp10
            tempstcgBreakUp10 = 0
        Else:
            tempstcgBreakUp10 = Application.WorksheetFunction.Max(0, tempstcgBreakUp10 - sumUD35_4_stcg20Per)
            sumUD35_4_stcg20Per = 0
        End If
...
'LTCG 20%
        ...
        If (sumUD35_4_ltcg20Per > templtcgBreakUp25) Then
            sumUD35_4_ltcg20Per = sumUD35_4_ltcg20Per - templtcgBreakUp25
            templtcgBreakUp25 = 0
        Else:
            templtcgBreakUp25 = Application.WorksheetFunction.Max(0, templtcgBreakUp25 - sumUD35_4_ltcg20Per)
            sumUD35_4_ltcg20Per = 0
        End If
...
If (sumUD35_4_ltcg125Per > templtcgBreakUp13) Then 'Not using
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp13
       templtcgBreakUp13 = 0
Else
       templtcgBreakUp13 = Application.WorksheetFunction.Max(0, templtcgBreakUp13 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
'2
If (sumUD35_4_ltcg125Per > templtcgBreakUp14) Then 'Not using
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp14
       templtcgBreakUp14 = 0
Else
       templtcgBreakUp14 = Application.WorksheetFunction.Max(0, templtcgBreakUp14 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
''3 Not using
'If (sumUD35_4_ltcg125Per > templtcgBreakUp15) Then
'       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp15
'       templtcgBreakUp15 = 0
'Else
'       templtcgBreakUp15 = Application.WorksheetFunction.Max(0, templtcgBreakUp15 - sumUD35_4_ltcg125Per)
'            sumUD35_4_ltcg125Per = 0
'End If

'15. B10
If (sumUD35_4_ltcg125Per > templtcgBreakUp15_B10) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp15_B10
       templtcgBreakUp15_B10 = 0
Else
       templtcgBreakUp15_B10 = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B10 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
'---14. B9e
If (sumUD35_4_ltcg125Per > templtcgBreakUp15_B9e) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp15_B9e
       templtcgBreakUp15_B9e = 0
Else
       templtcgBreakUp15_B9e = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B9e - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
'--13. B5c
If (sumUD35_4_ltcg125Per > templtcgBreakUp15_B5c) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp15_B5c
       templtcgBreakUp15_B5c = 0
Else
       templtcgBreakUp15_B5c = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B5c - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
'--12. B2e
If (sumUD35_4_ltcg125Per > templtcgBreakUp15_B2e) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp15_B2e
       templtcgBreakUp15_B2e = 0
Else
       templtcgBreakUp15_B2e = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B2e - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If


'11. B6ie - 112(1)(c )
If (sumUD35_4_ltcg125Per > templtcgBreakUp16) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp16
       templtcgBreakUp16 = 0
Else
       templtcgBreakUp16 = Application.WorksheetFunction.Max(0, templtcgBreakUp16 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
'10. B6iie - 115AC(1)(c )
If (sumUD35_4_ltcg125Per > templtcgBreakUp17) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp17
       templtcgBreakUp17 = 0
Else
       templtcgBreakUp17 = Application.WorksheetFunction.Max(0, templtcgBreakUp17 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
'9. B3iie - 115ACA(1)(b)
If (sumUD35_4_ltcg125Per > templtcgBreakUp18) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp18
       templtcgBreakUp18 = 0
Else
       templtcgBreakUp18 = Application.WorksheetFunction.Max(0, templtcgBreakUp18 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
'8. B6iiie - 115AD(1)(iii)
If (sumUD35_4_ltcg125Per > templtcgBreakUp27) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp27
       templtcgBreakUp27 = 0
Else
       templtcgBreakUp27 = Application.WorksheetFunction.Max(0, templtcgBreakUp27 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
'7. B8c - 115E(b)
If (sumUD35_4_ltcg125Per > templtcgBreakUp20) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp20
       templtcgBreakUp20 = 0
Else
       templtcgBreakUp20 = Application.WorksheetFunction.Max(0, templtcgBreakUp20 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If

'6. B11a2 - PTI_other than 112A_12.5%
If (sumUD35_4_ltcg125Per > templtcgBreakUp21) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp21
       templtcgBreakUp21 = 0
Else
       templtcgBreakUp21 = Application.WorksheetFunction.Max(0, templtcgBreakUp21 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
'5. B1(g)
If (sumUD35_4_ltcg125Per > templtcgBreakUp15_B1g) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp15_B1g
       templtcgBreakUp15_B1g = 0
Else
       templtcgBreakUp15_B1g = Application.WorksheetFunction.Max(0, templtcgBreakUp15_B1g - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If

'4. B3ie - 112 Proviso_12.5%
If (sumUD35_4_ltcg125Per > templtcgBreakUp22) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp22
       templtcgBreakUp22 = 0
Else
       templtcgBreakUp22 = Application.WorksheetFunction.Max(0, templtcgBreakUp22 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
'3. B11a1 - PTI_112A_12.5%
If (sumUD35_4_ltcg125Per > templtcgBreakUp23) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp23
       templtcgBreakUp23 = 0
Else
       templtcgBreakUp23 = Application.WorksheetFunction.Max(0, templtcgBreakUp23 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If

'2. B7c - 115AD(1)(iii) proviso
If (sumUD35_4_ltcg125Per > templtcgBreakUp19) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp19
       templtcgBreakUp19 = 0
Else
       templtcgBreakUp19 = Application.WorksheetFunction.Max(0, templtcgBreakUp19 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If

'1. B4c - 112A
If (sumUD35_4_ltcg125Per > templtcgBreakUp24) Then
       sumUD35_4_ltcg125Per = sumUD35_4_ltcg125Per - templtcgBreakUp24
       templtcgBreakUp24 = 0
Else
       templtcgBreakUp24 = Application.WorksheetFunction.Max(0, templtcgBreakUp24 - sumUD35_4_ltcg125Per)
            sumUD35_4_ltcg125Per = 0
End If
...
'LTCG 20% Newly added Sec
        cgosIncome_cgInc_ltcg_prctg20_secProviso = templtcgBreakUp25
...
'Added by Riyaz on 15/04/2025 for STCG 20%
'Updated by Bindu as its not following the order

        cgosIncome_cgInc_stcg_prctg20_sec115ad_1_b_ii = tempstcgBreakUp8
        cgosIncome_cgInc_stcg_PTI20 = tempstcgBreakUp9
        cgosIncome_cgInc_stcg_prctg20_sec111a = tempstcgBreakUp10
        
        


'        cgosIncome_cgInc_stcg_prctg20_sec111a = tempstcgBreakUp8
'        cgosIncome_cgInc_stcg_prctg20_sec115ad_1_b_ii = tempstcgBreakUp9
'        cgosIncome_cgInc_stcg_PTI20 = tempstcgBreakUp10

'LTCG 12.5%
        cgosIncome_cgInc_ltcg_prctg125_sec115E_a = templtcgBreakUp13
        cgosIncome_cgInc_ltcg_PTI112_sec48 = templtcgBreakUp14
        cgosIncome_cgInc_ltcg_PTI125_112_B9 = templtcgBreakUp15
        '--Newly added by Bindu on 4th June 26
        'cgosIncome_cgInc_ltcg_PTI125_112_B9 = templtcgBreakUp15
        '--Newly added by Bindu on 5th June 26
        cgosIncome_cgInc_ltcg_PTI125_112_B1g = templtcgBreakUp15_B1g
        cgosIncome_cgInc_ltcg_PTI125_112_B2e = templtcgBreakUp15_B2e
        cgosIncome_cgInc_ltcg_PTI125_112_B5c = templtcgBreakUp15_B5c
        cgosIncome_cgInc_ltcg_PTI125_112_B9e = templtcgBreakUp15_B9e
        cgosIncome_cgInc_ltcg_PTI125_112_B10 = templtcgBreakUp15_B10
        '--Ends
        
        cgosIncome_cgInc_ltcg_prctg125_sec112_1_c_2 = templtcgBreakUp16
        cgosIncome_cgInc_ltcg_prctg125_sec115AC_1 = templtcgBreakUp17
        cgosIncome_cgInc_ltcg_prctg125_sec115ACA_1 = templtcgBreakUp18
        cgosIncome_cgInc_ltcg_prctg125_sec115AD_3_Proviso = templtcgBreakUp19
        cgosIncome_cgInc_ltcg_prctg125_sec115E_b = templtcgBreakUp20
        cgosIncome_cgInc_ltcg_PTI125 = templtcgBreakUp21
        cgosIncome_cgInc_ltcg_prctg125_secProviso = templtcgBreakUp22
        cgosIncome_cgInc_ltcg_PTI125_112 = templtcgBreakUp23
        cgosIncome_cgInc_ltcg_prctg125_sec112A = templtcgBreakUp24
        
        cgosIncome_cgInc_ltcg_prctg125_sec115AD_3 = templtcgBreakUp27
If Sheet16.Range("sheet16.BFLA_Edit").value = "No" Then
 ...
 'storing diff section remaining value
    ...
    Sheet31.Range("BFLAtemp10SecPro").value = cgosIncome_cgInc_ltcg_prctg10_secProviso
    Sheet31.Range("BFLAtemp10Sec115ACA1").value = cgosIncome_cgInc_ltcg_prctg10_sec115ACA_1 'sachin
...
'LTCG 12.5% Added by Sai on 15/04/2025
        ...
        '--Newly added by Bindu on 5th June 26
        Sheet31.Range("BFLAtemp125Sec_112_B1g").value = cgosIncome_cgInc_ltcg_PTI125_112_B1g
        Sheet31.Range("BFLAtemp125Sec_112_B2e").value = cgosIncome_cgInc_ltcg_PTI125_112_B2e
        Sheet31.Range("BFLAtemp125Sec_112_B5c").value = cgosIncome_cgInc_ltcg_PTI125_112_B5c
        Sheet31.Range("BFLAtemp125Sec_112_B9e").value = cgosIncome_cgInc_ltcg_PTI125_112_B9e
        Sheet31.Range("BFLAtemp125Sec_112_B10").value = cgosIncome_cgInc_ltcg_PTI125_112_B10
        Sheet31.Range("BFLAtemp125Sec_112").value = cgosIncome_cgInc_ltcg_PTI125_112_B1g + cgosIncome_cgInc_ltcg_PTI125_112_B2e + cgosIncome_cgInc_ltcg_PTI125_112_B5c + cgosIncome_cgInc_ltcg_PTI125_112_B9e + cgosIncome_cgInc_ltcg_PTI125_112_B10
        ...
        Sheet31.Range("BFLAtemp125SecPro").value = cgosIncome_cgInc_ltcg_prctg125_secProviso
        
        Sheet31.Range("BFLAtemp125Sec115AD3").value = cgosIncome_cgInc_ltcg_prctg125_sec115AD_3
'LTCG 20% Newly added sec
...
Else
    ...
    Sheet31.Unprotect Password:=getmsgstate 'Newly added by sai on 18/11/2025
    
'STCG-15%
    Sheet31.Range("BFLAtemp15Sec111a").value = Sheet21.Range("STCG111A.IHLA").value
    Sheet31.Range("BFLAtemp15Sec115ad1bii").value = Sheet21.Range("STCG111A_STCG115AD_1_b_ii.IHLA").value
    Sheet31.Range("BFLAtempPTI15").value = Sheet21.Range("STCGPTI15.IHLA").value
    
'STCG-20%
    Sheet31.Range("BFLAtemp20Sec111a").value = Sheet21.Range("STCG20_111A").value
    Sheet31.Range("BFLAtemp20Sec115ad1bii").value = Sheet21.Range("STCG20_115AD").value
    Sheet31.Range("BFLAtempPTI20_STCG").value = Sheet21.Range("STCG20_PTI").value
    
'STCG-30%
    Sheet31.Range("BFLAtempPTI30").value = Sheet21.Range("STCGPTI30.IHLA").value
    Sheet31.Range("BFLAtemp115AD30").value = Sheet21.Range("STCG30_STCG115AD_1_ii.IHLA").value
    
'LTCG-10%
    
'    Sheet31.Range("BFLAtemp10SecPro").value = Sheet21.Range("").value              'Proviso
'
'    Sheet31.Range("BFLAtemp10Sec115ACA1").value = Sheet21.Range("LTCG_115ACA1_10").value 'Updated-7
'    Sheet31.Range("BFLAtemp10Sec115Eb").value = Sheet21.Range("LTCG_115EB_10").value     'Updated-4
'    Sheet31.Range("BFLAtemp10Sec1121c2").value = Sheet21.Range("LTCG_112_1_Cii_10").value 'Updated-9
'    Sheet31.Range("BFLAtemp10Sec115AC1").value = Sheet21.Range("LTCGP_115_E_b.IHLA").value   'Updated-8
'    Sheet31.Range("BFLAtemp10Sec115AD3").value = Sheet21.Range("LTCGP_112_1_c_iii.IHLA").value  'Updated-6
'    Sheet31.Range("BFLAtemp10Sec115AD3_Proviso").value = Sheet21.Range("LTCGP_115ADproviso.IHLA").value 'Updated-5
'    Sheet31.Range("BFLAtemp10Sec112A").value = Sheet21.Range("LTCGP_112A.IHLA").value                   'Updated-1



    Sheet31.Range("BFLAtemp10SecPro").value = 0                 'Proviso
    
    Sheet31.Range("BFLAtemp10Sec112A").value = Sheet21.Range("LTCGP_112A.IHLA").value    'Updated-1
    Sheet31.Range("BFLAtempPTI10_112").value = Sheet21.Range("LTCGP_PTI10_112A.IHLA").value 'Updated-2
    Sheet31.Range("BFLAtempPTI10").value = Sheet21.Range("LTCGP_PTI10.IHLA").value 'Updated 3
    Sheet31.Range("BFLAtemp10Sec115Eb").value = Sheet21.Range("LTCG_115EB_10").value     'Updated-4
    Sheet31.Range("BFLAtemp10Sec115AD3_Proviso").value = Sheet21.Range("LTCGP_115ADproviso.IHLA").value 'Updated-5
    Sheet31.Range("BFLAtemp10Sec115AD3").value = Sheet21.Range("LTCGP_112_1_c_iii.IHLA").value  'Updated-6
    Sheet31.Range("BFLAtemp10Sec115ACA1").value = Sheet21.Range("LTCG_115ACA1_10").value 'Updated-7
...
'LTCG 12.5% Added by Sai on 15/04/2025
        Sheet31.Range("BFLAtemp125Sec112_c").value = Sheet21.Range("LTCG_1121c").value 'Updated-8
        Sheet31.Range("BFLAtemp125Sec_115ACA").value = Sheet21.Range("LTCG_115ac1c").value 'Updated-6
        Sheet31.Range("BFLAtemp125Sec_115EB").value = Sheet21.Range("LTCG_PTI112a").value 'Updated-4
        Sheet31.Range("BFLAtemp125Sec_115EA").value = 0
        Sheet31.Range("BFLAtemp125Sec_115AC").value = Sheet21.Range("LTCG_115abc").value 'Updated-7
        Sheet31.Range("BFLAtemp125Sec_115AD_iii").value = Sheet21.Range("LTCG_115ad").value 'Updated-5
        Sheet31.Range("BFLAtemp125Sec_PTI").value = Sheet21.Range("LTCG_B12a2_125").value   'Updated-3
        Sheet31.Range("BFLAtemp125Sec_112_PTI").value = Sheet21.Range("LTCG_112aPTI").value 'Updated-2
        Sheet31.Range("BFLAtemp125Sec_112").value = Sheet21.Range("LTCG_1121").value 'Updated-9

        
        
        Sheet31.Range("BFLAtemp125Sec_112A").value = Sheet21.Range("LTCG_112a").value 'Updated-1
        Sheet31.Range("BFLAtemp125Sec_112sec_48").value = 0
        Sheet31.Range("BFLAtemp125SecPro").value = Sheet21.Range("LTCG_112b").value 'Updated-2a
'Added by Riyaz on 25/02/2026
        Sheet31.Range("BFLAtemp125Sec115AD3").value = Sheet21.Range("LTCG_115AD_125").value ' Updated for 6A

'LTCG-20%
       Sheet31.Range("BFLAtemp20SecPro").value = Sheet21.Range("LTCG112.IHLA").value 'Updated-1
       Sheet31.Range("BFLAtempPTI20").value = Sheet21.Range("LTCGPTI20.IHLA").value  'Updated-3
       Sheet31.Range("BFLAtemp20Sec112").value = Sheet21.Range("LTCGNP.IHLA").value  'Updated-2
...
Function ValidateHPlossSetoff_Upto2Lakhs() As Boolean
   ...
   ' HPlossCurYrSetoff_Upto2Lakhs = Sheet16.Range("Total_2XIII").value
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
...
'ii
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_ii() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_ii = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("hp.BFUnabsorbedDeprSetoff1").value > Sheet16.Range("hp.IncOfCurYrUndHeadFromCYLA1").value Then
             Sheet16.Range("hp.BFUnabsorbedDeprSetoff1").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no ii.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_ii = False
Exit Function
End If
End If
End Function
...
'ii
'Chandru
Function ValidateBroughtforalloundsec35_4_ii() As Boolean

      
        ValidateBroughtforalloundsec35_4_ii = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("hp.BFAllUs35Cl4Setoff1").value > Sheet16.Range("hp.IncOfCurYrUndHeadFromCYLA1").value Then
             Sheet16.Range("hp.BFAllUs35Cl4Setoff1").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no ii.")
        ValidateBroughtforalloundsec35_4_ii = False
Exit Function
End If
End If
End Function
...
'iv
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_iv() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_iv = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("busipofinclspec.BFUnabsorbedDeprSetoff2a").value > Sheet16.Range("busipofinclspec.IncOfCurYrUndHeadFromCYLA2a").value Then
             Sheet16.Range("busipofinclspec.BFUnabsorbedDeprSetoff2a").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no iv.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_iv = False
Exit Function
End If
End If
End Function

Function ValidateBroughtforalloundsec35_4_iv() As Boolean

      
        ValidateBroughtforalloundsec35_4_iv = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("busipofinclspec.BFAllUs35Cl4Setoff2a").value > Sheet16.Range("busipofinclspec.IncOfCurYrUndHeadFromCYLA2a").value Then
             Sheet16.Range("busipofinclspec.BFAllUs35Cl4Setoff2a").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no iv.")
        ValidateBroughtforalloundsec35_4_iv = False
Exit Function
End If
End If
End Function
...
'v
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_v() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_v = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("busipofinclspecified.BFUnabsorbedDeprSetoff2b").value > Sheet16.Range("busipofinclspecified.IncOfCurYrUndHeadFromCYLA2b").value Then
Sheet16.Range("busipofinclspecified.BFUnabsorbedDeprSetoff2b").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no v.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_v = False
Exit Function
End If
End If
End Function

Function ValidateBroughtforalloundsec35_4_v() As Boolean

      
        ValidateBroughtforalloundsec35_4_v = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("busipofinclspecified.BFAllUs35Cl4Setoff2b").value > Sheet16.Range("busipofinclspecified.IncOfCurYrUndHeadFromCYLA2b").value Then
             Sheet16.Range("busipofinclspecified.BFAllUs35Cl4Setoff2b").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no v.")
        ValidateBroughtforalloundsec35_4_v = False
Exit Function
End If
End If
End Function
...
'vi
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_vi() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_vi = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3").value Then
Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no via.") 'Updated by Bindu
        ValidateBroughtforwarddepreciationsetoff_BFLA_vi = False
Exit Function
End If
End If
End Function
Function ValidateBroughtforwarddepreciationsetoff_BFLA_vib() As Boolean 'Newly added by Bindu

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_vib = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3c").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3c").value Then
                Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3c").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no vib.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_vib = False
Exit Function
End If
End If
End Function
Function ValidateBroughtforalloundsec35_4_vi() As Boolean

      
        ValidateBroughtforalloundsec35_4_vi = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFAllUs35Cl4Setoff3").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3").value Then
             Sheet16.Range("stcg.BFAllUs35Cl4Setoff3").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no via.") 'Updated by Bindu
        ValidateBroughtforalloundsec35_4_vi = False
Exit Function
End If
End If
End Function
 Function ValidateBroughtforalloundsec35_4_vib() As Boolean 'Newly added by Bindu

      
        ValidateBroughtforalloundsec35_4_vib = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFAllUs35Cl4Setoff3_c").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3c").value Then
             Sheet16.Range("stcg.BFAllUs35Cl4Setoff3_c").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no vib.")
        ValidateBroughtforalloundsec35_4_vib = False
Exit Function
End If
End If
End Function
'vii
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_vii() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_vii = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3a").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3a").value Then
Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3a").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no vii.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_vii = False
Exit Function
End If
End If
End Function

Function ValidateBroughtforalloundsec35_4_vii() As Boolean

      
        ValidateBroughtforalloundsec35_4_vii = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFAllUs35Cl4Setoff3a").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3a").value Then
             Sheet16.Range("stcg.BFAllUs35Cl4Setoff3a").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no vii.")
        ValidateBroughtforalloundsec35_4_vii = False
Exit Function
End If
End If
End Function
...
'viii
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_viii() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_viii = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3b").value Then
Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no viii.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_viii = False
Exit Function
End If
End If
End Function

Function ValidateBroughtforalloundsec35_4_viii() As Boolean

      
        ValidateBroughtforalloundsec35_4_viii = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3b").value Then
             Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no viii.")
        ValidateBroughtforalloundsec35_4_viii = False
Exit Function
End If
End If
End Function
...
'ix
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_ix() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_ix = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b_DTAARates").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3b_DTAARates").value Then
Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b_DTAARates").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no ix.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_ix = False
Exit Function
End If
End If
End Function

Function ValidateBroughtforalloundsec35_4_ix() As Boolean

      
        ValidateBroughtforalloundsec35_4_ix = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b_DTAARates").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3b_DTAARates").value Then
             Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b_DTAARates").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no ix.")
        ValidateBroughtforalloundsec35_4_ix = False
Exit Function
End If
End If
End Function
...
'x
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_x() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_x = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4").value Then
Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no xa.") 'Updated by Bindu
        ValidateBroughtforwarddepreciationsetoff_BFLA_x = False
Exit Function
End If
End If
End Function
Function ValidateBroughtforwarddepreciationsetoff_BFLA_xb() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_xb = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4b").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4b").value Then
Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4b").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no xb.") 'Updated by Bindu
        ValidateBroughtforwarddepreciationsetoff_BFLA_xb = False
Exit Function
End If
End If
End Function
Function ValidateBroughtforalloundsec35_4_x() As Boolean

      
        ValidateBroughtforalloundsec35_4_x = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4").value Then
             Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no xa.") 'Updated by Bindu
        ValidateBroughtforalloundsec35_4_x = False
Exit Function
End If
End If
End Function
 Function ValidateBroughtforalloundsec35_4_xb() As Boolean 'Newly added by Bindu

      
        ValidateBroughtforalloundsec35_4_xb = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4_c").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4b").value Then
             Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no xb.")
        ValidateBroughtforalloundsec35_4_xb = False
Exit Function
End If
End If
End Function
'xi
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_xi() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_xi = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4a").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4a").value Then
Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4a").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no xi.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_xi = False
Exit Function
End If
End If
End Function

Function ValidateBroughtforalloundsec35_4_xi() As Boolean

      
        ValidateBroughtforalloundsec35_4_xi = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4a").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4a").value Then
             Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4a").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no xi.")
        ValidateBroughtforalloundsec35_4_xi = False
Exit Function
End If
End If
End Function
...
'xii
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_xii() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_xii = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff_DTAARates").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4a_DTAARates").value Then
Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff_DTAARates").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no xii.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_xii = False
Exit Function
End If
End If
End Function

Function ValidateBroughtforalloundsec35_4_xii() As Boolean

      
        ValidateBroughtforalloundsec35_4_xii = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFAllUs35Cl4Setoff_DTAARates").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4a_DTAARates").value Then
             Sheet16.Range("ltcg.BFAllUs35Cl4Setoff_DTAARates").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no xii.")
        ValidateBroughtforalloundsec35_4_xii = False
Exit Function
End If
End If
End Function
...
'xiii
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_xiii() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_xiii = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("othsrcincl.BFUnabsorbedDeprSetoff5").value > Sheet16.Range("othsrcincl.IncOfCurYrUndHeadFromCYLA5").value Then
Sheet16.Range("othsrcincl.BFUnabsorbedDeprSetoff5").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no xiii.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_xiii = False
Exit Function
End If
End If
End Function

Function ValidateBroughtforalloundsec35_4_xiii() As Boolean

      
        ValidateBroughtforalloundsec35_4_xiii = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("othsrcincl.BFAllUs35Cl4Setoff5").value > Sheet16.Range("othsrcincl.IncOfCurYrUndHeadFromCYLA5").value Then
             Sheet16.Range("othsrcincl.BFAllUs35Cl4Setoff5").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no xiii.")
        ValidateBroughtforalloundsec35_4_xiii = False
Exit Function
End If
End If
End Function
...
'xiv
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_xiv() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_xiv = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("rh.BFUnabsorbedDeprSetoff6").value > Sheet16.Range("rh.IncOfCurYrUndHeadFromCYLA6").value Then
Sheet16.Range("rh.BFUnabsorbedDeprSetoff6").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no xiv.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_xiv = False
Exit Function
End If
End If
End Function

Function ValidateBroughtforalloundsec35_4_xiv() As Boolean

      
        ValidateBroughtforalloundsec35_4_xiv = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("rh.BFAllUs35Cl4Setoff6").value > Sheet16.Range("rh.IncOfCurYrUndHeadFromCYLA6").value Then
             Sheet16.Range("rh.BFAllUs35Cl4Setoff6").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no xiv.")
        ValidateBroughtforalloundsec35_4_xiv = False
Exit Function
End If
End If
End Function
...
'xv
'Chandru
Function ValidateBroughtforwarddepreciationsetoff_BFLA_xv() As Boolean

      
        ValidateBroughtforwarddepreciationsetoff_BFLA_xv = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("rh.BFUnabsorbedDeprSetoff_DTAARates").value > Sheet16.Range("rh.IncOfCurYrUndHeadFromCYLA_DTAARates").value Then
Sheet16.Range("rh.BFUnabsorbedDeprSetoff_DTAARates").value = 0
             msgbox16 ("* Value of column no 3 cannot be more than amount as referred in column 1 for Sl no xv.")
        ValidateBroughtforwarddepreciationsetoff_BFLA_xv = False
Exit Function
End If
End If
End Function

Function ValidateBroughtforalloundsec35_4_xv() As Boolean

      
        ValidateBroughtforalloundsec35_4_xv = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("rh.BFAllUs35Cl4Setoff_DTAARates").value > Sheet16.Range("rh.IncOfCurYrUndHeadFromCYLA_DTAARates").value Then
             Sheet16.Range("rh.BFAllUs35Cl4Setoff_DTAARates").value = 0
             msgbox16 ("* Value of column no 4 cannot be more than amount as referred in column 1 for Sl no xv.")
        ValidateBroughtforalloundsec35_4_xv = False
Exit Function
End If
End If
End Function
...
Function ValidateBroughtforwardlosssetoff_BFLA_iii() As Boolean
    ...
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("BFlossPrevYrUndSameHeadSetoff3a").value > Sheet16.Range("busipofincl.IncOfCurYrUndHeadFromCYLA2").value Then
             Sheet16.Range("BFlossPrevYrUndSameHeadSetoff3a").value = 0
...
Function ValidateBroughtforwardlosssetoff_BFLA_iv() As Boolean
    ...
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("busipofinclspec.BFlossPrevYrUndSameHeadSetoff2a").value > Sheet16.Range("busipofinclspec.IncOfCurYrUndHeadFromCYLA2a").value Then
             Sheet16.Range("busipofinclspec.BFlossPrevYrUndSameHeadSetoff2a").value = 0
...
Function ValidateBroughtforwardlosssetoff_BFLA_v() As Boolean
    ...
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("busipofinclspecified.BFlossPrevYrUndSameHeadSetoff2b").value > Sheet16.Range("busipofinclspecified.IncOfCurYrUndHeadFromCYLA2b").value Then
             Sheet16.Range("busipofinclspecified.BFlossPrevYrUndSameHeadSetoff2b").value = 0
...
Function ValidateBroughtforwardlosssetoff_BFLA_vi() As Boolean
    ...
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3").value Then
             ...
             msgbox16 ("* Value of column no 2 cannot be more than amount as referred in column 1 for Sl no via.") 'Updated by Bindu
        ValidateBroughtforwardlosssetoff_BFLA_vi = False
Exit Function
End If
End If
End Function
 Function ValidateBroughtforwardlosssetoff_BFLA_vib() As Boolean 'Newly added by Bindu

      
        ValidateBroughtforwardlosssetoff_BFLA_vib = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3c").value > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3c").value Then
             Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3c").value = 0
             msgbox16 ("* Value of column no 2 cannot be more than amount as referred in column 1 for Sl no vib.")
        ValidateBroughtforwardlosssetoff_BFLA_vib = False
Exit Function
End If
End If
End Function
...
'x
 'Chandru
Function ValidateBroughtforwardlosssetoff_BFLA_x() As Boolean

      
        ValidateBroughtforwardlosssetoff_BFLA_x = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4").value Then
             ...
             msgbox16 ("* Value of column no 2 cannot be more than amount as referred in column 1 for Sl no xa.") 'Newly updated by Bindu
        ValidateBroughtforwardlosssetoff_BFLA_x = False
Exit Function
End If
End If
End Function
 Function ValidateBroughtforwardlosssetoff_BFLA_xb() As Boolean 'Newly added by Bindu

      
        ValidateBroughtforwardlosssetoff_BFLA_xb = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4b").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4b").value Then
             ...
             msgbox16 ("* Value of column no 2 cannot be more than amount as referred in column 1 for Sl no xb.")
        ValidateBroughtforwardlosssetoff_BFLA_xb = False
Exit Function
End If
End If
End Function
'xi
  'Chandru
Function ValidateBroughtforwardlosssetoff_BFLA_xi() As Boolean

      
        ValidateBroughtforwardlosssetoff_BFLA_xi = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4a").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4a").value Then
             ...
             msgbox16 ("* Value of column no 2 cannot be more than amount as referred in column 1 for Sl no xi.")
        ValidateBroughtforwardlosssetoff_BFLA_xi = False
Exit Function
End If
End If
End Function
...
'Chandru
Function ValidateBroughtforwardlosssetoff_BFLA_xii() As Boolean

      
        ValidateBroughtforwardlosssetoff_BFLA_xii = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff_DTAARates").value > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4a_DTAARates").value Then
         Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff_DTAARates").value = 0
             msgbox16 ("* Value of column no 2 cannot be more than amount as referred in column 1 for Sl no xii.")
        ValidateBroughtforwardlosssetoff_BFLA_xii = False
Exit Function
End If
End If
End Function
...
Function ValidateBFLA_LongtermShortterm_Limit_CFL() As Boolean
        ...
        Sheet16.Range("LTCG_TOTAL_LOSS").value > Sheet17.Range("totofbfloss.STCGLossCF8").value + Sheet17.Range("totofbfloss.LTCGLossCF8").value Then
...
End Function
 ...
 'Malli
 Function Validatesumfwdloss_fwddepr_fwdallowundsec35_4_setoffs() As Boolean

      
        Validatesumfwdloss_fwddepr_fwdallowundsec35_4_setoffs = True
    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
         If (Sheet16.Range("hp.BFlossPrevYrUndSameHeadSetoff1").value + Sheet16.Range("hp.BFUnabsorbedDeprSetoff1").value + Sheet16.Range("hp.BFAllUs35Cl4Setoff1").value) > Sheet16.Range("hp.IncOfCurYrUndHeadFromCYLA1").value Then
    Sheet16.Range("hp.BFUnabsorbedDeprSetoff1", "hp.BFAllUs35Cl4Setoff1").value = 0
    'MsgBox ("The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1")
     msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
Validatesumfwdloss_fwddepr_fwdallowundsec35_4_setoffs = False

End If

'-----------------------------------------------2

If (Sheet16.Range("BFlossPrevYrUndSameHeadSetoff3a").value + Sheet16.Range("busipofincl.BFUnabsorbedDeprSetoff2").value + Sheet16.Range("busipofincl.BFAllUs35Cl4Setoff2").value) > Sheet16.Range("busipofincl.IncOfCurYrUndHeadFromCYLA2").value Then
    'Sheet16.Range("BFlossPrevYrUndSameHeadSetoff3a", "busipofincl.BFAllUs35Cl4Setoff2").value = 0
    Sheet16.Range("BFlossPrevYrUndSameHeadSetoff3a").value = 0
    msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
    Validatesumfwdloss_fwddepr_fwdallowundsec35_4_setoffs = False
...
End If
'-----------------------------------------------3
If (Sheet16.Range("busipofinclspec.BFlossPrevYrUndSameHeadSetoff2a").value + Sheet16.Range("busipofinclspec.BFUnabsorbedDeprSetoff2a").value + Sheet16.Range("busipofinclspec.BFAllUs35Cl4Setoff2a").value) > Sheet16.Range("busipofinclspec.IncOfCurYrUndHeadFromCYLA2a").value Then
    Sheet16.Range("busipofinclspec.BFlossPrevYrUndSameHeadSetoff2a", "busipofinclspec.BFAllUs35Cl4Setoff2a").value = 0
   msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
    Validatesumfwdloss_fwddepr_fwdallowundsec35_4_setoffs = False
...
If (Sheet16.Range("busipofinclspecified.BFlossPrevYrUndSameHeadSetoff2b").value + Sheet16.Range("busipofinclspecified.BFUnabsorbedDeprSetoff2b").value + Sheet16.Range("busipofinclspecified.BFAllUs35Cl4Setoff2b").value) > Sheet16.Range("busipofinclspecified.IncOfCurYrUndHeadFromCYLA2b").value Then
    Sheet16.Range("busipofinclspecified.BFlossPrevYrUndSameHeadSetoff2b", "busipofinclspecified.BFAllUs35Cl4Setoff2b").value = 0
    msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
Validatesumfwdloss_fwddepr_fwdallowundsec35_4_setoffs = False
End If
...
If (Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3").value + Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3").value + Sheet16.Range("stcg.BFAllUs35Cl4Setoff3").value) > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3").value Then
    Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3", "stcg.BFAllUs35Cl4Setoff3").value = 0
   msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
...
If (Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3a").value + Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3a").value + Sheet16.Range("stcg.BFAllUs35Cl4Setoff3a").value) > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3a").value Then
    Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3a", "stcg.BFAllUs35Cl4Setoff3a").value = 0
    msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
Validatesumfwdloss_fwddepr_fwdallowundsec35_4_setoffs = False
End If
...
If (Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3b").value + Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b").value + Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b").value) > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3b").value Then
    Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3b", "stcg.BFAllUs35Cl4Setoff3b").value = 0
 msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
...
If (Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3b_DTAARates").value + Sheet16.Range("stcg.BFUnabsorbedDeprSetoff3b_DTAARates").value + Sheet16.Range("stcg.BFAllUs35Cl4Setoff3b_DTAARates").value) > Sheet16.Range("stcg.IncOfCurYrUndHeadFromCYLA3b_DTAARates").value Then
    Sheet16.Range("stcg.BFlossPrevYrUndSameHeadSetoff3b_DTAARates", "stcg.BFAllUs35Cl4Setoff3b_DTAARates").value = 0
   msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
...
If (Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4").value + Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4").value + Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4").value) > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4").value Then
    Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4", "ltcg.BFAllUs35Cl4Setoff4").value = 0
  msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
...
If (Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4a").value + Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff4a").value + Sheet16.Range("ltcg.BFAllUs35Cl4Setoff4a").value) > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4a").value Then
    Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff4a", "ltcg.BFAllUs35Cl4Setoff4a").value = 0
  msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
    Validatesumfwdloss_fwddepr_fwdallowundsec35_4_setoffs = False
...
If (Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff_DTAARates").value + Sheet16.Range("ltcg.BFUnabsorbedDeprSetoff_DTAARates").value + Sheet16.Range("ltcg.BFAllUs35Cl4Setoff_DTAARates").value) > Sheet16.Range("ltcg.IncOfCurYrUndHeadFromCYLA4a_DTAARates").value Then
    Sheet16.Range("ltcg.BFlossPrevYrUndSameHeadSetoff_DTAARates", "ltcg.BFAllUs35Cl4Setoff_DTAARates").value = 0
msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
...
If (Sheet16.Range("othsrcincl.BFUnabsorbedDeprSetoff5").value + Sheet16.Range("othsrcincl.BFAllUs35Cl4Setoff5").value) > Sheet16.Range("othsrcincl.IncOfCurYrUndHeadFromCYLA5").value Then
    Sheet16.Range("othsrcincl.BFUnabsorbedDeprSetoff5", "othsrcincl.BFAllUs35Cl4Setoff5").value = 0
 msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
...
If (Sheet16.Range("rh.BFlossPrevYrUndSameHeadSetoff6").value + Sheet16.Range("rh.BFUnabsorbedDeprSetoff6").value + Sheet16.Range("rh.BFAllUs35Cl4Setoff6").value) > Sheet16.Range("rh.IncOfCurYrUndHeadFromCYLA6").value Then
    Sheet16.Range("rh.BFlossPrevYrUndSameHeadSetoff6", "rh.BFAllUs35Cl4Setoff6").value = 0
 msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
   Validatesumfwdloss_fwddepr_fwdallowundsec35_4_setoffs = False
...
If (Sheet16.Range("rh.BFUnabsorbedDeprSetoff_DTAARates").value + Sheet16.Range("rh.BFAllUs35Cl4Setoff_DTAARates").value) > Sheet16.Range("rh.IncOfCurYrUndHeadFromCYLA_DTAARates").value Then
    Sheet16.Range("rh.BFUnabsorbedDeprSetoff_DTAARates", "rh.BFAllUs35Cl4Setoff_DTAARates").value = 0
msgbox16 ("* ""The sum of Column No. 2 + 3 + 4 should not exceed amount as referred in Column No. 1""")
...
'
''        If Sheet16.Range("sheet16.BalHPlossCurYrAftSetoff").value > 0 Or Sheet16.Range("Total_Column5").value > 0 Then
''Modified newly
'If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
'    If Sheet16.Range("sheet16.TotHPlossCurYrSetoff").value < 200000 Then 'SIT-93319 by sai on 22/05/2025
'        If Sheet16.Range("sheet16.BalHPlossCurYrAftSetoff").value > 0 Then
'            If Sheet16.Range("Total_Column5").value > 0 Then
...
'        ValidateEntireLossSetOff_CYLA = True
'
''IPIP-78460 by Sadineni on 18/11/2025
''*************************************************************************************
'If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
'
'     If Sheet16.Range("cyla.TotHPlossCurYr").value < 200000 Then
'            If Sheet16.Range("sheet16.TotHPlossCurYrSetoff").value > Sheet16.Range("cyla.TotHPlossCurYr").value Then
'                    msgbox16 """entire loss is not set off """
'                    ValidateEntireLossSetOff_CYLA = False
'                    Exit Function
'             End If
...
'IPIP-78460 by Sadineni on 19/11/2025
...
If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
     ...
     If Sheet16.Range("cyla.TotHPlossCurYr").value < 200000 Then
        ...
        'Changed as Per Shubham on 19/11/2025

                  msgbox16 """Total loss set off cannot exceed losses that can be set-off """
...
Function ValidateBFLA_STCG_Limit() As Boolean
        ...
        If Sheet17.Range("totcfloss.STCGLossCF11").value > 0 Then
            ...
            If Sheet16.Range("BFLA_Col5_Total").value > 0 Then
...
If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet17.Range("totcfloss.LTCGLossCF11").value > 0 Then
         ...
         If Sheet16.Range("LTCG_Col5_Total").value > 0 Then
...
'Newly added by sai on 03/04/2024
Function ValidateBFLA_BFSL_Limit() As Boolean

        ValidateBFLA_BFSL_Limit = True
If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet17.Range("totcfloss.LossFrmSpecBusCF11").value > 0 Then
         
'         If Sheet16.Range("BFLA_1_Col3_Total").value > 0 Then
          If Sheet16.Range("BFSL_Col3_Total").value > 0 Then 'Newly added by sai on 14/11/2024
        
            msgbox16 ("* ""Maximum Speculative business losses has not been setoff"" ")

        ValidateBFLA_BFSL_Limit = False
Exit Function
End If
End If
End If
...
Function ValidateBFLA_BFSD_Limit() As Boolean

        ValidateBFLA_BFSD_Limit = True
If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet17.Range("totcfloss.LossFrmSpecifiedBusCF11").value > 0 Then
         
'         If Sheet16.Range("BFLA_1_Col3_Total").value > 0 Then
          If Sheet16.Range("BFSD_Col3_Total").value > 0 Then 'Newly added by sai on 14/11/2024
        
            msgbox16 ("* ""Maximum Specified business losses has not been setoff"" ")

        ValidateBFLA_BFSD_Limit = False
Exit Function
End If
End If
End If
...
'Newly added by sai on 03/04/2024
Function ValidateBFLA_BFSL_LessthanCFL_BFSL() As Boolean

        ValidateBFLA_BFSL_LessthanCFL_BFSL = True
        If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("BFSL_TOTAL_LOSS").value < Sheet16.Range("BFSL_Income").value Then
        
        If Sheet16.Range("BFSL_TOTAL_LOSS").value < Sheet17.Range("yr2023.LossFrmSpecBusCF13").value Then
                     msgbox16 ("* ""Maximum Speculative business losses has not been setoff"" ")
                ValidateBFLA_BFSL_LessthanCFL_BFSL = False
        Exit Function
...
Function ValidateBFLA_BFSD_LessthanCFL_BFSD() As Boolean

        ValidateBFLA_BFSD_LessthanCFL_BFSD = True
        If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("BFSD_TOTAL_LOSS").value < Sheet16.Range("BFSD_Income").value Then
        
        If Sheet16.Range("BFSD_TOTAL_LOSS").value < Sheet17.Range("yr2023.LossFrmSpecifiedBusCF13").value Then
                     msgbox16 ("* ""Maximum Specified business losses has not been setoff"" ")
                ValidateBFLA_BFSD_LessthanCFL_BFSD = False
        Exit Function
...
'Newly added by sai on 03/04/2024
Function ValidateBFLA_BFNB_LessthanCFL_BFNB() As Boolean

        ValidateBFLA_BFNB_LessthanCFL_BFNB = True
        If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
    If Sheet16.Range("STLT_1_Total").value <> Sheet16.Range("BFF_Total_Loss").value Then
    

        If Sheet16.Range("BFNB_TOTAL_LOSS").value <> Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13a").value Then
          If Sheet16.Range("BFF_Total_Loss").value > Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13a").value _
           Or Sheet16.Range("BFNB_TOTAL_LOSS").value < Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13a").value Then
    

        If (Sheet16.Range("BFF_Total_Loss").value - Sheet17.Range("yr2023.LossFrmSpecBusCF13").value - Sheet17.Range("yr2023.LossFrmSpecifiedBusCF13").value) < Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13a").value Then
                     msgbox16 ("* ""Maximum Normal business losses has not been setoff"" ")
                ValidateBFLA_BFNB_LessthanCFL_BFNB = False
        Exit Function
        End If
...
'Newly added by sai on 03/04/2024
Function ValidateBFLA_BFNBaBFSLaBFSD_Limit_CFL() As Boolean
      
      Bussiness_Loss_Flag = True
        ValidateBFLA_BFNBaBFSLaBFSD_Limit_CFL = True
If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If (Sheet16.Range("BFF_Total_Loss").value > Sheet16.Range("TOTBFNB").value + Sheet17.Range("totofbfloss.LossFrmSpecBusCF8").value + Sheet17.Range("totofbfloss.LossFrmSpecifiedBusCF8").value) Or _
        Sheet16.Range("BFSL_TOTAL_LOSS").value > Sheet16.Range("TOTBFNB").value + Sheet17.Range("totofbfloss.LossFrmSpecBusCF8").value Or _
         Sheet16.Range("BFSD_TOTAL_LOSS").value > Sheet16.Range("TOTBFNB").value + Sheet17.Range("totofbfloss.LossFrmSpecifiedBusCF8").value Or _
        Sheet16.Range("BFNB_TOTAL_LOSS").value > Sheet16.Range("TOTBFNB").value Then
             msgbox16 ("* ""Losses set off cannot be more than the losses brought forward from previous years in Schedule CFL."" ")
             'Bussiness_Loss_Flag = False
        ValidateBFLA_BFNBaBFSLaBFSD_Limit_CFL = False
Exit Function
End If
End If
End Function
...
'Newly added by sai on 03/04/2024
Function ValidateBFLA_BFNB_Limit() As Boolean

        ValidateBFLA_BFNB_Limit = True
If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
        If Sheet16.Range("TOTBFNB").value > 0 Then
         
         If Sheet16.Range("BFLA_1_Col3_Total").value < 0 Then
        
            msgbox16 ("* ""Maximum normal business losses has not been setoff"" ")

        ValidateBFLA_BFNB_Limit = False
Exit Function
End If
End If
End If
...
'Malli-------29/05/2024
Function ValidateBroughtForwardLossSetoff_44BBA() As Boolean
        
        ValidateBroughtForwardLossSetoff_44BBA = True
 If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
         If Sheet16.Range("BFlossPrevYrUndSameHeadSetoff3a").value + Sheet16.Range("busipofincl.BFUnabsorbedDeprSetoff2").value > Sheet16.Range("BLLoss_44BB").value Then
         'As per Abhijeeth confirmation error message changed by Malli
            'B/F business loss and depreciation set off will be restricted to business income excluding income u/s 44BB & 44BBB
            'msgbox16 ("* ""Losses set off cannot be more than the losses brought forward from previous years in Schedule CFL."" ")
            '44BBD Added by Riyaz on 04/06/2026
            msgbox16 ("* ""B/F business loss and depreciation set off will be restricted to business income excluding income u/s 44BB & u/s 44BBD.""")
            ValidateBroughtForwardLossSetoff_44BBA = False
            Exit Function
         End If
 End If
 ...
 Dim Business_Dummy
 Business_Dummy = WorksheetFunction.Min(Sheet16.Range("busipofincl.BFAllUs35Cl4Setoff2").value, Sheet9.Range("Sheet11.Section44BB").value, Sheet9.Range("Sheet11.Section44BBD").value)


'Commented by Riyaz on 04/06/2026
'If Sheet16.Range("BFF_Total_Loss").value < Sheet17.Range("totofbfloss.BusLossOthThanSpecLossCF8").value Then
'
'    If Sheet16.Range("sheet16.BFLA_Edit").value = "Yes" Then
'      If (Sheet16.Range("busipofinclspec.IncOfCurYrAfterSetOffBFLosses2a").value + Sheet16.Range("busipofinclspecified.IncOfCurYrAfterSetOffBFLosses2b").value) = 0 And ((Sheet16.Range("busipofincl.IncOfCurYrAfterSetOffBFLosses2").value + Business_Dummy) - Sheet9.Range("Sheet11.Section44BB").value) > 0 Then
'          msgbox16 ("* ""Maximum normal business losses has not been setoff"" ")
'          ValidateBroughtForwardLossSetoff_44BBA = False
'      End If
'    End If
...
'New Requirement added by sai on 14/06/2024 as per Madhu

Function ValidateUD() As Boolean
ValidateUD = True
...
TotSetoff_UD2 = Sheet15.Range("UD2.TotSetoff").value
    ...
    If IIf(TotSetoff_UD = "", 0, TotSetoff_UD) <> BFLA_TOTDepreciationLossSetOff Then
        'msgbox16 ("* Amount of depreciation setoff against current year income must match with Total of brought forward depreciation set off in Sch BFLA")
        
    'Error message updated as per Madhu/ Shubham
         msgbox16 ("* Total of brought forward depreciation set off (Sl. No. 3(xvi) in Schedule BFLA must be equal to total of Column No. 4 of Schedule Unabsorbed Depreciation")
       ValidateUD = False
'        Exit Function
    End If
    ...
    If IIf(TotSetoff_UD2 = "", 0, TotSetoff_UD2) <> BFLA_TOTAllowanceLossSetOff Then
        'msgbox16 ("* Amount of allowance setoff against current year income must match with Total of brought forward allowance u/s 35(4) set off in Sch BFLA")
        
    'Error message updated as per Madhu/ Shubham
         msgbox16 ("* Total of brought forward allowance u/s 35(4) set off (Sl. No. 4(xvi) in Schedule BFLA must be equal to total of Column No. 7 of Schedule Unabsorbed Depreciation")
        ValidateUD = False
'        Exit Function
    End If
End Function
