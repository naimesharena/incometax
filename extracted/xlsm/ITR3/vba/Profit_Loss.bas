...
Public GrossTurnover1band1C As Variant
Public GrossTurnover62band62C As Variant
'''''''

'added by Chetan C M on 29/01/2026 for AY 2026-27'''''
Public GrossReceipt_PL As Variant
Public NetProfit_PL As Variant
'''''''''''


'Malli_01/10/2025
Public errorMsg_NOB8 As String
'---------------

Public errorMsg_NOB1, errorMsg_NOB2, errorMsg_NOB3, errorMsg_NOB5, errorMsg_NOB6, msgError As Variant
...
Public TempPL_61a_1b, TempPL_62iA, TempPL_62iB, TempPL_62iC As Variant 'Newly added by Sai
...
Sub CmdValidate_PL_Click()
    ValidateSheet_PL
    'CmdValidate_PL_Clicks
    fmsgboxStatus "Sheet Profit Loss is ok"
    'errorMsg_NOB6
   ' fmsgboxStatus (errorMsg_NOB6)
    
CloseMsg
End Sub
'Malli
'Function CmdValidate_PL_Clicks()
'    ValidateSheet_PL
'    'fmsgboxStatus "Sheet Profit Loss is ok"
'    'errorMsg_NOB6
'    fmsgboxStatus (errorMsg_NOB6)
...
noOfProcessSub = 7
    ...
    'Malli_01/10/2025
If Not ValidateGrspft_transferred_frmTradingAcnt Then
    Sheet4.Activate
       fmsgboxsmall (errorMsg_NOB8)
    CloseMsg
End If
    '----------------
...
If Not ValidateSecGROSSTURNOVER Then   'Newly added by Sai

'If Not ValidateSecGrossReceipts Then
    Sheet4.Activate
    fmsgboxsmall (errorMsg_NOB6)
    CloseMsg
'End If
End If

  
  If Not ValidateSecGrossReceipts Then   'Newly added by Sai
    Sheet4.Activate
    fmsgboxsmall (errorMsg_NOB6)
    CloseMsg
  End If
...
'start--
    ...
    If Not ValidateNetProfit_PL Then
        Sheet4.Activate
        fmsgboxsmall (errorMsg_NOB6)
        CloseMsg
    End If
...
'        End If
        ...
        If amountCheck Then
            ...
            End If
        End If
'Change-08.06.2023.101 -> SIT-53663
...
ValidateAmt_39 = True
    ...
    For i = 1 To ColCount_PAN39
        ...
        If Not chkCompulsory(Amt39_PL(i)) Then
            MsgBx_BadDept39 = MsgBx_BadDept39 + "* ""Please enter the amount of Bad Debts at Point-47 in schedule Profit and Loss A/c""" & Chr(13)
...
'        If PL_Address_State(i) <> "99-STATE OUTSIDE INDIA" Then
        If PL_Address_State(i) <> "99-Foreign" Then
...
'        errorMsg_NOB1 = errorMsg_NOB1 & "Please fill all the mandatory fields in table under section 44AD in schedule Profit & Loss A/c"
        errorMsg_NOB1 = errorMsg_NOB1 & """Please enter Name of Business in schedule Profit and Loss A/c"""
...
'        errorMsg_NOB2 = errorMsg_NOB2 & "Please fill all the mandatory fields in table under section 44ADA in schedule Profit & Loss A/c"
        errorMsg_NOB2 = errorMsg_NOB2 & """Please enter Name of Business in schedule Profit and Loss A/c"""
...
'        errorMsg_NOB3 = errorMsg_NOB3 & "Please fill all the mandatory fields in table under section 44AE in schedule Profit & Loss A/c"
        ...
        errorMsg_NOB3 = errorMsg_NOB3 & """Please enter Name of Business in schedule Profit and Loss A/c"""
...
For cntr = 1 To end44AE_RegNo
 ...
 'Else  'Malli commented 03/10/2025
...
For i = 1 To end44AE_RegNo
        ...
        '-----
                ...
                If Not checkfieldspecialcharacter1((i)) Then
...
Function ValidateNetProfit_PL() As Boolean
    ValidateNetProfit_PL = True
   
    
    NetProfit_PL = Sheet4.Range("PL.NetProfit").value
    
     
        Dim value44b As Double
        value44b = Sheet4.Range("PL.GrossReceipt44B").value
        value44b = value44b * 0.075
        If Sheet4.Range("PL.NetProfit44B").value < value44b Then
            errorMsg_NOB6 = errorMsg_NOB6 & "Income offered in section 44B can not be less than 7.5% gross receipt(turnover)." & Chr(13)
           ValidateNetProfit_PL = False
            
        End If
 
 
        Dim value44bb As Double
        value44bb = Sheet4.Range("PL.GrossReceipt44BB").value
        value44bb = value44bb * 0.1
        If Sheet4.Range("PL.NetProfit44BB").value < value44bb Then
            errorMsg_NOB6 = errorMsg_NOB6 & "Income offered in section 44BB can not be less than 10% gross receipt(turnover)." & Chr(13)
    ValidateNetProfit_PL = False
            
        End If
     
  
        Dim value44bba As Double
        value44bba = Sheet4.Range("PL.GrossReceipt44BBA").value
        value44bba = value44bba * 0.05
        If Sheet4.Range("PL.NetProfit44BBA").value < value44bba Then
            errorMsg_NOB6 = errorMsg_NOB6 & "Income offered in section 44BBA can not be less than 5% gross receipt(turnover)." & Chr(13)
    ValidateNetProfit_PL = False
            
        End If
        
   
        Dim value44bbc As Double
        value44bbc = Sheet4.Range("PL.GrossReceipt44BBC").value
        value44bbc = value44bbc * 0.2
        If Sheet4.Range("PL.NetProfit44BBC").value < value44bbc Then
            errorMsg_NOB6 = errorMsg_NOB6 & "Income offered in section 44BBC can not be less than 20% gross receipt(turnover)." & Chr(13)
    ValidateNetProfit_PL = False
            
        End If
        
   
        Dim value44bbd As Double
        value44bbd = Sheet4.Range("PL.GrossReceipt44BBD").value
        value44bbd = value44bbd * 0.25
        If Sheet4.Range("PL.NetProfit44BBD").value < value44bbd Then
            errorMsg_NOB6 = errorMsg_NOB6 & "Income offered in section 44BBD can not be less than 25% gross receipt(turnover)." & Chr(13)
    ValidateNetProfit_PL = False
            
        End If
        
    If Sheet4.Range("PL.GrossReceipt").value < Sheet4.Range("PL.NetProfit").value Then
        errorMsg_NOB6 = errorMsg_NOB6 + "* ""Please recheck Net profit at Sl. No. 66 of Schedule Profit and Loss. It cannot be less than the Gross receipts/ Turnover""" & Chr(13)
        ValidateNetProfit_PL = False
    End If
    
    If Sheet4.Range("PL.NetProfit").value > 0 And Sheet4.Range("PL.GrossReceipt").value = 0 Or Sheet4.Range("PL.GrossReceipt").value = "" Then
        errorMsg_NOB6 = errorMsg_NOB6 + "* ""Please enter Gross receipts/ Turnover at Sl. No. 66 of Schedule Profit and Loss""" & Chr(13)
        ValidateNetProfit_PL = False
    End If
    
    If Sheet4.Range("PL.GrossReceipt").value > 0 And Sheet4.Range("PL.NetProfit").value = 0 Or Sheet4.Range("PL.NetProfit").value = "" Then
        errorMsg_NOB6 = errorMsg_NOB6 + "* ""Please enter net profit at Sl. No. 66 against the Gross receipts/ Turnover in Schedule Profit and Loss""" & Chr(13)
        ValidateNetProfit_PL = False
    End If
...
'Added by Aavula Naresh AY 2025-26
GrossTurnover1band1C = Range("PL_61a_1b") + Range("PL_61b").value
GrossTurnover62band62C = Range("PL_62i_B") + Range("PL_62i_C").value
'''''''''

TempPL_61i = Sheet4.Range("PL_61i").value
TempPL_61a = Sheet4.Range("PL_61a").value
'=============================================
TempPL_61a_1b = Sheet4.Range("PL_61a_1b").value 'Newly added by Sai For AY 2024-25
'==================================================================================
...
'Newly added by Sai For AY 2024-25==================================
  TempPL_62iA = Sheet4.Range("PL_62iA").value
  TempPL_62iB = Sheet4.Range("PL_62iB").value
  TempPL_62iC = Sheet4.Range("PL_62iC").value
'===================================================================
...
errorMsg_NOB6 = errorMsg_NOB6 + "* ""61(iiA) can not be greater than 61(iA) in schedule Profit and Loss A/c""" & Chr(13)
...
'Newly added by Sai For AY 2024-25============================================================
If TempPL_61iib > 0 Then
  If TempPL_61a_1b = "" Or TempPL_61b = "" Then
   errorMsg_NOB6 = errorMsg_NOB6 + "* ""Invalid presumptive income under 44AD, as sum of 61(iB)+61(iC) is less than 61(iiB)" & Chr(13)
   End If
End If
'==============================================================================================
...
'Error message updated by Sai For AY 2024-25
errorMsg_NOB6 = errorMsg_NOB6 + "* Since the income is less than 6% of 61(i)(A),you are not entitled to avail the benefit of section 44AD" & Chr(13)
Exit Function
End If
...
'Newly modified by Sai For AY 2024-25=====================================================
If TempPL_61iib > TempPL_61b + TempPL_61a_1b Then
errorMsg_NOB6 = errorMsg_NOB6 + "* ""61(iiB) can not be greater than 61(iB) & 61(iC) in schedule Profit and Loss A/c"""
Exit Function
End If
'=========================================================================================
...
'newly added by sai For AY 2024-25=========================================================================
   If TempPL_61iib < (0.08 * (TempPL_61a_1b + TempPL_61b)) Then
   errorMsg_NOB6 = errorMsg_NOB6 + "* ""Since the income is less than 8% of 61(iB) & 61(iC) you are not entitled to avail the benefit of section 44AD" & Chr(13)
   Exit Function
   End If
'===========================================================================================================
...
errorMsg_NOB6 = errorMsg_NOB6 + "* ""Please enter Gross Profit from Speculative Activity in schedule Profit and Loss A/c""" & Chr(13)
...
errorMsg_NOB6 = errorMsg_NOB6 + "* ""Please enter Expenditure relating to Speculative Activity in schedule Profit and Loss A/c""" & Chr(13)
Exit Function
End If
End If
...
'        Sheet4.Range(Tadd).Offset(0, -1) = "99-STATE OUTSIDE INDIA"
        Sheet4.Range(Tadd).Offset(0, -1) = "99-Foreign"
        Sheet4.Range(Tadd).Offset(0, 1) = ""
...
' fivepersent = Sheet4.Range("PL_61i").value * 5 / 100
  fivepersent = TempPL_61i * 5 / 100
  
' If Sheet4.Range("PL_61a_1b").value > fivepersent Then
 If GrossTurnover1band1C >= fivepersent Then
 
'     If Sheet4.Range("PL_61i").value >= 20000001 Then

     If TempPL_61i >= 20000001 Then
'          errorMsg_NOB6 = errorMsg_NOB6 + "* Presumptive Taxation u/s 44AD is not applicable to you since receipts in cash and any other mode [61(iB)] is more than 5%." & Chr(13)
'           errorMsg_NOB6 = errorMsg_NOB6 + "* ""Presumptive section u/s 44AD is not applicable to you""" & Chr(13)
           errorMsg_NOB6 = errorMsg_NOB6 + "* ""Presumptive Taxation u/s 44AD is not applicable to you since receipts in cash and any other mode [61(iB)+61(iC)] is more than 5%.""" & Chr(13)
          ValidateSecGROSSTURNOVER = False
          Exit Function
     End If

'ElseIf Sheet4.Range("PL_61a_1b").value <= fivepersent Then
ElseIf GrossTurnover1band1C <= fivepersent Then

'  If Sheet4.Range("PL_61i").value >= 30000001 Then
  If TempPL_61i >= 30000001 Then
         errorMsg_NOB6 = errorMsg_NOB6 + "* Presumptive section u/s 44AD is not applicable to you" & Chr(13)
     ValidateSecGROSSTURNOVER = False
     Exit Function
     End If
...
'Newly added by Sai For AY 2024-25
Function ValidateSecGrossReceipts() As Boolean

ValidateSecGrossReceipts = True
Dim fivepersent As Variant
' fivepersent = Sheet4.Range("PL_62i").value * 5 / 100
  fivepersent = TempPL_62i * 5 / 100

' If Sheet4.Range("PL_62i_B").value > fivepersent Then
 If GrossTurnover62band62C > fivepersent Then
 
'     If Sheet4.Range("PL_62i").value >= 5000001 Then
     If TempPL_62i >= 5000001 Then
     
'      MsgBox ("testing")
'          msgError = msgError & "*  Presumptive section u/s 44AD is not applicable to you"
'          errorMsg_NOB6 = errorMsg_NOB6 + "* ""If Gross Receipts are more than Rs.5000000, it is mandatory to have a tax audit under 44AB. Presumptive section u/s 44ADA is not applicable to you. Please offer income through Schedules Profit & Loss and Balance Sheet." & Chr(13)
           errorMsg_NOB6 = errorMsg_NOB6 + "* ""If Gross Receipts are more than Rs.5000000 and cash receipts are more than 5% of total receipts, it is mandatory to have a tax audit under 44AB. Presumptive section u/s 44ADA is not applicable to you. Please offer income through Schedules Profit & Loss and Balance Sheet.""" & Chr(13)
          
          ValidateSecGrossReceipts = False
          Exit Function
     End If

'ElseIf Sheet4.Range("PL_62i_B").value <= fivepersent Then
ElseIf GrossTurnover62band62C <= fivepersent Then

'  If Sheet4.Range("PL_62i").value >= 7500001 Then
  If TempPL_62i >= 7500001 Then
  
         errorMsg_NOB6 = errorMsg_NOB6 + "* ""If Gross Receipts are more than Rs.7500000, it is mandatory to have a tax audit under 44AB. Presumptive section u/s 44ADA is not applicable to you. Please offer income through Schedules Profit & Loss and Balance Sheet." & Chr(13)
...
'Malli_01/10/2025
Function ValidateGrspft_transferred_frmTradingAcnt() As Boolean
ValidateGrspft_transferred_frmTradingAcnt = True
errorMsg_NOB8 = ""

Dim PL_GrossProfitLoss_14charchk As Variant

PL_GrossProfitLoss_14charchk = Sheet4.Range("PL_GrossProfitLoss").value
 
 
 If PL_GrossProfitLoss_14charchk < 0 Then
            
            If Len(PL_GrossProfitLoss_14charchk) > 15 Then
                     ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 13 in Schedule Profit & Loss. """ & Chr(13)
            End If
 
 Else:
 
            If Len(PL_GrossProfitLoss_14charchk) > 14 Then
                    ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 13 in Schedule Profit & Loss.""" & Chr(13)
            End If
 ...
 '14xitotal
            ...
            If Len(Sheet4.Range("PL.MiscOthIncome").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 14xi in Schedule Profit & Loss.""" & Chr(13)
            End If
            
            
  '14xii
 
 If Sheet4.Range("PL.TotOthIncome").value < 0 Then
            
            If Len(Sheet4.Range("PL.TotOthIncome").value) > 15 Then
                     ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 14xii in Schedule Profit & Loss. """ & Chr(13)
            End If
 
 Else:
 
            If Len(Sheet4.Range("PL.TotOthIncome").value) > 14 Then
                    ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 14xii in Schedule Profit & Loss.""" & Chr(13)
            End If
 ...
 End If
   ...
   '22xi
    ...
    If Len(Sheet4.Range("PL.TotEmployeeComp").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 22xi in Schedule Profit & Loss.""" & Chr(13)
    End If
    ...
    If Len(Sheet4.Range("PL.TotInsurances").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 23v in Schedule Profit & Loss.""" & Chr(13)
    End If
 
   '30iii
   If Len(Sheet4.Range("PL.CommissionExpdr").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 30iii in Schedule Profit & Loss.""" & Chr(13)
    End If
    
    '31iii
   If Len(Sheet4.Range("PLRY.Total").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 31iii in Schedule Profit & Loss.""" & Chr(13)
    End If
    
    '32iii
    
    If Len(Sheet4.Range("PLPC.Total").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 32iii in Schedule Profit & Loss.""" & Chr(13)
    End If
    
    '44x
    If Len(Sheet4.Range("PLRateEx.TotExciseCustomsVAT").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 44x in Schedule Profit & Loss.""" & Chr(13)
    End If
    
    '46
    If Len(Sheet4.Range("PL.OtherExpenses").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 46 in Schedule Profit & Loss.""" & Chr(13)
    End If
    
    '47Vi
     If Len(Sheet4.Range("PL.BadDebt").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 47Vi in Schedule Profit & Loss.""" & Chr(13)
    End If
    
    '50
    
    If Sheet4.Range("PL.PBIDTA").value < 0 Then
            
            If Len(Sheet4.Range("PL.PBIDTA").value) > 15 Then
                     ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 50 in Schedule Profit & Loss. """ & Chr(13)
            End If
    Else:
 
            If Len(Sheet4.Range("PL.PBIDTA").value) > 14 Then
                    ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 50 in Schedule Profit & Loss.""" & Chr(13)
            End If
   ...
   '51iii
   If Len(Sheet4.Range("PL.InterestExpdr").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 51iii in Schedule Profit & Loss.""" & Chr(13)
    End If

   '53
      If Len(Sheet4.Range("PL.PBT").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 53 in Schedule Profit & Loss.""" & Chr(13)
    End If
    
    '56
    
    If Sheet4.Range("PL.ProfitAfterTax").value < 0 Then
            
            If Len(Sheet4.Range("PL.ProfitAfterTax").value) > 15 Then
                     ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 56 in Schedule Profit & Loss. """ & Chr(13)
            End If
    Else:
 
            If Len(Sheet4.Range("PL.ProfitAfterTax").value) > 14 Then
                    ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 56 in Schedule Profit & Loss.""" & Chr(13)
            End If
   ...
   If Sheet4.Range("PL.AmtAvlAppr").value < 0 Then
            
            If Len(Sheet4.Range("PL.AmtAvlAppr").value) > 15 Then
                     ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 58 in Schedule Profit & Loss. """ & Chr(13)
            End If
    Else:
 
            If Len(Sheet4.Range("PL.AmtAvlAppr").value) > 14 Then
                    ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 58 in Schedule Profit & Loss.""" & Chr(13)
            End If
   ...
   If Sheet4.Range("PL.PartnerAccBalTrf").value < 0 Then
            
            If Len(Sheet4.Range("PL.PartnerAccBalTrf").value) > 15 Then
                     ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 60 in Schedule Profit & Loss. """ & Chr(13)
            End If
    Else:
 
            If Len(Sheet4.Range("PL.PartnerAccBalTrf").value) > 14 Then
                    ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 60 in Schedule Profit & Loss.""" & Chr(13)
            End If
   ...
   '63
   If Len(Sheet4.Range("PL_TotalPresumtiveIncome").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 63 in Schedule Profit & Loss.""" & Chr(13)
    End If

   
   '63ii
   If Len(Sheet4.Range("PL_63ii").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 63ii in Schedule Profit & Loss.""" & Chr(13)
    End If

   
   '64ia
    If Len(Sheet4.Range("PL_64GrossTurnOver").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 64ia in Schedule Profit & Loss.""" & Chr(13)
    End If
    
    '64iia
    
    If Len(Sheet4.Range("PL_64iia").value) > 14 Then
                   ValidateGrspft_transferred_frmTradingAcnt = False
                           errorMsg_NOB8 = errorMsg_NOB8 + "* "" Total amount should be  Numeric, Non-negative, Non-decimal, upto 99,999,999,999,999 at Sr.No 64iia in Schedule Profit & Loss.""" & Chr(13)
    End If

    '64iii
    
    If Sheet4.Range("PL_64iii").value < 0 Then
            
            If Len(Sheet4.Range("PL_64iii").value) > 15 Then
                     ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Total amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 64iii in Schedule Profit & Loss. """ & Chr(13)
            End If
    Else:
 
            If Len(Sheet4.Range("PL_64iii").value) > 14 Then
                    ValidateGrspft_transferred_frmTradingAcnt = False
                errorMsg_NOB8 = errorMsg_NOB8 + "* ""Total amount should be  Numeric , Non-decimal, upto 99,999,999,999,999 at Sr.No 64iii in Schedule Profit & Loss.""" & Chr(13)
            End If
