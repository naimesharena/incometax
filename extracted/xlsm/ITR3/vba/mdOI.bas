...
Public MiSmlMediumEntpspayable_7 As Variant ' For Table 11
Public MiSmlMediumEntps_7 As Variant 'For Table10
...
'rpcomments
    ...
    'AY_2024_25 ADD 'Malli
    If Not ValidateMiSmlMediumEntps_7() Then ValidateSheet6 = False
    '-------------------------------
    If Not ValidateRailwayAssetsPayable_7() Then ValidateSheet6 = False
    'AY_2024_25 ADD 'Malli
    If Not ValidateMiSmlMediumEntps_payable_7() Then ValidateSheet6 = False
    '-------------------------------
...
'Malli
'AY_2024_25
Function ValidateMiSmlMediumEntps_payable_7() As Boolean
    Dim i As Long
    
    ValidateMiSmlMediumEntps_payable_7 = True
    MiSmlMediumEntpspayable_7 = Sheet5.Range("sheet7.MiSmlMediumEntps_payable").value
    
    If Len(MiSmlMediumEntpspayable_7) > 14 Then
        msgbox7 ("* RailwayAssetsPayable in Sheet :PART A OI should not greater than 14 digits ")
        ValidateMiSmlMediumEntps_payable_7 = False
        Exit Function
    End If
    
    For i = 1 To Len(MiSmlMediumEntpspayable_7)
        If Not IsNumeric(MiSmlMediumEntpspayable_7) Then
            msgbox7 ("* RailwayAssetsPayable in Sheet :PART A OI must contain only digits from 0 to 9")
            ValidateMiSmlMediumEntps_payable_7 = False
            Exit Function
        End If
...
Function ValidateMiSmlMediumEntps_7() As Boolean
    Dim i As Long
    
    ValidateMiSmlMediumEntps_7 = True
    MiSmlMediumEntps_7 = Sheet5.Range("sheet7.MiSmlMediumEntps").value
    
    If Len(MiSmlMediumEntps_7) > 14 Then
        msgbox7 ("* RailwayAssetsPayable in Sheet :PART A OI should not greater than 14 digits ")
        ValidateMiSmlMediumEntps_7 = False
        Exit Function
    End If
    
    For i = 1 To Len(MiSmlMediumEntps_7)
        If Not IsNumeric(MiSmlMediumEntps_7) Then
            msgbox7 ("* RailwayAssetsPayable in Sheet :PART A OI must contain only digits from 0 to 9")
           ValidateMiSmlMediumEntps_7 = False
            Exit Function
        End If
