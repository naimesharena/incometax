...
'SIT-96983 Konda_22_07_2025
    'If (Len(Sheet15.Range("UD.AssessmentYear").item(1).value) > 0) Then
     If (Len(Sheet15.Range("UD.AssessmentYear").item(1).value) > 0) Or Sheet15.Range("UDCY2.Balance").value > 0 Or Sheet15.Range("UDCY.Balance").value > 0 Then
...
'                msgbox_UD ("* Assessment Year at Sr. No  " & i + 1 & "  in Sheet Unabsorbed Depriciation  should not exceed the AY 2021-22.")
             ...
             ''UD_E1_AY_2024_25 OLD 'MAlli
'        If Mid(AssYear_UD(i), 1, 4) > 2022 Then
''                Change.15.03.2023.102.IDS09
'                'msgbox_UD ("* Assessment Year at Sr. No  " & i + 1 & "  in Sheet Unabsorbed Depriciation  should not exceed the AY 2023-24.")
'                msgbox_UD ("* Assessment Year at Sr. No  " & i + 1 & "  in Sheet Unabsorbed Depriciation  should not exceed the AY 2022-23.")
''                End Change.IDS09
'                ValidateAssYear_UD = False
'                Exit Function
'            End If
'
            'UD_C1_AY_2024_25 CHANGE 'MAlli
'            If Mid(AssYear_UD(i), 1, 4) > 2023 Then
            
            ''Added by Aavula Naresh for 2025-26
'                 If Mid(AssYear_UD(i), 1, 4) > 2024 Then
''                msgbox_UD ("* Assessment Year at Sr. No  " & i + 1 & "  in Sheet Unabsorbed Depriciation should not exceed the AY 2023-24.")
'                msgbox_UD ("* Assessment Year at Sr. No  " & i + 1 & "  in Sheet Unabsorbed Depriciation should not exceed the AY 2024-25.")
                ''''''''
                
                'added by Chetan C M for AY 2026-27
                'start--
                 If Mid(AssYear_UD(i), 1, 4) > 2025 Then
                    msgbox_UD ("* Assessment Year at Sr. No  " & i + 1 & "  in Sheet Unabsorbed Depriciation should not exceed the AY 2025-26.")
                '--end
