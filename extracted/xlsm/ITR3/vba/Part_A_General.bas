...
Public SecnAcknoth_General As Variant
'==============================================
...
Public Flat2 As String    'Newly added by sadineni on 23/06/2026
Public Area2 As String  '  Newly added by sadineni on 23/06/2026
Public City2 As String    'Newly added by sadineni on 23/06/2026
Public sCountry2 As String 'Newly added by sadineni on 23/06/2026
Public State2 As String    'Newly added by sadineni on 23/06/2026
Public PinCode2 As String  'Newly added by sadineni on 23/06/2026
Public ZipCode2 As String  'Newly added by sadineni on 23/06/2026
...
Public Address, Repemail As Variant

'newly Added

Public OptOutAB As String
Public OptOutSetB As String
'''

Public Investment As Variant
Public Claim115H As Variant

Public end_SecCode, end_SecDate, end_SecAcknumber, end_SecCodeYN As Long
...
Public ChkDate As Variant 'Added by Sai

Public AckNumberAuditDateSec92E As Variant 'Added by Sai
...
'Newly added by Sai
EfilingCommon.DefinedgridNameRange = "sheet1.AuditedSection||sheet1.AuditYN||sheet1.DateOfAudit||Sheet1.AckNumoth"
...
Function shtPartA_General() As Boolean
    ...
    'vbMessgaeCaption = "ITR 3: AY: 2022-23"
...
If UniqueNumber <> "" And CheckSpecialCharacter5(UniqueNumber) Then
...
'If Sheet1.Range("Alternate_Address").value = "Yes" Then
If Sheet1.Range("sheet1.ResidenceNo2").value <> "" Or Sheet1.Range("sheet1.LocalityOrArea2").value <> "" Or Sheet1.Range("sheet1.CityOrTownOrDistrict2").value <> "" Or Sheet1.Range("sheet1.StateCode2").value <> "(Select)" Or Sheet1.Range("sheet1.CountryCode2").value <> "(Select)" Or Sheet1.Range("sheet1.PinCode2").value <> "" Then
...
If Not ChkArea2 Then MsgBx_General = MsgBx_General + "* ""Area/ Locality in Sheet: Personal Information is mandatory in schedule Part A General under Personal Information""" & Chr(13)
If Not ChkCity2 Then MsgBx_General = MsgBx_General + "* ""Town/City/District in Sheet: Personal Information is mandatory in schedule Part A General""" & Chr(13)
If Not ChkState2 Then MsgBx_General = MsgBx_General + "* ""State in Sheet: Personal Information is mandatory in schedule Part A General""" & Chr(13)

End If

If Not ChkCountry2 Then shtPartA_General = False
If Not ChkPincode2 Then shtPartA_General = False
If Not ChkZipcode2 Then shtPartA_General = False
'End If
...
'If Not ChkDOB Then MsgBx_General = MsgBx_General + "* Date of Birth/Formation in Sheet: Personal Information is mandatory in schedule Part A General" & Chr(13)
  ...
  'Error Message changed by Sai For AY 2024-25
If Not ChkDOB Then MsgBx_General = MsgBx_General + "* Please enter Date of Birth / Formation" & Chr(13)
...
If Not ChkMobileNo Then MsgBx_General = MsgBx_General + "*  ""Primary Mobile number in Sheet: Personal Information is mandatory in schedule Part A General""" & Chr(13)

'Added by Naresh As per V0.2
 If Not ChkAddress Then MsgBx_General = MsgBx_General + "* ""Kindly select the appropriate option for secondary address in Schedule Part A General""" & Chr(13)

'Newly added by Sai on 08/02/2024
If Not ChkDueDate Then MsgBx_General = MsgBx_General + "* Please select the dropdown for Due date for filing return of income" & Chr(13)
...
If Not ChkReturnFileSec Then MsgBx_General = MsgBx_General + "* Filed u/s or Filed in response to notice u/s in Part A General is mandatory." & Chr(13)


'new change
'Change-20.01.2023.101.25C
If Not MandatorySEBI Then shtPartA_General = False
...
'
'        End If
'Change-19.12.2022.102.08A
'Validate_CurrentAY23_24 'Commented by Sai For AY 2023-24


'Validate_CurrentAY24_25 'Newly Modified by Sai For AY 2024-25

'end---

'Validate_BAC115DateOfFiling

' Validate_CurrentAY25_26
 
 
' Commented by Aavula For AY 2026-27

' Validate_CurrentAY25_26_Method
' Validate_CurrentAY24_25_SetA
' Validate_CurrentAY25_26_A23i
' Validate_CurrentAY25_26_A23Bi
' Validate_CurrentAY25_26_A23Ci
' Validate_CurrentAY25_26_SetB
'''''''''''''''''''''''''''''''''''''''''''
...
Validate_BusiProfAssyr_2026_27

Validate_Form10IEAoldtax_I
Validate_Form10IEAoldtax_IA
Validate_Form10IEANewTax
Validate_Form10IEANewTaxIB

Validate_Form10IEAB_2026_27
...
'check in ITR3
'If Not ValidateReturnFileSection Then MsgBx_General1 = MsgBx_General1 + "* Please enter the date of Notice u/s 139(9)/142(1)/148/153C/119(2)(b)/section 139 read with section 92CD and Date of filing of original return and Receipt Number in schedule Part A General" & Chr(13)
'----
   
     'Error message Changed by Sai For AY 2024-25
     
'If Sheet1.Range("sheet1.NoticeDate").MergeArea.Locked = False Then
'  If Not ValidateReturnFileSection Then MsgBx_General1 = MsgBx_General1 + "* Please enter the date of Notice u/s 139(9)/142(1)/148/153C/119(2)(b)/section 139 read with section 92CD in schedule Part A General" & Chr(13)
'End If
  If Not ValidateReturnFileSection Then shtPartA_General = False

'Commented by Aavula For AY 2026-27
'If Not UDINNo1 Then MsgBx_General = MsgBx_General + "* ""Please enter the valid UDIN in schedule Part A General" & Chr(13)
'''''''
...
'    If Not ValidateSelection44AE Then MsgBx_General1 = MsgBx_General1 + "*Please select Whether assesee is declaring income under section 44AE/44B/44BB/44BBA in schedule Part A General Information" & Chr(13)
    ...
    If Not ValidateSelection44AE Then MsgBx_General1 = MsgBx_General1 + "* Please select Whether assesee is declaring income under section 44AE/44B/44BB/44BBA/44DA/44DB/44BBC/44BBD/44DA in schedule Part A General Information " & Chr(13)
'    If Not ValidateSec5cflg Then MsgBx_General1 = MsgBx_General1 + "*Please select Whether during the year Total sales/turnover/gross receipts of business exceeds Rs. 1 crore but does not exceeds Rs. 10 Crore?  in schedule Part A General Information" & Chr(13)
    ...
    'Added by Aavula Naresh on 10/03/2025
    If Not ValidateSec5cflg Then MsgBx_General1 = MsgBx_General1 + "* ""Please select the range of Total sales/turnover/gross receipts of business in schedule Part A General Information""" & Chr(13)
    
    'Added by Aavula Naresh on 10/02/2025
...
'    If Not ValidateSecAggrigateflg Then MsgBx_General1 = MsgBx_General1 + "*Please enter percentage in field ""If Yes is selected at a2i, please provide the value of amounts received in cash & non-a/c payee cheque/DD as a percentage of all amounts received during the previous year including amount received for sales, turnover or gross receipts or on capital account like capital contributions, loans etc. in part A general""" & Chr(13)
'     If Not ValidateSecAggrigateflg Then MsgBx_General1 = MsgBx_General1 + "* Please select If yes is selected at a2i,  whether aggregate of all amounts received including amount received for sales, turnover or gross receipts during the previous year, in cash & non-a/c payee cheque/DD, does not exceed five per cent of said amount  in schedule Part A General Information """ & Chr(13)
     If Not ValidateSecAggrigateflg Then MsgBx_General1 = MsgBx_General1 + "* ""Please select the percentage of amounts received in cash & non a/c payee cheque/ bank draft out of the aggregate receipts during the previous year in schedule Part A General Information """ & Chr(13)
...
'    If Not ValidateSecAggrigateflg1 Then MsgBx_General1 = MsgBx_General1 + "* Please enter percentage in field ""If Yes is selected at a2i, please provide the value of payments in cash & non-a/c payee cheque/DD as a percentage of aggregate of all payments  during the previous year made including amount incurred for expenditure or on capital account such as asset acquisition, repayment of loans etc.,"" in Part a general" & Chr(13)
'     If Not ValidateSecAggrigateflg1 Then MsgBx_General1 = MsgBx_General1 + "* Please select If yes is selected at a2i , whether aggregate of all payments made including amount incurred for expenditure, in cash & non-a/c payee cheque/DD, during the previous year does not exceed five per cent of the said payment ? in schedule Part A General Information """ & Chr(13)
     If Not ValidateSecAggrigateflg1 Then MsgBx_General1 = MsgBx_General1 + "* ""Please select the percentage of payments made in cash & non a/c payee cheque/ bank draft out of the aggregate payments made during the previous year in schedule Part A General Information """ & Chr(13)
...
setTblinfo_NRI
  ...
  ValidateLEI 'Newly added by Sai For AY 2024-25
  validatesheetSebi  'Newly added by Sai For AY 2024-25
...
'  'MsgBx_General = MsgBx_General & "* Have you opted for new tax regime u/s 115BAC and filed Form 10IE in AY 2022-23" & Chr(13)
'  MsgBx_General = MsgBx_General & "* Have you opted for new tax regime u/s 115BAC and filed Form 10IE in earlier years?" & Chr(13)
' 'end---
'
'  End If
...
On Error Resume Next
    ...
    RepMobileNo = Sheet1.Range("sheet1.RepMobileNo")
    ...
    If Trim(RepMobileNo) = "" Or IsEmpty(RepMobileNo) Then
    ...
    If Trim(RepMobileNo) <> "" Then
        If Mid(RepMobileNo, 1, 1) = "0" Then
          fmsgboxStatus ("""Contact Number of representative assessee cannot begin with '0' in schedule Part A General""")
          RepChkMobileNo = False
        Exit Function
        End If
    End If
...
Function ChkSpecialCharinNonMandatoryfield() As Boolean
   ...
   ' IncomeTaxWardCircle_1 = Range("sheet1.DesigOfficerWardorCircle").value
...
Function ChkAddress() As Boolean
On Error Resume Next
    ChkAddress = True
    Address = Sheet1.Range("Secondary_Address")
    If Trim(Address) = "" Or Trim(Address) = "(Select)" Then
        ChkAddress = False
        Exit Function
    End If
End Function
...
On Error Resume Next
    ...
    End If
End Function
Function ChkArea2() As Boolean
On Error Resume Next
    ChkArea2 = True
'    Area = Sheet1.Range("sheet1.LocalityOrArea2")
     Area2 = Sheet1.Range("sheet1.LocalityOrArea2")
    RoadOrStreet = Sheet1.Range("sheet1.RoadOrStreet2")
    If Trim(Area) = "" Or IsEmpty(Area2) Then
        ChkArea2 = False
        Exit Function
    End If

    If Len(Trim(Area2)) > 50 Then
        fmsgboxStatus ("""Area/ Locality cannot be more than 50 characters in schedule Part A General under Personal Information""")
        ChkArea2 = False
        Exit Function
    End If
    
      If Not CheckSpecialCharacter4New(Area2) Then
        ChkArea2 = False
        fmsgboxStatus ("Area / Locality  in Sheet : Part A-General cannot contain special charachters <> ")
        Exit Function
    End If
...
End Function
'Town/City/District2 Validation
Function ChkCity2() As Boolean
On Error Resume Next
    ChkCity2 = True
'    City = Sheet1.Range("sheet1.CityOrTownOrDistrict2")
     City2 = Sheet1.Range("sheet1.CityOrTownOrDistrict2")
    
    If Trim(City2) = "" Or IsEmpty(City2) Then
        ChkCity2 = False
        Exit Function
    End If

    If Len(Trim(City2)) > 50 Then
        fmsgboxStatus ("""Town/City/District cannot be more than 50 characters in schedule Part A General""")
        ChkCity2 = False
        Exit Function
    End If
...
On Error Resume Next
    ...
    If Trim(State) <> "" Then
     ...
     Dim PIN_targetadd, state_targetadd As String
      ...
      PIN_targetadd = Replace(Sheet1.Range("sheet1.PinCode").Address, "$", "")
      
      
    If state_Validation(PIN_targetadd, state_targetadd) = False Then Sheet1.Range("sheet1.PinCode").value = ""
...
'State Validation
Function ChkState2() As Boolean
On Error Resume Next
    ChkState2 = True
'    State = Sheet1.Range("sheet1.StateCode2")
    
     State2 = Sheet1.Range("sheet1.StateCode2")
    
    If Trim(State2) = "" Or Trim(State2) = "(Select)" Or Trim(State2) = "(" Then
        ChkState2 = False
        Exit Function
    End If
    ...
    If Trim(State2) <> "" Then
     ...
     Dim PIN_targetadd, state_targetadd As String
      ...
      state_targetadd = Replace(Sheet1.Range("sheet1.StateCode2").Address, "$", "")
      PIN_targetadd = Replace(Sheet1.Range("sheet1.PinCode2").Address, "$", "")
      
      
    If state_Validation(PIN_targetadd, state_targetadd) = False Then Sheet1.Range("sheet1.PinCode2").value = ""
...
'Pincode2 Validation
Function ChkPincode2() As Boolean
On Error Resume Next
    ChkPincode2 = True
    'PinCode = Sheet1.Range("sheet1.PinCode2")
    
     PinCode2 = Sheet1.Range("sheet1.PinCode2")
    
    
    If sCountry <> "" And UCase(Mid(sCountry, 1, InStr(1, sCountry, "-") - 1)) = "91" Then
        If PinCode2 = "" Or IsEmpty(PinCode2) Then
         If Sheet1.Range("Sheet1.PinCode2").MergeArea.Locked = False Then
            MsgBx_General = MsgBx_General + "* ""Pin code is mandatory in tab: Personal Information in schedule Part A General""" & Chr(13)
            ChkPincode2 = False
            Exit Function
         End If
        ...
        If Len(Trim(PinCode2)) > 6 Then
            MsgBx_General = MsgBx_General + "* ""Pin Code must be exactly 6 digits and should not start with zero in schedule Part A General""" & Chr(13)
            ChkPincode2 = False
            Exit Function
        End If
        
        If Mid(PinCode2, 1, 1) = "0" Then
            MsgBx_General = MsgBx_General + "* Pincode in Sheet : Part A-General should not start with 0" & Chr(13)
            ChkPincode2 = False
            Exit Function
        End If
...
On Error Resume Next
    ...
    If sCountry <> "" And UCase(Mid(sCountry, 1, InStr(1, sCountry, "-") - 1)) <> "91" Then
      ...
      If Sheet1.Range("sheet1.ZipCode").MergeArea.Locked = False Then
...
''ZipCode Validation
'Function ChkZipcode2() As Boolean
'On Error Resume Next
'    ChkZipcode2 = True
'    'ZipCode = Sheet1.Range("sheet1.ZipCode2")
'     ZipCode2 = Sheet1.Range("sheet1.ZipCode2")
'
'
'      If sCountry <> "" And UCase(Mid(sCountry, 1, InStr(1, sCountry, "-") - 1)) <> "91" Then
'       If Sheet1.Range("sheet1.ZipCode2").MergeArea.Locked = False Then
'        If Trim(ZipCode2) = "" Or IsEmpty(ZipCode2) Then
'            MsgBx_General = MsgBx_General + "* ""Zip Code is compulsory, if there is no Zip Code then select ""No ZIP Code in schedule Part A General""" & Chr(13)
'            ChkZipcode2 = False
'            Exit Function
'        End If
...
'      If sCountry <> "" And UCase(Mid(sCountry, 1, InStr(1, sCountry, "-") - 1)) <> "91" Then
  If sCountry2 <> "" And UCase(Mid(sCountry2, 1, InStr(1, sCountry2, "-") - 1)) <> "91" Then 'updated by sadineni on 23/06/2026
       If Sheet1.Range("sheet1.ZipCode2").MergeArea.Locked = False Then
        If Trim(ZipCode2) = "" Or IsEmpty(ZipCode2) Then
            MsgBx_General = MsgBx_General + "* ""Zip Code is compulsory, if there is no Zip Code then select ""No ZIP Code in schedule Part A General""" & Chr(13)
            ChkZipcode2 = False
...
On Error Resume Next
    ...
    ChkFlat2 = True
'    Flat = Sheet1.Range("sheet1.ResidenceNo2")
     Flat2 = Sheet1.Range("sheet1.ResidenceNo2")
    
    If Trim(Flat2) = "" Or IsEmpty(Flat2) Then
        ChkFlat2 = False
        Exit Function
    End If

    If Len(Trim(Flat2)) > 50 Then
        fmsgboxStatus ("""Flat/ Door/ Building cannot be more than 50 characters in schedule Part A General under Personal Information""")
        ChkFlat2 = False
        Exit Function
    End If
...
'
    ...
    If Not CheckSpecialCharacter4New(Flat2) Then
        ChkFlat2 = False
        fmsgboxStatus ("Flat/Door/Building  in Sheet : Part A-General cannot contain special charachters <> ")
        Exit Function
    End If
...
On Error Resume Next
    ...
    If Len(Trim(MobileNo)) > 10 Then
        fmsgboxStatus ("Please enter a valid 10 digit Primary Mobile Number in schedule Part A General")
        ChkMobileNo = False
        Exit Function
    End If
...
'    If Not (Len(Trim(MobileNo)) <= 10 And Len(Trim(MobileNo)) >= 5) Then
        ...
        fmsgboxStatus ("Please enter a valid Primary Mobile Number in schedule Part A General")
        ChkMobileNo = False
        Exit Function
    End If
        End If
...
End If
    ...
    If Trim(MobileNo) <> "" Then
        For i = 1 To Len(MobileNo)
            If Not IsNumeric(Mid(MobileNo, i, 1)) Then
                fmsgboxStatus ("Mobile Number1 in schedule Part A General must contain only digits from 0 to 9")
                ChkMobileNo = False
            Exit Function
            End If
        Next
    ...
    If Trim(CountryCode1) = "" Then
                fmsgboxStatus ("""Country Code in Primary Mobile No. in Sheet: Personal Information is mandatory in schedule Part A General""")
                ChkMobileNo = False
                Exit Function
    End If
    End If
    ...
    If Len(Trim(CountryCode1)) > 5 Then
        fmsgboxStatus ("Country Code for Mobile No 1 cannot exceed 5 characters in schedule Part A General")
        ChkMobileNo = False
        Exit Function
    End If
    ...
    If Trim(CountryCode1) <> "" Then
        For i = 1 To Len(CountryCode1)
            If Not IsNumeric(Mid(CountryCode1, i, 1)) Then
                fmsgboxStatus ("Country Code for Mobile No 1 must contain only digits from 0 to 9 in schedule Part A General")
                ChkMobileNo = False
            Exit Function
            End If
        Next
    ...
    If Trim(MobileNo) <> "" Then
        If Mid(MobileNo, 1, 1) = "0" Then
          fmsgboxStatus ("""Primary Mobile Number cannot begin with '0' in schedule Part A General""")
          ChkMobileNo = False
        Exit Function
        End If
    End If
    ...
    If Trim(CountryCode1) <> "" Then
        If CountryCode1 = "0" Or CountryCode1 = "00" Or CountryCode1 = "000" Or CountryCode1 = "0000" Or CountryCode1 = "00000" Then
          fmsgboxStatus ("Please enter valid Country Code for Mobile No 1 in Sheet : PART A - GENERAL")
          ChkMobileNo = False
        Exit Function
        End If
    End If
...
On Error Resume Next
    ChkEmail2 = True
    email = Sheet1.Range("Sheet1.RepEmail")
    ...
    If Len(Trim(email)) > 125 Then
        fmsgboxStatus (" ""Email-Id of the representative assessee cannot be more than 125 characters in schedule Part A General""")
        ChkEmail2 = False
        Exit Function
    End If
End Function
...
MobileCountryCode1 = Sheet1.Range("Countrycode3").value
    If mobileNo1 <> "" Then
    If Trim(MobileCountryCode1) = "" Or IsEmpty(MobileCountryCode1) Then
                    fmsgboxStatus ("""Country Code for contact number of representative assessee in Part A General  cannot be blank.""") & Chr(13)
    ...
    If Len(Trim(MobileCountryCode1)) > 5 Then
                    fmsgboxStatus ("""Country Code in Contact No. of Representative assessee in Part A General cannot exceed 5 characters""") & Chr(13)
        ChkCountrycode1 = False
        Exit Function
    End If
    If MobileCountryCode1 = "0" Or MobileCountryCode1 = "00" Or MobileCountryCode1 = "000" Or MobileCountryCode1 = "0000" Or MobileCountryCode1 = "00000" Then
                    fmsgboxStatus ("""Please enter valid Country Code in Contact No. of Representative assessee in Part A General""") & Chr(13)
        ChkCountrycode1 = False
        Exit Function
    End If
    ...
    If Trim(MobileCountryCode1) <> "" Then
        For i = 1 To Len(MobileCountryCode1)
            If Not IsNumeric(Mid(MobileCountryCode1, i, 1)) Then
                    fmsgboxStatus ("""Country Code in Contact No. of Representative assessee in Part A General must contain only digits from 0 to 9""") & Chr(13)
                ChkCountrycode1 = False
            Exit Function
            End If
        Next
...
On Error Resume Next
    Dim i As Long
    ChkMobileNo1 = True
    MobileNo = Sheet1.Range("sheet1.RepMobileNo")
...
On Error Resume Next
   ...
   ' scountry = Mid(scountry, 1, 4)
    ...
    End If
End Function
Function ChkCountry2() As Boolean
On Error Resume Next
    ChkCountry2 = True
'    sCountry = Sheet1.Range("sheet1.CountryCode2")
     sCountry2 = Sheet1.Range("sheet1.CountryCode2")
   ' scountry = Mid(scountry, 1, 4)
   
    If isdropdownblank(sCountry2) Then
        sCountry2 = ""
    End If
    
    If Trim(sCountry2) = "" Or Trim(sCountry2) = "(Select)" Or Trim(sCountry2) = "(" Then
        ChkCountry2 = False
        Exit Function
    End If
End Function
...
On Error Resume Next
    ...
    DirectorCompany = Sheet1.Range("IsDirectorCompany")
         If Sheet1.Range("IsDirectorCompany").MergeArea.Locked = False Then
...
'Commented by Aavula Naresh on 24/10/2024
...
ValidateSectionCodeGrid = True
    ...
    If Sheet1.Range("sheet1.PortugeseCC5A").value = "" Or Sheet1.Range("sheet1.PortugeseCC5A").value = "(Select)" Then
    MsgBx_SectionCode = MsgBx_SectionCode + "*  Whether governed by Portuguese Civil code is mandatory in schedule Part A General"
...
'Dim rangecells2
'Set rangecells2 = Sheet1.Range("Sheet1.AckNumoth").Cells
'Dim i As Long
...
'SecnAcknoth_General(i) = rangecells2.item(i).value
'
...
'If Len(SecnAcknoth_General) = 0 Then
' MsgBx_SectionCode = MsgBx_SectionCode + "*Please enter the Acknowledgment number" & Chr(13)
'
'End If
'
'End If
...
setTableinfo_SecCodeYN
setTableinfo_SecnDate
setTableinfo_SecnAcknumber 'Newly added by Sai
Dim rangecells As Range
Set rangecells = Sheet1.Range("sheet1.AuditYN").Cells
Dim rangecells1 As Range
Set rangecells1 = Sheet1.Range("sheet1.DateOfAudit").Cells
...
ReDim SecnCodeYN_General(end_SecCodeYN)
ReDim SecnDate_General(end_SecCodeYN)
ReDim SecnAcknoth_General(end_SecCodeYN)
 
For i = 1 To end_SecCodeYN
SecnCodeYN_General(i) = rangecells.item(i).value
SecnAcknoth_General(i) = rangecells2.Cells(1, 1).item(i).value
...
'Newly added by Bindu
'newly modified by Sai for SIT-69048
If Len(SecnAcknoth_General(i)) = 0 Then
   MsgBx_SectionCode = MsgBx_SectionCode + "*Please enter the Acknowledgment number at Sr. No  " & i & " " & Chr(13)
...
'Newly added by Sai on 13/02/2024
Sub setTableinfo_SecnAcknumber()
    Dim rangecells As Range
    Dim mIntCells As Long
    Dim mIntCtr As Long
    Dim ccount As Long
    ccount = 0
    mIntCells = Sheet1.Range("Sheet1.AckNumoth").count
    Set rangecells = Sheet1.Range("Sheet1.AckNumoth").Cells
     For mIntCtr = 1 To mIntCells
            If Not rangecells.item(mIntCtr).value = "" Then
               ccount = ccount + 1
               'rangecells.Item(mIntCtr).Select
...
'    ElseIf UCase(Range("sheet1.StateCode1").value) = "99-STATE OUTSIDE INDIA" Then
    ElseIf UCase(Range("sheet1.StateCode1").value) = "99-Foreign" Then
        Sheet1.Range("sheet1.CountryCode").value = "(Select)"
...
'      ElseIf Not UCase(Range("sheet1.StateCode1").value) = "99-STATE OUTSIDE INDIA" Then
      ElseIf Not UCase(Range("sheet1.StateCode1").value) = "99-Foreign" Then
...
Function CheckState2(State As String, ByRef vType As String) As Boolean
On Error Resume Next
'State is Mandatory in tab: Personal Information
...
'           Sheet1.Range("CountryCode2").MergeArea.value = ""
        ...
        Sheet1.Protect Password:=getmsgstate
'    ElseIf UCase(Range("sheet1.StateCode2").value) = "99-STATE OUTSIDE INDIA" Then
    ElseIf UCase(Range("sheet1.StateCode2").value) = "99-Foreign" Then
        Sheet1.Range("sheet1.CountryCode2").value = "(Select)"
...
'           Sheet1.Range("CountryCode2").MergeArea.value = ""
        ...
        Sheet1.Protect Password:=getmsgstate
         ...
         ElseIf UCase(Range("sheet1.StateCode2").value) = UCase("99-Foreign") Then
        Sheet1.Range("sheet1.CountryCode2").value = "(Select)"
...
'      ElseIf Not UCase(Range("sheet1.StateCode2").value) = "99-STATE OUTSIDE INDIA" Then
      ElseIf Not UCase(Range("sheet1.StateCode2").value) = "99-Foreign" Then
...
'            fmsgboxStatus "Pan of the Representative Assesse should have the 4th character as P"
            ...
            fmsgboxStatus """Fourth letter should be ""P"" in PAN of representative."""
            '''''''''''
...
'                fmsgboxStatus ("Please enter valid date in dd/mm/yyyy format  in schedule Part A General under Personal Information")
                fmsgboxStatus ("""Please enter the date in DD/MM/YYYY format""")
                Exit Function
            End If
        
' Change-12.12.2022.102.02A
'            If Not ChkMaxDOBDate(dob, "31/03/2022") Then
'                 fmsgboxStatus ("Date should not be after 31/03/2022 for AY 2022-23 in schedule Part A General under Personal Information")


            'Added by Sai for 2024-25 Change
...
'                 fmsgboxStatus ("Date should not be after 31/03/2025 for AY 2025-26 in schedule Part A General under Personal Information")
            ...
            'Added by Aavula Naresh for AY 2026-27
               ...
               If Not ChkMaxDOBDate23_24(dob, "31/03/2026") Then
...
On Error Resume Next
    ...
    CheckDOC = True
            ...
            'Year changed by Sai for  AY 2024-25
'            If Not ChkMaxDOBDate23_24(doc, "31/03/2024") Then
'            If Not ChkMaxDOBDate23_24(doc, "31/03/2025") Then

             If Not ChkMaxDOBDate23_24(doc, "31/03/2026") Then
             
                 'fmsgboxStatus ("Date of commencement should not be after 31/03/2023 for AY 2023-24")
'                 fmsgboxStatus ("Date of commencement should not be after 31/03/2024 for AY 2024-25")
'                 fmsgboxStatus ("Date of commencement should not be after 31/03/2025 for AY 2025-26")
                 
                  fmsgboxStatus ("Date of commencement should not be after 31/03/2026 for AY 2026-27")
...
'Function FormatNCheckDate(ByRef dt As Variant, Optional Year As String = "2022") As Boolean
 
 Function FormatNCheckDate(ByRef dt As Variant, Optional Year As String = "2023") As Boolean 'Year change by Sai
On Error Resume Next
...
'        If val(Mid(dob, 7, 4)) > 2021 Then
        If val(Mid(dob, 7, 4)) > 2022 Then         'Year change by Sai
                    ChkMaxDOBDateDef = False
                    Exit Function
'        ElseIf val(Mid(dob, 7, 4)) = 2021 Then
        ElseIf val(Mid(dob, 7, 4)) = 2021 Then      'Year change by Sai
...
Function ChkMaxDOBDateCease(dob As Variant, maxDefinedDOB As Variant) As Boolean
On Error Resume Next
     ChkMaxDOBDateCease = True
     If Len(dob) > 0 Then
'        If val(Mid(dob, 7, 4)) > 2022 Then
        If val(Mid(dob, 7, 4)) > 2023 Then       'Year Change by Sai
                    ChkMaxDOBDateCease = False
                    Exit Function
'        ElseIf val(Mid(dob, 7, 4)) = 2022 Then
        ElseIf val(Mid(dob, 7, 4)) = 2023 Then   'Year Change by Sai
            If val(Mid(dob, 4, 2)) >= 4 Then
                If val(Mid(dob, 1, 2)) >= 1 Then
                    ChkMaxDOBDateCease = False
                    Exit Function
...
'DoF should not be after 31/03/2019, for A.Y. 2018-19
    ...
    If Len(dob) > 0 Then
        If Not FormatNCheckDate(dob) Then
           ...
           'Error msg Changed by Sai For AY 2024-25
...
'         'Year change by Aavula Naresh AY 2025-26
...
'            fmsgboxStatus (" ""Date of filing in Sheet : PART A-GENERAL  should be on or after 01/04/2025""")
         ...
         'change by Aavula Naresh AY 2026-27
            If EfilingCommon.checkFirstDateBefore(dob, "31/03/2026") Then
            fmsgboxStatus (" ""Date of filing in Sheet : PART A-GENERAL  should be on or after 01/04/2026""")
            
                Range("sheet1.OrigRetFiledDate").Select
...
'            fmsgboxStatus ("Date of notice or Order cannot be prior to 01/04/2023")
            
          'Year changed by Sai for  AY 2024-25
'            If EfilingCommon.checkFirstDateBefore(dob, "31/03/2024") Then
'            fmsgboxStatus ("Date of notice or Order cannot be prior to 01/04/2024")


'            'Year changed by Aavula Naresh for  AY 2025-26
'            If EfilingCommon.checkFirstDateBefore(dob, "31/03/2025") Then
'            fmsgboxStatus ("Date of notice or Order cannot be prior to 01/04/2025")

            'Year changed by Aavula Naresh for  AY 2026-27
            If EfilingCommon.checkFirstDateBefore(dob, "31/03/2026") Then
            fmsgboxStatus ("Date of notice or Order cannot be prior to 01/04/2026")
'end---
            CheckNoticeDateBefore = False
            Exit Function
        Else
...
Function FormatNCheckDateDOF1B(ByRef dt As Variant, Optional Year As String = "2025") As Boolean
 On Error Resume Next
    FormatNCheckDateDOF1B = True
    If Len(dt) > 0 Then
        'Format the date in dd/mm/yyyy format
        If Mid(dt, 3, 1) <> "/" Then 'Checking between dd/mm
            If Mid(dt, 3, 1) = "\" Then
        ...
        If val(Mid(dt, 1, 2)) < 0 Or val(Mid(dt, 1, 2)) > 31 Then FormatNCheckDateDOF1B = False
        If val(Mid(dt, 4, 2)) < 0 Or val(Mid(dt, 4, 2)) > 12 Then FormatNCheckDateDOF1B = False
        If val(Mid(dt, 7, 4)) < 1900 Then FormatNCheckDateDOF1B = False

        If Not IsDate(dt) Then FormatNCheckDateDOF1B = False
...
Function ValidateSTDcode() As Boolean
    ...
    If Trim(Mid(STDcode, 1, 1)) = 0 Then
        fmsgboxStatus ("STDCode Do not prefix '0' before STD code in schedule Part A General")
        ValidateSTDcode = False
        Exit Function
    End If
    ...
    If Trim(STDcode) <> "" Then
        For i = 1 To Len(STDcode)
            If Not IsNumeric(Mid(STDcode, i, 1)) Then
                fmsgboxStatus ("STDcode must contain only digits from 0 to 9 in schedule Part A General")
                ValidateSTDcode = False
            Exit Function
            End If
        Next
...
'    If Len(PhoneNo) > 10 Then
    If Len(PhoneNo) > 12 Then 'AY 2024-25 Change added by Sai
        fmsgboxStatus ("Phone Number should be at most 12 digits in schedule Part A General")
    ...
    'SIT-91293 sadineni 13_09_2025
               fmsgboxStatus ("""Invalid Residential/Office Phone Number in schedule Part A General""")
            ValidatePhoneNo = False
            Exit Function
            End If
        Next
...
'        If (Len(PhoneNo) + Len(STDcode)) <> 10 Then
        If (Len(PhoneNo) + Len(STDcode)) > 12 Then 'AY 2024-25 Error Msg Change added by Sai
'            fmsgboxStatus ("STD Code & Phone Number should be 10 digits and STD code cannot begin from 0 in schedule Part A General")
             fmsgboxStatus ("""Invalid Phone Number. STD/ISD Code + Landline Number should be 12 digits and cannot begin with '0' in schedule Part A General""")
...
'    End If
     ...
     fmsgboxStatus ("Country Code in Secondary Mobile in Sheet: Personal Information is mandatory in schedule Part A General")
        ValidateMobileNoSec = False
        Exit Function
    End If
   ...
   If Sheet1.Range("CountryCode2").value <> "91" Then
    If Not (Len(Trim(MobileNo_2)) <= 10 And Len(Trim(MobileNo_2)) >= 5) Then
        fmsgboxStatus ("""Please enter a valid Secondary Mobile Number in schedule Part A General""")
        ValidateMobileNoSec = False
        Exit Function
    End If
    Else
...
'Common.MsgPISheet = ""
  'vbMessgaeCaption = "ITR 3: AY: 2017-18"
    ...
    'Notice Number Mandatory
        If Trim(Mid(Range("sheet1.ReturnFileSec1"), 1, 2)) = "17" Or Trim(Mid(Range("sheet1.ReturnFileSec1"), 1, 2)) = "18" Or Trim(Mid(Range("sheet1.ReturnFileSec1"), 1, 2)) = "19" Then
...
''Chane-ANK
'        If Not ValidateReceiptNo Then
'            MsgBx_General1 = MsgBx_General1 + "Receipt no. is mandatory in schedule Part A General"
'            Exit Function
'        End If
'        If Not ValidateDOF Then
''            MsgBx_General1 = MsgBx_General1 + "Date of filing of original return is mandatory In Sheet: Personal Information and cannot be prior to 01/04/2023"
' 'Error Msg Changed by Sai
''             MsgBx_General1 = MsgBx_General1 + "Date of filing of original return is mandatory In Sheet: Personal Information and cannot be prior to 01/04/2024"
'                 MsgBx_General1 = MsgBx_General1 + "Date of filing of original return is mandatory In Sheet: Personal Information and cannot be prior to 01/04/2025"
'
'            Exit Function
'        End If
''            MsgBx_General1 = MsgBx_General1 + "* Receipt Number And Date of Filing Original Return : Income Details is Mandatory" & Chr(13)
''            Exit Function
''---
'End If
'
...
'        MsgBx_General1 = MsgBx_General1 + "* Notice Date : Income Details is Mandatory" & Chr(13)
         'SIT-69189 Modified by Sai For AY 2024-25
        
'        MsgBx_General1 = MsgBx_General1 + "* Notice Date : Income Details is Mandatory" & Chr(13)
        MsgBx_General1 = MsgBx_General1 + "* ""Please enter the date of Notice u/s 139(9)/142(1)/148/153C/119(2)(b)/section 139 read with section 92CD in schedule Part A General" & Chr(13)
        Exit Function
        End If
        End If
'    End If
...
'         MsgBx_General1 = MsgBx_General1 + "* Unique number is mandatory for Filed in response to notice u/s is  139(9)/142(1)/148/153C or Filed u/s is 119(2)(b)-after condonation of delay in Part A General Information." & Chr(13)

   'Changed by sai on 20/09/2024
          MsgBx_General1 = MsgBx_General1 + "* Unique number is mandatory for Filed in response to notice u/s is  139(9)/142(1)/148/153C or Filed u/s is 139(9A) - After condonation of delay u/s 119(2)(b) in Part A General Information." & Chr(13)
...
'        If Trim(Mid(Range("sheet1.ReturnFileSec1"), 1, 2)) = "20" Then
...
'        End If
    ...
    If Trim(Mid(Range("sheet1.ReturnFileSec1"), 1, 2)) = "20" Or Trim(Mid(Range("sheet1.ReturnFileSec1"), 1, 2)) = "18" Then
        If Sheet1.Range("sheet1.NoticeDate").value = "" Then
'
        MsgBx_General1 = MsgBx_General1 + "* ""Please enter the date of Notice u/s 139(9)/142(1)/148/153C/119(2)(b)/section 139 read with section 92CD in schedule Part A General" & Chr(13)
...
On Error Resume Next
   ...
   If Trim(DOF) = "" Or Trim((DOF)) = "00/00/0000" Then
       ...
       'Common.MsgPISheet = Common.MsgPISheet + "* Date of filing is  Mandatory for return filed u/s 139(5)/139(9)/92CD" & Chr(13)
        'MsgBx_General1 = MsgBx_General1 + "* Date of filing is  Mandatory for return filed u/s 139(5)/139(9)/92CD" & Chr(13)
        MsgBx_General1 = MsgBx_General1 + "* Date of filing of original return is mandatory In Sheet: Personal Information and cannot be prior to 01/04/2025" & Chr(13)
        Exit Function
        ValidateDOF
    End If
    End If
...
'        MsgBx_General1 = MsgBx_General1 + "* Receipt no. is mandatory in schedule Part A General"
         MsgBx_General1 = MsgBx_General1 + "* Receipt no. is mandatory in schedule Part A General" & Chr(13)
        Exit Function
    End If
    End If
...
Function ValidateRepEmail() As Boolean
    ...
    Repemail = Sheet1.Range("Sheet1.RepEmail")
    If (AsseseeRepFlg_1 = "Y") Then
...
If Mid(Sheet1.Range("sheet1.ResidentialStatus1").value, 1, 3) = "NRI" Then
    If ((Sheet1.Range("sheet1.NRI_PE").value = "(Select)") Or (Sheet1.Range("sheet1.NRI_PE").value = "")) Then
      If Sheet1.Range("sheet1.NRI_PE").MergeArea.Locked = False Then
...
'Added by Aavula Naresh on 11/03/2026
...
If ((Sheet1.Range("sheet1.LiableSec5cflg").value = "" Or Sheet1.Range("sheet1.LiableSec5cflg").value = "(Select)")) Then
...
'Added by Aavula Naresh on 11/03/2026
  If Sheet1.Range("Sheet1.LiableSecAggrigateflg").MergeArea.Locked = False Then
'If ((Sheet1.Range("sheet1.LiableSec5cflg").value = "Yes") And (Sheet1.Range("sheet1.LiableSecAggrigateflg").value = "" Or Sheet1.Range("sheet1.LiableSecAggrigateflg").value = "(Select)")) Then
 If ((Sheet1.Range("sheet1.LiableSecAggrigateflg").value = "" Or Sheet1.Range("sheet1.LiableSecAggrigateflg").value = "(Select)")) Then
...
'Added by Aavula Naresh on 11/03/2026
  If Sheet1.Range("Sheet1.LiableSecAggrigate1flg").MergeArea.Locked = False Then
'If ((Sheet1.Range("sheet1.LiableSec5cflg").value = "Yes") And (Sheet1.Range("sheet1.LiableSecAggrigate1flg").value = "" Or Sheet1.Range("sheet1.LiableSecAggrigate1flg").value = "(Select)")) Then
 If ((Sheet1.Range("sheet1.LiableSecAggrigate1flg").value = "" Or Sheet1.Range("sheet1.LiableSecAggrigate1flg").value = "(Select)")) Then
...
Function Validate92ESec() As Boolean
    ...
    'Newly added by Sai For AY 2024-25
    AckNumberAuditDateSec92E = Sheet1.Range("Sheet1.AckNumAuditReport92E").value
...
'             MsgBx_General = MsgBx_General & "Please select a Date of audit report in Sheet : PART A - GENERAL" & Chr(13)
            MsgBx_General = MsgBx_General & """Please select a Date of audit report in schedule Part A General""" & Chr(13)
            Validate92ESec = False
'            Exit Function
        End If
     ...
     'Newly added by Sai For AY 2024-25
     If LiableSec92Eflgdia = "Y" Then
        If AckNumberAuditDateSec92E = "" Then
            MsgBx_General = MsgBx_General & """Please enter the Acknowledgment number""" & Chr(13)
            Validate92ESec = False
            Exit Function
        End If
      End If
...
'        If Not CheckDateMinDDMMYYYY(AuditDateSec92E, 1, 4, 2024, "Date of audit report in sheet PART A - General cannot be less than 01/04/2024") Then
'
''            MsgBx_General = MsgBx_General & "Date of audit report in Sheet : PART A - GENERAL  must not be less than 01/04/2021" & Chr(13)
'            MsgBx_General = MsgBx_General & "Date of audit report in Sheet : PART A - GENERAL  must not be less than 01/04/2024" & Chr(13)
'            Validate92ESec = False
'            Exit Function
'        End If
    Else
...
End If
'Newly added by Sai For AY 2024-25
   If Not Validate44AB_1 Then Validate44AB_accountant = False
   If Not Validate44AD_4ADA_AE_BB Then Validate44AB_accountant = False
...
'    If Not ValidateMemberShipNum Then Validate44AB_accountant = False
    ...
    If Not ValidateAckNumAudit Then Validate44AB_accountant = False
...
'Newly added by Sai For AY 2024-25------------------------------------
    ...
    'Commented by Aavula For AY 2026-27
'    If Not ValidateUDINAudit Then Validate44AB_accountant = False
   ''''''''
...
'Newly added by Sai For AY 2024-25
Function Validate44AD_4ADA_AE_BB() As Boolean

Validate44AD_4ADA_AE_BB = True

If Sheet1.Range("Sheet1.Condition_44AB").value <> "" Then

     If Mid(Sheet1.Range("Sheet1.Condition_44AB").value, 1, 3) = "bii" Then
     
     'added by sai on 31/12/2024
         If Mid(Sheet1.Range("Sheet1.Condition_44AB").value, 1, 4) <> "biii" Then

             If Sheet1.Range("Sheet1.bii").value = "" Or Sheet1.Range("Sheet1.bii_1").value = "" Or Sheet1.Range("Sheet1.bii_2").value = "" Or Sheet1.Range("Sheet1.bii_3").value = "" Then
             
             'For Testing
'              If Sheet1.Range("Sheet1.bii").value = "" And Sheet1.Range("Sheet1.bii_1").value = "" And Sheet1.Range("Sheet1.bii_2").value = "" And Sheet1.Range("Sheet1.bii_3").value = "" Then
             
              Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* Please select an apprpriate condtion by virtue of which you are liable for audit under section 44AD/44ADA/44AE/44BB in Audit information " & Chr(13)

              Validate44AD_4ADA_AE_BB = False
             End If
         End If
     End If
End If
...
Function Validate44AB_1() As Boolean

Validate44AB_1 = True

If Mid(Sheet1.Range("sheet1.LiableSec44ABflg").value, 1, 1) = "Y" Then

  If Sheet1.Range("Sheet1.Condition_44AB").value = "" And Not Sheet1.Range("Sheet1.Condition_44AB").Locked = True Then

    Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* Please select an appropriate condition by virtue of which you are liable for audit" & Chr(13)

    Validate44AB_1 = False
   End If
End If
...
'    Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* Please select a Date of furnishing of the audit report in schedule Part A General" & Chr(13)
    Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* Please select a Date of furnishing of the audit report." & Chr(13)
...
Function Validate_AuditorNAme() As Boolean
    ...
    If Sheet1.Range("sheet1.AudFrmName").value = "" Then
        Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* ""Please enter the name of the auditor in schedule Part A General""" & Chr(13)
        Validate_AuditorNAme = False
    End If
    
    If Sheet1.Range("sheet1.AudFrmName").value <> "" Then
       If Len(Sheet1.Range("sheet1.AudFrmName").value) > 125 Then
        Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* ""Name of the auditor cannot be more than 125 characters in schedule Part A General""" & Chr(13)
       End If
'       If Len(Sheet1.Range("sheet1.AudFrmName").value) < 125 Then
'        Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* ""Name of the auditor cannot be less than 125 characters in schedule Part A General""" & Chr(13)
'       End If
    End If
...
If Sheet1.Range("sheet1.AudFrmPAN").value = "" Then
    Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* ""Please enter the PAN of the proprietorship/firm.""" & Chr(13)
...
'    Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* Please enter Date of Report of the Audit in schedule Part A General" & Chr(13)
    Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* ""Please select a Date of audit report in Schedule Part A General.""" & Chr(13)
ValidateDateofAuditReport = False
End If
End Function

'Newly added by Sai For AY 2024-25
Function ValidateAckNumAudit() As Boolean
ValidateAckNumAudit = True
If Sheet1.Range("Sheet1.AckNumAuditReport").value = "" Then

'    Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* ""Please enter the Acknowledgment number""" & Chr(13)
'Added by Naresh For AY 2026-27
   Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* ""Please enter the Acknowledgment number of audit report in Schedule Part A General""" & Chr(13)
''''''''''

ValidateAckNumAudit = False
End If
End Function

'Newly added by Sai For AY 2024-25

Function ValidateUDINAudit() As Boolean
ValidateUDINAudit = True
If Sheet1.Range("Sheet1.UDINAuditNum").value = "" Then

    Msg_Bx_44ABAccount = Msg_Bx_44ABAccount + "* ""Please provide UDIN""." & Chr(13)
ValidateUDINAudit = False
End If
End Function
...
'    Dim i As Long
    ...
    For i = 1 To end_Shares1
        ...
        If Not chkCompulsory(Share_OP_Cost(i)) Then
            MsgBx_General = MsgBx_General + "* Please enter cost of acquisition for opening balance of unlisted shares at Sr.No " & i & "in schedule Part A General" & Chr(13)
...
Function ValidateAcquired_Shares() As Boolean
    ...
    For i = 1 To end_Shares1
        ...
        If chkCompulsory(Share_Acquired_Count(i)) Then
            ...
            If Not chkCompulsory(Share_Acquired_Date(i)) Then
                ...
                ValidateAcquired_Shares = False
            End If
            'Change-22.12.2022.102.022A
'            If Not ChkMaxDOBDate(Share_Acquired_Date(i), "31/03/2022") Then
'                MsgBx_General = MsgBx_General + ("Please enter date of subscription/purchase shares acquired during the year before 31/03/2022 in schedule Part A General. ")
'                ValidateAcquired_Shares = False
'            End If


           'Year changed by Sai from 2023 to 2024
'            If Not ChkMaxDOBDate_2324(Share_Acquired_Date(i), "31/03/2024") Then
'                MsgBx_General = MsgBx_General + ("Please enter date of subscription/purchase shares acquired during the year before 31/03/2024 in schedule Part A General. ") & Chr(13)
'                ValidateAcquired_Shares = False
'            End If

          'Year Change by Aavula Naresh for AY 2025-26
'            If Not ChkMaxDOBDate_2324(Share_Acquired_Date(i), "31/03/2025") Then
'                MsgBx_General = MsgBx_General + ("Please enter date of subscription/purchase shares acquired during the year before 31/03/2025 in schedule Part A General. ") & Chr(13)
'                ValidateAcquired_Shares = False
'            End If
            
           'end---
           If Not ChkMaxDOBDate_2324(Share_Acquired_Date(i), "31/03/2026") Then
                MsgBx_General = MsgBx_General + ("Please enter date of subscription/purchase shares acquired during the year before 31/03/2026 in schedule Part A General. ") & Chr(13)
                ValidateAcquired_Shares = False
            End If
...
pmsg = "“Since you are 'No' or 'Yes-but beyond due date' for New tax Regime u/s 115BAC. You will not be eligible to set-off House property loss and claim following deduction/allowances. Do you want to continue?"
pnew = Chr(10) + Chr(13)
...
pmsg = pmsg + pnew + "13.Chapter VIA Deduction (life insurance, health insurance premium, pension funds, provident fund, donation etc) except Contribution made by employer to notified pension scheme u/s 80CCD(2) & Deduction in respect of employment of new employees u/s 80JJAA, & deduction u/s 80CCH(2) "
 'End Change
pmsg = pmsg + pnew + "Do you want to proceed ?( Click Yes to Proceed)"

'answer = MsgBox(pmsg, vbQuestion + vbYes + vbDefaultButton2, "Confirmation")
...
ThisWorkbook.Unprotect Password:=getmsgstate
  ...
  'Newly added by Sai For 80GGC,80DD,80U Unvisible=====================================
...
'=======================================================================================================================
'Change-ANK
'Change-16.02.2023.103.PAG
'If Sheet1.Range("OptingNewTaxRegime").value = "Continue to opt" Then
'             Sheet1.Range("sheet1.capacityassessee").value = ""
'             Sheet1.Unprotect Password:=getmsgstate
'             Sheet1.Range("sheet1.capacityassessee").Interior.ColorIndex = 15  ', "AU"
'             Sheet1.Range("sheet1.capacityassessee").MergeArea.Locked = True
...
ThisWorkbook.Unprotect Password:=getmsgstate
 Sheet55.Unprotect Password:=getmsgstate
  ...
  'Newly added by Sai FOR 80GGC,80DD,80U visible=========================
  'Malli
     Sheet58.Unprotect Password:=getmsgstate
...
If answer <> vbYes Then
    ...
    Sheet1.Range("OptingNewTaxRegime").value = "(Select)"
End If
'Change-19.12.2022.102.06B
'reset10IEAy23_24         'Commented by Sai For AY 2023-24 Old
'CurrentYearOptionAY23_24 'Commented by Sai For AY 2023-24 Old
'end---
...
'commented by sai on 27/05/2025 as it was auto populated field and changed the logic as per DE V0.5 and V0.6
'*********************************************************************************************************************
'   Dim HpCount As Long
'
...
'Change-20.01.2023.101.AMTC.15B
    Sheet23.Unprotect Password:=getmsgstate
    ...
    '==================================================================================
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd1").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd1").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd1").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    '''''''''''
    
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd2").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd2").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd2").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    '''''''''''
    
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd3").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd3").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd3").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    '''''''''''
    
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    '''''''''''
    
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd5").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd5").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd5").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    '''''''''''
    
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd4").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd4").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd4").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    '''''''''''
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd6").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd6").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd6").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    '''''''''''
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd7").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd7").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd7").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd8").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd8").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd8").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd9").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd9").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd9").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd10").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd10").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd10").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd11").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd11").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd11").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd12").Interior.ColorIndex = 15   ', "AU"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd12").value = ""
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd12").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
...
'Change-20.01.2023.101.AMTC.15C
    ...
    Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd1").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd1-AMTC.AmtCreditUtilized1)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd1").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd1").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    
    Sheet23.Unprotect Password:=getmsgstate
        Sheet23.Range("AMTC.BalAmtCreditCarryFwd2").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd2-AMTC.AmtCreditUtilized2)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd2").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd2").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    
    Sheet23.Unprotect Password:=getmsgstate
     Sheet23.Range("AMTC.BalAmtCreditCarryFwd3").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd3-AMTC.AmtCreditUtilized3)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd3").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd3").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    
    Sheet23.Unprotect Password:=getmsgstate
        Sheet23.Range("AMTC.BalAmtCreditCarryFwd").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd-AMTC.AmtCreditUtilized)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate

Sheet23.Unprotect Password:=getmsgstate
        Sheet23.Range("AMTC.BalAmtCreditCarryFwd5").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd5-AMTC.AmtCreditUtilized5)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd5").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd5").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
    
    Sheet23.Unprotect Password:=getmsgstate
        Sheet23.Range("AMTC.BalAmtCreditCarryFwd4").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd4-AMTC.AmtCreditUtilized4)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd4").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd4").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate

Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd6").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd6-AMTC.AmtCreditUtilized6)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd6").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd6").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate

Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd7").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd7-AMTC.AmtCreditUtilized7)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd7").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd7").MergeArea.Locked = True

Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd8").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd8-AMTC.AmtCreditUtilized8)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd8").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd8").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate

Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd9").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd9-AMTC.AmtCreditUtilized9)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd9").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd9").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate

Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd10").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd10-AMTC.AmtCreditUtilized10)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd10").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd10").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate

Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd11").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd11-AMTC.AmtCreditUtilized11)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd11").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd11").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate

Sheet23.Unprotect Password:=getmsgstate
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd12").formula = "=IF(bacValue=1,0,MAX(0,(AMTC.AmtCreditBalBroughtFwd12-AMTC.AmtCreditUtilized12)))"
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd12").Interior.ColorIndex = 2
    Sheet23.Range("AMTC.BalAmtCreditCarryFwd12").MergeArea.Locked = True
    Sheet23.Protect Password:=getmsgstate
...
'Change-27.01.2023.101.CFL.6C
    Sheet17.Unprotect Password:=getmsgstate
    Sheet17.Range("yr2022.BusLossOthThanSpecLossCF12b").Interior.ColorIndex = 15   ', "AU"
    Sheet17.Range("yr2022.BusLossOthThanSpecLossCF12b").MergeArea.Locked = True
    Sheet17.Range("yr2022.BusLossOthThanSpecLossCF12b").ClearContents
    
    
'Newly added by Sai For AY 2024-25
   
    Sheet17.Unprotect Password:=getmsgstate
    Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13b").Interior.ColorIndex = 15   ', "AU"
    Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13b").MergeArea.Locked = True
    Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13b").ClearContents
    
    'Added by Aavula Naresh AY 2025-26

    Sheet17.Unprotect Password:=getmsgstate
    Sheet17.Range("yr2024.BusLossOthThanSpecLossCF14b").Interior.ColorIndex = 15   ', "AU"
    Sheet17.Range("yr2024.BusLossOthThanSpecLossCF14b").MergeArea.Locked = True
    Sheet17.Range("yr2024.BusLossOthThanSpecLossCF14b").ClearContents
    ''''''
    
   'Added by Aavula Naresh for AY 2026-27

    Sheet17.Unprotect Password:=getmsgstate
    Sheet17.Range("yr2025.BusLossOthThanSpecLossCF15b").Interior.ColorIndex = 15   ', "AU"
    Sheet17.Range("yr2025.BusLossOthThanSpecLossCF15b").MergeArea.Locked = True
    Sheet17.Range("yr2025.BusLossOthThanSpecLossCF15b").ClearContents
    ''''''
...
'Change-27.01.2023.101.CFL.6B
    Sheet17.Range("yr2022.BusLossOthThanSpecLossCF12b").Interior.Color = (&HCCFFCC)  ', "AU"
    Sheet17.Range("yr2022.BusLossOthThanSpecLossCF12b").Locked = False
    
    
  'newly added by Sai For AY 2024-25
    Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13b").Interior.Color = (&HCCFFCC)  ', "AU"
    Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13b").Locked = False
    
    'Added by Aavula Naresh AY 2025-26
    Sheet17.Range("yr2024.BusLossOthThanSpecLossCF14b").Interior.Color = (&HCCFFCC)  ', "AU"
    Sheet17.Range("yr2024.BusLossOthThanSpecLossCF14b").Locked = False
    '''
    'Added by Aavula Naresh AY 2026-27
    Sheet17.Range("yr2025.BusLossOthThanSpecLossCF15b").Interior.Color = (&HCCFFCC)  ', "AU"
    Sheet17.Range("yr2025.BusLossOthThanSpecLossCF15b").Locked = False
    '''
...
'commented by Chetan C M for Ay 2026-27---start---
'    Sheet19.Unprotect Password:=getmsgstate
...
'---end
    ...
    Sheet19.Unprotect Password:=getmsgstate
    Sheet19.Range("scvia.Section80DValue").Interior.ColorIndex = 15   'Added by Aavula Naresh
    Sheet19.Range("scvia.Section80DValue").MergeArea.Locked = True
    
    
    'SIT-91088 sadineni 15_09_2025
    
'    Sheet19.Unprotect Password:=getmsgstate
'    Sheet19.Range("scvia.Section80JJAA").Interior.ColorIndex = 15     'Added by Aavula Naresh
'    Sheet19.Range("scvia.Section80JJAA").MergeArea.Locked = True
'    Sheet19.Range("scvia.Section80JJAA").MergeArea.value = 0    'Malli_05/07/2025
    
    
    Sheet19.Unprotect Password:=getmsgstate
    Sheet19.Range("scvia.Section80IA").Interior.ColorIndex = 15     'Added by Aavula Naresh
    Sheet19.Range("scvia.Section80IA").MergeArea.Locked = True
    
    Sheet19.Unprotect Password:=getmsgstate
    Sheet19.Range("scvia.Section80IB").Interior.ColorIndex = 15     'Added by Aavula Naresh
    Sheet19.Range("scvia.Section80IB").MergeArea.Locked = True
...
'    Range("SELECT80U").value = "(Select)"
    ...
    Sheet19.Unprotect Password:=getmsgstate  'Malli_05/07/2025
    ...
    Sheet19.Unprotect Password:=getmsgstate
    Sheet19.Range("Sheet19.AckNum.10CCD").Interior.ColorIndex = 15   ', "AU"
    Sheet19.Range("Sheet19.AckNum.10CCD").MergeArea.Locked = True
...
'----end
     ...
     Sheet19.Range("scvia.Section80DValue").Interior.ColorIndex = xlNone   ', "AU"'Added by Aavula Naresh
     Sheet19.Range("scvia.Section80DValue").formula = "=Eligible_Amount_80D"
     Sheet19.Range("scvia.Section80DValue").MergeArea.Locked = True
...
'     Sheet19.Range("scvia.Section80JJAA").Interior.Color = (&HCCFFCC)     'Added by Aavula Naresh
'     Sheet19.Range("scvia.Section80JJAA").Locked = False
     
     
        Sheet19.Range("scvia.Section80IA").Interior.ColorIndex = xlNone   ', "AU"'Added by Aavula Naresh
        Sheet19.Range("scvia.Section80IA").formula = "=IA80.TotSchedule80_IA"
        Sheet19.Range("scvia.Section80IA").MergeArea.Locked = True
        
        Sheet19.Range("scvia.Section80IB").Interior.ColorIndex = xlNone ', "AU"'Added by Aavula Naresh
        Sheet19.Range("scvia.Section80IB").formula = "=IB80.TotSchedule80_IB"
        Sheet19.Range("scvia.Section80IB").MergeArea.Locked = True
...
'    Sheet19.Range("scvia.Section80EE").Locked = False
      ...
      Sheet19.Range("Sheet19.AckNum").Font.Color = vbBlack
...
'    Sheet19.Range("SELECT80U").value = "(Select)"
    ...
    Sheet19.Range("Sheet19.AckNum.10CCD").Interior.Color = (&HCCFFCC) ', "AU"
    Sheet19.Range("Sheet19.AckNum.10CCD").MergeArea.Locked = False
    Sheet19.Range("Sheet19.AckNum.10CCD").Font.Color = vbBlack
    ...
    Sheet19.Range("Sheet19.AckNum.10CCE").Font.Color = vbBlack
...
'    Sheet12.Range("ESR1ii.AmtUs35Allowable").formula = "=ROUND(IF(OR(Sheet1.OptOutNewTaxRegime=""No"",Sheet1.OptOutNewTaxRegime=""Yes-but beyond due date""),0,ESR1ii.AmtDebPL*1),0)"
...
'    Sheet12.Range("ESR1iia.AmtUs35Allowable").formula = "=ROUND(IF(OR(Sheet1.OptOutNewTaxRegime=""No"",Sheet1.OptOutNewTaxRegime=""Yes-but beyond due date""),0,ESR1iia.AmtDebPL*1),0)"
...
'    Sheet12.Range("ESR1iii.AmtUs35Allowable").formula = "=ROUND(IF(OR(Sheet1.OptOutNewTaxRegime=""No"",Sheet1.OptOutNewTaxRegime=""Yes-but beyond due date""),0,ESR1iii.AmtDebPL*1),0)"
...
'    Sheet12.Range("ESR2AA.AmtUs35Allowable").formula = "=ROUND(IF(OR(Sheet1.OptOutNewTaxRegime=""No"",Sheet1.OptOutNewTaxRegime=""Yes-but beyond due date""),0,ESR2AA.AmtDebPL*1),0)"
...
'    Sheet12.Range("ESR35CCC.AmtUs35Allowable").formula = "=ROUND(IF(OR(Sheet1.OptOutNewTaxRegime=""No"",Sheet1.OptOutNewTaxRegime=""Yes-but beyond due date""),0,ESR35CCC.AmtDebPL*1),0)"
    Sheet12.Protect Password:=getmsgstate
...
Sub resetDPMForYes() '1
   Application.EnableEvents = False
'Change-20.01.2023.101.DPM.2B
...
'    Sheet10.Range("DPM45.WDVFirstDay").value = ""
    ...
    'AY_2024_25 'Malli
    Sheet10.Range("DPM45.Adjmt2NDprov3section115BAC").Interior.ColorIndex = 15   ', "AU"
    Sheet10.Range("DPM45.Adjmt2NDprov3section115BAC").MergeArea.Locked = True
    Sheet10.Range("DPM45.Adjmt2NDprov3section115BAC").value = ""
...
'    Sheet9.Range("I19:I27").Locked = True
    ...
    'AY_2024_25 'ADD 'Malli
     Sheet10.Unprotect Password:=getmsgstate
    Sheet10.Range("DPM15.Adjmt2NDprov3section115BAC").Interior.Color = (&HCCFFCC)  ', "AU"
    Sheet10.Range("DPM15.Adjmt2NDprov3section115BAC").MergeArea.Locked = False
     
    Sheet10.Range("DPM30.Adjmt2NDprov3section115BAC").Interior.Color = (&HCCFFCC)  ', "AU"
    Sheet10.Range("DPM30.Adjmt2NDprov3section115BAC").MergeArea.Locked = False
     
    Sheet10.Range("DPM40.Adjmt2NDprov3section115BAC").Interior.Color = (&HCCFFCC)  ', "AU"
    Sheet10.Range("DPM40.Adjmt2NDprov3section115BAC").MergeArea.Locked = False
...
'    Sheet10.Range("DPM45.WDVFirstDay").MergeArea.Locked = False
    ...
    'AY_2024_25 ADD 'Malli
'    Sheet10.Range("DPM45.Adjmt2NDprov3section115BAC").Interior.Color = (&HCCFFCC)     ', "AU"
'    Sheet10.Range("DPM45.Adjmt2NDprov3section115BAC").MergeArea.Locked = False
    '---------------------
...
'    Sheet10.Range("DPM45.AddlnDeprlessthan180days").MergeArea.Locked = False
    ...
    'AY_2024_25 ADD 'Malli
    Sheet10.Unprotect Password:=getmsgstate
    Sheet10.Range("DPM15.Adjmt2NDprov3section115BAC").Interior.ColorIndex = 15   ', "AU"
    Sheet10.Range("DPM15.Adjmt2NDprov3section115BAC").MergeArea.Locked = True
    Sheet10.Range("DPM15.Adjmt2NDprov3section115BAC").value = ""
    
    Sheet10.Unprotect Password:=getmsgstate
    Sheet10.Range("DPM30.Adjmt2NDprov3section115BAC").Interior.ColorIndex = 15   ', "AU"
    Sheet10.Range("DPM30.Adjmt2NDprov3section115BAC").MergeArea.Locked = True
    Sheet10.Range("DPM30.Adjmt2NDprov3section115BAC").value = ""
    
    Sheet10.Unprotect Password:=getmsgstate
    Sheet10.Range("DPM40.Adjmt2NDprov3section115BAC").Interior.ColorIndex = 15   ', "AU"
    Sheet10.Range("DPM40.Adjmt2NDprov3section115BAC").MergeArea.Locked = True
    Sheet10.Range("DPM40.Adjmt2NDprov3section115BAC").value = ""
...
'Change.14.03.2023.102.IDS.17
'Function FormatNCheckDateVDA(ByRef dt As Variant, Optional Year As String = "2023") As Boolean
Function FormatNCheckDateVDA(ByRef dt As Variant, Optional Year As String = "2024") As Boolean 'Year Changed by Sai
 On Error Resume Next
    FormatNCheckDateVDA = True
    If Len(dt) > 0 Then
        'Format the date in dd/mm/yyyy format
        If Mid(dt, 3, 1) <> "/" Then 'Checking between dd/mm
            If Mid(dt, 3, 1) = "\" Then
        ...
        If val(Mid(dt, 1, 2)) < 0 Or val(Mid(dt, 1, 2)) > 31 Then FormatNCheckDateVDA = False
        If val(Mid(dt, 4, 2)) < 0 Or val(Mid(dt, 4, 2)) > 12 Then FormatNCheckDateVDA = False
        If val(Mid(dt, 7, 4)) < 1900 Then FormatNCheckDateVDA = False

        If Not IsDate(dt) Then FormatNCheckDateVDA = False
        
    End If
End Function
'End change.102.IDS.17
...
PAN = UCase(PAN)
    ...
    If Len(PAN) > 0 Then
      ...
      If Not ChkAlphabet(Mid(PAN, 4, 1)) Then
       ...
       'commented by Aavula Naresh AY 2025-26
...
Function ChkDPIIT(item As Variant) As Boolean
    ...
    If Len(item) < 5 Or Left(item, 4) <> "DIPP" Then
        ChkDPIIT = False
    ...
    If Len(numPart) < 3 Or Len(numPart) > 5 Then
        ChkDPIIT = False
        Range("ESOP.DPIIT").value = ""
        Exit Function
    End If

    Range("ESOP.DPIIT").value = item
    ChkDPIIT = True
End Function

'Newly added by Sai on 08/02/2024 For AY 2024-25
Function ChkDueDate() As Boolean
On Error Resume Next
    ChkDueDate = True
    ChkDate = Sheet1.Range("Sheet1.DueDate")
    
    If Trim(ChkDate) = "" Then
        ChkDueDate = False
        Exit Function
    End If
End Function
...
Dim Sebi As Variant
Sebi = Trim(Range("Sheet1.SEBI_Regn_No").value)
...
'Newly added Sai For Ay 2024-25


Function CheckSpecialCharacter_New_1(emailid As Variant) As Boolean
On Error Resume Next
    Dim specialCharArray As Variant
    Dim iCharCount, iSpecialChar As Long
...
Function UDINNo1() As Boolean
On Error Resume Next
    UDINNo1 = True
    
    
    
    Dim UDINNO As Variant

    
    UDINNO = Trim(Sheet1.Range("Sheet1.UDINAuditNum"))

    
    
    If UDINNO <> "" Then
        If Not CheckSpecialCharacter_New_1(UDINNO) Then
...
Function ValidateMobileNumber() As Boolean
    ...
    For i = 1 To Len(MobileNumber)
        If Not IsNumeric(Mid(MobileNumber, i, 1)) Then
             fmsgbox ("* ""Primary Mobile Number must contain only digits from 0 to 9 in Sheet Income Details""")
            ValidateMobileNumber = False
            Exit Function
        End If
        
       If (Mid(MobileNumber, 1, 1) = "0") Then
       fmsgbox ("* ""Primary Mobile Number cannot begin with '0' in sheet Income Details""")
            ValidateMobileNumber = False
            Exit Function
        End If
