...
Function ValidateLoanDate_80EEB() As Boolean
    ...
    For i = 1 To end_80EEB
        ...
        If Not chkCompulsory(LoanDate_80EEB(i)) Then
             MsgBox_80EEB = MsgBox_80EEB + "* ""Please provide Date of sanction of in schedule 80EEB."" at Sr. No " & i & "" & Chr(13)
...
Function ValidateLoanAmt_80EEB() As Boolean
    ...
    For i = 1 To end_80EEB
        ...
        If Not chkCompulsory(LoanAmt_80EEB(i)) Then
             MsgBox_80EEB = MsgBox_80EEB + "* ""Please provide Total Loan taken in schedule 80EEB"" at Sr. No " & i & "" & Chr(13)
