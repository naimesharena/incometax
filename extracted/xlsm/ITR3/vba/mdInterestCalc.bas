...
'Added by Riyaz on 26/02/2026
Public MonthsAfterDueDate As String
...
age1 = calculateAge(Sheet1.Range("sheet1.DOB").value)
If (age1 <= 59) Then
agestatus = "NC"
...
'Updated by Bindu on 8th June 26 as per DE Sheet V3, bacvalue = 2 adding for applicable elseif conditions
...
'''''''''''''''''''''''''''''''''''''''''''''Interest234C - Start''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    If Mid(Sheet1.Range("sheet1.Status").value, 1, 1) = "I" And (Mid(Sheet1.Range("sheet1.ResidentialStatus1").value, 1, 3) = "RES" Or Mid(Sheet1.Range("sheet1.ResidentialStatus1").value, 1, 3) = "NOR") And (agestatus = "SC" Or agestatus = "SSC") And Sheet9.Range("sheet12.IncChrgUnHdProftGain").value = 0 Then
        Sheet7.Range("Sheet9.IntrstPayUs234C").value = 0
    
    ElseIf Sheet7.Range("sheet9.GrossTaxPayable").value <> (Sheet7.Range("Sheet9.GrossTaxLiability").value - Sheet7.Range("sheet9.GrossTaxPayable_3b").value) Then
...
'''''''''''''''''''''''''''''''''''''''''''''Interest234B - Start''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
 ...
 'Added by Riyaz on 16/09/2025 for Senior citizen
...
Dim calcInterestPayable234A As Long
    ...
    Else
        For i = 1 To MonthsAfterDueDate
            calcInterestPayable234A = calcInterestPayable234A + Sheet33.Range("CG" & i + 9).value
...
Sub aa()
Call Calculate_InterestPayable234B(0, 0, 0, 0, 0, 0, 0)
End Sub
...
'Changed by Riyaz on 31/10/2025
        Sheet33.Unprotect Password:=EfilingCommon.getmsgstate
        Sheet33.Range("CI2").value = getDueDate
        Sheet33.Range("CI3").value = getDueDate
        Sheet33.Range("CI4").value = getDueDate
        Sheet33.Protect Password:=EfilingCommon.getmsgstate
...
'Added by Riyaz on 08/09/2025
       ...
       Sheet33.Protect Password:=EfilingCommon.getmsgstate
        ...
        '--Commented by Bindu on 8th June 26 as per Shubham bro
        'if tax liability is 10k then 234B shouldn't compute but 234A should work bcz of that commenting .. at the end of this function again checking
        'Tax liability & making 234B as Zero as per condition
...
'Changed by Riyaz on 03/10/2025 For testing purpose
        
'        dateOfProcessing = Sheet32.Range("DateOfFiling").value
         dateOfProcessing = Sheet52.Range("sheet9.Date").value
 
        
'        AssYear = 2025  '2025 to 2026 changed by Riyaz 26/02/2026
         AssYear = 2026
       ...
       carryForwardPrinicipal = carryForwardPrinicipal
                ...
                Dim MonthFlag As Boolean
                DueDate_1 = getDueDate
                
                MonthFlag = Enddateofthemonth(DueDate_1)

        If MonthFlag = True Then
            month_count_1 = (CLng(Mid(Dformat(DueDate_1, "yyyy-mm-dd"), 6, 2)) - 3)
        Else
...
'==================================================================================================================
'                    Sheet33.Unprotect Password:=EfilingCommon.getmsgstate
'                    Sheet33.Range("CB" & i + 4).value = calcIntrst234BOnPeriod
'                    Sheet33.Protect Password:=EfilingCommon.getmsgstate
'                    calcInterestPayable234B = calcInterestPayable234B + calcIntrst234BOnPeriod

'Updated by sadineni on 05/06/2026 as per Riyaz
                If (age1 > 59) And (Sheet9.Range("sheet12.NetPLAftAdjBusOthThanSpec").value + Sheet9.Range("sheet12.AdjustedPLFrmSpecuBus").value + Sheet9.Range("sheet12.AdjustedPLFrmSpecifiedBus").value) = 0 Then
                    calcIntrst234BOnPeriod = 0
                    Sheet33.Unprotect Password:=EfilingCommon.getmsgstate
                    Sheet33.Range("CB" & i + 4).value = calcIntrst234BOnPeriod
                    Sheet33.Protect Password:=EfilingCommon.getmsgstate
...
'by sadineni on 29/04/2026
 ...
 'by sadineni on 29/04/2026 for original return date diffrence month calc
                ...
                End If
                    ...
                    Else
                        If i = 1 Then
                            balanceInterest = Sheet33.Range("CG" & i + 4).value + carryForwardInterest + calcIntrst234BOnPeriod + intrstPayUs234C_1
                        ElseIf i = month_count_1 And getDueDate = Sheet33.Range("Q5").value Then
                            balanceInterest = Sheet33.Range("CG" & i + 4).value + carryForwardInterest + calcIntrst234BOnPeriod + intrstPayUs234F_1
                        ElseIf i = month_count_1 And getDueDate = Sheet33.Range("Q6").value Then
                            balanceInterest = Sheet33.Range("CG" & i + 4).value + carryForwardInterest + calcIntrst234BOnPeriod + intrstPayUs234F_1
                        ElseIf i = month_count_1 And getDueDate = Sheet33.Range("Q7").value Then
                            balanceInterest = Sheet33.Range("CG" & i + 4).value + carryForwardInterest + calcIntrst234BOnPeriod + intrstPayUs234F_1
                        ElseIf i <= Revisedmonthdiff Then
                            balanceInterest = Sheet33.Range("CG" & i + 4).value + carryForwardInterest + calcIntrst234BOnPeriod
                        Else
                            balanceInterest = carryForwardInterest + calcIntrst234BOnPeriod
...
'Added by Riyaz on 08/09/2025
                Sheet33.Unprotect Password:=EfilingCommon.getmsgstate
                Sheet33.Range("CD" & i + 5).value = balanceInterest
                Sheet33.Protect Password:=EfilingCommon.getmsgstate
                
                SATPaidAtPeriod = Application.WorksheetFunction.SumIf(Range("FormulaOfSAT1"), "=" & i, Range("IT.Amt"))

'Added by Riyaz on 08/09/2025
                Sheet33.Unprotect Password:=EfilingCommon.getmsgstate
                Sheet33.Range("CE" & i + 5).value = SATPaidAtPeriod
                Sheet33.Protect Password:=EfilingCommon.getmsgstate
...
'---Newly updated by Bindu on 8th June 26 as per Shubham bro
If ((SysCalculatedNetTaxLiability - (tdsamtused + tcsamtused)) >= CONST_NET_Limit And _
        matchedAdvanceTax < CONST_ATP_Limit / 100 * (SysCalculatedNetTaxLiability - (tdsamtused + tcsamtused))) Then
     Calculate_InterestPayable234B = WorksheetFunction.Round(calcInterestPayable234B, 0)
...
Sub filingdate()
    ...
    If retfilestatus = "18" Or _
       retfilestatus = "17" Or UpdatedY Then
    origrevisedstatus = "R"
    End If
...
'            If Not CheckDateMinDDMMYYYY(OrigRetFiledDate_1, 1, 4, 2022, "Original return filing date cannot be less than 01/04/2022") Then
...
'todaysdate1 = Dformat(Sheet52.Range("sheet9.Date").value, "yyyy-mm-dd")
...
'  Else
'        Altduedate = "30/11/2023"

'         Altduedate = "30/11/2024"   'Year Changed by Sai
         
         
'         Altduedate = "15/12/2024"     'Changed by sai on 06/12/2024 for Due date extended to 15th Dec 2024
          Altduedate = "30/11/2025"     'by sai on 28/03/2025 for AY 2025-26
...
'        Altduedate = "31/03/2020"
'  Else
'        Altduedate = "31/10/2024" 'Year Changed by Sai
        
        
'        Altduedate = "15/11/2024" 'Changed by sai on 16/10/2024-Bindu 27/11/24
         'Altduedate = "31/10/2025"  'by sai on 28/03/2025 for AY 2025-26
          Altduedate = Sheet33.Range("AuditcaseDate_44AB") 'Sadineni_30_10_2025
        
        
'        Altduedate = "31/10/2023"
        'Altduedate = "07/11/2022"
'    End If
Else
'    If Mid(Sheet1.Range("sheet1.StateCode1").value, 1, 2) = "14" Or Mid(Sheet1.Range("sheet1.StateCode1").value, 1, 2) = "37" Then
'    Altduedate = "31/03/2020"
'    Else
'    Altduedate = "31/07/2023"

'     Altduedate = "31/07/2024"  'Year Changed by Sai
'      Altduedate = "15/09/2025"  'by sai on 28/03/2025 for AY 2025-26
       Altduedate = Sheet33.Range("NonAudit_DueDate")
...
'UnCommented by sai on 20/12/2024 for 234F is getting Zero for carryforward loss case
...
'Commented by sai on 20/12/2024 for 234F is getting Zero for carryforward loss case
...
'ElseIf (Returnfiledstatus = "13" Or Returnfiledstatus = "11" Or Returnfiledstatus = "12" Or UpdatedN) And Range("Sheet8b.TotalIncome").value > 500000 And (VerificationDate1 > DueDate) And (VerificationDate1 <= "2024-12-31") Then '*chandru
' ElseIf (Returnfiledstatus = "13" Or Returnfiledstatus = "11" Or Returnfiledstatus = "12" Or UpdatedN) And Range("Sheet8b.TotalIncome").value > 500000 And (VerificationDate1 > DueDate) And (VerificationDate1 <= "2025-01-15") Then 'Changed by sai as Due Date extended from 31st Dec to 15th Jan 25
  ElseIf (Returnfiledstatus = "13" Or Returnfiledstatus = "11" Or Returnfiledstatus = "12" Or UpdatedN) And Range("Sheet8b.TotalIncome").value > 500000 And (VerificationDate1 > DueDate) And (VerificationDate1 <= "2025-12-31") Then 'Changed by sai for AY 2025-26
...
'ElseIf (Returnfiledstatus = "17" Or UpdatedY Or Returnfiledstatus = "18") And Range("Sheet8b.TotalIncome").value > 500000 And (DateOfFiling1 > DueDate) And (DateOfFiling1 <= "2024-12-31") Then '*chandru
' ElseIf (Returnfiledstatus = "17" Or UpdatedY Or Returnfiledstatus = "18") And Range("Sheet8b.TotalIncome").value > 500000 And (DateOfFiling1 > DueDate) And (DateOfFiling1 <= "2025-01-15") Then 'Changed by sai as Due Date extended from 31st Dec to 15th Jan 25
 ElseIf (Returnfiledstatus = "17" Or UpdatedY Or Returnfiledstatus = "18") And Range("Sheet8b.TotalIncome").value > 500000 And (DateOfFiling1 > DueDate) And (DateOfFiling1 <= "2025-12-31") Then 'Changed by sai as Due Date extended from 31st Dec to 15th Jan 25
intrstPayUs234F = 5000
Else
intrstPayUs234F = 5000
End If
...
'Changed by Riyaz on 26/02/2026 for testing purpose
'todaysdate1 = Sheet32.Range("DateOfProcessing").value
todaysdate1 = Dformat(Sheet52.Range("sheet9.Date").value, "yyyy-mm-dd")
...
'Changed by Riyaz on 26/02/2026
'          Altduedate = "30/11/2025"
          Altduedate = Sheet33.Range("AuditcaseDate_92E")
          
ElseIf (CheckAuditFLAG Or RepSec92EOtherFlag_2 Or CheckAuditFLAGIF Or Sheet29.Range("BooksSpouse44ABFlg").value = "Yes") Then

'Changed by Riyaz on 26/02/2026
         'Altduedate = "31/10/2025"
          Altduedate = Sheet33.Range("AuditcaseDate_44AB")

Else
'Changed by Riyaz on 26/02/2026
'      Altduedate = "15/09/2025"
        Altduedate = Sheet33.Range("NonAudit_DueDate")
End If
