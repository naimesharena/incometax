...
Public currCntAlwnc1, currCntAlwnc2, currCntAlwnc3, currCntAlwnc4, currCntAlwnc5, currCntAlwnc6, currCntAlwnc7, currCntAlwnc8, currCntAlwnc9, currCntAlwnc10, currCntAlwnc11, currCntAlwnc12, currCntAlwnc13, currCntAlwnc14, currCntAlwnc15, currCntAlwnc16 As Variant
...
'Modified by sai on 13/02/2025 For AY 2025-26
'EfilingCommon.DefinedgridNameRange = "LTCG.B9_PreviousYer_1||LTCG.B9_DeductionSection_1||LTCG.B9_AsstAcquiredYer_1||LTCG.B9_AmtUtilised_1||LTCG.B9_AmtNotUsed_1||LTCG.B9_dateof_limitorwithdrawal_1"

'by sadineni for AY 2026-27 on 26/02/2026
EfilingCommon.DefinedgridNameRange = "LTCG.B9_PreviousYer_1||LTCG.B9_DeductionSection_1||LTCG.B9_AsstAcquiredYer_1||LTCG.B9_AmtUtilised_1||LTCG.B9_AmtNotUsed_1"
...
Set previoussheet = ThisWorkbook.Sheets(ActiveSheet.index - 1)
...
Set nextsheet = ThisWorkbook.Sheets(ActiveSheet.index + 1)
nextsheet.Activate
'''''''''''
...
Function CountDropdown1(ByVal sDropdownValue As String, rangecells As Range, rangeCount As Long) As Long
    ...
    If Not IsEmpty(rangeValue) And UBound(rangeValue) > 0 Then
      For i = 1 To UBound(rangeValue)
       ...
       If Trim(sDropdownValue) = "Dearness Allowance(DA)" Then
       currCnt2 = currCnt2 + 1
       End If
       ...
       If Trim(sDropdownValue) = "House Rent Allowance(HRA)" Then
       currCnt4 = currCnt4 + 1
       End If

       If Trim(sDropdownValue) = "Leave Travel Allowance(LTA)" Then
       currCnt5 = currCnt5 + 1
       End If

       If Trim(sDropdownValue) = "Children Education Allowance(CEA)" Then
       currCnt6 = currCnt6 + 1
       End If
...
'       If Trim(sDropdownValue) = "Sec 10(5)-Leave Travel concession/assistance" Then
       If Trim(sDropdownValue) = "Sec 10(5)- Travel concession/assistance received" Then   'Added by Aavula Naresh on 16/05/2025
...
'calculateAge = (2023) - val(Mid(dob, 7, 4))
'calculateAge = (2024) - val(Mid(dob, 7, 4)) 'Year Changed by Sai

'calculateAge = (2025) - val(Mid(dob, 7, 4)) 'Changed by Aavula Naresh AY 2025-26

calculateAge = (2026) - val(Mid(dob, 7, 4)) 'changed by Chetan C M for AY 2026-27
...
'--Commenting by Bindu on 11th Feb 26 as per V0.01
...
'Newly added by sai on 24/02/2025================================================================
...
'Newly modified by sai on 17/02/2025 for AY 2025-26 DE 0.2
'====================================================================
rngname_CG = "STCG.A3ai_NRItaxSTTPaid||STCG.A3aii_NRItaxSTTPaid||STCG.A3b_NRItaxSTTNotPaid||STCG.A4aia_FullConsideration||STCG.A4aib_FullMarketvalue||STCG.A4aii_FullConsiderationS||STCG.A4bi_AquisitCost||STCG.A4bii_ImproveCost||STCG.A4biii_ExpOnTrans||STCG.A4d_LossSec94of7Or94of8"
LOCKRANGEcg (rngname_CG)
'=====================================================================


'$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
'modified by Sai as per the Requirement on 24/02/2025 For AY 2025-26

'For 6a sub points Lock
'******************************
Sheet13.Unprotect Password:=sPassword
'rngname_CG = "LTCG.B4ai_LTCGWithoutBenefit||LTCG.B4aii_LTCGWithoutBenefit||LTCG.B4aiii_LTCGWithoutBenefit"
'Updated by Bindu on 22nd Feb 26
rngname_CG = "LTCG.B4aiii_LTCGWithoutBenefit"

LOCKRANGEcg (rngname_CG)

'For 6b sub points Lock
'******************************
Sheet13.Unprotect Password:=sPassword
'rngname_CG = "LTCG.B06d_i_ExemptionGrandTotal||LTCG.B06d_ii_ExemptionGrandTotal||LTCG.B06d_iii_ExemptionGrandTotal"
'Updated by Bindu on 22nd Feb 26
rngname_CG = "LTCG.B06d_iii_ExemptionGrandTotal"
...
'*************************
Sheet13.Unprotect Password:=sPassword
' rngname_CG = "LTCG.B6aia_FullConsideration||LTCG.B6aib_FullMarketValue||LTCG.B6aii_FullConsiderationS||LTCG.B6aia_FullConsideration_ii||LTCG.B6aib_FullMarketValue_ii||LTCG.B6aii_FullConsiderationS_ii"
 'Updated By Binduon 18th Feb26
 rngname_CG = "LTCG.B6aia_FullConsideration_ii||LTCG.B6aib_FullMarketValue_ii||LTCG.B6aii_FullConsiderationS_ii"
...
'*************************
Sheet13.Unprotect Password:=sPassword
' rngname_CG = "LTCG.Bi5bi_AquisitCost||LTCG.Bi5bii_ImproveCost||LTCG.Bi5biii_ExpOnTrans||LTCG.B07dii_ExemptionGrandTotal||LTCG.Bi5bi_AquisitCost_ii||LTCG.Bi5bii_ImproveCost_ii||LTCG.Bi5biii_ExpOnTrans_ii||LTCG.B07dii_ExemptionGrandTotal_ii"
 'Updated by bindu on 18th feb 26
 rngname_CG = "LTCG.Bi5bi_AquisitCost_ii||LTCG.Bi5bii_ImproveCost_ii||LTCG.Bi5biii_ExpOnTrans_ii||LTCG.B07dii_ExemptionGrandTotal_ii"

LOCKRANGEcg (rngname_CG)


'For 7iiai Split Lock
'*************************
Sheet13.Unprotect Password:=sPassword
'rngname_CG = "LTCG.B6ibia_FullConsideration||LTCG.B6ibib_FullMarketValue||LTCG.B6ibii_FullConsideration50CA||LTCG.B6ibia_FullConsideration_ii||LTCG.B6ibib_FullMarketValue_ii||LTCG.B6ibii_FullConsideration50CA_ii"
'Updating by Bindu on 18th Feb 26
rngname_CG = "LTCG.B6ibia_FullConsideration_ii||LTCG.B6ibib_FullMarketValue_ii||LTCG.B6ibii_FullConsideration50CA_ii"

LOCKRANGEcg (rngname_CG)

'For 7iiai_bi Split Lock
'*************************
Sheet13.Unprotect Password:=sPassword
'rngname_CG = "LTCG.Bii5bi_AquisitCost||LTCG.Bii5bii_ImproveCost||LTCG.Bii5biii_ExpOnTrans||LTCG.B07div_ExemptionGrandTotal||LTCG.Bii5bi_AquisitCost_ii||LTCG.Bii5bii_ImproveCost_ii||LTCG.Bii5biii_ExpOnTrans_ii||LTCG.B07div_ExemptionGrandTotal_ii"
'Updated by Bindu on 18th feb 26
rngname_CG = "LTCG.Bii5bi_AquisitCost_ii||LTCG.Bii5bii_ImproveCost_ii||LTCG.Bii5biii_ExpOnTrans_ii||LTCG.B07div_ExemptionGrandTotal_ii"

LOCKRANGEcg (rngname_CG)


'For 7iiiai Split Lock
'*************************
Sheet13.Unprotect Password:=sPassword
rngname_CG = "LTCG.B6iiiaia_FullConsideration||LTCG.B6iiiaib_FullMarketValue||LTCG.B6iiiaii_FullConsiderationS||LTCG.Biii5bi_AquisitCost||LTCG.Biii5bii_ImproveCost||LTCG.Biii5biii_ExpOnTrans||LTCG.B07dv_ExemptionGrandTotal"
LOCKRANGEcg (rngname_CG)

'For 8bi Lock
'*************************
Sheet13.Unprotect Password:=sPassword
'rngname_CG = "LTCG.8_i.DeductionUnder54F||LTCG.8_ii.DeductionUnder54F"
'Updated by Bindu on 18th feb 26
rngname_CG = "LTCG.8_ii.DeductionUnder54F"

LOCKRANGEcg (rngname_CG)

'For 9ai and 9aii Lock
'***********************
Sheet13.Unprotect Password:=sPassword
'rngname_CG = "LTCG.B6ai_SaleonSpecAsset||LTCG.B6aii_SaleonSpecAsset"
'Updated by Bindu on 18th Feb 26
rngname_CG = "LTCG.B6aii_SaleonSpecAsset"
LOCKRANGEcg (rngname_CG)

'For 9bi and 9bii Lock
'***********************
Sheet13.Unprotect Password:=sPassword
'rngname_CG = "LTCG.B6bi_DednSpecAssetus115||LTCG.B6bii_DednSpecAssetus115"
'Updated by Bindu on 18th Feb 26
rngname_CG = "LTCG.B6bii_DednSpecAssetus115"


LOCKRANGEcg (rngname_CG)

'For 9di,9dii,9de Lock
'***********************
'rngname_CG = "LTCG.B6di_SaleOtherSpecAsset||LTCG.B6dii_SaleOtherSpecAsset"
'LOCKRANGEcg (rngname_CG)
...
'
'
''modified by sai on 18/02/2025 for AY 2025-26 as per DE 0.2
'rngname_CG = "LTCG.B07dii_ExemptionGrandTotal||LTCG.B07div_ExemptionGrandTotal||LTCG.B07dv_ExemptionGrandTotal"
'LOCKRANGEcg (rngname_CG)
...
Function checkfieldSuperSpecialcharacter(field As Variant) As Boolean
    ...
    Next
End Function
Function FormatNCheckDate80GGC(ByRef dt As Variant, Optional Year As String = "2025") As Boolean 'Change by Aavula
 On Error Resume Next
    FormatNCheckDate80GGC = True
    If Len(dt) > 0 Then
        ...
        If val(Mid(dt, 1, 2)) < 0 Or val(Mid(dt, 1, 2)) > 31 Then FormatNCheckDate80GGC = False
        If val(Mid(dt, 4, 2)) < 0 Or val(Mid(dt, 4, 2)) > 12 Then FormatNCheckDate80GGC = False
        If val(Mid(dt, 7, 4)) < 1900 Then FormatNCheckDate80GGC = False

        If Not IsDate(dt) Then FormatNCheckDate80GGC = False
...
'Commented by sai as per DE 0.2 for AY 2025-26
...
'
'
''commented by sai on 17/02/2025
'
''rngname_CG = "LTCG.8.DeductionUnder54F||LTCG.B06d_ExemptionGrandTotal||LTCG.B07dii_ExemptionGrandTotal||LTCG.B07div_ExemptionGrandTotal||LTCG.B07dv_ExemptionGrandTotal"
''UNLOCKRANGEcg (rngname_CG)
'
...
'---By Bindu on 11th feb 26
Sheet13.Range("STCG.A3a_NRItaxSTTPaid_i_ii").EntireRow.Hidden = True
Sheet13.Range("STCG.A3a_NRItaxSTTPaid").EntireRow.Hidden = True


'--Ends
Sheet13.Range("LTCG.B.NRI").EntireRow.Hidden = False
 '---BY Bindu on 18th Feb 26'
    Sheet13.Range("LTCG.Bi5e_CapgainonAssets").EntireRow.Hidden = True
    Sheet13.Range("LTCG.Bi5e_CapgainonAssets_ii").EntireRow.Hidden = True
    Sheet13.Range("LTCG.Bii5e_CapgainonAssets").EntireRow.Hidden = True
    Sheet13.Range("LTCG.Bii5e_CapgainonAssets_ii").EntireRow.Hidden = True
    Sheet13.Range("LTCG.Biii5eiii_CapgainonAssets").EntireRow.Hidden = True
    
    
    Sheet13.Range("LTCG.8.ai_LTCG_AfterThreshold").EntireRow.Hidden = True
    Sheet13.Range("LTCG.8.aii_LTCG_AfterThreshold").EntireRow.Hidden = True
    
    Sheet13.Range("LTCG.8.DeductionUnder54F").EntireRow.Hidden = True
    Sheet13.Range("LTCG.8_i.DeductionUnder54F").EntireRow.Hidden = True
    Sheet13.Range("LTCG.5.LTCG_AssetsB8Above").EntireRow.Hidden = True
    Sheet13.Range("LTCG.5.cii_LTCG_AssetsB8Above").EntireRow.Hidden = True
    
    Sheet13.Range("LTCG.B6ai_SaleonSpecAsset").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B6a_SaleonSpecAsset").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B6b_DednSpecAssetus115").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B6bi_DednSpecAssetus115").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B6cii_BalonSpeciAsset").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B6cii_BalonSpeciAsset").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B6c_BalonSpeciAsset").EntireRow.Hidden = True
    
    
    Sheet13.Range("LTCG.B4a_LTCGWithoutBenefit").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B4ai_LTCGWithoutBenefit").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B4aii_LTCGWithoutBenefit").EntireRow.Hidden = True
    
    Sheet13.Range("LTCG.B06d_ExemptionGrandTotal").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B06d_i_ExemptionGrandTotal").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B06d_ii_ExemptionGrandTotal").EntireRow.Hidden = True
    
    Sheet13.Range("LTCG.B4e_LTCGOnUnlistedSecurity").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B4eii_LTCGOnUnlistedSecurity").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B4eiii_LTCGOnUnlistedSecurity").EntireRow.Hidden = True
    
    Sheet13.Range("LTCG.B7e_CapgainonAssets_ii").EntireRow.Hidden = True
    Sheet13.Range("LTCG.B7e_CapgainonAssets").EntireRow.Hidden = True
...
month = calcNoOfMonths("23/09/2025", "22/09/2025")
Debug.Print month
End Sub
'Sadineni_08_09_2025
...
If getDueDate = Sheet33.Range("NonAudit_DueDate") Then 'Sadineni_08_09_2025
'    If Enddateofthemonth(startDate) Then               'Sadineni_08_09_2025
        currentMonth = val(Mid(currentDate, 4, 2)) + 1
Else
    currentMonth = val(Mid(currentDate, 4, 2))
'   End If
...
Else
   ...
   If (val(Mid(currentDate, 1, 2)) > val(Mid(startDate, 1, 2))) And (currentMonth = startmonth) Then
        ...
        'dpk2610
   'New change for Extended due of 15th Nov 2024
'   ElseIf val(Mid(startDate, 1, 2)) = 15 And (currentMonth >= startmonth) Then
    ElseIf val(Mid(startDate, 1, 2)) = 7 And (currentMonth >= startmonth) Then 'uncommented by sai on 17/04/2025 for AY 2025-26
...
'Newly change by Bindu as per Extended due date is 15th Nov 24
'If val(Mid(startDate, 1, 2)) = 15 And (currentYear > startyear) Then

If val(Mid(startDate, 1, 2)) = 7 And (currentYear > startyear) Then 'uncommented by sai on 17/04/2025 for AY 2025-26
        calcNoOfMonths = calcNoOfMonths + 1
End If
End If
End Function
...
'       taxPayable = 0
'
'ElseIf totInc >= 300001 And totInc <= 700000 Then
'
'        tempTax = (totInc - 300000) * (0.05)
'        taxPayable = Round(tempTax, 0)
'
'  ElseIf totInc >= 700001 And totInc <= 1000000 Then
'        tempTax = (totInc - 700000) * (0.1)
'        taxPayable = Round((tempTax + 20000), 0)
'
'  ElseIf totInc >= 1000001 And totInc <= 1200000 Then
'        tempTax = (totInc - 1000000) * (0.15)
'        taxPayable = Round((tempTax + 50000), 0)
'
'ElseIf totInc >= 1200001 And totInc <= 1500000 Then
'        tempTax = (totInc - 1200000) * (0.2)
'
'         taxPayable = Round((tempTax + 80000), 0)
'
'ElseIf totInc >= 1500001 Then
'        tempTax = (totInc - 1500000) * (0.3)
'
'        taxPayable = Round((tempTax + 140000), 0)
'
'End If
'
...
'Updated for AY 2026-27 by sadineni on 29/04/2026
...
Sheet61.Protect Password:=getmsgstate 'added by Chetan C M for AY 2025-26 on 27/05/2025
...
Function InsertRowsAndFillFormulas(Optional vRows As Long = 0) As Long
    ...
    For Each sht In _
        ...
        On Error Resume Next
        ActiveSheet.Unprotect Password:=sPassword 'Newly added by sai for SIT-73593 on 26/04/2024
...
Function InsertDiffRowsAndFillFormulasPART_A_GEN(Optional vRows As Long = 0) As Long
Sheet1.Activate
    Dim x As Long
    Dim sht As Worksheet
    Dim shts() As String
    ...
    If vRows = 0 Then
        ...
        Default:=1, Type:=1) 'Default for 1 row, type 1 is number
        If vRows = False Then
            InsertDiffRowsAndFillFormulasPART_A_GEN = 0
            Exit Function
        End If
    End If
    ...
    Worksheets(shts).Select
    Sheet1.Activate
    InsertDiffRowsAndFillFormulasPART_A_GEN = vRows
    Sheet1.Activate
    ActiveSheet.Protect Password:=sPassword
End Function

'Malli
'AY_2024_25 New Shedule ADDED
...
Function checkallfieldspecialcharacter_80U_80DD(field As Variant) As Boolean
    ...
    Next
End Function
Function CountDropdown_Leave(ByVal sDropdownValue As String, rangecells As Range, rangeCount As Long) As Long
...
If Not IsEmpty(rangeValue) And UBound(rangeValue) > 0 Then
    ...
    For i = 1 To UBound(rangeValue)
      'If Trim(rangeValue(i)) = Trim(sDropdownValue) And (IIf(Trim(rangeValue(i)) = "", "(Select)", Trim(rangeValue(i))) <> "(Select)") Then
          ...
          If Trim(rangeValue(i)) = "Leave Travel Allowance(LTA)" Then
             currCnt1 = currCnt1 + 1
           End If
       'End If
    Next
End If
CountDropdown_Leave = currCnt1
End Function
...
Function state_Validation_Level(sheetname1 As Worksheet, ByVal pin_trgt_adrs As String, ByVal state_trgt_adrs As String) As Boolean
    state_Validation_Level = True
    ...
    Dim PinCode As Range
            ...
            If Range(pin_trgt_adrs).value <> "" Then
              Dim state1 As String
                ...
                If state1 = True Then
                ' MsgBox ("Invalid Pincode")
                ' sheetname1.Range(pin_trgt_adrs).value = ""
                state_Validation_Level = False
                Else
                state1 = Application.VLookup(Range(pin_trgt_adrs).value, SheetALL.Range("All_PinCode_V"), 2, False)
                If Not (state1 = UCase(Mid(Range(state_trgt_adrs).value, 4)) Or EfilingCommon.StateMatchesPin(Range(state_trgt_adrs).value, Range(pin_trgt_adrs).value)) Then
                    state_Validation_Level = False
...
If DupFlag = False Then
   ...
   If IsError(StateName) Then
       ...
       End If
   Else
       StateCode = Application.VLookup(StateName, SheetALL.Range("ES:ET"), 2, False)
...
Function state_Validation_Levele2(sheetname1 As Worksheet, ByVal pin_trgt_adrs As String, ByVal state_trgt_adrs As String) As Boolean
    state_Validation_Levele2 = True
    ...
    Dim PinCode As Range
            ...
            If Range(pin_trgt_adrs).value <> "" Then
              Dim state1 As String
                ...
                If Not (state1 = UCase(Mid(Range(state_trgt_adrs).value, 4)) Or EfilingCommon.StateMatchesPin(Range(state_trgt_adrs).value, Range(pin_trgt_adrs).value)) Then
                    state_Validation_Levele2 = False
...
'added by Chetan C M for AY 2025-26 on 26/05/2025
'start--
