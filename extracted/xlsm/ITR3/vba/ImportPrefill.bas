...
'ImportTDSonSalary_pfl (jsonText)  'Malli commented replaced to below of schedule salary SIT_94677
ImportPartB_TTI (jsonText)
ImportScheduleS_Block (jsonText)
...
If (SheetALL.Range("bacValue").value) = 2 Then   'Malli_06/04/2026
ImportSchedule80D (jsonText)
End If
...
ESRImport (jsonText)
ImportScheduleCG_POPUPPfl (jsonText)   'Malli_AY_2026_27  15/04/2026
...
End If
ScheduleRA_pfl (jsonText)
ImportScheduleESOP (jsonText)

ImportVerification_pfl (jsonText)


''Malli Commented AY_2026-27 prefill posiability removed
...
If (SheetALL.Range("bacValue").value) = 2 Then  'Malli_06/04/2026
'TVN_Malli_AY_2025_26
ImportSchedule10AA (jsonText)
'----------------------------
End If

'Malli_AY_2026_27  11/02/2025
If (SheetALL.Range("bacValue").value) = 2 Then

'Malli_AY_2026_27 06/05/2026  SIT-118452
...
''Malli----------AY_2025_26_ITR-3_PrefillSRS_V0.3
...
If jsonObject("lastFiledITR").exists("natOfBus") Then
...
If jsonObject("form3CD").exists("NatOfBus") Then
If jsonObject("form3CD") <> Null Then
Set init = jsonObject("form3CD")("NatOfBus")
Set Nodelist = New Collection
    Set Nodelist = jsonObject("form3CD")("NatOfBus")("NatureOfBusiness")
End If
End If
...
'Konda updated on 08-10-2025-SIT-94690--SIT-91429
Set init = jsonObject("form26as")

If IsNull(jsonObject("form26as")) Then
Exit Function
End If

'If init.exists("scheduleTPSA") Then
''--------------------on 08-10-2025-SIT-94690--SIT-91429
''Konda updated on 10-09-2025--SIT-91546
''Set init = jsonObject("form26as")("ScheduleTPSA")
'Set init = jsonObject("form26as")("scheduleTPSA")
''------------on 10-09-2025--SIT-91546
...
'AY_2024_25 ADD
'MAlli'----------------Increase------------------------
If Sheet42.Range("ICDS.InAccPolicies").Locked = False Then
        Sheet42.Range("ICDS.InAccPolicies").value = jsonObject("form3CD")("ScheduleICDS2024")("AccPolicyAmt")("IncreaseInProfit")
    End If
    If Sheet42.Range("ICDS.InValuationInv").Locked = False Then
        Sheet42.Range("ICDS.InValuationInv").value = jsonObject("form3CD")("ScheduleICDS2024")("InventoriesValue")("IncreaseInProfit")
    End If
    If Sheet42.Range("ICDS.InConsContracts").Locked = False Then
        Sheet42.Range("ICDS.InConsContracts").value = jsonObject("form3CD")("ScheduleICDS2024")("ConstContractsAmt")("IncreaseInProfit")
    End If
    If Sheet42.Range("ICDS.InRevenueRecog").Locked = False Then
        Sheet42.Range("ICDS.InRevenueRecog").value = jsonObject("form3CD")("ScheduleICDS2024")("RevenueRcgAmt")("IncreaseInProfit")
    End If
    If Sheet42.Range("ICDS.InTangibleFixAssests").Locked = False Then
'Change-1, ANK-126, 26.05.2022
        Sheet42.Range("ICDS.InTangibleFixAssests").value = jsonObject("form3CD")("ScheduleICDS2024")("TangiableFixedAsset")("IncreaseInProfit")
'        Sheet42.Range("ICDS.TangibleFixAssests").value = jsonObject("form3CD")("ScheduleICDS")("TangibleFixedAsset")
'---
    End If
    If Sheet42.Range("ICDS.InChngRates").Locked = False Then
        Sheet42.Range("ICDS.InChngRates").value = jsonObject("form3CD")("ScheduleICDS2024")("ForeignExgRates")("IncreaseInProfit")
    End If
    If Sheet42.Range("ICDS.InGovgrants").Locked = False Then
        Sheet42.Range("ICDS.InGovgrants").value = jsonObject("form3CD")("ScheduleICDS2024")("GovtGrants")("IncreaseInProfit")
    End If
    If Sheet42.Range("ICDS.InSecurities").Locked = False Then
        Sheet42.Range("ICDS.InSecurities").value = jsonObject("form3CD")("ScheduleICDS2024")("Securities")("IncreaseInProfit")
    End If
    If Sheet42.Range("ICDS.InBorrowingCosts").Locked = False Then
        Sheet42.Range("ICDS.InBorrowingCosts").value = jsonObject("form3CD")("ScheduleICDS2024")("BorrowingCosts")("IncreaseInProfit")
    End If
    If Sheet42.Range("ICDS.InProvLiability").Locked = False Then
        Sheet42.Range("ICDS.InProvLiability").value = jsonObject("form3CD")("ScheduleICDS2024")("ProvAssets")("IncreaseInProfit")
    End If
'Malli--------------------Decrease
If Sheet42.Range("ICDS.DeAccPolicies").Locked = False Then
        Sheet42.Range("ICDS.DeAccPolicies").value = jsonObject("form3CD")("ScheduleICDS2024")("AccPolicyAmt")("DecreaseInProfit")
    End If
    If Sheet42.Range("ICDS.DeValuationInv").Locked = False Then
        Sheet42.Range("ICDS.DeValuationInv").value = jsonObject("form3CD")("ScheduleICDS2024")("InventoriesValue")("DecreaseInProfit")
    End If
    If Sheet42.Range("ICDS.DeConsContracts").Locked = False Then
        Sheet42.Range("ICDS.DeConsContracts").value = jsonObject("form3CD")("ScheduleICDS2024")("ConstContractsAmt")("DecreaseInProfit")
    End If
    If Sheet42.Range("ICDS.DeRevenueRecog").Locked = False Then
        Sheet42.Range("ICDS.DeRevenueRecog").value = jsonObject("form3CD")("ScheduleICDS2024")("RevenueRcgAmt")("DecreaseInProfit")
    End If
    If Sheet42.Range("ICDS.DeTangibleFixAssests").Locked = False Then
'Change-1, ANK-126, 26.05.2022
        Sheet42.Range("ICDS.DeTangibleFixAssests").value = jsonObject("form3CD")("ScheduleICDS2024")("TangiableFixedAsset")("DecreaseInProfit")
'        Sheet42.Range("ICDS.TangibleFixAssests").value = jsonObject("form3CD")("ScheduleICDS")("TangibleFixedAsset")
'---
    End If
    If Sheet42.Range("ICDS.DeChngRates").Locked = False Then
        Sheet42.Range("ICDS.DeChngRates").value = jsonObject("form3CD")("ScheduleICDS2024")("ForeignExgRates")("DecreaseInProfit")
    End If
    If Sheet42.Range("ICDS.DeGovgrants").Locked = False Then
        Sheet42.Range("ICDS.DeGovgrants").value = jsonObject("form3CD")("ScheduleICDS2024")("GovtGrants")("DecreaseInProfit")
    End If
    If Sheet42.Range("ICDS.DeSecurities").Locked = False Then
        Sheet42.Range("ICDS.DeSecurities").value = jsonObject("form3CD")("ScheduleICDS2024")("Securities")("DecreaseInProfit")
    End If
    If Sheet42.Range("ICDS.DeBorrowingCosts").Locked = False Then
        Sheet42.Range("ICDS.DeBorrowingCosts").value = jsonObject("form3CD")("ScheduleICDS2024")("BorrowingCosts")("DecreaseInProfit")
    End If
    If Sheet42.Range("ICDS.DeProvLiability").Locked = False Then
        Sheet42.Range("ICDS.DeProvLiability").value = jsonObject("form3CD")("ScheduleICDS2024")("ProvAssets")("DecreaseInProfit")
    End If
    '------------------------------------------------------------------
End Function
        ...
        For Each Node1 In nodeList1
            ...
            If Sheet13.Cells(rowcount, A7_AsstAcquiredYer_1).Locked = False Then
                ...
                ElseIf Node1("YrInWhichAssetAcq") = "2020" Then
                    Sheet13.Cells(rowcount, A7_AsstAcquiredYer_1).value = "2020-2021"
                End If
            End If
    ...
    If UnutilizedLtcgFlag = "Y" Then
        ...
        For Each Node1 In nodeList1
            ...
            If Sheet13.Cells(rowcount, B9_AsstAcquiredYer_1).Locked = False Then
                ...
                ElseIf Node1("YrInWhichAssetAcq") = "2020" Then
                    Sheet13.Cells(rowcount, B9_AsstAcquiredYer_1).value = "2020-2021"
                End If
            End If
...
'Commented and updated by Konda on 05-09-2025 SIT-94698---SIT-91316
...
If Sheet12.Range("ESR1i.AmtUs35Allowable").Locked = False Then
    Sheet12.Range("ESR1i.AmtUs35Allowable").value = jsonObject("form3CD")("ScheduleESR")("DeductionUs35")("Section351I")("DeductUs35")("AmtUs35Allowable")
End If
If Sheet12.Range("ESR1ii.AmtUs35Allowable").Locked = False Then
    Sheet12.Range("ESR1ii.AmtUs35Allowable").value = jsonObject("form3CD")("ScheduleESR")("DeductionUs35")("Section351Ii")("DeductUs35")("AmtUs35Allowable")
End If
If Sheet12.Range("ESR1iia.AmtUs35Allowable").Locked = False Then
    Sheet12.Range("ESR1iia.AmtUs35Allowable").value = jsonObject("form3CD")("ScheduleESR")("DeductionUs35")("Section351Iia")("DeductUs35")("AmtUs35Allowable")
End If
If Sheet12.Range("ESR1iii.AmtUs35Allowable").Locked = False Then
    Sheet12.Range("ESR1iii.AmtUs35Allowable").value = jsonObject("form3CD")("ScheduleESR")("DeductionUs35")("Section351Iii")("DeductUs35")("AmtUs35Allowable")
End If
If Sheet12.Range("ESR1iv.AmtUs35Allowable").Locked = False Then
    Sheet12.Range("ESR1iv.AmtUs35Allowable").value = jsonObject("form3CD")("ScheduleESR")("DeductionUs35")("Section351Iv")("DeductUs35")("AmtUs35Allowable")
End If
If Sheet12.Range("ESR2AA.AmtUs35Allowable").Locked = False Then
    Sheet12.Range("ESR2AA.AmtUs35Allowable").value = jsonObject("form3CD")("ScheduleESR")("DeductionUs35")("Section352AA")("deductUs35")("AmtUs35Allowable")
End If
If Sheet12.Range("ESR2AB.AmtUs35Allowable").Locked = False Then
    Sheet12.Range("ESR2AB.AmtUs35Allowable").value = jsonObject("form3CD")("ScheduleESR")("DeductionUs35")("Section352AB")("deductUs35")("AmtUs35Allowable")
End If
If Sheet12.Range("ESR35CCC.AmtUs35Allowable").Locked = False Then
    Sheet12.Range("ESR35CCC.AmtUs35Allowable").value = jsonObject("form3CD")("ScheduleESR")("DeductionUs35")("Section35CCC")("DeductUs35")("AmtUs35Allowable")
End If
If Sheet12.Range("ESR35CCD.AmtUs35Allowable").Locked = False Then
    Sheet12.Range("ESR35CCD.AmtUs35Allowable").value = jsonObject("form3CD")("ScheduleESR")("DeductionUs35")("Section35CCD")("DeductUs35")("AmtUs35Allowable")
End If
'---------------------------on 05-09-2025 SIT-94698--SIT-91316
...
If jsonObject.exists("form3CD") Then
...
If Sheet10.Range("RealizationTotalPeriod").Locked = False Then
    Sheet10.Range("RealizationTotalPeriod").value = jsonObject("form3CD")("ScheduleDPM")("PlantMachinery")("Rate15")("DepreciationDetail")("WdvFirstDay")
End If
If Sheet10.Range("DPM15.WDVFirstDay").Locked = False Then
    Sheet10.Range("DPM15.WDVFirstDay").value = jsonObject("form3CD")("ScheduleDPM")("PlantMachinery")("Rate15")("DepreciationDetail")("WdvfirstDay")
End If

If Sheet10.Range("DPM30.WDVFirstDay").Locked = False Then
    Sheet10.Range("DPM30.WDVFirstDay").value = jsonObject("form3CD")("ScheduleDPM")("PlantMachinery")("Rate30")("DepreciationDetail")("WdvfirstDay")
End If
If Sheet10.Range("DPM40.WDVFirstDay").Locked = False Then
    Sheet10.Range("DPM40.WDVFirstDay").value = jsonObject("form3CD")("ScheduleDPM")("PlantMachinery")("Rate40")("DepreciationDetail")("WdvfirstDay")
End If

If Sheet10.Range("DPM45.WDVFirstDay3").Locked = False Then
    Sheet10.Range("DPM45.WDVFirstDay3").value = jsonObject("form3CD")("ScheduleDPM")("PlantMachinery")("Rate45")("depreciationDetail")("wdvfirstDay")
End If

'Change-10, Test-019, Remark - Adding form3CD values
If Sheet10.Range("DAOB5.WDVFirstDay").Locked = False Then
    Sheet10.Range("DAOB5.WDVFirstDay").value = jsonObject("form3CD")("ScheduleDOA")("building")("Rate5")("DepreciationDetail")("WdvfirstDay")
End If
If Sheet10.Range("DAOB10.WDVFirstDay").Locked = False Then
    Sheet10.Range("DAOB10.WDVFirstDay").value = jsonObject("form3CD")("ScheduleDOA")("building")("Rate10")("DepreciationDetail")("WdvfirstDay")
End If
If Sheet10.Range("DAOB100.WDVFirstDay").Locked = False Then
    Sheet10.Range("DAOB100.WDVFirstDay").value = jsonObject("form3CD")("ScheduleDOA")("building")("Rate40")("DepreciationDetail")("WdvfirstDay")
End If

End If     'uncommented By Konda on 05-09-2025 SIT-94765--SIT-91369
'Else       'Commented by Kondaon 05-09-2025 SIT-94765--SIT-91369

'ElseIf jsonObject.exists("lastFiledITR") Then
'AY_2024_25 Changes  Malli
If jsonObject.exists("lastFiledITR") Then       'updated by Konda on 05-09-2025 SIT-94765--SIT-91369
If Sheet10.Range("DPM15.WDVFirstDayBAC").Locked = False Then
    'Sheet10.Range("DPM15.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("PlantMachinery")("ScheduleDPM")("Rate15")("DepreciationDetail")("AdjustAccTax115BACAmt")
    'Sheet10.Range("DPM15.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("PlantMachinery")("scheduleDPM")("Rate15")("DepreciationDetail")("AdjustAccTax115BACAmt")
    
    Sheet10.Range("DPM15.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate15")("DepreciationDetail")("AdjustAccTax115BACAmt")
End If
If Sheet10.Range("DPM30.WDVFirstDayBAC").Locked = False Then
    'Sheet10.Range("DPM30.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("PlantMachinery")("ScheduleDPM")("Rate30")("DepreciationDetail")("AdjustAccTax115BACAmt")
    'Sheet10.Range("DPM30.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("PlantMachinery")("scheduleDPM")("Rate30")("DepreciationDetail")("AdjustAccTax115BACAmt")
    
    Sheet10.Range("DPM30.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate30")("DepreciationDetail")("AdjustAccTax115BACAmt")
End If

If Sheet10.Range("DPM40.WDVFirstDayBAC").Locked = False Then
    'Sheet10.Range("DPM40.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("PlantMachinery")("ScheduleDPM")("Rate40")("DepreciationDetail")("AdjustAccTax115BACAmt")
    'Sheet10.Range("DPM40.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("PlantMachinery")("scheduleDPM")("Rate40")("DepreciationDetail")("AdjustAccTax115BACAmt")
    
      Sheet10.Range("DPM40.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate40")("DepreciationDetail")("AdjustAccTax115BACAmt")
End If

If Sheet10.Range("DPM45.WDVFirstDayBAC").Locked = False Then
    'Sheet10.Range("DPM45.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("PlantMachinery")("ScheduleDPM")("Rate45")("DepreciationDetail")("AdjustAccTax115BACAmt")
    'Sheet10.Range("DPM45.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("PlantMachinery")("scheduleDPM")("Rate45")("DepreciationDetail")("AdjustAccTax115BACAmt")
    
     Sheet10.Range("DPM45.WDVFirstDayBAC").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate45")("DepreciationDetail")("AdjustAccTax115BACAmt")
End If

If Sheet10.Range("DPM15.AdditionsGrThan180Days").Locked = False Then
    'Sheet10.Range("DPM15.AdditionsGrThan180Days").value = jsonObject("lastFiledITR")("ScheduleDPM")("PlantMachinery")("Rate15")("DepreciationDetail")("AdditionsGrThan180Days")
     Sheet10.Range("DPM15.AdditionsGrThan180Days").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate15")("DepreciationDetail")("AdditionsGrThan180Days")
End If

If Sheet10.Range("DPM30.AdditionsGrThan180Days").Locked = False Then
    'Sheet10.Range("DPM30.AdditionsGrThan180Days").value = jsonObject("lastFiledITR")("ScheduleDPM")("PlantMachinery")("Rate30")("DepreciationDetail")("AdditionsGrThan180Days")
     Sheet10.Range("DPM30.AdditionsGrThan180Days").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate30")("DepreciationDetail")("AdditionsGrThan180Days")
End If

If Sheet10.Range("DPM40.AdditionsGrThan180Days").Locked = False Then
    'Sheet10.Range("DPM40.AdditionsGrThan180Days").value = jsonObject("lastFiledITR")("ScheduleDPM")("PlantMachinery")("Rate40")("DepreciationDetail")("AdditionsGrThan180Days")
    Sheet10.Range("DPM40.AdditionsGrThan180Days").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate40")("DepreciationDetail")("AdditionsGrThan180Days")
End If

If Sheet10.Range("DPM45.AdditionsGrThan180Days").Locked = False Then
    'Sheet10.Range("DPM45.AdditionsGrThan180Days").value = jsonObject("lastFiledITR")("ScheduleDPM")("PlantMachinery")("Rate45")("DepreciationDetail")("AdditionsGrThan180Days")
     Sheet10.Range("DPM45.AdditionsGrThan180Days").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate45")("DepreciationDetail")("AdditionsGrThan180Days")
End If

If Sheet10.Range("DPM15.AdditionsLessThan180Days").Locked = False Then
    'Sheet10.Range("DPM15.AdditionsLessThan180Days").value = jsonObject("lastFiledITR")("ScheduleDPM")("PlantMachinery")("Rate15")("DepreciationDetail")("AdditionsLessThan180Days")
     Sheet10.Range("DPM15.AdditionsLessThan180Days").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate15")("DepreciationDetail")("AdditionsLessThan180Days")
End If

If Sheet10.Range("DPM30.AdditionsLessThan180Days").Locked = False Then
    'Sheet10.Range("DPM30.AdditionsLessThan180Days").value = jsonObject("lastFiledITR")("ScheduleDPM")("PlantMachinery")("Rate30")("DepreciationDetail")("AdditionsLessThan180Days")
    Sheet10.Range("DPM30.AdditionsLessThan180Days").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate30")("DepreciationDetail")("AdditionsLessThan180Days")
End If
If Sheet10.Range("DPM40.AdditionsLessThan180Days").Locked = False Then
    
    'Sheet10.Range("DPM40.AdditionsLessThan180Days").value = jsonObject("lastFiledITR")("ScheduleDPM")("PlantMachinery")("Rate40")("DepreciationDetail")("AdditionsLessThan180Days")
    Sheet10.Range("DPM40.AdditionsLessThan180Days").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate40")("DepreciationDetail")("AdditionsLessThan180Days")
End If

If Sheet10.Range("DPM45.AdditionsLessThan180Days").Locked = False Then
    'Sheet10.Range("DPM45.AdditionsLessThan180Days").value = jsonObject("lastFiledITR")("ScheduleDPM")("PlantMachinery")("Rate45")("DepreciationDetail")("AdditionsLessThan180Days")
    Sheet10.Range("DPM45.AdditionsLessThan180Days").value = jsonObject("lastFiledITR")("scheduleDPM")("PlantMachinery")("Rate45")("DepreciationDetail")("AdditionsLessThan180Days")
End If
...
'TVN_Malli_AY_2025_26
If Sheet10.Range("DAOF10.AdditionsGrThan180Days").Locked = False Then
    Sheet10.Range("DAOF10.AdditionsGrThan180Days").value = jsonObject("form3CD")("ScheduleDOA")("furnitureFittings")("Rate10")("DepreciationDetail")("AdditionsGrThan180Days")
End If

If Sheet10.Range("DAOI25.AdditionsGrThan180Days").Locked = False Then
    Sheet10.Range("DAOI25.AdditionsGrThan180Days").value = jsonObject("form3CD")("ScheduleDOA")("intangibleAssets")("Rate25")("DepreciationDetail")("AdditionsGrThan180Days")
End If

If Sheet10.Range("DAOS20.AdditionsGrThan180Days").Locked = False Then
    Sheet10.Range("DAOS20.AdditionsGrThan180Days").value = jsonObject("form3CD")("ScheduleDOA")("ships")("Rate20")("DepreciationDetail")("AdditionsGrThan180Days")
End If



If Sheet10.Range("DAOF10.AdditionsLessThan180Days").Locked = False Then
    Sheet10.Range("DAOF10.AdditionsLessThan180Days").value = jsonObject("form3CD")("ScheduleDOA")("furnitureFittings")("Rate10")("DepreciationDetail")("AdditionsLessThan180Days")
End If

If Sheet10.Range("DAOI25.AdditionsLessThan180Days").Locked = False Then
    Sheet10.Range("DAOI25.AdditionsLessThan180Days").value = jsonObject("form3CD")("ScheduleDOA")("intangibleAssets")("Rate25")("DepreciationDetail")("AdditionsLessThan180Days")
End If

If Sheet10.Range("DAOS20.AdditionsLessThan180Days").Locked = False Then
    Sheet10.Range("DAOS20.AdditionsLessThan180Days").value = jsonObject("form3CD")("ScheduleDOA")("ships")("Rate20")("DepreciationDetail")("AdditionsLessThan180Days")
End If



If Sheet10.Range("DPM15.Adjmt2NDprov3section115BAC").Locked = False Then
    Sheet10.Range("DPM15.Adjmt2NDprov3section115BAC").value = jsonObject("form3CD")("ScheduleDPM")("PlantMachinery")("Rate15")("DepreciationDetail")("AdjustmentSec115BAC")
End If

If Sheet10.Range("DPM30.Adjmt2NDprov3section115BAC").Locked = False Then
    Sheet10.Range("DPM30.Adjmt2NDprov3section115BAC").value = jsonObject("form3CD")("ScheduleDPM")("PlantMachinery")("Rate30")("DepreciationDetail")("AdjustmentSec115BAC")
End If

If Sheet10.Range("DPM40.Adjmt2NDprov3section115BAC").Locked = False Then
    Sheet10.Range("DPM40.Adjmt2NDprov3section115BAC").value = jsonObject("form3CD")("ScheduleDPM")("PlantMachinery")("Rate40")("DepreciationDetail")("AdjustmentSec115BAC")
End If

'Note: we are not prefilling this field for 45%
'If Sheet10.Range("DPM45.Adjmt2NDprov3section115BAC").Locked = False Then
'    Sheet10.Range("DPM45.Adjmt2NDprov3section115BAC").value = jsonObject("form3CD")("PlantMachinery")("ScheduleDPM")("Rate45")("DepreciationDetail")("AdjustmentSec115BAC")
'End If
...
'Malli_AY_2026_27 18/02/2026  field is autopopulated
'Dim Section44B
...
''TVN_Malli_AY_2025_26
'Dim Section44BBC
'Section44BBC = jsonObject("form3CD")("ScheduleBP")("DeemedProfitBusUs")("Section44BBC")
'If Section44BBC <> "" And Sheet9.Range("sheet11.Section44BBC").Locked = False Then
'    Sheet9.Range("sheet11.Section44BBC").value = UCase(Section44BBC)
'End If
''-----------------------
'Dim Section44BB
...
Dim Section44DA
Section44DA = jsonObject("form3CE")("ScheduleBP")("DeemedProfitBusUs")("Section44DA")
If Section44DA <> "" And Sheet9.Range("sheet12.Section44DA").Locked = False Then
    Sheet9.Range("sheet12.Section44DA").value = Section44DA
End If
...
Dim ChangeInAcctMethFlg, EffectOnPL, DecProOrIncLossUs145_A, ValRawMaterial, ValFinishedGoods, ChngStockValMetFlg As Variant
    Set jsonObject = ParseJson.ParseJson(jsonText)
'Konda updated on 05-09-2025-SIT-94690--SIT-91429
Dim ScheduleTPSAFlg_FLG, ScheduleTPSAFlg_Imp
...
''        End If
        ...
        If Sheet5.Range("sheet6.IntOnBorrCap").Locked = False Then
           ...
           'Malli_29/03/2025
             Sheet5.Range("sheet6.IntOnBorrCap").value = jsonObject("form3CD")("PartAOI")("AmtDisallUs36")("IntOnBorrCap")
        End If
        '--------------
...
'        End If
        ...
        End If
         'Jyoti25026 need to confirm remmove it or not
        '--------------
        'Malli_AY_2026-27 prefill posibility removed
...
'        End If
        ...
        End If
'uncommented By Konda on 05-09-2025 SIT-94680--SIT-91381
        If Sheet5.Range("shee6.NonComp40aiiChapXVIIBAmt").Locked = False Then
            Sheet5.Range("shee6.NonComp40aiiChapXVIIBAmt").value = jsonObject("form3CD")("PartAOI")("AmtDisallUs40")("NonComp40AiiChapXVIIBAmt")
        End If
'------------------on 05-09-2025 SIT-94680--SIT-91381
...
'        End If
        ...
        End If
        If Sheet5.Range("J76").Locked = False Then
            Sheet5.Range("J76").value = jsonObject("form3CD")("PartAOI")("AmtDisallUs43BPyNowAll")("AmtUs43B")("IntPayaleToFINBFC")
        End If
        ...
        'POI_C81_AY_2024_25 ADD 'Malli
'        If Sheet5.Range("Sheet7.MSEPayable").Locked = False Then
'            Sheet5.Range("Sheet7.MSEPayable").value = jsonObject("form3CD")("PartAOI")("AmtDisallUs43BPyNowAll")("AmtUs43B")("Msepayable")
'        End If
''
        ''Malli----------AY_2025_26_ITR-3_PrefillSRS_V0.3
'        If Sheet5.Range("sheet7.MiSmlMediumEntps").Locked = False Then
'            Sheet5.Range("sheet7.MiSmlMediumEntps").value = jsonObject("form3CD")("PartAOI")("AmtDisallUs43BPyNowAll")("AmtUs43B")("Msepayable")
'        End If
        '-----------------------
...
'        End If
        ...
        'POI_C92_AY_2024_25 ADD 'Malli
'        If Sheet5.Range("Sheet7.MSEPayable1").Locked = False Then
'            Sheet5.Range("Sheet7.MSEPayable1").value = jsonObject("form3CD")("PartAOI")("AmtDisall43B")("AmtUs43B")("Msepayable")
'        End If


'un commented Malli_AY_2026_27 06/05/2026 SIT-117773
'       'Malli----------AY_2025_26_ITR-3_PrefillSRS_V0.3
          If Sheet5.Range("sheet7.MiSmlMediumEntps_payable").Locked = False Then
            Sheet5.Range("sheet7.MiSmlMediumEntps_payable").value = jsonObject("form3CD")("PartAOI")("AmtDisall43B")("AmtUs43B")("Msepayable")
        End If
'        '---------------------------------
        
        
'        If Sheet5.Range("sheet7.MSEPayable1").Locked = False Then
'            Sheet5.Range("sheet7.MSEPayable1").value = jsonObject("form3CD")("PartAOI")("AmtDisall43B")("AmtUs43B")("MSEPayable1")
'        End If
        '------------------------------
...
'        End If
        ...
        'Malli_AY_2026_27  06/05/2026  SIT-117773
        'form3CD.PartAOI.interestDisAllowUs23SMEAct
        If Sheet5.Range("sheet7.Intrestsec23").Locked = False Then
            Sheet5.Range("sheet7.Intrestsec23").value = jsonObject("form3CD")("PartAOI")("interestDisAllowUs23SMEAct")
        End If
        '----------------------------------------
...
'Konda updated on 05-09-2025-SIT-94690--SIT-91429
            'Sheet5.Range("sheet7.Section92CE_Flag").value = jsonObject("form3CD")("PartAOI")("ScheduleTPSAFlg")
            ScheduleTPSAFlg_FLG = jsonObject("form3CD")("PartAOI")("ScheduleTPSAFlg")
            If ScheduleTPSAFlg_FLG = "Y" Then
                ScheduleTPSAFlg_Imp = "Yes"
             ElseIf ScheduleTPSAFlg_FLG = "N" Then
                ScheduleTPSAFlg_Imp = "No"
            End If
            Sheet5.Range("sheet7.Section92CE_Flag").value = Trim(ScheduleTPSAFlg_Imp)
 '------------------on 05-09-2025-SIT-94690---SIT-91429
        End If
...
On Error Resume Next
    ...
    Dim TDSCreditName, PanOtherPerson, Aadhar_TDS3, PAN, Aadhaar, DeductedYear, BroughtFwdTDSAmt, TDSSectiondeducted_TDS3 As Variant
    ...
    Dim TDSSection_Gen, sectioncode As Variant
...
'    Set nodeList = jsonObject("form26as")("scheduleTDS3Dtls")
    ...
    'Malli----------AY_2025_26_ITR-3_PrefillSRS_V0.3
     TDSSectiondeducted_TDS3 = Sheet28.Range("TDS3.TdsIsDeducted").Column
    '----------------------------------------------
    ...
    For Each Node In Nodelist
        ...
        ElseIf UCase(TDSCreditName_TDS3) = "O" Then
            TDSCreditName_TDS3 = "Other Person"
        Else
            TDSCreditName_TDS3 = "(Select)"
        End If
        'Malli
        '
...
'        End If
      ...
      If sectioncode <> "" Then
                   ...
                   ' TDSSection_Gen = "194I(b)-Rent on other than plant and machinery"
                    ...
                    'ElseIf sectioncode = UCase("4IA") Then
                    ElseIf sectioncode = UCase("9IA") Then
                    TDSSection_Gen = "194IA-TDS on Sale of immovable property"

                    'ElseIf sectioncode = UCase("4IB") Then
                    ElseIf sectioncode = UCase("9IB") Then
                    TDSSection_Gen = "194IB-Payment of rent by certain individuals or Hindu undivided"

                    ElseIf sectioncode = UCase("4IC") Then
                    TDSSection_Gen = "194IC-Payment under specified agreement"

                    'ElseIf sectioncode = UCase("94J-A") Then
                    ElseIf sectioncode = UCase("4JA") Then
                    TDSSection_Gen = "194J(a)-Fees for technical services"

                    'ElseIf sectioncode = UCase("94J-B") Then
                    ElseIf sectioncode = UCase("4JB") Then
                    TDSSection_Gen = "194J(b)-Fees for professional  services or royalty etc"

                    ElseIf sectioncode = UCase("94K") Then
...
'--------------------------------------------------------------------------------------------
                    ...
                    'ElseIf sectioncode = UCase("94B-P") Then
                    ElseIf sectioncode = UCase("4BP") Then
                    ...
                    'ElseIf sectioncode = UCase("94R-P") Then
                    ElseIf sectioncode = UCase("4RP") Then
                    ...
                    'ElseIf sectioncodeE = UCase("94S-P") Then
                    ElseIf sectioncode = UCase("4SP") Then
                    ...
                    'ElseIf sectioncodeE = UCase("94N-C") Then
                    ElseIf sectioncode = UCase("4NC") Then
                    ...
                    'ElseIf sectioncodeE = UCase("94N-FT") Then
                    ElseIf sectioncode = UCase("NFT") Then
                 ...
                 If TDSSection_Gen <> "" Then
                     Sheet28.Cells(rowcount, TDSSectiondeducted_TDS3).value = TDSSection_Gen
                     sectioncode = ""
                 End If
...
'AadhaarOfSpouse = jsonObject("lastFiledITR")("schedule5A2014")("AadhaarOfSpouse")

AadhaarOfSpouse = jsonObject("lastFiledITR")("schedule5A2014")("aadharOfSpouse")   'aadharOfSpouse
...
If init.exists("schedulePTIDtls") Then
   ...
   'Malli
    'Set Nodelist = jsonObject("form64A")("schedulePTI")("schedulePTIDtls")("capitalGainsPTI")
    ...
    For Each Node In Nodelist
            ...
            InvstmntCvrdUs115UA115UB = UCase(Node(("InvstmntCvrdUs115UA115UB")))
                ...
                ElseIf InvstmntCvrdUs115UA115UB = "B" Then
                   ...
                   'TVN_Malli_AY_2025_26
                ElseIf InvstmntCvrdUs115UA115UB = "C" Then
                   InvstmntCvrdUs115UA115UB = "SECTION 115U"
                   '---------------------------------
                Else
...
'commented by malli on 19/06/2025
'*************************************************************************************************************
...
If Not IsNull(jsonObject("ScheduleEI")) Then    'For AY 2025-26_Konda_25_07_2025 SIT-97378
    ...
    For Each Node In Nodelist
        rowcount = rowcount + 1
            ...
            If Sheet24.Cells(rowcount, NatureOfIncome).Locked = False Then
                If Node("NatureDesc") = "OTH" Then
                    Sheet24.Cells(rowcount, NatureOfIncome).value = "Any other"
                    'Malli_28/08/2025
                ElseIf Node("NatureDesc") = "DMDP" Then
...
'            Range("SchAL.b.Cash").value = CashInHand
        ...
        'Malli''''''''''''''''''
        'AL_C68_AY_2024_25 Change 'Malli
...
'Malli-----------------11/06/2025
'Dim NodeRefund As Object
'Set NodeRefund = jsonObject("incDeductionsOthIncCPC")
'For Each Node In NodeRefund
'
...
'Newly added by Jyoti 'AY_2025_26 OS_ this field is autopopulated
'AY_2024_25 Add Jyoti25026
...
'                End If
           ...
           If AssYr = "2020-21" Then
                ...
                End If
    'Konda updated on 08-09-2025--SIT-94808--SIT-91378
...
'                End If
                ...
                End If
'---------------------on 08-09-2025--SIT-94808--SIT-91378
                If Sheet23.Range("AMTC.AmtCreditUtilized7").Locked = False Then
...
'Set jsonObject = ParseJson.ParseJson(jsonText)
'
'Set init = jsonObject("form26as")("scheduleHP")
...
'            End If
'
'            'MsgBox (Nodelist2("aadhaarofTenant"))
'
'                If Sheet8.Range("HP.AnnualLetableValue" & rowcount).Locked = False Then
'                    Sheet8.Range("HP.AnnualLetableValue" & rowcount).value = UCase(Node("grossRent"))
'                End If
'
...
'----------- Riyaz & Konda
 If jsonObject("personalInfo").exists("filingStatus") Then
        If jsonObject("personalInfo")("filingStatus").exists("residentialStatus") Then
...
'----------------
'Uncommented By Konda on 10-09-2025--SIT-94747
...
'    If jsonObject("filingStatus").exists("NewTaxRegime") Then
'    If jsonObject("filingStatus")("NewTaxRegime") = "Y" Then
'        Sheet1.Shapes("BacYes").OLEFormat.Object.value = 1
'        BacYesValueChange
'    ElseIf jsonObject("filingStatus")("NewTaxRegime") = "N" Then
...
'        Sheet1.Range("AYinOpting").value = jsonObject("filingStatus")("AYOptedIn")
'    End If
'    If Sheet1.Range("Sheet1.date10IE_Opt").Locked = False Then
'    Dim DateOfFilingdate10IE_Opt As String
'        DateOfFilingdate10IE_Opt = Mid(jsonObject("filingStatus")("NewForm10IEDate"), 9, 2) & "/" & Mid(jsonObject("filingStatus")("NewForm10IEDate"), 6, 2) & "/" & Mid(jsonObject("filingStatus")("NewForm10IEDate"), 1, 4)
'        Sheet1.Range("Sheet1.date10IE_Opt").value = DateOfFilingdate10IE_Opt
'    End If
'    If Sheet1.Range("Sheet1.acknowledgementNumber_Opt").Locked = False Then
'        Sheet1.Range("Sheet1.acknowledgementNumber_Opt").value = jsonObject("filingStatus")("NewForm10IEAckNo")
'    End If
    
    '---------------------------Malli
    'Malli comented------------------
'    If Sheet1.Range("Opt_Out115BAC").Locked = False Then
'            Dim OprionOptout115BAc As String
'            If jsonObject("filingStatus")("OldTaxRegime") = "Y" Then
'            OprionOptout115BAc = "Yes"
'            ElseIf jsonObject("filingStatus")("OldTaxRegime") = "N" Then
'            OprionOptout115BAc = "No"
'            End If
'        Sheet1.Range("Opt_Out115BAC").value = OprionOptout115BAc
'    End If
    
    'Malli comented------------------
    
'    If Sheet1.Range("AYinOptOut").Locked = False Then
'        Sheet1.Range("AYinOptOut").value = jsonObject("filingStatus")("AYOptedOut")
'    End If
'    If Sheet1.Range("Sheet1.date10IE_OptOut").Locked = False Then
'    Dim DateOfFilingdate10IE_Optout As String
'        DateOfFilingdate10IE_Optout = Mid(jsonObject("filingStatus")("OldForm10IEDate"), 9, 2) & "/" & Mid(jsonObject("filingStatus")("OldForm10IEDate"), 6, 2) & "/" & Mid(jsonObject("filingStatus")("OldForm10IEDate"), 1, 4)
'        Sheet1.Range("Sheet1.date10IE_OptOut").value = DateOfFilingdate10IE_Optout
'    End If
'    If Sheet1.Range("Sheet1.acknowledgementNumber_OptOut").Locked = False Then
'        Sheet1.Range("Sheet1.acknowledgementNumber_OptOut").value = jsonObject("filingStatus")("OldForm10IEAckNo")
'    End If
...
'    End If
    ...
    'Malli-------------------------------
'    If jsonObject.exists("filingStatus") And jsonObject("filingStatus") <> Null Then
'    If jsonObject("filingStatus").exists("OptOutNewTaxRegime") Then
'    If jsonObject("filingStatus")("OptOutNewTaxRegime") = "YBD" Then
'        Sheet1.Range("OptingNewTaxRegime").value = "Yes-but beyond due date"
       'NewBacYesValueChange
'    ElseIf jsonObject("filingStatus")("OptingNewTaxRegime") = "YWD" Then
'
'        Sheet1.Range("OptingNewTaxRegime").value = "Yes-within due date"
'NewBacNoValueChange
'    ElseIf jsonObject("filingStatus")("OptingNewTaxRegime") = "N" Then
'
...
'TVN_Malli_AY_2025_26-------------------------comented by Malli
 
''For SIT-70494 Modified by Sai on 29/02/2024
'    If jsonObject.exists("filingStatus") And jsonObject("filingStatus") <> Null Then
'            If jsonObject("filingStatus").exists("OptOutNewTaxRegime") Then
'              If jsonObject("filingStatus")("OptOutNewTaxRegime") = "B" Then
'                Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "Yes-but beyond due date"
'                NewBacYesValueChange
'
'                ElseIf jsonObject("filingStatus")("OptOutNewTaxRegime") = "N" Then
'                Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "No"
'                NewBacYesValueChange
'
'                ElseIf jsonObject("filingStatus")("OptOutNewTaxRegime") = "Y" Then
'                Sheet1.Range("Sheet1.OptOutNewTaxRegime").value = "Yes-within due date"
'                NewBacNoValueChange
'
'          End If
'        End If
...
'    '------------------------------------
'
'    'PAG1_C50_AY_2024_25 Change 'Malli
'    If Sheet1.Range("Sheet1.Form10IEADate").Locked = False Then
'        Dim Form10IEADateReqdFormat As String
'        Form10IEADateReqdFormat = Mid(jsonObject("Form10IEA")("dateOfFiling"), 9, 2) & "/" & Mid(jsonObject("Form10IEA")("dateOfFiling"), 6, 2) & "/" & Mid(jsonObject("Form10IEA")("dateOfFiling"), 1, 4)
'        Sheet1.Range("Sheet1.Form10IEADate").value = Form10IEADateReqdFormat
'    End If
'    'PAG1_C51_AY_2024_25 Change 'Malli
'    If Sheet1.Range("Sheet1.Form10IEAAckNo").Locked = False Then
'        Sheet1.Range("Sheet1.Form10IEAAckNo").value = jsonObject("Form10IEA")("acknNumber")
'    End If
    '---------------------------
        
        
'Malli_AY_2026-27  06/04/2026  Change
'    'TVN_Malli_AY_2025_26--------------------------------------------------------------------------------------
'
''If jsonObject.exists("Form10IEA") And jsonObject("Form10IEA") <> Null Then
'If jsonObject.exists("Form10IEA") Then
'
'    Dim OptOutNewTaxRegime_AY24_25_P, Form10IEADate_AY24_25_P, Form10IEAAckNo_AY24_25_P, filedForm10IEA_P, acknNumber_P, dateOfFiling_P As Variant
'
'
'    OptOutNewTaxRegime_AY24_25_P = jsonObject("Form10IEA")("OptOutNewTaxRegime_AY24_25")
'    Form10IEADate_AY24_25_P = jsonObject("Form10IEA")("Form10IEADate_AY24_25")
'    Form10IEAAckNo_AY24_25_P = jsonObject("Form10IEA")("Form10IEAAckNo_AY24_25")
'
'    dateOfFiling_P = jsonObject("Form10IEA")("dateOfFiling")
'    acknNumber_P = jsonObject("Form10IEA")("acknNumber")
'    filedForm10IEA_P = jsonObject("Form10IEA")("filedForm10IEA")
'
'
'
''If UCase(OptOutNewTaxRegime_AY24_25_P) = "NA" Or OptOutNewTaxRegime_AY24_25_P = "" Then
'If UCase(OptOutNewTaxRegime_AY24_25_P) = "NA" Or OptOutNewTaxRegime_AY24_25_P = "" Or Not jsonObject("Form10IEA").exists("OptOutNewTaxRegime_AY24_25") Then
'
'                    If Sheet1.Range("Sheet1.MethodofOptOutNewTaxRegime").Locked = False Then
'                        Sheet1.Range("Sheet1.MethodofOptOutNewTaxRegime").value = "by exercising the option in the return of income only (form 10IEA is not applicable)"
'                    End If
'
'                    OptOutNewTaxregime_25_26
'
'                    If Sheet1.Range("Sheet1.OptOutNewTaxRegimeSetB").Locked = False Then
'                        Sheet1.Range("Sheet1.OptOutNewTaxRegimeSetB").value = "No"
'                        NewTaxRegime_New
'                    End If
'
'
'
'ElseIf UCase(OptOutNewTaxRegime_AY24_25_P) = "YES" Or UCase(OptOutNewTaxRegime_AY24_25_P) = "NO" Or UCase(OptOutNewTaxRegime_AY24_25_P) = "Y" Or UCase(OptOutNewTaxRegime_AY24_25_P) = "N" Then
'
'    If Sheet1.Range("Sheet1.MethodofOptOutNewTaxRegime").Locked = False Then
'        Sheet1.Range("Sheet1.MethodofOptOutNewTaxRegime").value = "by filing 10IEA (having income from business or profession)"
'    End If
'            OptOutNewTaxregime_25_26
'
'            If UCase(OptOutNewTaxRegime_AY24_25_P) = "YES" Or UCase(OptOutNewTaxRegime_AY24_25_P) = "Y" Then
'                    If Sheet1.Range("Sheet1.115BAC").Locked = False Then
'                       Sheet1.Range("Sheet1.115BAC").value = "Yes"
'                    End If
'                    Taxregime_25_26
'
'                    If Form10IEADate_AY24_25_P <> "" And Sheet1.Range("BAC115.DateOfFiling").Locked = False Then
'                       Sheet1.Range("BAC115.DateOfFiling").value = Mid(Form10IEADate_AY24_25_P, 9, 2) & "/" & Mid(Form10IEADate_AY24_25_P, 6, 2) & "/" & Mid(Form10IEADate_AY24_25_P, 1, 4)
'                    End If
'                    If Form10IEAAckNo_AY24_25_P <> "" And Sheet1.Range("BAC115.AcknowledgementNo").Locked = False Then
'                       Sheet1.Range("BAC115.AcknowledgementNo").value = Form10IEAAckNo_AY24_25_P
'                    End If
'
'                    If filedForm10IEA_P <> "" And Sheet1.Range("Sheet1.OptOutNewTaxRegime_New_Yes").Locked = False Then
'                            If UCase(filedForm10IEA_P) = "YES" Or UCase(filedForm10IEA_P) = "Y" Then
'                                Sheet1.Range("Sheet1.OptOutNewTaxRegime_New_Yes").value = "Yes"
'                            ElseIf UCase(filedForm10IEA_P) = "NO" Or UCase(filedForm10IEA_P) = "N" Then
'                                Sheet1.Range("Sheet1.OptOutNewTaxRegime_New_Yes").value = "No"
'                            End If
'                            Taxregime_25_26_A
'
'                            If dateOfFiling_P <> "" And Sheet1.Range("BAC115.DateOfFiling_New_Yes").Locked = False Then
'                                Sheet1.Range("BAC115.DateOfFiling_New_Yes").value = Mid(dateOfFiling_P, 9, 2) & "/" & Mid(dateOfFiling_P, 6, 2) & "/" & Mid(dateOfFiling_P, 1, 4)
'                            End If
'                            If acknNumber_P <> "" And Sheet1.Range("BAC115.AcknowledgementNo_New_Yes").Locked = False Then
'                                Sheet1.Range("BAC115.AcknowledgementNo_New_Yes").value = acknNumber_P
'                            End If
'
'                     End If
'
...
'
'
'             ElseIf UCase(OptOutNewTaxRegime_AY24_25_P) = "NO" Or UCase(OptOutNewTaxRegime_AY24_25_P) = "N" Then
'                   If Sheet1.Range("Sheet1.115BAC").Locked = False Then
'                       Sheet1.Range("Sheet1.115BAC").value = "No"
'                    End If
'                    Taxregime_25_26
'                    If filedForm10IEA_P <> "" And Sheet1.Range("Sheet1.OptOutNewTaxRegime_New_No").Locked = False Then
'                            If UCase(filedForm10IEA_P) = "YES" Or UCase(filedForm10IEA_P) = "Y" Then
...
'                            Taxregime_25_26_B
'
'                            If dateOfFiling_P <> "" And Sheet1.Range("BAC115.DateOfFiling_New_No").Locked = False Then
'                                Sheet1.Range("BAC115.DateOfFiling_New_No").value = Mid(dateOfFiling_P, 9, 2) & "/" & Mid(dateOfFiling_P, 6, 2) & "/" & Mid(dateOfFiling_P, 1, 4)
'                            End If
'                            If acknNumber_P <> "" And Sheet1.Range("BAC115.AcknowledgementNo_New_No").Locked = False Then
'                                Sheet1.Range("BAC115.AcknowledgementNo_New_No").value = acknNumber_P
'                            End If
'
'                     End If
'
...
' End If
 ...
 'Malli_AY_2026-27 06/04/2026<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
 'lastFiledITR.incFrmBusOrProf
 'Form10IEA.form10IEAEarlierAYOldRegime
 'Form10IEA.form10IEAAssYear
 'Form10IEA.form10IEAEarlierAYAckOldRegime
 'Form10IEA.f10IEAEarlierAYNewRegime
 'Form10IEA.assYrF10IEANewTaxReg
 'Form10IEA.form10IEAEarlierAYAckNewRegime
 'Form10IEA.f10IEACurrAYNewRegime
 'Form10IEA.f10IEADateCurrAYNewTax
 'Form10IEA.f10IEAAckNoCurrAYNewTax
 'Form10IEA.f10IEACurrAYOldRegime
 'Form10IEA.f10IEADateCurrAYOldTax
 'Form10IEA.f10IEAAckNoCurrAYOldTax
 
 
 Dim incFrmBusOrProf_pfl, form10IEAEarlierAYOldRegime_pfl, form10IEAAssYear_pfl, form10IEAEarlierAYAckOldRegime_pfl, f10IEAEarlierAYNewRegime_pfl, assYrF10IEANewTaxReg_pfl, form10IEAEarlierAYAckNewRegime_pfl, f10IEACurrAYNewRegime_pfl, f10IEADateCurrAYNewTax_pfl, f10IEAAckNoCurrAYNewTax_pfl, f10IEACurrAYOldRegime_pfl, f10IEADateCurrAYOldTax_pfl, f10IEAAckNoCurrAYOldTax_pfl As Variant
 incFrmBusOrProf_pfl = jsonObject("lastFiledITR")("incFrmBusOrProf")
...
If incFrmBusOrProf_pfl <> "" Then

        If UCase(incFrmBusOrProf_pfl) = UCase("Y") Or UCase(incFrmBusOrProf_pfl) = UCase("YES") Then
                    If Sheet1.Range("Sheet1.BusiProfAssyr").Locked = False Then
                    Sheet1.Range("Sheet1.BusiProfAssyr").value = "Yes"
                    BusiProfAssyr_26_27
                    End If
                    ...
                    If form10IEAEarlierAYOldRegime_pfl <> "" Then
                        ...
                        If UCase(form10IEAEarlierAYOldRegime_pfl) = UCase("Y") Or UCase(form10IEAEarlierAYOldRegime_pfl) = UCase("YES") Then
                                    ...
                                    If Sheet1.Range("Sheet1.Form10IEAoldtax").Locked = False Then
                                    Sheet1.Range("Sheet1.Form10IEAoldtax").value = "Yes"
                                    Form10IEAoldtax_26_27
                                    End If
                                    
                                    If form10IEAAssYear_pfl <> "" And Sheet1.Range("Sheet1.AssYr_IA").Locked = False Then
                                           Sheet1.Range("Sheet1.AssYr_IA").value = form10IEAAssYear_pfl
                                    End If
                                    
                                    If form10IEAEarlierAYAckOldRegime_pfl <> "" And Sheet1.Range("Sheet1.AckNo_IA").Locked = False Then
                                           Sheet1.Range("Sheet1.AckNo_IA").value = form10IEAEarlierAYAckOldRegime_pfl
                                    End If
                                    ...
                                    If f10IEAEarlierAYNewRegime_pfl <> "" Then
                                        If UCase(f10IEAEarlierAYNewRegime_pfl) = UCase("Y") Or UCase(f10IEAEarlierAYNewRegime_pfl) = UCase("YES") Then
                                                    ...
                                                    If Sheet1.Range("Sheet1.Form10IEAoldtax_IA").Locked = False Then
                                                       Sheet1.Range("Sheet1.Form10IEAoldtax_IA").value = "Yes"
                                                       Form10IEAoldtax_IA_26_27
                                                    End If
                                                    
                                                     
                                                    If assYrF10IEANewTaxReg_pfl <> "" And Sheet1.Range("Sheet1.AssYr_IIA").Locked = False Then
                                                       Sheet1.Range("Sheet1.AssYr_IIA").value = assYrF10IEANewTaxReg_pfl
                                                    End If
                                                    
                                                    If form10IEAEarlierAYAckNewRegime_pfl <> "" And Sheet1.Range("Sheet1.AckNo_IIA").Locked = False Then
                                                       Sheet1.Range("Sheet1.AckNo_IIA").value = form10IEAEarlierAYAckNewRegime_pfl
                                                    End If
                                                    
                                        ElseIf UCase(f10IEAEarlierAYNewRegime_pfl) = UCase("N") Or UCase(f10IEAEarlierAYNewRegime_pfl) = UCase("NO") Then
                                                    
                                                    If Sheet1.Range("Sheet1.Form10IEAoldtax_IA").Locked = False Then
                                                       Sheet1.Range("Sheet1.Form10IEAoldtax_IA").value = "No"
                                                       Form10IEAoldtax_IA_26_27
                                                    End If
                                                    ...
                                                    If f10IEACurrAYNewRegime_pfl <> "" Then
                                                            ...
                                                            If UCase(f10IEACurrAYNewRegime_pfl) = UCase("Y") Or UCase(f10IEACurrAYNewRegime_pfl) = UCase("YES") Then
                                                                        If Sheet1.Range("Sheet1.Form10IEANewTax").Locked = False Then
                                                                            Sheet1.Range("Sheet1.Form10IEANewTax").value = "Yes"
                                                                            Form10IEANewtax_26_27
                                                                        End If
                                                                        ...
                                                                        If f10IEADateCurrAYNewTax_pfl <> "" Then
                                                                                ...
                                                                                dfmt_f10IEADateCurrAYNewTax_pfl = Mid(f10IEADateCurrAYNewTax_pfl, 9, 2) & "/" & Mid(f10IEADateCurrAYNewTax_pfl, 6, 2) & "/" & Mid(f10IEADateCurrAYNewTax_pfl, 1, 4)
                                                                                    If Sheet1.Range("Sheet1.DOFNewTax_bi").Locked = False Then
                                                                                    Sheet1.Range("Sheet1.DOFNewTax_bi").value = dfmt_f10IEADateCurrAYNewTax_pfl
                                                                                    End If
                                                                        End If
                                                                        
                                                                        If f10IEAAckNoCurrAYNewTax_pfl <> "" And Sheet1.Range("Sheet1.AckNoNewTax_Bi").Locked = False Then
                                                                        Sheet1.Range("Sheet1.AckNoNewTax_Bi").value = f10IEAAckNoCurrAYNewTax_pfl
                                                                        End If
                                                                        
                                                            ElseIf UCase(f10IEACurrAYNewRegime_pfl) = UCase("N") Or UCase(f10IEACurrAYNewRegime_pfl) = UCase("NO") Then
                                                                        If Sheet1.Range("Sheet1.Form10IEANewTax").Locked = False Then
                                                                            Sheet1.Range("Sheet1.Form10IEANewTax").value = "No"
                                                                            Form10IEANewtax_26_27
                                                                        End If
                                                            End If
                        ...
                        ElseIf UCase(form10IEAEarlierAYOldRegime_pfl) = UCase("N") Or UCase(form10IEAEarlierAYOldRegime_pfl) = UCase("NO") Then
                                    ...
                                    If Sheet1.Range("Sheet1.Form10IEAoldtax").Locked = False Then
                                    Sheet1.Range("Sheet1.Form10IEAoldtax").value = "No"
                                    Form10IEAoldtax_26_27
                                    End If
                                    ...
                                    If f10IEACurrAYOldRegime_pfl <> "" Then
                                            ...
                                            If UCase(f10IEACurrAYOldRegime_pfl) = UCase("Y") Or UCase(f10IEACurrAYOldRegime_pfl) = UCase("YES") Then
                                                            If Sheet1.Range("Sheet1.Form10IEANewTaxIB").Locked = False Then
                                                            Sheet1.Range("Sheet1.Form10IEANewTaxIB").value = "Yes"
                                                            Form10IEANewTaxIB_26_27
                                                            End If
                                                            ...
                                                            If f10IEADateCurrAYOldTax_pfl <> "" Then
                                                               ...
                                                               dfmt_f10IEADateCurrAYOldTax_pfl = Mid(f10IEADateCurrAYOldTax_pfl, 9, 2) & "/" & Mid(f10IEADateCurrAYOldTax_pfl, 6, 2) & "/" & Mid(f10IEADateCurrAYOldTax_pfl, 1, 4)
                                                                        If Sheet1.Range("Sheet1.DOF_Ibi").Locked = False Then
                                                                        Sheet1.Range("Sheet1.DOF_Ibi").value = dfmt_f10IEADateCurrAYOldTax_pfl
                                                                        End If
                                                            End If
                                                            
                                                            If f10IEAAckNoCurrAYOldTax_pfl <> "" And Sheet1.Range("Sheet1.AckNo_IBi").Locked = False Then
                                                               Sheet1.Range("Sheet1.AckNo_IBi").value = f10IEAAckNoCurrAYOldTax_pfl
                                                            End If
                                                            
                                            ElseIf UCase(f10IEACurrAYOldRegime_pfl) = UCase("N") Or UCase(f10IEACurrAYOldRegime_pfl) = UCase("NO") Then
                                                            If Sheet1.Range("Sheet1.Form10IEANewTaxIB").Locked = False Then
                                                            Sheet1.Range("Sheet1.Form10IEANewTaxIB").value = "No"
                                                            Form10IEANewTaxIB_26_27
                                                            End If
                                            End If
        ...
        ElseIf UCase(incFrmBusOrProf_pfl) = UCase("N") Or UCase(incFrmBusOrProf_pfl) = UCase("NO") Then
                    If Sheet1.Range("Sheet1.BusiProfAssyr").Locked = False Then
                    Sheet1.Range("Sheet1.BusiProfAssyr").value = "No"
                    BusiProfAssyr_26_27
                    End If
...
Else:
    If Sheet1.Range("Sheet1.BusiProfAssyr").Locked = False Then
                    Sheet1.Range("Sheet1.BusiProfAssyr").value = "(Select)"
                    BusiProfAssyr_26_27
    End If
End If
...
'----------------------------------------------------------------------------------------------------------
    If Sheet1.Range("acknowledgmentnumber").Locked = False Then
        Sheet1.Range("acknowledgmentnumber").value = jsonObject("filingStatus")("Form10IEAckNo")
    End If
    ...
    If Sheet1.Range("sheet1.capacityassessee").Locked = False Then
        ...
        DateOfFilingReqdFormat = Mid(jsonObject("filingStatus")("Form10IEDate"), 9, 2) & "/" & Mid(jsonObject("form10IE")("Form10IEDate"), 6, 2) & "/" & Mid(jsonObject("form10IE")("Form10IEDate"), 1, 4)
...
'    End If
    ...
    End If
    End If
    Dim RepName, Repcapacity, RepAddress, RepPAN, RepAadhaar, CompDirectorPrvYrFlg, RepEmailID, RepMobileNo, countryCodeRepMobileNo_pfl
...
'      RepAadhaar = jsonObject("assesseeRep")("aadhaarCardNo")
      ...
      'If RepName <> "" Or Repcapacity <> "" Or RepAddress <> "" Or RepPAN <> "" Or RepAadhaar <> "" Then
      If RepName <> "" Or RepEmailID <> "" Or RepMobileNo <> "" Or countryCodeRepMobileNo_pfl <> "" Then

      If Sheet1.Range("sheet1.AsseseeRepFlg").Locked = False Then
...
'     End If
      ...
      'Malli PAG_C111&112_AY_2026-27
        If RepEmailID <> "" And Sheet1.Range("Sheet1.RepEmail").Locked = False Then
          Sheet1.Range("Sheet1.RepEmail").value = RepEmailID
        End If
        
         
        If countryCodeRepMobileNo_pfl <> "" And Sheet1.Range("Countrycode3").Locked = False Then
          'Malli_SIT-116380  13/04/2026
         ' Sheet1.Range("Countrycode3").value = countryCodeRepMobileNo_pfl
          Sheet1.Range("sheet1.Repcountrycode").value = countryCodeRepMobileNo_pfl
        End If
        
        
        If RepMobileNo <> "" And Sheet1.Range("sheet1.RepMobileNo").Locked = False Then
          Sheet1.Range("sheet1.RepMobileNo").value = RepMobileNo
        End If
...
'PAG_C126_AY_2024_25 'Malli
    Dim FiiFpiFlagPfl
    Dim SebiRegnNopfl
    FiiFpiFlagPfl = jsonObject("lastFiledITR")("filingStatus")("FiiFpiFlag")
    SebiRegnNopfl = jsonObject("lastFiledITR")("filingStatus")("SebiRegnNo")

    'Dim FiiFpiFlagPfl, SebiRegnNopfl As Variant
    If FiiFpiFlagPfl <> "" Then
            If FiiFpiFlagPfl = "Y" Then
                FiiFpiFlagPfl = "Yes"
            ElseIf FiiFpiFlagPfl = "N" Then
                FiiFpiFlagPfl = "No"
            End If
    Else
        FiiFpiFlagPfl = "(Select)"
    End If
    If FiiFpiFlagPfl <> "" And Sheet1.Range("Foreign_institutinal_investment").Locked = False Then
        Sheet1.Range("Foreign_institutinal_investment").value = FiiFpiFlagPfl
    End If
'PAG_C127_AY_2024_25 'Malli
    If SebiRegnNopfl <> "" And Sheet1.Range("Sheet1.SEBI_Regn_No").Locked = False Then
        Sheet1.Range("Sheet1.SEBI_Regn_No").value = SebiRegnNopfl
    End If
    
    
    'PAG_C129_AY_2024_25 ADD Malli
...
'    End If
    ...
    'Malli_SIT-117030  13/04/2026

'    If LiableSec5cflg = "Y" Then
'        Sheet1.Range("sheet1.LiableSec5cflg").value = "Yes"
'    ElseIf LiableSec5cflg = "N" Then
'        Sheet1.Range("sheet1.LiableSec5cflg").value = "No, turnover does not exceed 1 crore"
'    ElseIf LiableSec5cflg = "M" Then
'        Sheet1.Range("sheet1.LiableSec5cflg").value = "No, turnover exceeds 10 crores"
'
'    End If
    
    
    If LiableSec5cflg = "N" Then
        Sheet1.Range("sheet1.LiableSec5cflg").value = "Up to Rs. 1 crore"
    ElseIf LiableSec5cflg = "Y" Then
        Sheet1.Range("sheet1.LiableSec5cflg").value = "More than Rs. 1 crore and up to Rs. 10 crores"
    ElseIf LiableSec5cflg = "M" Then
        Sheet1.Range("sheet1.LiableSec5cflg").value = "More than Rs. 10 crores"
...
'Malli----------AY_2025_26_ITR-3_PrefillSRS_V0.3
    ...
    'TVN_Malli_AY_2025-26_uncomented by Malli Preffill Posibility  given
    Dim LiableSecAggrigateflg
    'lastFiledITR.AuditInfo.AgrOfAllAmtsRcvd
    ...
    If LiableSecAggrigateflg = "Y" And Sheet1.Range("sheet1.LiableSecAggrigateflg").Locked = False Then
        ...
        Sheet1.Range("sheet1.LiableSecAggrigateflg").value = "Up to 5%"
        '-----------------------------
    ElseIf LiableSecAggrigateflg = "N" And Sheet1.Range("sheet1.LiableSecAggrigateflg").Locked = False Then
        ...
        Sheet1.Range("sheet1.LiableSecAggrigateflg").value = "More than 5%"
        '-----------------
    End If
    End If
    '---------------------------------------------------
    ...
    'lastFiledITR.AuditInfo.AgrOfAllPayMade
    ...
    If LiableSecAggrigateflg1 = "Y" And Sheet1.Range("sheet1.LiableSecAggrigate1flg").Locked = False Then
        ...
        Sheet1.Range("sheet1.LiableSecAggrigate1flg").value = "Up to 5%"
        '---------------------
    ElseIf LiableSecAggrigateflg1 = "N" And Sheet1.Range("sheet1.LiableSecAggrigate1flg").Locked = False Then
        ...
        Sheet1.Range("sheet1.LiableSecAggrigate1flg").value = "More than 5%"
        '-------------------------
    End If
    End If
'------------------------------------------------------------------------------
...
'change-22, prefill-tracker, D32
    ...
    'Malli AY_2026-27 fields removed  23/02/2026
    
    'SIT-118049 uncommented by Mallikarjun 06/05/2026
...
'
    '-------------
    'PAG_C148_AY_2024_25 ADD 'Malli
    Sheet1.Range("Sheet1.AckNumAuditReport").value = jsonObject("form3CD")("AuditInfo")("AckNum44AB")
     
     
     'Malli AY_2026-27 fields removed  23/02/2026
     'PAG_C149_AY_2024_25 ADD 'Malli
    'Sheet1.Range("Sheet1.UDINAuditNum").value = jsonObject("form3CD")("AuditInfo")("Udin")
    ...
    If jsonObject("form3CEB") <> Null Then
    ...
    ElseIf LiableSec92Eflg = "N" Then
        ...
        Sheet1.Unprotect Password:=getmsgstate
        Sheet1.Range("sheet1.LiableSec92Eflgdia").Locked = False
        Sheet1.Range("sheet1.LiableSec92Eflgdia").value = "No"
        Sheet1.Range("sheet1.LiableSec92Eflgdia").Locked = True
        Sheet1.Protect Password:=getmsgstate
    Else
        'Sheet1.Range("sheet1.LiableSec92Eflg").value = "N-No"  'Malli
        Sheet1.Unprotect Password:=getmsgstate
        Sheet1.Range("sheet1.LiableSec92Eflgdia").Locked = False
        Sheet1.Range("sheet1.LiableSec92Eflgdia").value = "No"
        Sheet1.Range("sheet1.LiableSec92Eflgdia").Locked = True
...
'    LiableSec92Eflgdia = jsonObject("form3CEB")("AuditInfo")("AccountAuditFlag")
    ...
    'PAG_C153_AY_2024_25 ADD 'Malli
    Dim AckNum92E
    AckNum92E = jsonObject("form3CEB")("AuditInfo")("AuditDetails92E")("AckNum92E")
    If AckNum92E <> "" And Sheet1.Range("Sheet1.AckNumAuditReport92E").Locked = False Then
                Sheet1.Range("Sheet1.AckNumAuditReport92E").value = AckNum92E
    End If
    ...
    '--------------------
      ...
      Dim AuditedSectionColNo, AuditYNColNo, DateOfAuditColNo, AckNumOthColNo
...
If init.exists("AuditDetails") Then
    ...
    'PAG_C157_AY_2024_25   'Malli
    AckNumOthColNo = Sheet1.Range("Sheet1.AckNumoth").Column       'Malli
    ...
    If (TotalXMLRow > 0) Then
        ...
        End If
        If Sheet1.Range("Sheet1.AckNumoth").Locked = False Then    'Malli
            Sheet1.Range("Sheet1.AckNumoth").ClearContents
        End If
'        If Sheet1.Range("Sheet1.AckNumoth").Locked = False Then    'Malli
'            Sheet1.Range("Sheet1.AckNumoth").ClearContents
'        End If
    ...
    If (TotalDiffRow > 0) Then
        AddDiffRows_AuditDetailsNew (TotalDiffRow)
    End If
...
'For SIT-70495
        If Sheet1.Cells(rowcount, AckNumOthColNo).Locked = False Then
            'Sheet1.Cells(rowcount, AckNumOthColNo).value = jsonObject("form3CEB")("AuditInfo")("AuditDetails")("AckNumOth")
            Sheet1.Cells(rowcount, AckNumOthColNo).value = Node("AckNumOth")
        End If
...
'        End If
    ...
    If (TotalDiffRow > 0) Then
       Sheet1.Activate  'Malli IPIP-66714 18/11/2025 (while importing Json range names are changed PAG to VIA )
       AddDiffRows_AuditReportDTLNew (TotalDiffRow)
    End If
    ...
    For Each Node In Nodelist
        rowcount = rowcount + 1
'Konda updated on 10-09-2025---SIT-94764
        'iACTYN = Node("AuditReportSection")
  '------on 10-09-2025---SIT-94764
        Dim iDate, sDate
...
'        End If
    ...
    'Konda updated on 10-09-2025---SIT-94764
            ...
            Sheet1.Cells(rowcount, SectionsColNo).value = Node("AuditReportSection")
     '-----------------on 10-09-2025---SIT-94764
        End If
...
If init.exists("heldUnlistedEqShrPrYrDtls") Then
    ...
    If (TotalDiffRow > 0) Then
        Sheet1.Activate 'Malli_18/11/2025
        AddDiffRows_ShareDetailsNew (TotalDiffRow)
    End If
...
'following code Is commented
        ...
        ElseIf iReturnFile = "20" Then
           sReturnFile = "119(2)(b)- after condonation of delay"  'Uncommented Konda in AY2025-26 23-12-2025
           
'           sReturnFile = "139(9A) - After condonation of delay u/s 119(2)(b)" 'Changed by sai
...
If YYYY = "2010" Then
    If Date_1 <> "" And Sheet17.Range("yr1999.DateOfFiling").Locked = False Then
    Sheet17.Range("yr1999.DateOfFiling").value = Date_1
    End If
    
    If Node("LossFrmSpecifiedBusCF") <> "" And Sheet17.Range("yr1999.BusLossSpecBus").Locked = False Then
    Sheet17.Range("yr1999.BusLossSpecBus").value = Node("LossFrmSpecifiedBusCF")
    End If
End If

If YYYY = "2011" Then
    If Date_1 <> "" And Sheet17.Range("yr2000.DateOfFiling1").Locked = False Then
    Sheet17.Range("yr2000.DateOfFiling1").value = Date_1
    End If
    
    If Node("LossFrmSpecifiedBusCF") <> "" And Sheet17.Range("yr2003.LossFrmSpecifiedBusCF9").Locked = False Then
    Sheet17.Range("yr2003.LossFrmSpecifiedBusCF9").value = Node("LossFrmSpecifiedBusCF")
    End If
End If

If YYYY = "2012" Then
    If Date_1 <> "" And Sheet17.Range("yr2001.DateOfFiling2").Locked = False Then
    Sheet17.Range("yr2001.DateOfFiling2").value = Date_1
    End If
    
    If Node("LossFrmSpecifiedBusCF") <> "" And Sheet17.Range("yr2003.LossFrmSpecifiedBusCF8").Locked = False Then
    Sheet17.Range("yr2003.LossFrmSpecifiedBusCF8").value = Node("LossFrmSpecifiedBusCF")
    End If
End If
...
If YYYY = "2013" Then
    ...
    'Malli_commented AY_2026-27 11/02/2026
...
'    End If
''Konda updated on 12-09-2025---SIT-95105
'    If node("AdjustAccTax115BACAmt") <> "" And Sheet17.Range("yr2006.BusLossOthThanSpecLossCF7b").Locked = False Then
'    Sheet17.Range("yr2006.BusLossOthThanSpecLossCF7b").value = node("AdjustAccTax115BACAmt")
'    End If
''-----------SIT-95105
'
'      '---------------------------------------------
...
'    End If
    ...
    End If
 'Konda updated on 12-09-2025---SIT-95105
    If Node("AdjustAccTax115BACAmt") <> "" And Sheet17.Range("yr2006.BusLossOthThanSpecLossCF9b").Locked = False Then
    Sheet17.Range("yr2006.BusLossOthThanSpecLossCF9b").value = Node("AdjustAccTax115BACAmt")
    End If
 '---------SIT-95105
...
'    End If
    ...
    End If
'Konda updated on 12-09-2025---SIT-95105
    If Node("AdjustAccTax115BACAmt") <> "" And Sheet17.Range("yr2007.BusLossOthThanSpecLossCF9b").Locked = False Then
    Sheet17.Range("yr2007.BusLossOthThanSpecLossCF9b").value = Node("AdjustAccTax115BACAmt")
    End If
'-----------SIT-95105
...
'    End If
    ...
    End If
'Konda updated on 12-09-2025---SIT-95105
    If Node("AdjustAccTax115BACAmt") <> "" And Sheet17.Range("yr2020.BusLossOthThanSpecLossCF10b").Locked = False Then
    Sheet17.Range("yr2020.BusLossOthThanSpecLossCF10b").value = Node("AdjustAccTax115BACAmt")
    End If
'-----------SIT-95105
...
'Konda updated on 12-09-2025---SIT-95105
    If Node("AdjustAccTax115BACAmt") <> "" And Sheet17.Range("yr2021.BusLossOthThanSpecLossCF11b").Locked = False Then
    Sheet17.Range("yr2021.BusLossOthThanSpecLossCF11b").value = Node("AdjustAccTax115BACAmt")
    End If
'-----------SIT-95105
...
'    End If
    ...
    If YYYY = "2022" Then
      If Date_1 <> "" And Sheet17.Range("yr2022.DateOfFiling12").Locked = False Then
    Sheet17.Range("yr2022.DateOfFiling12").value = Date_1
    End If
    ...
    End If
    If Node("OthSrcLossRaceHorseCF") <> "" And Sheet17.Range("yr2022.OthSrcLossRaceHorseCF12").Locked = False Then
    Sheet17.Range("yr2022.OthSrcLossRaceHorseCF12").value = Node("OthSrcLossRaceHorseCF")
    End If
    
    If Node("BroughtFrwrdBusLoss") <> "" And Sheet17.Range("yr2022.BusLossOthThanSpecLossCF12a").Locked = False Then
    Sheet17.Range("yr2022.BusLossOthThanSpecLossCF12a").value = Node("BroughtFrwrdBusLoss")
    End If
'Konda updated on 12-09-2025---SIT-95105
    If Node("AdjustAccTax115BACAmt") <> "" And Sheet17.Range("yr2022.BusLossOthThanSpecLossCF12b").Locked = False Then
    Sheet17.Range("yr2022.BusLossOthThanSpecLossCF12b").value = Node("AdjustAccTax115BACAmt")
    End If
'-----------SIT-95105
    If Node("LossFrmSpecifiedBusCF") <> "" And Sheet17.Range("yr2022.LossFrmSpecifiedBusCF12").Locked = False Then
    Sheet17.Range("yr2022.LossFrmSpecifiedBusCF12").value = Node("LossFrmSpecifiedBusCF")
    End If
    
    If Node("LossFrmSpecBusCF") <> "" And Sheet17.Range("yr2022.LossFrmSpecBusCF12").Locked = False Then
    Sheet17.Range("yr2022.LossFrmSpecBusCF12").value = Node("LossFrmSpecBusCF")
    End If
    ...
    If YYYY = "2023" Then
      If Date_1 <> "" And Sheet17.Range("yr2023.DateOfFiling13").Locked = False Then
    Sheet17.Range("yr2023.DateOfFiling13").value = Date_1
    End If
    ...
    End If
    If Node("OthSrcLossRaceHorseCF") <> "" And Sheet17.Range("yr2023.OthSrcLossRaceHorseCF13").Locked = False Then
    Sheet17.Range("yr2023.OthSrcLossRaceHorseCF13").value = Node("OthSrcLossRaceHorseCF")
    End If
    
    If Node("BroughtFrwrdBusLoss") <> "" And Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13a").Locked = False Then
    Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13a").value = Node("BroughtFrwrdBusLoss")
    End If
'Konda updated on 12-09-2025---SIT-95105
    If Node("AdjustAccTax115BACAmt") <> "" And Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13b").Locked = False Then
    Sheet17.Range("yr2023.BusLossOthThanSpecLossCF13b").value = Node("AdjustAccTax115BACAmt")
    End If
'-----------SIT-95105
    If Node("LossFrmSpecifiedBusCF") <> "" And Sheet17.Range("yr2023.LossFrmSpecifiedBusCF13").Locked = False Then
       Sheet17.Range("yr2023.LossFrmSpecifiedBusCF13").value = Node("LossFrmSpecifiedBusCF")
    End If
    
    If Node("LossFrmSpecBusCF") <> "" And Sheet17.Range("yr2023.LossFrmSpecBusCF13").Locked = False Then
        Sheet17.Range("yr2023.LossFrmSpecBusCF13").value = Node("LossFrmSpecBusCF")
    End If
    '=======================
    ...
    'Malli_AY_2025_26   sit_94783
If YYYY = "2024" Then
      If Date_1 <> "" And Sheet17.Range("yr2024.DateOfFiling14").Locked = False Then
    Sheet17.Range("yr2024.DateOfFiling14").value = Date_1
    End If
    ...
    End If
    If Node("OthSrcLossRaceHorseCF") <> "" And Sheet17.Range("yr2024.OthSrcLossRaceHorseCF14").Locked = False Then
    Sheet17.Range("yr2024.OthSrcLossRaceHorseCF14").value = Node("OthSrcLossRaceHorseCF")
    End If
    If Node("BroughtFrwrdBusLoss") <> "" And Sheet17.Range("yr2024.BusLossOthThanSpecLossCF14a").Locked = False Then
    Sheet17.Range("yr2024.BusLossOthThanSpecLossCF14a").value = Node("BroughtFrwrdBusLoss")
    End If
'Konda updated on 12-09-2025---SIT-95105
    If Node("AdjustAccTax115BACAmt") <> "" And Sheet17.Range("yr2024.BusLossOthThanSpecLossCF14b").Locked = False Then
    Sheet17.Range("yr2024.BusLossOthThanSpecLossCF14b").value = Node("AdjustAccTax115BACAmt")
    End If
'-----------SIT-95105
    If Node("LossFrmSpecifiedBusCF") <> "" And Sheet17.Range("yr2024.LossFrmSpecifiedBusCF14").Locked = False Then
    Sheet17.Range("yr2024.LossFrmSpecifiedBusCF14").value = Node("LossFrmSpecifiedBusCF")
    End If
    If Node("LossFrmSpecBusCF") <> "" And Sheet17.Range("yr2024.LossFrmSpecBusCF14").Locked = False Then
    Sheet17.Range("yr2024.LossFrmSpecBusCF14").value = Node("LossFrmSpecBusCF")
    End If
End If
'----------------------------------------------------------------------------------------------------------


'Malli_AY_2026_27  11/02/2026

If YYYY = "2025" Then
    If Date_1 <> "" And Sheet17.Range("yr2025.DateOfFiling15").Locked = False Then
    Sheet17.Range("yr2025.DateOfFiling15").value = Date_1
    End If
    ...
    If Node("OthSrcLossRaceHorseCF") <> "" And Sheet17.Range("yr2025.OthSrcLossRaceHorseCF15").Locked = False Then
    Sheet17.Range("yr2025.OthSrcLossRaceHorseCF15").value = Node("OthSrcLossRaceHorseCF")
    End If
    
    If Node("BroughtFrwrdBusLoss") <> "" And Sheet17.Range("yr2025.BusLossOthThanSpecLossCF15a").Locked = False Then
    Sheet17.Range("yr2025.BusLossOthThanSpecLossCF15a").value = Node("BroughtFrwrdBusLoss")
    End If

    If Node("AdjustAccTax115BACAmt") <> "" And Sheet17.Range("yr2025.BusLossOthThanSpecLossCF15b").Locked = False Then
    Sheet17.Range("yr2025.BusLossOthThanSpecLossCF15b").value = Node("AdjustAccTax115BACAmt")
    End If

    If Node("LossFrmSpecifiedBusCF") <> "" And Sheet17.Range("yr2025.LossFrmSpecifiedBusCF15").Locked = False Then
    Sheet17.Range("yr2025.LossFrmSpecifiedBusCF15").value = Node("LossFrmSpecifiedBusCF")
    End If
    
    If Node("LossFrmSpecBusCF") <> "" And Sheet17.Range("yr2025.LossFrmSpecBusCF15").Locked = False Then
    Sheet17.Range("yr2025.LossFrmSpecBusCF15").value = Node("LossFrmSpecBusCF")
    End If
End If
    ...
    For Each Node In Nodelist
        rowcount = rowcount + 1
            ...
            If Sheet27.Cells(rowcount, FA_B_NatureOfInterestvalueColNo).Locked = False Then
                ...
                ElseIf iStatus = "BENEFICIAL_OWNER" Then
                     sStatus = "BENEFICIAL_OWNER"
'Konda updated on 08-09-2025--SIT-94818--SIT-91291

'                ElseIf iStatus = "OWNER" Then
'                     sStatus = "OWNER"
                ElseIf iStatus = "BENIFICIARY" Then
                     sStatus = "BENIFICIARY"
'-----------------------on 08-09-2025--SIT-94818--SIT-91291
                Else
                    sStatus = "(Select)"
                End If
...
Set Nodelist = jsonObject("lastFiledITR")("scheduleFA")("detailsOfOthSourcesIncOutsideIndia")
    ...
    'FA_G_WhetherTaxable = Sheet27.Range("FA_G_WhetherTaxable").Column   'Malli
...
'Konda---SIT-81162-addedd this
Dim NodeMain, NodeListMain

Set NodeListMain = jsonObject("lastFiledITR")("bankAccountDtls")

For Each NodeMain In NodeListMain
          If Sheet7.Range("Sheet9.IBANSELECT").Locked = False Then
            If NodeMain("bankDtlsFlag") = "Y" Then
                Sheet7.Range("Sheet9.IBANSELECT").value = "Yes"
            End If
        
            If NodeMain("bankDtlsFlag") = "N" Then
                Sheet7.Range("Sheet9.IBANSELECT").value = "No"
            End If
        End If
Next NodeMain
...
If UCase(Node("salNatureDesc")) <> UCase("10(13A)") Then 'Malli
...
'            iNature = "Sec " & UCase(node("SalNatureDesc"))
              Debug.Print UCase(Node("salNatureDesc"))
...
'''Malli----------AY_2025_26_ITR-3_PrefillSRS_V0.3
''form24q.usrDeductUndChapVIAType.section80C
...
'Malli_AY_2026_27 SIT-121104  04/06/2026
If Sheet19.Range("Sheet19.Specified_Disease").Locked = False Then
Dim nameOfSpecDisease80DDB_pfl, nameOfSpecDisease80DDB_prfl As Variant
    nameOfSpecDisease80DDB_pfl = jsonObject("lastFiledITR")("usrDeductUndChapVIAType")("nameOfSpecDisease80DDB")
         If nameOfSpecDisease80DDB_pfl <> "" Then
            
            If UCase(nameOfSpecDisease80DDB_pfl) = UCase("a") Then
                    nameOfSpecDisease80DDB_prfl = "(a) Dementia"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("b") Then
                    nameOfSpecDisease80DDB_prfl = "(b) Dystonia Musculorum Deformans"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("c") Then
                    nameOfSpecDisease80DDB_prfl = "(c) Motor Neuron Disease"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("d") Then
                    nameOfSpecDisease80DDB_prfl = "(d) Ataxia"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("e") Then
                    nameOfSpecDisease80DDB_prfl = "(e) Chorea"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("f") Then
                    nameOfSpecDisease80DDB_prfl = "(f) Hemiballismus"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("g") Then
                    nameOfSpecDisease80DDB_prfl = "(g) Aphasia"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("h") Then
                    nameOfSpecDisease80DDB_prfl = "(h) Parkinsons Disease"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("i") Then
                    nameOfSpecDisease80DDB_prfl = "(i) Malignant Cancers"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("j") Then
                    nameOfSpecDisease80DDB_prfl = "(j) Full Blown Acquired Immuno-Deficiency Syndrome (AIDS)"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("k") Then
                    nameOfSpecDisease80DDB_prfl = "(k) Chronic Renal failure"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("l") Then
                    nameOfSpecDisease80DDB_prfl = "(l) Hematological disorders"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("m") Then
                    nameOfSpecDisease80DDB_prfl = "(m) Hemophilia"
                    
            ElseIf UCase(nameOfSpecDisease80DDB_pfl) = UCase("n") Then
                    nameOfSpecDisease80DDB_prfl = "(n) Thalassaemia"
                    
            Else
                    nameOfSpecDisease80DDB_prfl = ""
            End If
           
                   If nameOfSpecDisease80DDB_prfl <> "" Then
                       Sheet19.Range("Sheet19.Specified_Disease").value = nameOfSpecDisease80DDB_prfl
                   End If
...
If Sheet19.Range("scvia.Section80CCD").Locked = False Then
    Sheet19.Range("scvia.Section80CCD").value = jsonObject("form24q")("usrDeductUndChapVIAType")("section80CCDEmployer")
End If
'If Sheet19.Range("SELECT80DD").Locked = False Then
'    If jsonObject("lastFiledITR")("usrDeductUndChapVIAType")("section80DDUsrType") = "1" Then
'            Sheet19.Range("SELECT80DD").value = "1-Dependent person with Disability"
'    ElseIf jsonObject("lastFiledITR")("usrDeductUndChapVIAType")("section80DDUsrType") = "2" Then
'            Sheet19.Range("SELECT80DD").value = "2-Dependent person withSevere Disability"
'    End If

'VIA_C11_AY_2024_25 Change Malli
...
If Sheet19.Range("SELECT80DDB").Locked = False Then
    If jsonObject("lastFiledITR")("usrDeductUndChapVIAType")("section80DDBUsrType") = "1" Then
        Sheet19.Range("SELECT80DDB").value = "1-Self or dependent"
    ElseIf jsonObject("lastFiledITR")("usrDeductUndChapVIAType")("section80DDBUsrType") = "2" Then
        Sheet19.Range("SELECT80DDB").value = "2-Self or Dependent(Senior Citizen)"
    End If
       
 'VIA_C12_AY_2024_25 Change Malli
...
End If
'If Sheet19.Range("SELECT80U").Locked = False Then
'     If jsonObject("lastFiledITR")("usrDeductUndChapVIAType")("section80UUsrType") = "1" Then
'        Sheet19.Range("SELECT80U").value = "1-Self with disability"
'    ElseIf jsonObject("lastFiledITR")("usrDeductUndChapVIAType")("section80UUsrType") = "2" Then
'        Sheet19.Range("SELECT80U").value = "2-Self with severe disability"
'    End If
'End If

''VIA_C36_AY_2024_25 Change 'Malli
...
'''VIA_C20_AY_2024_25 Change 'Malli
...
''Malli----------AY_2025_26_ITR-3_PrefillSRS_V0.3
'Malli----------SIT_94536
'Sheet19.AckNum  Form10BA.Form10BAAckNum
...
If Form10BAAckNum_pfl <> "" Then
        If SheetALL.Range("bacValue").value = 1 Then
                Sheet19.Unprotect Password:=EfilingCommon.getmsgstate
        ...
        Else
                'Malli_SIT-121311 04/06/2026
                'If Form10BAAckNum_pfl <> "" And Sheet19.Range("Sheet19.AckNum").Locked = False Then
                If Form10BAAckNum_pfl <> "" Then
...
If Form10CCDAckNum_pfl <> "" Then
        If SheetALL.Range("bacValue").value = 1 Then
        Sheet19.Unprotect Password:=EfilingCommon.getmsgstate
                Sheet19.Range("Sheet19.AckNum.10CCD").Locked = False
                'Sheet19.Range("Sheet19.AckNum.10CCD").Interior.Color = "&HCCFFCC"
                Sheet19.Range("Sheet19.AckNum.10CCD").value = Form10CCDAckNum_pfl
                Sheet19.Range("Sheet19.AckNum.10CCD").Font.Color = (&HD8D8D8)
                Sheet19.Range("Sheet19.AckNum.10CCD").Interior.Color = (&HD8D8D8)
                Sheet19.Range("Sheet19.AckNum.10CCD").Locked = True
        Else
                'Malli_SIT-121311 04/06/2026
                'If Form10CCDAckNum_pfl <> "" And Sheet19.Range("Sheet19.AckNum.10CCD").Locked = False Then
                If Form10CCDAckNum_pfl <> "" Then
                    Sheet19.Unprotect Password:=getmsgstate
                    Sheet19.Range("Sheet19.AckNum.10CCD").value = Form10CCDAckNum_pfl
                End If
...
Dim jsonObject, init, Node As Object
Set jsonObject = ParseJson.ParseJson(jsonText)
Dim ProvisoFlag
...
If Sheet1.Range("clauseiv7provisio139iFlg").Locked = False Then
        ...
        clauseiv7provisio139i_pfl = jsonObject("filingStatus")("clauseiv7provisio139i")
           'Set init = jsonObject("FilingStatus")
           
           'If init.exists("clauseiv7provisio139i") Then
           If clauseiv7provisio139i_pfl <> "" Then
           
               'If init("clauseiv7provisio139i") = "Y" Then
               If UCase(clauseiv7provisio139i_pfl) = UCase("Y") Then
...
End If
End If
'Comented by Jyoti  as per AY_2025_26 the secoundary Prefill source lastFiledITR was removed
'AY 2025 -26 Jyoti25026
...
'Jyoti uncommented need to confirm
...
'Malli-----------
'Dim BankDtlsFlag_1 As Variant
'BankDtlsFlag_1 = jsonObject("bankAccountDtls")("bankDtlsFlag")
'If BankDtlsFlag_1 = "Y" Or BankDtlsFlag_1 = "N" Then
'Sheet7.Range("Sheet9.IBANSELECT") = "Yes"
'End If

'need to confirm comment or not below code Jyoti
'Jyoti 3 commented
'If jsonObject("bankAccountDtls")("bankDtlsFlag") <> Null Then
'Sheet7.Range("Sheet9.IBANSELECT") = "Yes"
'End If
'---------------------

'Malli_AY_2025_26----------------neeed to confirm add or not Jyoti
Set NodeListMain = jsonObject("bankAccountDtls")
    For Each NodeMain In NodeListMain
        Set Nodelist = NodeMain("addtnlBankDetails")
'--------------------------
       ...
       CheckBox = Sheet7.Range("tempxml").Column  'Malli_AY_2025_26 'Jyoti25026
        ...
        If (TotalXMLRow > 0) Then
            ...
            Sheet7.Range("tempxml").ClearContents  'Malli_AY_2025_26'Jyoti25026
        End If
        'Jyoti Commented 25026
        If (TotalDiffRow > 0) Then
         'AddDiffRows_BANK (TotalDiffRow)
            Dim idi As Long
            idi = 0
            For idi = 1 To TotalDiffRow
              Sheet7.Activate  'SIT_91039
                AddDiffRows_BANK (1)
            Next
        End If
    ...
    'Jyoti_AY_2025_26 Uncomented----Jyoti25026
    'AY-2024_25 Change
...
'--------------------------------------------------------------------
     ...
     '-----------------------------------------
        ...
        Next Node
            RecTDS1 = cnt
   Next NodeMain  'Jyoti_AY_2025_26
End Function
...
'    Set rangecells6 = Sheet28.Range("TCS.AmtTCSClaimedThisYear").Cells
    ...
    For Each Node In Nodelist
        ...
        If Node.exists("TCSCreditName") Then
            ...
            '===================================
            'Malli
               If Node("TCSCreditName") = "S" Or Node("TCSCreditName") = 1 Then
                rangecells1.item(cnt).value = "Self"
                Else
                rangecells1.item(cnt).value = "Other Person"
                End If
                'rangecells1.item(cnt).value = Node("TCSCreditName")
                '==================================
            End If
...
'Change-11(c), Test-022, Remark -
        If Node("deductedYr") <> "" Then
            rangecells4.item(cnt).value = Node("deductedYr")
        End If
         If Node("broughtFwdTCSAmt") <> "" Then
            rangecells5.item(cnt).value = Node("broughtFwdTCSAmt")
        End If
...
Function ImportScheduleTDS2_pfl(jsonText As String)
    ...
    Dim TaxDeductedOwnHandsColNo, TaxDeductedIncomeColNo, TaxDeductedTDSColNo, TaxClaimedOwnHandsColNo, TaxClaimedIncomeColNo, TaxClaimedTDSColNo, TDSSectiondeducted_TDS2
...
'    End If
   ...
   ' TaxClaimedTDSColNo = Sheet28.Range("TDS2.ClaimedTDS5A").Column
    ...
    TDSSectiondeducted_TDS2 = Sheet28.Range("TDS2.TdsDeducted").Column
    '----------------------------------------------------
    ...
    If (TotalDiffRow > 0) Then
        ...
        'SIT_91324
        Sheet28.Activate
        Cmd_AddRows_TDS2_Click_1 (TotalDiffRow)
    End If
...
'
'        End If
        Dim TDSCreditName_pfl
        TDSCreditName_pfl = Node("TDSCreditName")
        If TDSCreditName_pfl <> "" Then
            If TDSCreditName_pfl = "S" Then
                Sheet28.Cells(rowcount, TDSCreditName_TDS2).value = "Self"
            ElseIf TDSCreditName_pfl = "O" Then
                Sheet28.Cells(rowcount, TDSCreditName_TDS2).value = "Other Person"
            End If
        End If
       ...
       'TVN_Malli_AY_2025_26_comented by Mallikarjun
        '----------------------------------------------------
        'Newlly ADDED by Malli
...
'
'           ElseIf sectioncode = "4Ib" Or sectioncode = "4IB" Then
'             HeadIncome_TDS2 = "Income from House Property"
'
'
'
''    194, 194A, 193, 194I, 194D, 194DA, 194G, 194H, 194B, 194BA, 194LB, 194LC, 194LD, 194LBL, 194E 194BB
'
'
...
'           sectioncode = "4BB" Or sectioncode = "BBJ" Or _
'           sectioncode = "4BA" Then
'
'               HeadIncome_TDS2 = "Income from Other Sources"
'
'            ElseIf sectioncode = "4LA" Or sectioncode = "4IA" Then
...
'--------------------------------
       ...
       'Newly added by sadineni on 23/06/2026
                    ElseIf sectioncode = UCase("94T") Then
                    TDSSection_Gen = "194T-Payments to partners of firms"
                 ...
                 If TDSSection_Gen <> "" Then
                     Sheet28.Cells(rowcount, TDSSectiondeducted_TDS2).value = TDSSection_Gen
                     sectioncode = ""
                 End If
...
'-----------------------------------------------
 ...
 'TVN_Malli_AY_2025_26 uncomented by mallikarjun
...
Dim nodeList9, nodeList10, nodeList11, nodeList12, nodeList13, nodeList14, nodeList15, nodeList16 As Object
...
Set nodeList16 = New Collection 'Malli_AY_2025_26
        ...
        For Each Node In Nodelist
            If Node.exists("secCd") And Node.exists("subSecCd") Then
                ...
                If Node("secCd") = "80IB" Then
                    ...
                    '--------------------------
                End If
               'Malli uncomented-----------11/06/2025
                'Commmented by Jyoti25026
...
'                    End If
                    If Node("state") = "04" Or Node("state") = "4" Then    'Assam
                        Set nodeTemp = CreateObject("Scripting.Dictionary")
                        nodeTemp("deductAmountSec80") = Node("deductAmountSec80")
                        nodeList7.add nodeTemp
                    End If
                    If Node("state") = "03" Or Node("state") = "3" Then    'Arunachal Pradesh
                        Set nodeTemp = CreateObject("Scripting.Dictionary")
                        nodeTemp("deductAmountSec80") = Node("deductAmountSec80")
...
'                    End If
'                End If
            End If   'Malli uncomented-----------11/06/2025
        Next Node
...
'Malli-------AY_2025_26 11/06/2025

If nodeList16.count > 0 Then   'IC80.Sikkim
    
        DeductSikkimColNo = Sheet37.Range("IC80.Sikkim").Column
        
        TotalExRow = Sheet37.Range("IC80.Sikkim").Rows.count
        
        TotalXMLRow = nodeList16.count
        TotalDiffRow = TotalXMLRow - TotalExRow
        
        If (TotalXMLRow > 0) Then
            If Sheet37.Range("IC80.Sikkim").Locked = False Then
                Sheet37.Range("IC80.Sikkim").ClearContents
            End If
        End If
        
        If (TotalDiffRow > 0) Then
         Sheet37.Activate
         AddDiffRows_Sikkim (TotalDiffRow)
        End If
        
        rowcount = getRowNo(Sheet37.Range("IC80.Sikkim").name)
        rowcount = rowcount - 1
        cnt = 0
        
        For Each Node In nodeList16
            rowcount = rowcount + 1
                If Sheet37.Cells(rowcount, DeductSikkimColNo).Locked = False Then
                    Sheet37.Cells(rowcount, DeductSikkimColNo).value = Node("deductAmountSec80")
                End If
...
If jsonObject("ScheduleESOP").exists("ScheduleESOP2223_Type") Then
    If jsonObject("ScheduleESOP")("ScheduleESOP2223_Type").exists("TaxDeferredBFEarlierAY") Then
        If jsonObject("ScheduleESOP")("ScheduleESOP2223_Type")("AssessmentYear") = "2022-23" And Sheet46.Range("ESOP.TaxPrevAY2").Locked = False Then
            Sheet46.Range("ESOP.TaxPrevAY2") = jsonObject("ScheduleESOP")("ScheduleESOP2223_Type")("TaxDeferredBFEarlierAY")
        End If
    End If
End If

'AY_2024_25 ESOP_C1 Malli uncomented
If jsonObject("ScheduleESOP").exists("ScheduleESOP2324_Type") Then
    If jsonObject("ScheduleESOP")("ScheduleESOP2324_Type").exists("TaxDeferredBFEarlierAY") Then
        If jsonObject("ScheduleESOP")("ScheduleESOP2324_Type")("AssessmentYear") = "2023-24" And Sheet46.Range("ESOP.TaxPrevAY3").Locked = False Then
            Sheet46.Range("ESOP.TaxPrevAY3") = jsonObject("ScheduleESOP")("ScheduleESOP2324_Type")("TaxDeferredBFEarlierAY")
        End If
    End If
End If
 '-------------------------------------------------
...
If jsonObject("ScheduleESOP").exists("ScheduleESOP2425_Type") Then
    If jsonObject("ScheduleESOP")("ScheduleESOP2425_Type").exists("TaxDeferredBFEarlierAY") Then
        If jsonObject("ScheduleESOP")("ScheduleESOP2425_Type")("AssessmentYear") = "2024-25" And Sheet46.Range("ESOP.TaxPrevAY4").Locked = False Then
            Sheet46.Range("ESOP.TaxPrevAY4") = jsonObject("ScheduleESOP")("ScheduleESOP2425_Type")("TaxDeferredBFEarlierAY")
        End If
    End If
End If
'------------------------------------------

'Malli_AY_2026-27  23/02/2026
If jsonObject("ScheduleESOP").exists("ScheduleESOP2526_Type") Then
    If jsonObject("ScheduleESOP")("ScheduleESOP2526_Type").exists("TaxDeferredBFEarlierAY") Then
        If jsonObject("ScheduleESOP")("ScheduleESOP2526_Type")("AssessmentYear") = "2025-26" And Sheet46.Range("ESOP.TaxPrevAY5").Locked = False Then
            Sheet46.Range("ESOP.TaxPrevAY5") = jsonObject("ScheduleESOP")("ScheduleESOP2526_Type")("TaxDeferredBFEarlierAY")
        End If
    End If
End If
'----------------------------
...
Set Nodelist = jsonObject("Schedule80G")("Don50PercentApprReqd")("DoneeWithPan")
    ...
    DoneeARN = Sheet20.Range("Per5080G.ARN_Reference").Column
...
'    TotalDonationAmt = Sheet20.Range("Per5080G.TotalDonationAmt").Column
'    EligibleAmt = Sheet20.Range("Per5080G.EligibleAmt").Column
    ...
    If (TotalXMLRow > 0) Then
        ...
        End If
        If Sheet20.Range("Per5080G.ARN_Reference").Locked = False Then
            Sheet20.Range("Per5080G.ARN_Reference").ClearContents
        End If
        ...
        End If
'        If Sheet20.Range("Per5080G.TotalDonationAmt").Locked = False Then
'            Sheet20.Range("Per5080G.TotalDonationAmt").ClearContents
'        End If
'        If Sheet20.Range("Per5080G.EligibleAmt").Locked = False Then
'            Sheet20.Range("Per5080G.EligibleAmt").ClearContents
'        End If
    ...
    For Each Node In Nodelist
        rowcount = rowcount + 1
            ...
            End If
'Change-ANK
'Change-Satya for SIT-49367 for DoneeARN tag. Previously it was ArnNbr
...
'---
            ...
            End If
'            If Sheet20.Cells(rowcount, TotalDonationAmtColNo).Locked = False Then
'                Sheet20.Cells(rowcount, TotalDonationAmtColNo).value = Node("DonationAmt")
'            End If
'            If Sheet20.Cells(rowcount, EligibleAmtColNo).Locked = False Then
'                Sheet20.Cells(rowcount, EligibleAmtColNo).value = Node("EligibleDonationAmt")
'            End If
...
End Function
'Function ImportScheduleS_Block(jsonText As String)
'On Error Resume Next
'    Dim TotalXMLRow As Long
'    Dim TotalDiffRow As Long
'    Dim RecTDS1 As Long
'    Dim jsonObject, Nodelist, nodeList1, nodeList1A, nodeList1B As Object
...
'            End If
'
'            If Sheet39.Range("SAL.Salary" & rowcount).Locked = False Then
'                Sheet39.Range("SAL.Salary" & rowcount).value = Node("salaries")("grosssalary")
'            End If
'            If Sheet39.Range("SAL.AllowancesNotExempt" & rowcount).Locked = False Then
'                Sheet39.Range("SAL.AllowancesNotExempt" & rowcount).value = Node("salaries")("salary")
'            End If
'
'
'
...
'             End If
'
'            If Sheet39.Range("SAL.ValueOfPerquisites" & rowcount).Locked = False Then
'                Sheet39.Range("SAL.ValueOfPerquisites" & rowcount).value = Node("Salaries")("Salarys")("ValueOfPerquisites")
'            End If
'
...
'                    ElseIf Node1("natureDesc") = "16" Then
'                        'valsalarydropdown2 = "Stock options allotted or transferred by employer being an eligible start-up referred to in section 80-IAC"
'                         valsalarydropdown2 = "Stock options allotted or transferred by employer being an eligible start-up referred to in section 80-IAC-Tax to be defered"
...
''Change-14, 01.05.2022, NatureOfPerquisitesType.natureDesc
'                    ElseIf Node1("natureDesc") = "21" Then
'                        valsalarydropdown2 = "Stock options allotted or transferred by employer being an eligible start-up referred to in section 80-IAC-Tax not to be defered"
'                    ElseIf Node1("natureDesc") = "OTH" Then
...
'                End If
'
''                MsgBox " Sheet39.Cells(rowcount2, ValueAmount).value     " & Sheet39.Cells(rowcount2, ValueAmount).value
''                MsgBox "rowcount2        " & rowcount2
''                MsgBox "ValueAmount        " & ValueAmount
'
...
'            End If
'            End If
'            If Sheet39.Range("SAL.ProfitsinLieuOfSalary" & i).Locked = False Then
'                Sheet39.Range("SAL.ProfitsinLieuOfSalary" & i).value = Node("salarys")("profitsinLieuOfSalary")
'            End If
'
...
''-----------Riyaz---SIT-70868
''Set init = jsonObject("lastFiledITR")
''If init.exists("natOfEmployment") Then
...
'        rowcount = rowcount + 1
'
'            Dim NatureOfEmployment1 As String
'            NatureOfEmployment1 = UCase(Node1("natOfEmployment"))
'
'            If NatureOfEmployment1 = "CGOV" Then NatureOfEmployment1 = "Central Government"
'            If NatureOfEmployment1 = "SGOV" Then NatureOfEmployment1 = "State Government"
'            If NatureOfEmployment1 = "PE" Then NatureOfEmployment1 = "CG-Pensioners"
'            If NatureOfEmployment1 = "PESG" Then NatureOfEmployment1 = "SG-Pensioners"
'            If NatureOfEmployment1 = "PEPS" Then NatureOfEmployment1 = "PSU-Pensioners"
'            If NatureOfEmployment1 = "PEO" Then NatureOfEmployment1 = "Others-Pensioners"
'            If NatureOfEmployment1 = "PSU" Then NatureOfEmployment1 = "Public Sector Undertaking"
'            If NatureOfEmployment1 = "OTH" Then NatureOfEmployment1 = "OTHERS"
'
'            If Sheet39.Range("sheet.EmployerCategory" & rowcount).Locked = False Then
'                Sheet39.Range("sheet.EmployerCategory" & rowcount).value = NatureOfEmployment1
'
'
'End If
'Next Node1
...
If init.exists("salary") Then
     ...
     'Newly Changed by sai on 27/08/2024 for SIT-70868
    Set Nodelist = jsonObject("lastFiledITR")("natOfEmployment")
            ...
            For Each Node1 In nodeList1A
                ...
                If Sheet39.Cells(rowcount1, section).Locked = False Then
                    ...
                    ElseIf Node1("natureDesc") = "4" Then
                        valsalarydropdown1 = "House Rent Allowance"
                    ElseIf Node1("natureDesc") = "5" Then
 'Konda updated on 12-09-2025--SIT-91365
'                        valsalarydropdown1 = "Leave Travel Allowance"
                         valsalarydropdown1 = "Leave Travel Allowance(LTA)"
'-------------on 12-09-2025--SIT-91365
                    ElseIf Node1("natureDesc") = "6" Then
                        valsalarydropdown1 = "Children Education Allowance"
                    ElseIf Node1("natureDesc") = "7" Then
                        valsalarydropdown1 = "Other Allowance"
                    ElseIf Node1("natureDesc") = "8" Then
                        valsalarydropdown1 = "The contribution made  by the Employer  towards  pension scheme as referred u/s 80CCD"
    'Konda updated as per new schema v.07 on 22-09-2025--SIT-101668
'                    ElseIf Node1("natureDesc") = "9" Then
'                       ' valsalarydropdown1 = "Amount deemed to be income under rule 11 of Fourth Schedule"
...
'                End If
                ...
                If Sheet39.Cells(rowcount2, ValueAmount).Locked = False Then
        'Konda updated on 12-09-2025--SIT-97593
                    If Node1("natureDesc") <> "NA" Then
                    Sheet39.Cells(rowcount2, ValueAmount).value = Node1("othAmount")
                    End If
        '------------------------on 12-09-2025--SIT-97593
                End If
...
Set Nodelist = jsonObject("form24q")("allwncExemptUs10DtlsType")
   ...
   ' AddRows_Others_Pre_fill
    ...
    For Each Node In Nodelist
   'Malli----------AY_2025_26_ITR-3_PrefillSRS_V0.310(5)
   'Debug.Print UCase(Node("salNatureDesc"))
If UCase(Node("salNatureDesc")) <> UCase("10(13A)") Then
   '------------------------------------------------------
...
Sub AddRows_Others_Pre_fill(nOfRows As Long) ' Newly added by sai on 27/08/2024
...
Function ScheduleRA_pfl(jsonText As String)
On Error Resume Next
Dim jsonDictionary, jsonObject As Object
Dim Node, Nodelist, init As Object
...
Dim TotalDiffRow As Long
Dim TotalExRow As Long
Dim DoneeNameColNo, AddrDtlColNo, CityColNo, StateColNo, PincodeColNo, DoneePANColNo, AmtCashColNo, AmtOtherColNo, EligibleAmtColNo, iState, sState

Set jsonObject = ParseJson.ParseJson(jsonText)
  
Set init = jsonObject("Schedule80RA")
If init.exists("DonationDtlsRsrchAssctn") Then
  
Set Nodelist = jsonObject("Schedule80RA")("DonationDtlsRsrchAssctn")
    
    DoneeNameColNo = Sheet50.Range("Name_of_Donee_80GGA").Column
    AddrDtlColNo = Sheet50.Range("Address_80GGA").Column
    CityColNo = Sheet50.Range("City_Town_District_80GGA").Column
    StateColNo = Sheet50.Range("State_Code_80GGA").Column
    PincodeColNo = Sheet50.Range("Pincode_80GGA").Column
    DoneePANColNo = Sheet50.Range("PAN_of_donee_80GGA").Column
    AmtCashColNo = Sheet50.Range("Donation_cash_80GGA").Column
    AmtOtherColNo = Sheet50.Range("Donation_other_80GGA").Column
    EligibleAmtColNo = Sheet50.Range("Donation_Eligible_80GGA").Column
    
    TotalExRow = Sheet50.Range("Name_of_Donee_80GGA").Rows.count
    
    TotalXMLRow = Nodelist.count
    TotalDiffRow = TotalXMLRow - TotalExRow
    
    If (TotalXMLRow > 0) Then
        If Sheet50.Range("Name_of_Donee_80GGA").Locked = False Then
            Sheet50.Range("Name_of_Donee_80GGA").ClearContents
        End If
        If Sheet50.Range("Address_80GGA").Locked = False Then
            Sheet50.Range("Address_80GGA").ClearContents
        End If
        If Sheet50.Range("City_Town_District_80GGA").Locked = False Then
            Sheet50.Range("City_Town_District_80GGA").ClearContents
        End If
        If Sheet50.Range("State_Code_80GGA").Locked = False Then
            Sheet50.Range("State_Code_80GGA").ClearContents
        End If
        If Sheet50.Range("Pincode_80GGA").Locked = False Then
            Sheet50.Range("Pincode_80GGA").ClearContents
        End If
        If Sheet50.Range("PAN_of_donee_80GGA").Locked = False Then
            Sheet50.Range("PAN_of_donee_80GGA").ClearContents
        End If
        If Sheet50.Range("Donation_cash_80GGA").Locked = False Then
            Sheet50.Range("Donation_cash_80GGA").ClearContents
        End If
        If Sheet50.Range("Donation_other_80GGA").Locked = False Then
            Sheet50.Range("Donation_other_80GGA").ClearContents
        End If
        If Sheet50.Range("Donation_Eligible_80GGA").Locked = False Then
            Sheet50.Range("Donation_Eligible_80GGA").ClearContents
        End If
    End If
    
    If (TotalDiffRow > 0) Then
     AddDiffRows_80RA (TotalDiffRow)
    End If
    
    rowcount = getRowNo(Sheet50.Range("Name_of_Donee_80GGA").name)
    rowcount = rowcount - 1
    cnt = 0
    ...
    For Each Node In Nodelist
        rowcount = rowcount + 1
            ...
            If Sheet50.Cells(rowcount, DoneeNameColNo).Locked = False Then
                Sheet50.Cells(rowcount, DoneeNameColNo).value = Node("NameOfDonee")
            End If
            If Sheet50.Cells(rowcount, AddrDtlColNo).Locked = False Then
                Sheet50.Cells(rowcount, AddrDtlColNo).value = Node("AddressDetail")("AddrDetail")
            End If
            If Sheet50.Cells(rowcount, CityColNo).Locked = False Then
                Sheet50.Cells(rowcount, CityColNo).value = Node("AddressDetail")("CityOrTownOrDistrict")
            End If
            iState = Node("AddressDetail")("StateCode")
            sState = Findtext(CStr(iState), "State")
            If Sheet50.Cells(rowcount, StateColNo).Locked = False Then
                Sheet50.Cells(rowcount, StateColNo).value = sState
            End If
            If Sheet50.Cells(rowcount, PincodeColNo).Locked = False Then
                Sheet50.Cells(rowcount, PincodeColNo).value = Node("AddressDetail")("PinCode")
            End If
            If Sheet50.Cells(rowcount, DoneePANColNo).Locked = False Then
                Sheet50.Cells(rowcount, DoneePANColNo).value = Node("DoneePAN")
            End If
            If Sheet50.Cells(rowcount, AmtCashColNo).Locked = False Then
                Sheet50.Cells(rowcount, AmtCashColNo).value = Node("DonationAmtCash")
            End If
            If Sheet50.Cells(rowcount, AmtOtherColNo).Locked = False Then
                Sheet50.Cells(rowcount, AmtOtherColNo).value = Node("DonationAmtOtherMode")
            End If
            If Sheet50.Cells(rowcount, EligibleAmtColNo).Locked = False Then
                Sheet50.Cells(rowcount, EligibleAmtColNo).value = Node("EligibleDonationAmt")
            End If
    cnt = cnt + 1
    Next Node
RecTCS = cnt
...
If Sheet59.Range("DatefilingFm10IA_80DD").Locked = False Then
   Sheet59.Range("DatefilingFm10IA_80DD").value = dob      'DatefilingFm10IA_80DD
End If

If Sheet59.Range("DatefilingFm10IA_80U").Locked = False Then
   Sheet59.Range("DatefilingFm10IA_80U").value = dob       'DatefilingFm10IA_80U
End If
...
If acknNumber <> "" And Sheet59.Range("AckNoFm10IAfiled_80DD").Locked = False Then
        Sheet59.Range("AckNoFm10IAfiled_80DD").value = acknNumber_1   'AckNoFm10IAfiled_80DD
End If
If acknNumber <> "" And Sheet59.Range("AckNoFm10IAfiled_80U").Locked = False Then
Sheet59.Range("AckNoFm10IAfiled_80U").value = acknNumber_1            'AckNoFm10IAfiled_80U
End If
...
If section80UUsrType <> "" And Sheet59.Range("Naturedisability_80U").Locked = False Then
     Sheet59.Range("Naturedisability_80U").value = section80UUsrType
End If


End Function

Sub Cmd_AddRows_TDS2_Click_1(TotalDiffRow As Long)
Dim vRows As Long
Sheet28.Activate
'Malli----------AY_2025_26_ITR-3_PrefillSRS_V0.3
...
vRows = EfilingCommon.insertRowUnderSectionWithFormula(TotalDiffRow)
End Sub
...
'  For Each Node_1 In Node_1M
'
'       'Set Nodelist_3 = Node_1("tenantDetails")
'        rowcount = rowcount + 1
'
'            cnt = 0
'            cnt = getRowNo(Sheet8.Range("HP.NameofTenant" & rowcount).name)
...
'                    End If
'                    'Sheet15.Cells(cnt, Sheet15.Range("HP.TANofTenant" & rowcount).Column).Value = UCase(Node2("PANTANofTenant"))
'
'        ' Next Node_2
'
'             End If
...
'        If AnnualLetableValue_HP(i) = 0 And (Mid(ifLetOut_HP(i), 1, 1) = "L" Or Mid(ifLetOut_HP(i), 1, 1) = "D") Then
...
If init.exists("propertyDetails") Then
    ...
    If Node.exists("coOwners") Then
            ...
            For Each Node2 In Nodelist2
                ...
                End If
                    If Node2.Exsist("AadhaarofTenant") Then
           'Konda updated on 05-09-2025--SIT-94718
                        'Sheet8.Cells(cnt, Sheet8.Range("HP.AadharofTenant" & rowcount).Column).value = UCase(Node2("aadhaarofTenant"))
                        Sheet8.Cells(cnt, Sheet8.Range("HP.AadharofTenant" & rowcount).Column).value = UCase(Node2("AadhaarofTenant"))
             '-------------------on 05-09-2025--SIT-94718
                    End If
            Next Node2
            End If
...
'------------------------------
             ...
             'Malli_18/02/2026  HP_C_AY_2026_27>>>>>>>>>>>>>>
...
'TVN_Malli-AY_2025_26

Function ImportSchedule10AA(jsonText As String)
On Error Resume Next

Dim Node, Nodelist, jsonObject, init As Object
Dim TotalExRow, TotalXMLRow, TotalDiffRow, RecTDS1, rowcount, cnt As Long
Dim Nodelist_count As Variant
'Dim jsonObject
Set jsonObject = ParseJson.ParseJson(jsonText)

'form56f.Schedule10AA.DeductSEZ.DedUs10Detail.Undertaking.DedFromUndertakingWithAy.AssmtYrUnit
'form56f.Schedule10AA.DeductSEZ.DedUs10Detail.Undertaking.DedFromUndertakingWithAy.DedUs10Sub
 Set init = jsonObject("form56F")
 
If Not init.exists("Schedule10AA") Then
    Exit Function
End If
Set Nodelist = jsonObject("form56F")("Schedule10AA")("DeductSEZ")("DedUs10Detail")("Undertaking")("DedFromUndertakingWithAy")

  Dim AA10_AssmtYrUnit, AA10_DedFromUndertaking As Variant
    AA10_AssmtYrUnit = Sheet18.Range("AA10.AssmtYrUnit").Column
    AA10_DedFromUndertaking = Sheet18.Range("AA10.DedFromUndertaking").Column
    
  TotalExRow = Sheet18.Range("AA10.AssmtYrUnit").Rows.count
  
  TotalXMLRow = Nodelist.count
  TotalDiffRow = TotalXMLRow - TotalExRow
  
  If (TotalXMLRow > 0) Then
        If Sheet18.Range("AA10.AssmtYrUnit").Locked = False Then
            Sheet18.Range("AA10.AssmtYrUnit").ClearContents
        End If
        If Sheet18.Range("AA10.DedFromUndertaking").Locked = False Then
            Sheet18.Range("AA10.DedFromUndertaking").ClearContents
        End If
  End If
  
   If (TotalDiffRow > 0) Then
         AddDiffRows_Ded (TotalDiffRow)
    End If
  
    rowcount = getRowNo(Sheet18.Range("AA10.AssmtYrUnit").name)
    rowcount = rowcount - 1
...
Nodelist_count = 1
 ...
 For Each Node In Nodelist
   ...
   'If Nodelist_count = 1 Then
   
            If Sheet18.Cells(rowcount, AA10_AssmtYrUnit).Locked = False Then
                Sheet18.Cells(rowcount, AA10_AssmtYrUnit).value = Node("AssmtYrUnit")
            End If
            If Sheet18.Cells(rowcount, AA10_DedFromUndertaking).Locked = False Then
                Sheet18.Cells(rowcount, AA10_DedFromUndertaking).value = Node("DedUs10Sub")
            End If
            
'   ElseIf Nodelist_count = 2 Then
'
'            If Sheet18.Cells(rowcount, AA10_AssmtYrUnit).Locked = False Then
'                Sheet18.Cells(rowcount, AA10_AssmtYrUnit).value = Node("AssmtYrUnit")
'            End If
...
'   End If
'
   'Nodelist_count = Nodelist_count + 1
