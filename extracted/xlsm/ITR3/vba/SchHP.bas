...
'Jyoti_19/05
Public end_hprptfrm_24B_cnt As Variant
...
'    If Not Validate_24b() Then ValidatesheetHP = False 'Jyoti
   
    If Not Validate24B_Table() Then ValidatesheetHP = False 'by Sai on 27/05/2025
    ...
    For te = 1 To Sheet8.Range("PropertySectionCOunt").value
        If Sheet8.Range("HP.RentOfEarlierYrSec_AandAA" & te).value > 0 Then
          ...
          'msgbox_hprptfrm ("* Address Of Property at Sr. no " & te & " in Sheet HOUSE_PROPERTY  is mandatory")
            msgbox_hprptfrm ("*Address of property is mandatory at Sr. no " & te & " in schedule HP.")
                    ...
                    End If
                     ...
                     If Mid(Sheet8.Range("HP.ifLetOut" & hpi).value, 1, 1) = "S" Then
                         'Temp = Temp + 1
                          ...
                          'Jyoti 26_06_2025
                            'msgbox_hprptfrm "* Interest cannot be more than Rs. 2,00,000 for category self-occupied in Schedule HP." & Chr(13)
                             msgbox_hprptfrm "* Amount of deduction for interest u/s 24(b) in case of Self Occupied House Property or aggregate of such properties  cannot exceed 2 lakh. Therefore, interest is being restrcited to 2 lakh" & Chr(13)
            ...
            For SPI = 1 To UBound(letoutarr)
                ...
                If letoutarr(SPI) = "S" Then
                  ...
                  Next
                    ...
                    Sheet8.Activate
                        fmsgboxStatus "Rent not realized cannot exceed Gross rent received or receivable or letable value" ', vbOKOnly, "Error!"
                        CloseMsg
                    End If
...
'    ''Newly Added by Aavula
'    Dim i As Long
'
'For i = 1 To Sheet8.Range("HP.Co.Name1").count
'
'
'If Sheet8.Range("HP.Co.Name1").Cells(i, 1).value <> "" Or Sheet8.Range("HP.Co.Pan1").Cells(i, 1).value <> "" Or Sheet8.Range("HP.Co.Aadhaar1").Cells(i, 1).value <> "" Or Sheet8.Range("HP.Co.Share1").Cells(i, 1).value <> "" Then
'
' If Sheet8.Range("HP.Co.Name1").Cells(i, 1).value = "" Then
'            ValidatesheetHP = False
'            msgbox_hprptfrm ("*Please enter the name of the co-owner at Sr. No " & i & ".")
'        End If
'End If
'
'Next i
...
Function ValidateCityOrTownOrDistrict_HP() As Boolean
    ...
    For i = 1 To end_hprptfrm
        ...
        If Not chkCompulsory(CityOrTownOrDistrict_HP(i)) Then
            'msgbox_hprptfrm ("*Town/City at Sr. no" & i & " in Sheet HOUSE_PROPERTY  is Mandatory")
            msgbox_hprptfrm ("*Town/City is mandatory in tab: Sl no B2 in schedule HP.")
            ValidateCityOrTownOrDistrict_HP = False
            Exit Function
        End If
        If Not checkfieldspecialcharacter(CityOrTownOrDistrict_HP(i)) Then
            msgbox_hprptfrm ("*Town/City at Sr. no" & i & "   characters < > & ' " & Chr(34) & " are not allowed in Sheet HOUSE_PROPERTY")
            ValidateCityOrTownOrDistrict_HP = False
            Exit Function
        End If
    Next
...
Function ValidateStateCode_HP() As Boolean
    ...
    For i = 1 To end_hprptfrm
        ...
        If Not chkCompulsory(StateCode_HP(i)) Then
            'msgbox_hprptfrm ("* State at Sr. no" & i & " is Mandatory in Sheet HOUSE_PROPERTY")
            msgbox_hprptfrm ("* State of property  is mandatory at Sr. no" & i & " in schedule HP.")
            
            ValidateStateCode_HP = False
            Exit Function
        End If
        
'Change by sai on 16/10/2024=====================================================================
...
Function ValidateCountryCode_HP() As Boolean
    ...
    For i = 1 To end_hprptfrm
        ...
        If Not chkCompulsory(CountryCode_HP(i)) Then
            'msgbox_hprptfrm ("* Country at Sr. no " & i & " is mandatory in Sheet HOUSE_PROPERTY")
            msgbox_hprptfrm ("* Country of property at Sr. no " & i & " is mandatory in schedule HP.")
    ...
    For i = 1 To end_hprptfrm
        ...
        If chkCompulsory(Country1) And chkCompulsory(state1) Then
            ...
            If (Country1 <> "91" And state1 <> "99") Then
                ...
                msgbox_hprptfrm ("* Country cannot be other than India as you have selected an Indian state at Sr. no " & i & " in schedule HP.")
    ...
    For i = 1 To end_hprptfrm
        ...
        If CountryCode_HP(i) <> "91" Then
            If Not chkCompulsory(ZipCode_HP(i)) Then
                msgbox_hprptfrm ("* Zip Code at Sr. no " & i & " is mandatory.If ZIP code is not available, then enter XXXXXX in Sheet HOUSE_PROPERTY")
                ValidateZipCode_HP = False
                Exit Function
            End If
            If Not checkfieldspecialcharacter(ZipCode_HP(i)) Then
                msgbox_hprptfrm ("* Zip Code at Sr. no " & i & " characters < > & ' " & Chr(34) & " are not allowed in Sheet HOUSE_PROPERTY")
                ValidateZipCode_HP = False
                Exit Function
            End If
        Else
    ...
    For i = 1 To end_hprptfrm
        ...
        If CountryCode_HP(i) = "91" Then
            If Not chkCompulsory(PinCode_HP(i)) Then
                'msgbox_hprptfrm ("* PinCode at Sr. no" & i & " is Mandatory in Sheet HOUSE_PROPERTY")
                msgbox_hprptfrm ("* Pin code of Property is mandatory at Sr. no" & i & " in schedule HP ")
                ValidatePinCode_HP = False
                Exit Function
            End If
            If Not chkNumeric(PinCode_HP(i)) Then
                msgbox_hprptfrm ("* PinCode at Sr. no" & i & " only digits 0 to 9 allowed  in Sheet HOUSE_PROPERTY")
                ValidatePinCode_HP = False
                Exit Function
            End If
        Else
...
Function ValidateifLetOut_HP() As Boolean
    ...
    For i = 1 To end_hprptfrm
        ...
        If Not chkCompulsory(ifLetOut_HP(i)) Then
            msgbox_hprptfrm ("* Please select type of House Property in Sheet HOUSE_PROPERTY " & i)
...
'Function ValidateTotalIncomeChargeableUnHP_HP() As Boolean
    ...
    If Sheet8.Range("HP.TotalIncomeChargeableUnHP").value < 0 Then
    If Len(TotalIncomeChargeableUnHP_HP) > 15 Then
        msgbox_hprptfrm ("* Total income chargeable cannot be greater than 14 digits")
...
Sub AddBlockCall_hprptfrm()
    ...
    blockcount = Sheet8.Range("PropertySectionCOunt").value
    Sheet8.Unprotect Password:=getmsgstate
    Sheet8.Range("HP.SlNo" & blockcount).value = blockcount
...
Function addblock(prevrangename As Variant, blockname As Variant, frmcounter As Variant, totalblocksize As Variant)
 ...
 'Added by sai on 27/05/2025 as it was auto populated field and changed the logic as per DE V0.5 and V0.6
'********************************************************************************************************************************
...
On Error Resume Next
 ...
 'ramya11
 'Jyoti 26_06_2025
 'fmsgboxsmall "* Interest cannot be more than Rs. 2,00,000 for category two self-occupied in schedule HP." ', vbOKOnly, "Error(s)!"
  fmsgboxsmall "* Amount of deduction for interest u/s 24(b) in case of Self Occupied House Property or aggregate of such properties  cannot exceed 2 lakh. Therefore, interest is being restrcited to 2 lakh" ', vbOKOnly, "Error(s)!"
'commented by Jyoti2025
...
'            msgbox_hprptfrm ("*""Please provide Name of the Bank/ Person from which the loan is taken in schedule 24(b)"" at Sr. No " & i & "") & Chr(13)
        ...
        End If
         ...
         If Len(BankName_24B(i)) > 125 Then
           msgbox_hprptfrm ("* Name of the Bank/ Person at Sr. No " & i & " in Sheet 24(b) should be less than or equal to 125 characters.") & Chr(13)
            ValidateBankName_24b = False
            Exit Function
        End If
        ...
        If Not checkfieldSuperSpecialcharacter(BankName_24B(i)) Then
            msgbox_hprptfrm ("* Name of the Bank/ Person in schedule 24b at Sl.no. " & i & " should not Contain <, >, characters.") & Chr(13)
            ValidateBankName_24b = False
            Exit Function
        End If
...
Function ValidateAccntNum_24b() As Boolean
    ...
    For i = 1 To end_24b
        ...
        If Not chkCompulsory(AccntNum_24b(i)) Then '"Please provide Loan Account number of the Bank or any reference number if loan is taken from other than Bank"
'          msgbox_hprptfrm ("* ""Please provide Loan Account number of the Bank / Institution from which loan is taken in schedule 24(b)"" at Sr. No " & i & "") & Chr(13)
        ...
        'Updated by Ayush on 19/06/2025
...
'                msgbox_hprptfrm ("* ""Loan outstanding as on last date of financial year is mandatory in schedule 24(b)"" at Sr. No " & i & "") & Chr(13)
               ' msgbox_hprptfrm ("* ""Loan outstanding as on last date of finacial year is mandatory in schedule 24(b). Please enter 0 in case the entire loan is repaid during the year"" at Sr. No " & i & "") & Chr(13)
            'Jyoti 26_06_2025
            msgbox_hprptfrm ("* ""Loan outstanding as on last date of finacial year is mandatory in Table 24(b) of Schedule HP. Please enter 0 in case the entire loan is repaid during the year "" at Sr. No " & i & "") & Chr(13)
...
Function ValidateIntrst_24b() As Boolean
    ...
    For i = 1 To end_24b
        ...
        If Not chkCompulsory(Intrst_24B(i)) Then
             msgbox_hprptfrm ("* ""Please provide Interest on borrowed capital u/s 24(b)"" at Sr. No " & i & "") & Chr(13)
...
Function ValidateBankAccountNumber_24b(BankAccountNumber As Variant, CC As Variant) As Boolean
...
Function Validate24B_Table() As Boolean
    ...
    Dim sharepercent As Variant
    Dim cosharepercent As Double
    Dim end_hpco_24d As Long 'Added by Ankita
...
'                    msgbox_hprptfrm ("*""Please provide Name of the Bank Person from which the loan is taken in schedule 24(b)"" at Sr. No " & j & "") & Chr(13)
                    msgbox_hprptfrm ("*""Please provide Name of the Bank/ Institution/Person from which the loan is taken in schedule 24(b)"" at Sr. No " & j & "") & Chr(13)
                    Validate24B_Table = False
                    Exit Function
                End If
                
                If Len(BankName_24B(i, j)) > 125 Then
                    msgbox_hprptfrm ("* Name of the Bank Person at Sr. No " & j & " in Sheet 24(b) should be less than or equal to 125 characters.") & Chr(13)
                    Validate24B_Table = False
                    Exit Function
                End If
                ...
                If Not checkfieldSuperSpecialcharacter(BankName_24B(i, j)) Then
                    msgbox_hprptfrm ("* Name of the Bank Person in schedule 24b at Sl.no. " & j & " should not Contain <, >, characters.") & Chr(13)
                    Validate24B_Table = False
                    Exit Function
                End If
...
'                    msgbox_hprptfrm ("* ""Please provide Loan Account number of the Bank or any reference number if loan is taken from other than Bank"" at Sr. No " & j & "") & Chr(13)
               'Updated by Ayush
                     msgbox_hprptfrm ("* ""Please provide Loan Account number of the Bank or any reference number if loan is taken from other than Bank"" at Sr. No " & j & "") & Chr(13)
                ...
                If UCase(BankorInst_24b(i, j)) = UCase("Bank") Then
                    If Not ValidateBankAccountNumber_24b(AccntNum_24b(i, j), j) Then
                    'Msgbox_BA = Msgbox_BA + "Account Number at Sr.No " & j & " in Sheet Taxes Paid and Verification is mandatory" & Chr(13)
                    Validate24B_Table = False
                    Exit Function
                    End If
                End If
             ...
             If Not chkCompulsory(LoanDate_24B(i, j)) Then
                 msgbox_hprptfrm ("* ""Please provide Date of sanction of Loan in schedule 24(b)"" at Sr. No " & j & "") & Chr(13)
                Validate24B_Table = False
                Exit Function
            End If
...
'                msgbox_hprptfrm ("* Date can not be after 31/03/2025 at Sr. No " & j & ".") & Chr(13)
            ...
            '             MsgBox_24b = MsgBox_24b + "* ""Please provide Total Loan taken in schedule 24(b)"" at Sr. No " & j & "" & Chr(13)
                    msgbox_hprptfrm ("* ""Please provide Total amount of loan in schedule 24(b)"" at Sr. No " & j & "") & Chr(13)
                Validate24B_Table = False
                Exit Function
            End If
            ...
            '            MsgBox_24b = MsgBox_24b & "* Total loan taken should be more than 0 in schedule 24(b) at Sr. No  " & j & "" & Chr(13)
               msgbox_hprptfrm ("* Total amount of loan should be more than 0 in schedule 24(b) at Sr. No  " & j & "") & Chr(13)
                Validate24B_Table = False
                Exit Function
            End If
...
'                    msgbox_hprptfrm ("* ""Loan outstanding as on last date of financial year is mandatory in schedule 24(b)"" at Sr. No " & j & "") & Chr(13)
                   ' msgbox_hprptfrm ("* ""Loan outstanding as on last date of finacial year is mandatory in schedule 24(b). Please enter 0 in case the entire loan is repaid during the year"" at Sr. No " & j & "") & Chr(13)
'Jyoti 26_06_2025
 msgbox_hprptfrm ("* "" Loan outstanding as on last date of finacial year is mandatory in Table 24(b) of Schedule HP. Please enter 0 in case the entire loan is repaid during the year  "" at Sr. No " & j & "") & Chr(13)
            ...
            If Not chkCompulsory(Intrst_24B(i, j)) Then
                 msgbox_hprptfrm ("* ""Please provide Interest on borrowed capital u/s 24(b)"" at Sr. No " & j & "") & Chr(13)
                Validate24B_Table = False
                Exit Function
            End If
            '         If Len(Intrst_24b(i)) > 15 Then
