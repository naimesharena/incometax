...
Public rangenamestring As Variant
...
If Sheet1.Range("sheet1.ReturnFileSec").value = "139(8A)" Then
    ...
    If Len(Sheet202.Range("U_Total")) > 14 Then
        Validatesheet_ATI = False
        msgbox_1398AATI = msgbox_1398AATI + "* Length of 1Af in Schedule Part B-ATI should not be more than 14 characters." & Chr(13)
    End If
...
'        msgbox_1398AATI = msgbox_1398AATI + "* Amount at Sr No 3 cannot be less than Amount at Sr No 5" & Chr(13)
        msgbox_1398AATI = msgbox_1398AATI + "* Amount payable in Sl. No. 3 is less than amount payable as per last valid return in Sl. No. 5" & Chr(13)
'End Change
        Validatesheet_ATI = False
    End If
...
'        msgbox_1398AATI = msgbox_1398AATI + "* Amount at Sr No 4 cannot be greater than Amount at Sr No 6i" & Chr(13)
        'msgbox_1398AATI = msgbox_1398AATI + "* Amount refundable in Sl. No. 4 is more than refund claimed as per last valid return in Sl. No. 6ai." & Chr(13)
        
        'Added by Aavula Nareshon 11/11/2024 SIT-82953
        msgbox_1398AATI = msgbox_1398AATI + "* Amount refundable in Sl. No. 4 is more than refund claimed as per last valid return in Sl. No. 6i." & Chr(13)

'End Change
        Validatesheet_ATI = False
    End If
    
    If Len(Sheet202.Range("U_AmtPayable")) > 14 Then
        Validatesheet_ATI = False
        msgbox_1398AATI = msgbox_1398AATI + "* Length of Sl NO.3 in Schedule Part B-ATI should not be more than 14 characters." & Chr(13)
    End If
    If Len(Sheet202.Range("U_AmtRefundable")) > 14 Then
        Validatesheet_ATI = False
        msgbox_1398AATI = msgbox_1398AATI + "* Length of Sl NO.4 in Schedule Part B-ATI should not be more than 14 characters." & Chr(13)
    End If
    If Len(Sheet202.Range("U_Refund")) > 14 Then
        Validatesheet_ATI = False
        msgbox_1398AATI = msgbox_1398AATI + "* Length of Sl NO.6i in Schedule Part B-ATI should not be more than 14 characters." & Chr(13)
    End If
    If Len(Sheet202.Range("U_TotRefund")) > 14 Then
        Validatesheet_ATI = False
        msgbox_1398AATI = msgbox_1398AATI + "* Length of Sl NO.6ii in Schedule Part B-ATI should not be more than 14 characters." & Chr(13)
    End If
    If Len(Sheet202.Range("U_AmtRefundable")) > 14 Then
        Validatesheet_ATI = False
        msgbox_1398AATI = msgbox_1398AATI + "* Length of Sl NO.7 in Schedule Part B-ATI should not be more than 14 characters." & Chr(13)
    End If
    If Len(Sheet202.Range("U_AggrLiabilityRefund")) > 14 Then
        Validatesheet_ATI = False
        msgbox_1398AATI = msgbox_1398AATI + "* Length of Sl NO.9i in Schedule Part B-ATI should not be more than 14 characters." & Chr(13)
    End If
    If Len(Sheet202.Range("U_AggrLiabilityNoRefund")) > 14 Then
        Validatesheet_ATI = False
        msgbox_1398AATI = msgbox_1398AATI + "* Length of Sl NO.9ii in Schedule Part B-ATI should not be more than 14 characters." & Chr(13)
    End If
    If Len(Sheet202.Range("U_AddtnlIncTax")) > 14 Then
        Validatesheet_ATI = False
        msgbox_1398AATI = msgbox_1398AATI + "* Length of Sl NO.10 in Schedule Part B-ATI should not be more than 14 characters." & Chr(13)
    End If
    If Len(Sheet202.Range("U_NetPayable")) > 14 Then
        Validatesheet_ATI = False
        msgbox_1398AATI = msgbox_1398AATI + "* Length of Sl NO.11 in Schedule Part B-ATI should not be more than 14 characters." & Chr(13)
    End If
    If Len(Sheet202.Range("U_TaxDue10_11")) > 14 Then
        Validatesheet_ATI = False
        msgbox_1398AATI = msgbox_1398AATI + "* Length of Sl NO.13 in Schedule Part B-ATI should not be more than 14 characters." & Chr(13)
    End If
     'Change-01.11.2023.102.Ver.0.6
    If Mid(Sheet1.Range("sheet1.ReturnFileSec"), 4, 4) = "(8A)" And Sheet202.Range("U_NetPayable").value <= 0 Then
        ...
        'msgbox_1398AATI = msgbox_1398AATI + "* ""Since you are filing Updated return, you are expected to have ""Net amount payable"" more than 0 to be able to pay tax u/s 140B.""" & Chr(13)
    ...
    'Added by sai on 16/12/2024====================================
     If Sheet202.Range("U_TaxUS140B") > Sheet202.Range("U_NetPayable").value Then
    
        msgbox_1398AATI = msgbox_1398AATI + "* ""Tax paid u/s 140B is more than ""sl.no.12.Net amount payable"". Hence your updated return may be invalid as it appears to result in refund as provided in clause (c) to first proviso of 139(8A)." & Chr(13)
'
        Validatesheet_ATI = False
  ...
  End If
    ...
    If UCase(Sheet201.Range("U_PreviouslyFiledForThisAY").value) = UCase("No") Then
            If Sheet202.Range("U_RegAssessementTAX").value > 0 Then
                msgbox_1398AATI = msgbox_1398AATI + "If A5 in Part A gen 139(8A)  is ""No"", then ""Regular Assessment Tax"" can't be claimed" & Chr(13) 'Changed on 30/10/2024
                Validatesheet_ATI = False
            End If
...
'Modified by sadineni on 10/12/2025
...
'added by sai on 09/12/2024
      If Sheet202.Range("U_BSRCode1").item(i, 1).value <> "" Or Sheet202.Range("U_DateDep1").item(i, 1).value <> "" Or _
        Sheet202.Range("U_SrlNoOfChaln1").item(i, 1).value <> "" Or Sheet202.Range("U_Amt1").item(i, 1).value <> "" Then
        
        
'        If Sheet202.Range("U_BSRCode1").item(i).value = "" Then
        If Sheet202.Range("U_BSRCode1").item(i, 1).value = "" Then
...
'         msgbox_1398AATI = msgbox_1398AATI + "Invalid BSR code at Sr. No  " & i & "  in Sheet PartB ATI. First three digits from the left stand are for district code; next three digits stand for revenue centre code within the district and last single digit stands for population range code" & Chr(13)
          msgbox_1398AATI = msgbox_1398AATI + "Invalid BSR code at Sr. No  " & i & "  in schedule IT-1. First three digits from the left stand are for district code; next three digits stand for revenue centre code within the district and last single digit stands for population range code" & Chr(13)
         ValidateBSR_IT1 = False
        Exit Function
     End If
UpdateProgressBar
...
'   msgbox_1398AATI = msgbox_1398AATI + "* Please enter valid date in dd/mm/yyyy format in schedule IT at Sr.NO " & i & " in PartB ATI" & Chr(13)
'    msgbox_1398AATI = msgbox_1398AATI + "* Please enter valid date in dd/mm/yyyy format in schedule IT-1 at Sr.NO " & i & " in PartB ATI" & Chr(13)
     msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter valid date in dd/mm/yyyy format in schedule IT-1"" at Sr.No " & i & "" & Chr(13)
    
    Exit Function
End If

If Not chkCompulsory_1398A(DateCredit_IT1(i)) Then
'    msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter date of credit into Govt account in schedule IT at Sr.NO " & i & """" & Chr(13)
     msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter date of credit into Govt account in schedule IT-1"" at Sr.No " & i & "" & Chr(13)
...
'If Not ChkMinInclusiveDate_1398A(Dformat(DateCredit_IT1(i), ""), "2023-01-01") Then '' schedule IT-1

If Not ChkMinInclusiveDate_1398A(Dformat(DateCredit_IT1(i), ""), "2024-01-01") Then 'Changed by sai on 30/10/2024

'    msgbox_1398AATI = msgbox_1398AATI + "*Date of credit to Central government at Sr. No  " & i & " cannot be prior to 01/01/2024 in PartB ATI" & Chr(13)
     msgbox_1398AATI = msgbox_1398AATI + "*Date of credit to Central government at Sr. No  " & i & " cannot be prior to 01/01/2024 in schedule IT-1" & Chr(13)
    ValidateDate_IT1 = False
    Exit Function
End If
...
'    msgbox_1398AATI = msgbox_1398AATI + "* Please enter the Serial Number of Challan at Sr.NO " & i & "in PartB ATI" & Chr(13)
     'msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter the Serial Number of Challan at Sr.No " & i & " in schedule IT-1""" & Chr(13)
     msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter Serial Number of Challan at Sr.No " & i & " in schedule IT-1""" & Chr(13) 'Added by Shrutika(03/12/2025)UR
...
'    msgbox_1398AATI = msgbox_1398AATI + "* Please enter the Tax Paid Amount at Sr.NO " & i & " in PartB ATI" & Chr(13)
    ' msgbox_1398AATI = msgbox_1398AATI + "* Please enter the Tax Paid Amount at Sr.No " & i & " in schedule IT-1" & Chr(13)
     msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter Amount at Sr.No " & i & " in schedule IT-1""" & Chr(13) 'Added by Shrutika(03/12/2025)UR
...
'        Sheet202.Range("U_SrlNoOfChaln2").item(i).value <> "" Or Sheet202.Range("U_Amt2").item(i).value <> "" Then
  ...
  'Added by sai on 09/12/2024
    If Sheet202.Range("U_BSRCode2").Cells(i, 1).value <> "" Or Sheet202.Range("U_DateDep2").Cells(i, 1).value <> "" Or _
        Sheet202.Range("U_SrlNoOfChaln2").Cells(i, 1).value <> "" Or Sheet202.Range("U_Amt2").item(i, 1).value <> "" Then
          
'        If Sheet202.Range("U_BSRCode2").item(i).value = "" Then
         If Sheet202.Range("U_BSRCode2").item(i, 1).value = "" Then
            flag = False
'             msgbox_1398AATI = msgbox_1398AATI + "* Please enter the BSR code in Schedule IT" & Chr(13)
...
'    msgbox_1398AATI = msgbox_1398AATI + "* Please enter the BSR Code at Sr.NO " & i & "in PartB ATI" & Chr(13)
     msgbox_1398AATI = msgbox_1398AATI + "* Please enter the BSR Code at Sr.No " & i & " in Schedule IT-2" & Chr(13)
...
'         msgbox_1398AATI = msgbox_1398AATI + "Invalid BSR code at Sr. No  " & i & "  in Sheet PartB ATI. First three digits from the left stand are for district code; next three digits stand for revenue centre code within the district and last single digit stands for population range code" & Chr(13)
          msgbox_1398AATI = msgbox_1398AATI + "Invalid BSR code at Sr. No  " & i & "  in Sheet Schedule IT-2. First three digits from the left stand are for district code; next three digits stand for revenue centre code within the district and last single digit stands for population range code" & Chr(13)
         ValidateBSR_IT2 = False
        Exit Function
     End If
UpdateProgressBar
...
'   msgbox_1398AATI = msgbox_1398AATI + "* Please enter valid date in dd/mm/yyyy format in schedule IT at Sr.NO " & i & " in PartB ATI" & Chr(13)
'    msgbox_1398AATI = msgbox_1398AATI + "* Please enter valid date in dd/mm/yyyy format in schedule IT-2 at Sr.NO " & i & " in PartB ATI" & Chr(13)
    msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter valid date in dd/mm/yyyy format in schedule IT-2"" at Sr.No " & i & "" & Chr(13)
...
'    msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter date of credit into Govt account in schedule IT. at Sr.NO " & i & """" & Chr(13)
'     msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter date of credit into Govt account in schedule IT-2. at Sr.NO " & i & """" & Chr(13)
      msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter date of credit into Govt account in schedule IT-2"" at Sr.No " & i & "" & Chr(13)
...
If Not ChkMinInclusiveDate_1398A(Dformat(DateCredit_IT2(i), ""), "2023-04-01") Then ''
    msgbox_1398AATI = msgbox_1398AATI + "*Date of credit to Central government at Sr. No  " & i & " cannot be prior to 01/04/2023 in schedule IT-2" & Chr(13)
    ValidateDate_IT2 = False
    Exit Function
End If
Next
...
'    msgbox_1398AATI = msgbox_1398AATI + "* Please enter the Serial Number of Challan at Sr.NO " & i & "in PartB ATI" & Chr(13)
    ' msgbox_1398AATI = msgbox_1398AATI + "* Please enter the Serial Number of Challan at Sr.No " & i & "in schedule IT-2" & Chr(13)
     msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter Serial Number of Challan at Sr.No " & i & " in schedule IT-2""" & Chr(13) 'Added by Shrutika(03/12/2025)UR
...
'    msgbox_1398AATI = msgbox_1398AATI + "* Please enter the Tax Paid Amount at Sr.NO " & i & " in PartB ATI" & Chr(13)
    ' msgbox_1398AATI = msgbox_1398AATI + "* Please enter the Tax Paid Amount at Sr.No " & i & " in schedule IT-2" & Chr(13)
     msgbox_1398AATI = msgbox_1398AATI + "* ""Please enter Amount at Sr.No " & i & " in schedule IT-2""" & Chr(13)  'Added by Shrutika(03/12/2025)UR
