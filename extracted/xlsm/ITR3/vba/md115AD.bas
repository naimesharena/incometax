...
'Public ShareTrans_115AD_1 As Variant   'commented by Chetan C M on 30/01/2026 for AY 2026-27
...
Public end115AD, end115AD1, end115AD2, end115AD3, end115AD4, end115AD5, end115AD7, end115AD8, end115AD9, end115ADB As Long
...
Sub setTableInfo115AD8()
    ...
    For mIntCtr = 1 To mIntCells
        If rangecells.item(mIntCtr).value <> "(Select)" And rangecells.item(mIntCtr).value <> "" And rangecells.item(mIntCtr).Locked = False Then
        ccount = ccount + 1
        End If
    Next
    end115AD8 = ccount
...
Function ValidateTotalSaleValue_115AD_1T() As Boolean
    ...
    For i = 1 To end115AD
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Please enter Total Sale Value at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
...
Function ValidateShareAcq_115AD_1() As Boolean
    ...
    For i = 1 To end115AD
        ...
        If ShareAcq_115AD_1(i) = "(Select)" Then
...
Function ValidateISINCode_115AD() As Boolean
    ...
    For i = 1 To end115AD
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Please enter the ISIN Code. at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
        ...
        If Len(ISINCode_115AD(i)) > 0 Then
            ...
            'start--
                ...
                MsgBox_115AD = MsgBox_115AD + "* Please enter the valid ISIN Code. at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
            '--end
                ValidateISINCode_115AD = False
                Exit Function
            End If
...
Function ValidateNameofShare_115AD() As Boolean
    ...
    For i = 1 To end115AD
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Please enter Name of the Share/Unit at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Name of the Share/Unit at Sr. No." & i & " should not exceed 125 characters.in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
            ValidateNameofShare_115AD = False
            Exit Function
        End If
...
Function ValidateNoofShare_115AD() As Boolean
    ...
    For i = 1 To end115AD
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Please enter the No. of Shares/Units at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end  ValidateNoofShare_115AD = False
            Exit Function
        End If
...
Function ValidateSalePriceperShare_115AD() As Boolean
    ...
    For i = 1 To end115AD
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Please enter the Sale-price per Share/Unit at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
...
Function ValidateCOAwithIndex_115AD() As Boolean
    ...
    For i = 1 To end115AD
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Please enter the Cost of acquisition at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
...
Function ValidateFairMarketValue_115AD() As Boolean
    ...
    For i = 1 To end115AD
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Please enter the Fair Market Value per share/unit as on 31st January,2018 in Column 10 of Schedule 115AD(1)(iii)proviso. If share is Acquired after 31st Jan 2018 , please enter ""0""" & Chr(13)
        '--end
...
Function ValidateExpenditureWholly_115AD() As Boolean
    ...
    For i = 1 To end115AD
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Please enter the Expenditure incurred wholly and exclusively in connection with transfer at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
...
'    ReDim FullValueConsideration_115AD(end115AD)
    ...
    For i = 1 To end115AD
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Total sale Value (4*5) cannot be more than 14 digits at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
        ValidateNonEditableFields_115AD = False
        'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'            Exit Function
        End If
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Cost of acquisition without indexation cannot be more than 14 digits at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
            ValidateNonEditableFields_115AD = False
            'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'            Exit Function
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Long term capital asset acquired before 01.02.2018 cannot be more than 14 digits at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
            ValidateNonEditableFields_115AD = False
            'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'            Exit Function
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Total Fair Market Value of capital asset cannot be more than 14 digits at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
            ValidateNonEditableFields_115AD = False
            'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'            Exit Function
        ...
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Total deductions cannot be more than 14 digits at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
            ValidateNonEditableFields_115AD = False
            'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'            Exit Function
...
'        End If
        ...
        If Not Balance_115AD(i) < 0 Then
            ...
            'start--
                ...
                MsgBox_115AD = MsgBox_115AD + "* Balance cannot be more than 14 digits at Sr. No." & i & " in Schedule 115AD(1)(iii) proviso" & Chr(13)
            '--end
                ValidateNonEditableFields_115AD = False
                'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'                Exit Function
...
Function ValidateTotalFields_115AD() As Boolean
 ...
 'changed by Chetan C M on 10/09/2025
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Total of column number 6 cannot be more than 14 digits in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
 ...
 If Len(Total_COAwithoutIndex_115AD) > 14 Then 'Or Len(Tmparray(0)) > 11 Then
  'changed by Chetan C M on 10/09/2025
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Total of column number 7 cannot be more than 14 digits in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
            ValidateTotalFields_115AD = False
            'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'            Exit Function
 ...
 'changed by Chetan C M on 10/09/2025
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Total of column number 8 cannot be more than 14 digits in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
            ValidateTotalFields_115AD = False
            'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'            Exit Function
 ...
 'changed by Chetan C M on 10/09/2025
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Total of column number 9 cannot be more than 14 digits in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
            ValidateTotalFields_115AD = False
            'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'            Exit Function
 ...
 'changed by Chetan C M on 10/09/2025
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Total of column number 11 cannot be more than 14 digits in Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
            ValidateTotalFields_115AD = False
            'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'            Exit Function
 ...
 'changed by Chetan C M on 10/09/2025
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Total of column number 12 cannot be more than 14 digits Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
            ValidateTotalFields_115AD = False
            'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'            Exit Function
 ...
 'changed by Chetan C M on 10/09/2025
        'start--
            ...
            MsgBox_115AD = MsgBox_115AD + "* Total of column number 13 cannot be more than 14 digits Schedule 115AD(1)(iii) proviso" & Chr(13)
        '--end
            ValidateTotalFields_115AD = False
            'commented by Chetan C M on 13/10/2025 for SIT-SIT-95268 (issue 11)
'            Exit Function
...
'    setTableInfo115AD6
    ...
    end115AD = WorksheetFunction.Max(end115AD, end115AD1, end115AD2, end115AD3, end115AD4, end115AD5, end115AD7, end115AD8, end115AD9, end115ADB)
    
    If Not ValidateShareAcq_115AD_1 Then Validate115AD_1 = False
    
'If Not ValidateShareTra_115AD_1 Then Validate115AD_1 = False 'Added by Aavula Naresh   'commented by Chetan C M for AY 2026-27
