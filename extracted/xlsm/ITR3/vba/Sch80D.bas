...
'added by Chetan C M on 25/05/2025 for AY 2025-26
'start--
'TableA1
...
If Not Validate_80D Then
   ...
   ' MsgBox (MsgBox_80D), vbOKOnly, vbMessgaeCaption
    fmsgbox (MsgBox_80D)
    CloseMsg
End If
End Sub
...
Function ChkFamilyMember() As Boolean
    ...
    If Sheet55.Range("DropDown_ValueOf_FamilyM_80D").MergeArea.Locked = False Then
   ...
   If Sheet55.Range("DropDown_ValueOf_SC_80D").MergeArea.Locked = False Then
...
Function ValidateAmtB2_80D() As Boolean
    ...
    Dim rangecells As Range
    Dim i As Long
    'Set rangecells = Sheet55.Range("AmtB2.80D").Cells  'Konda updated on 28-05-2025
