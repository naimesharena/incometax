...
Option Explicit
Public TradingNature1, TradingAmount1, TradingNature2, TradingAmount2, MsgBx_TradingNature1, MsgBx_TradingNature2, MsgBx_TradingNature3, MsgBx_TradingNature4 As Variant
...
'start--
    ...
    If Not ValidateTrading Then
    Sheet49.Activate
    fmsgboxsmall (MsgBx_TradingNature4)
    CloseMsg
    End If
'--end
...
Function ValidateTrading() As Boolean

    ValidateTrading = True
   
        
    If Sheet49.Range("IncomeIntraTrading_12b").value > Sheet49.Range("turnoverintraTrading_12a").value Then
        MsgBx_TradingNature4 = MsgBx_TradingNature4 + "*Income from Intraday Trading can not be more than Turnover from Intraday Trading in Schedule Trading Accoun" & Chr(13)
        ValidateTrading = False
    End If
    
    If Sheet49.Range("turnoverintraTrading_12a").value > 0 And Sheet49.Range("IncomeIntraTrading_12b").value = 0 Then
        MsgBx_TradingNature4 = MsgBx_TradingNature4 + "* ""Please enter profit/loss from Intraday Trading in Schedule Trading Account""" & Chr(13)
        ValidateTrading = False
    End If
    
    If Sheet49.Range("IncomeFO_Trading_12d").value > Sheet49.Range("turnoverFO_Trading_12c").value Then
        MsgBx_TradingNature4 = MsgBx_TradingNature4 + "*Income from Futures & Options Trading  can not be more than Turnover from Futures & Options Trading in Schedule Trading Account" & Chr(13)
        ValidateTrading = False
    End If
    
    If Sheet49.Range("turnoverFO_Trading_12c").value > 0 And Sheet49.Range("IncomeFO_Trading_12d").value = 0 Then
        MsgBx_TradingNature4 = MsgBx_TradingNature4 + "* ""Please enter profit/loss from Futures & Options Trading in Schedule Trading Account""" & Chr(13)
        ValidateTrading = False
    End If
