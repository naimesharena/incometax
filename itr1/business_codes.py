...
Counts pinned from the official AY 2026-27 utilities:
  * ``NOB_MASTER``: 356 codes (ITR3 dropdown `Nature_of_Business`)
  * ``NOB_44AD``: 315 codes (ITR4 dropdown `NOB44AD`)
  * ``NOB_44ADA``: 38 codes (ITR4 dropdown `NOB44ADA`)
  * ``NOB_44AE``: 7 codes (ITR4 dropdown `NOB`)
"""

from __future__ import annotations

# Complete official nature-of-business master (ITR-3 utility)
# (code, official label) pairs, in official dropdown order.
NOB_MASTER = (
...
# Official dropdown for presumptive business u/s 44AD (ITR-4)
# (code, official label) pairs, in official dropdown order.
NOB_44AD = (
    ("01001", "Growing and manufacturing of tea"),
    ("01002", "Growing and manufacturing of coffee"),
...
# Official dropdown for presumptive profession u/s 44ADA (ITR-4)
# (code, official label) pairs, in official dropdown order.
NOB_44ADA = (
    ("14001", "Software development"),
    ("14002", "Other software consultancy"),
...
# Official dropdown for goods carriages u/s 44AE (ITR-4)
# (code, official label) pairs, in official dropdown order.
NOB_44AE = (
    ("08001", "Renting of land transport equipment"),
    ("11002", "Packers and movers"),
...
NOB_MASTER_BY_CODE = dict(NOB_MASTER)
NOB_44AD_BY_CODE = dict(NOB_44AD)
NOB_44ADA_BY_CODE = dict(NOB_44ADA)
NOB_44AE_BY_CODE = dict(NOB_44AE)
